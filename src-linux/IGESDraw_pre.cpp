...
// classes forward declarations only
    py::class_<IGESDraw , shared_ptr<IGESDraw> >(m,"IGESDraw",R"#(This package contains the group of classes necessary for Structure Entities implied in Drawings and Structured Graphics (Sets for drawing, Drawings and Views).)#");
    ...
    py::class_<IGESDraw_HArray1OfConnectPoint ,opencascade::handle<IGESDraw_HArray1OfConnectPoint> , IGESDraw_Array1OfConnectPoint, Standard_Transient>(m,"IGESDraw_HArray1OfConnectPoint",R"#()#");
    py::class_<IGESDraw_HArray1OfViewKindEntity ,opencascade::handle<IGESDraw_HArray1OfViewKindEntity> , IGESDraw_Array1OfViewKindEntity, Standard_Transient>(m,"IGESDraw_HArray1OfViewKindEntity",R"#()#");
    ...
    py::class_<IGESDraw_ToolCircArraySubfigure , shared_ptr<IGESDraw_ToolCircArraySubfigure> >(m,"IGESDraw_ToolCircArraySubfigure",R"#(Tool to work on a CircArraySubfigure. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolConnectPoint , shared_ptr<IGESDraw_ToolConnectPoint> >(m,"IGESDraw_ToolConnectPoint",R"#(Tool to work on a ConnectPoint. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolDrawing , shared_ptr<IGESDraw_ToolDrawing> >(m,"IGESDraw_ToolDrawing",R"#(Tool to work on a Drawing. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolDrawingWithRotation , shared_ptr<IGESDraw_ToolDrawingWithRotation> >(m,"IGESDraw_ToolDrawingWithRotation",R"#(Tool to work on a DrawingWithRotation. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolLabelDisplay , shared_ptr<IGESDraw_ToolLabelDisplay> >(m,"IGESDraw_ToolLabelDisplay",R"#(Tool to work on a LabelDisplay. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolNetworkSubfigure , shared_ptr<IGESDraw_ToolNetworkSubfigure> >(m,"IGESDraw_ToolNetworkSubfigure",R"#(Tool to work on a NetworkSubfigure. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolNetworkSubfigureDef , shared_ptr<IGESDraw_ToolNetworkSubfigureDef> >(m,"IGESDraw_ToolNetworkSubfigureDef",R"#(Tool to work on a NetworkSubfigureDef. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolPerspectiveView , shared_ptr<IGESDraw_ToolPerspectiveView> >(m,"IGESDraw_ToolPerspectiveView",R"#(Tool to work on a PerspectiveView. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolPlanar , shared_ptr<IGESDraw_ToolPlanar> >(m,"IGESDraw_ToolPlanar",R"#(Tool to work on a Planar. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolRectArraySubfigure , shared_ptr<IGESDraw_ToolRectArraySubfigure> >(m,"IGESDraw_ToolRectArraySubfigure",R"#(Tool to work on a RectArraySubfigure. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolSegmentedViewsVisible , shared_ptr<IGESDraw_ToolSegmentedViewsVisible> >(m,"IGESDraw_ToolSegmentedViewsVisible",R"#(Tool to work on a SegmentedViewsVisible. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolView , shared_ptr<IGESDraw_ToolView> >(m,"IGESDraw_ToolView",R"#(Tool to work on a View. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolViewsVisible , shared_ptr<IGESDraw_ToolViewsVisible> >(m,"IGESDraw_ToolViewsVisible",R"#(Tool to work on a ViewsVisible. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDraw_ToolViewsVisibleWithAttr , shared_ptr<IGESDraw_ToolViewsVisibleWithAttr> >(m,"IGESDraw_ToolViewsVisibleWithAttr",R"#(Tool to work on a ViewsVisibleWithAttr. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
