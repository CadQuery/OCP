...
// classes forward declarations only
    ...
    py::class_<LDOM_SBuffer , shared_ptr<LDOM_SBuffer>  >(m,"LDOM_SBuffer",R"#(Class LDOM_SBuffer inherits streambuf and redefines some virtual methods of it (overflow() and xsputn()). This class contains pointers on first and current element of sequence, also it has methods for the sequence management.)#");
    ...
    py::class_<LDOM_BasicText , shared_ptr<LDOM_BasicText>  , LDOM_BasicNode >(m,"LDOM_BasicText",R"#(None)#");
