...
// classes
    ...
    static_cast<py::class_<BRepPrim_OneAxis ,std::unique_ptr<BRepPrim_OneAxis> ,Py_BRepPrim_OneAxis >>(m.attr("BRepPrim_OneAxis"))
...
;
    ...
    static_cast<py::class_<BRepPrim_GWedge ,std::unique_ptr<BRepPrim_GWedge>  >>(m.attr("BRepPrim_GWedge"))
...
;
    ...
    static_cast<py::class_<BRepPrim_Revolution ,std::unique_ptr<BRepPrim_Revolution>  , BRepPrim_OneAxis >>(m.attr("BRepPrim_Revolution"))
...
;
    ...
    static_cast<py::class_<BRepPrim_Cylinder ,std::unique_ptr<BRepPrim_Cylinder>  , BRepPrim_Revolution >>(m.attr("BRepPrim_Cylinder"))
...
;
    ...
    static_cast<py::class_<BRepPrim_Torus ,std::unique_ptr<BRepPrim_Torus>  , BRepPrim_Revolution >>(m.attr("BRepPrim_Torus"))
...
;
    ...
    static_cast<py::class_<BRepPrim_Wedge ,std::unique_ptr<BRepPrim_Wedge>  , BRepPrim_GWedge >>(m.attr("BRepPrim_Wedge"))
...
;
    ...
    static_cast<py::class_<BRepPrim_Builder ,std::unique_ptr<BRepPrim_Builder>  >>(m.attr("BRepPrim_Builder"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepPrim_Cone ,std::unique_ptr<BRepPrim_Cone>  , BRepPrim_Revolution >>(m.attr("BRepPrim_Cone"))
...
;
    ...
    static_cast<py::class_<BRepPrim_Sphere ,std::unique_ptr<BRepPrim_Sphere>  , BRepPrim_Revolution >>(m.attr("BRepPrim_Sphere"))
        .def(py::init< const Standard_Real >()  , py::arg("Radius") )
        .def(py::init< const gp_Pnt &,const Standard_Real >()  , py::arg("Center"),  py::arg("Radius") )
        .def(py::init< const gp_Ax2 &,const Standard_Real >()  , py::arg("Axes"),  py::arg("Radius") )
        .def("MakeEmptyLateralFace",
...
;
    ...
    static_cast<py::class_<BRepPrim_FaceBuilder ,std::unique_ptr<BRepPrim_FaceBuilder>  >>(m.attr("BRepPrim_FaceBuilder"))
        .def(py::init<  >()  )
