...
// classes
    ...
    static_cast<py::class_<TopOpeBRep_PointClassifier ,std::unique_ptr<TopOpeBRep_PointClassifier>  >>(m.attr("TopOpeBRep_PointClassifier"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_Point2d ,std::unique_ptr<TopOpeBRep_Point2d>  >>(m.attr("TopOpeBRep_Point2d"))
        .def(py::init<  >()  )
        .def("Dump",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_Hctxff2d ,opencascade::handle<TopOpeBRep_Hctxff2d>  , Standard_Transient >>(m.attr("TopOpeBRep_Hctxff2d"))
        ...
        .def("GetTolerances",
             (void (TopOpeBRep_Hctxff2d::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_Hctxff2d::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_Hctxff2d::GetTolerances),
             R"#(None)#"  , py::arg("Tol1"),  py::arg("Tol2"))
        .def("GetMaxTolerance",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_WPointInterIterator ,std::unique_ptr<TopOpeBRep_WPointInterIterator>  >>(m.attr("TopOpeBRep_WPointInterIterator"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<TopOpeBRep ,std::unique_ptr<TopOpeBRep>>(m,"TopOpeBRep");

    static_cast<py::class_<TopOpeBRep ,std::unique_ptr<TopOpeBRep>  >>(m.attr("TopOpeBRep"))
        .def_static("Print_s",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_ShapeScanner ,std::unique_ptr<TopOpeBRep_ShapeScanner>  >>(m.attr("TopOpeBRep_ShapeScanner"))
        .def(py::init<  >()  )
        .def("Clear",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_HArray1OfLineInter ,std::unique_ptr<TopOpeBRep_HArray1OfLineInter>  >>(m.attr("TopOpeBRep_HArray1OfLineInter"))
...
;
    ...
    static_cast<py::class_<TopOpeBRep_FacesIntersector ,std::unique_ptr<TopOpeBRep_FacesIntersector>  >>(m.attr("TopOpeBRep_FacesIntersector"))
        .def(py::init<  >()  )
        .def("Perform",
        ...
        .def("GetTolerances",
             (void (TopOpeBRep_FacesIntersector::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_FacesIntersector::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_FacesIntersector::GetTolerances),
             R"#(Return the tolerance values used in the last Perform() call If ForceTolerances() has been called, return the given values. If not, return values extracted from shapes.)#"  , py::arg("tolarc"),  py::arg("toltang"))
;


    static_cast<py::class_<TopOpeBRep_WPointInter ,std::unique_ptr<TopOpeBRep_WPointInter>  >>(m.attr("TopOpeBRep_WPointInter"))
        .def(py::init<  >()  )
        .def("Set",
             ...
             R"#(None)#"  , py::arg("P"))
        .def("ParametersOnS1",
             (void (TopOpeBRep_WPointInter::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_WPointInter::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_WPointInter::ParametersOnS1),
             R"#(None)#"  , py::arg("U"),  py::arg("V"))
        .def("ParametersOnS2",
             (void (TopOpeBRep_WPointInter::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_WPointInter::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_WPointInter::ParametersOnS2),
             R"#(None)#"  , py::arg("U"),  py::arg("V"))
        .def("Parameters",
             (void (TopOpeBRep_WPointInter::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_WPointInter::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_WPointInter::Parameters),
             R"#(None)#"  , py::arg("U1"),  py::arg("V1"),  py::arg("U2"),  py::arg("V2"))
        .def("ValueOnS1",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_FaceEdgeIntersector ,std::unique_ptr<TopOpeBRep_FaceEdgeIntersector>  >>(m.attr("TopOpeBRep_FaceEdgeIntersector"))
        .def(py::init<  >()  )
        .def("Perform",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_DSFiller ,std::unique_ptr<TopOpeBRep_DSFiller>  >>(m.attr("TopOpeBRep_DSFiller"))
        .def(py::init<  >()  )
        .def("Insert",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_Bipoint ,std::unique_ptr<TopOpeBRep_Bipoint>  >>(m.attr("TopOpeBRep_Bipoint"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRep_LineInter ,std::unique_ptr<TopOpeBRep_LineInter>  >>(m.attr("TopOpeBRep_LineInter"))
        .def(py::init<  >()  )
        .def("SetLine",
        ...
        .def("SetVPBounds",
             ...
             R"#(None)#" )
        .def("VPBounds",
             (void (TopOpeBRep_LineInter::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRep_LineInter::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&TopOpeBRep_LineInter::VPBounds),
             R"#(None)#"  , py::arg("f"),  py::arg("l"),  py::arg("n"))
        .def("IsPeriodic",
        ...
        .def("Period",
             ...
             R"#(None)#" )
        .def("Bounds",
             (void (TopOpeBRep_LineInter::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_LineInter::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_LineInter::Bounds),
             R"#(None)#"  , py::arg("f"),  py::arg("l"))
        .def("HasVInternal",
        ...
        .def("GetTraceIndex",
             (void (TopOpeBRep_LineInter::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRep_LineInter::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&TopOpeBRep_LineInter::GetTraceIndex),
             R"#(None)#"  , py::arg("exF1"),  py::arg("exF2"))
...
;
    ...
    register_default_constructor<TopOpeBRep_FFTransitionTool ,std::unique_ptr<TopOpeBRep_FFTransitionTool>>(m,"TopOpeBRep_FFTransitionTool");

    static_cast<py::class_<TopOpeBRep_FFTransitionTool ,std::unique_ptr<TopOpeBRep_FFTransitionTool>  >>(m.attr("TopOpeBRep_FFTransitionTool"))
...
;
    ...
    static_cast<py::class_<TopOpeBRep_HArray1OfVPointInter ,std::unique_ptr<TopOpeBRep_HArray1OfVPointInter>  >>(m.attr("TopOpeBRep_HArray1OfVPointInter"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    register_default_constructor<TopOpeBRep_PointGeomTool ,std::unique_ptr<TopOpeBRep_PointGeomTool>>(m,"TopOpeBRep_PointGeomTool");

    static_cast<py::class_<TopOpeBRep_PointGeomTool ,std::unique_ptr<TopOpeBRep_PointGeomTool>  >>(m.attr("TopOpeBRep_PointGeomTool"))
...
;
    ...
    static_cast<py::class_<TopOpeBRep_EdgesFiller ,std::unique_ptr<TopOpeBRep_EdgesFiller>  >>(m.attr("TopOpeBRep_EdgesFiller"))
        .def(py::init<  >()  )
        .def("Insert",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_VPointInter ,std::unique_ptr<TopOpeBRep_VPointInter>  >>(m.attr("TopOpeBRep_VPointInter"))
        .def(py::init<  >()  )
        .def("SetPoint",
        ...
        .def("GetShapes",
             (void (TopOpeBRep_VPointInter::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRep_VPointInter::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&TopOpeBRep_VPointInter::GetShapes),
             R"#(None)#"  , py::arg("I1"),  py::arg("I2"))
        .def("TransitionOnS1",
        ...
        .def("IsOnDomS2",
             ...
             R"#(None)#" )
        .def("ParametersOnS1",
             (void (TopOpeBRep_VPointInter::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_VPointInter::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_VPointInter::ParametersOnS1),
             R"#(None)#"  , py::arg("u"),  py::arg("v"))
        .def("ParametersOnS2",
             (void (TopOpeBRep_VPointInter::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_VPointInter::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_VPointInter::ParametersOnS2),
             R"#(None)#"  , py::arg("u"),  py::arg("v"))
        .def("Value",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_EdgesIntersector ,std::unique_ptr<TopOpeBRep_EdgesIntersector>  >>(m.attr("TopOpeBRep_EdgesIntersector"))
        .def(py::init<  >()  )
        .def("SetFaces",
        ...
        .def("ToleranceMax",
             ...
             R"#(None)#" )
        .def("Tolerances",
             (void (TopOpeBRep_EdgesIntersector::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_EdgesIntersector::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_EdgesIntersector::Tolerances),
             R"#(None)#"  , py::arg("tol1"),  py::arg("tol2"))
        .def("NbPoints",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_FaceEdgeFiller ,std::unique_ptr<TopOpeBRep_FaceEdgeFiller>  >>(m.attr("TopOpeBRep_FaceEdgeFiller"))
        .def(py::init<  >()  )
        .def("Insert",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_VPointInterClassifier ,std::unique_ptr<TopOpeBRep_VPointInterClassifier>  >>(m.attr("TopOpeBRep_VPointInterClassifier"))
        .def(py::init<  >()  )
        .def("VPointPosition",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_ShapeIntersector ,std::unique_ptr<TopOpeBRep_ShapeIntersector>  >>(m.attr("TopOpeBRep_ShapeIntersector"))
        .def(py::init<  >()  )
        ...
        .def("GetTolerances",
             (void (TopOpeBRep_ShapeIntersector::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRep_ShapeIntersector::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRep_ShapeIntersector::GetTolerances),
             R"#(return MAX of intersection tolerances with which FacesIntersector from TopOpeBRep was working.)#"  , py::arg("tol1"),  py::arg("tol2"))
        .def("DumpCurrent",
...
;
    ...
    register_default_constructor<TopOpeBRep_GeomTool ,std::unique_ptr<TopOpeBRep_GeomTool>>(m,"TopOpeBRep_GeomTool");

    static_cast<py::class_<TopOpeBRep_GeomTool ,std::unique_ptr<TopOpeBRep_GeomTool>  >>(m.attr("TopOpeBRep_GeomTool"))
...
;
    ...
    static_cast<py::class_<TopOpeBRep_FacesFiller ,std::unique_ptr<TopOpeBRep_FacesFiller>  >>(m.attr("TopOpeBRep_FacesFiller"))
        .def(py::init<  >()  )
        .def("Insert",
        ...
        .def("SetTraceIndex",
             ...
             R"#(None)#"  , py::arg("exF1"),  py::arg("exF2"))
        .def("GetTraceIndex",
             (void (TopOpeBRep_FacesFiller::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRep_FacesFiller::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&TopOpeBRep_FacesFiller::GetTraceIndex),
             R"#(None)#"  , py::arg("exF1"),  py::arg("exF2"))
        .def_static("Lminmax_s",
                    (void (*)( const TopOpeBRep_LineInter & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const TopOpeBRep_LineInter & ,  Standard_Real & ,  Standard_Real &  ) >(&TopOpeBRep_FacesFiller::Lminmax),
                    R"#(Computes <pmin> and <pmax> the upper and lower bounds of <L> enclosing all vpoints.)#"  , py::arg("L"),  py::arg("pmin"),  py::arg("pmax"))
...
;
    ...
    static_cast<py::class_<TopOpeBRep_VPointInterIterator ,std::unique_ptr<TopOpeBRep_VPointInterIterator>  >>(m.attr("TopOpeBRep_VPointInterIterator"))
        .def(py::init<  >()  )
        .def(py::init< const TopOpeBRep_LineInter & >()  , py::arg("LI") )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TopOpeBRep_ShapeIntersector2d ,std::unique_ptr<TopOpeBRep_ShapeIntersector2d>  >>(m.attr("TopOpeBRep_ShapeIntersector2d"))
        .def(py::init<  >()  )
        .def("InitIntersection",
