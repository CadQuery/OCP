...
;
    ...
    register_default_constructor<Standard ,std::unique_ptr<Standard>>(m,"Standard");

    static_cast<py::class_<Standard ,std::unique_ptr<Standard>  >>(m.attr("Standard"))
...
;
    ...
    static_cast<py::class_<Standard_GUID ,std::unique_ptr<Standard_GUID>  >>(m.attr("Standard_GUID"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Standard_ErrorHandler ,std::unique_ptr<Standard_ErrorHandler>  >>(m.attr("Standard_ErrorHandler"))
        .def(py::init<  >()  )
        .def("Destroy",
