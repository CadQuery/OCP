...
// classes
    ...
    static_cast<py::class_<LocOpe_BuildWires ,std::unique_ptr<LocOpe_BuildWires>  >>(m.attr("LocOpe_BuildWires"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<LocOpe_Pipe ,std::unique_ptr<LocOpe_Pipe>  >>(m.attr("LocOpe_Pipe"))
...
;
    ...
    static_cast<py::class_<LocOpe_PntFace ,std::unique_ptr<LocOpe_PntFace>  >>(m.attr("LocOpe_PntFace"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<LocOpe ,std::unique_ptr<LocOpe>>(m,"LocOpe");

    static_cast<py::class_<LocOpe ,std::unique_ptr<LocOpe>  >>(m.attr("LocOpe"))
        .def_static("Closed_s",
...
;
    ...
    static_cast<py::class_<LocOpe_BuildShape ,std::unique_ptr<LocOpe_BuildShape>  >>(m.attr("LocOpe_BuildShape"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<LocOpe_Generator ,std::unique_ptr<LocOpe_Generator>  >>(m.attr("LocOpe_Generator"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
        .def("Init",
...
;
    ...
    static_cast<py::class_<LocOpe_RevolutionForm ,std::unique_ptr<LocOpe_RevolutionForm>  >>(m.attr("LocOpe_RevolutionForm"))
        .def(py::init<  >()  )
        .def("Perform",
...
;
    ...
    static_cast<py::class_<LocOpe_SplitDrafts ,std::unique_ptr<LocOpe_SplitDrafts>  >>(m.attr("LocOpe_SplitDrafts"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
        .def("Init",
...
;
    ...
    static_cast<py::class_<LocOpe_Spliter ,std::unique_ptr<LocOpe_Spliter>  >>(m.attr("LocOpe_Spliter"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
        .def("Init",
...
;
    ...
    static_cast<py::class_<LocOpe_LinearForm ,std::unique_ptr<LocOpe_LinearForm>  >>(m.attr("LocOpe_LinearForm"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<LocOpe_FindEdges ,std::unique_ptr<LocOpe_FindEdges>  >>(m.attr("LocOpe_FindEdges"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<LocOpe_CurveShapeIntersector ,std::unique_ptr<LocOpe_CurveShapeIntersector>  >>(m.attr("LocOpe_CurveShapeIntersector"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<LocOpe_Gluer ,std::unique_ptr<LocOpe_Gluer>  >>(m.attr("LocOpe_Gluer"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<LocOpe_Prism ,std::unique_ptr<LocOpe_Prism>  >>(m.attr("LocOpe_Prism"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<LocOpe_SplitShape ,std::unique_ptr<LocOpe_SplitShape>  >>(m.attr("LocOpe_SplitShape"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
        .def("Init",
...
;
    ...
    static_cast<py::class_<LocOpe_FindEdgesInFace ,std::unique_ptr<LocOpe_FindEdgesInFace>  >>(m.attr("LocOpe_FindEdgesInFace"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<LocOpe_DPrism ,std::unique_ptr<LocOpe_DPrism>  >>(m.attr("LocOpe_DPrism"))
...
;
    ...
    static_cast<py::class_<LocOpe_CSIntersector ,std::unique_ptr<LocOpe_CSIntersector>  >>(m.attr("LocOpe_CSIntersector"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
        .def("Init",
...
;
    ...
    static_cast<py::class_<LocOpe_Revol ,std::unique_ptr<LocOpe_Revol>  >>(m.attr("LocOpe_Revol"))
        .def(py::init<  >()  )
        .def("Perform",
