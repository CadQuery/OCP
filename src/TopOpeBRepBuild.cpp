...
// classes
    ...
    static_cast<py::class_<TopOpeBRepBuild_LoopClassifier ,std::unique_ptr<TopOpeBRepBuild_LoopClassifier> ,Py_TopOpeBRepBuild_LoopClassifier >>(m.attr("TopOpeBRepBuild_LoopClassifier"))
        .def("Compare",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_LoopSet ,std::unique_ptr<TopOpeBRepBuild_LoopSet>  >>(m.attr("TopOpeBRepBuild_LoopSet"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_AreaBuilder ,std::unique_ptr<TopOpeBRepBuild_AreaBuilder>  >>(m.attr("TopOpeBRepBuild_AreaBuilder"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_ShapeSet ,std::unique_ptr<TopOpeBRepBuild_ShapeSet>  >>(m.attr("TopOpeBRepBuild_ShapeSet"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_Builder ,std::unique_ptr<TopOpeBRepBuild_Builder>  >>(m.attr("TopOpeBRepBuild_Builder"))
        ...
        .def("KPissososh",
             ...
             R"#(None)#"  , py::arg("S"))
        .def("KPiskoleanalyse",
             (void (TopOpeBRepBuild_Builder::*)( const TopAbs_State ,  const TopAbs_State ,  const TopAbs_State ,  const TopAbs_State ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRepBuild_Builder::*)( const TopAbs_State ,  const TopAbs_State ,  const TopAbs_State ,  const TopAbs_State ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&TopOpeBRepBuild_Builder::KPiskoleanalyse),
             R"#(None)#"  , py::arg("FT1"),  py::arg("FT2"),  py::arg("ST1"),  py::arg("ST2"),  py::arg("I"),  py::arg("I1"),  py::arg("I2"))
        .def("KPiskoletgeanalyse",
             (void (TopOpeBRepBuild_Builder::*)( const TopOpeBRepDS_Config ,  const TopAbs_State ,  const TopAbs_State ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRepBuild_Builder::*)( const TopOpeBRepDS_Config ,  const TopAbs_State ,  const TopAbs_State ,  Standard_Integer &  ) const>(&TopOpeBRepBuild_Builder::KPiskoletgeanalyse),
             R"#(None)#"  , py::arg("Conf"),  py::arg("ST1"),  py::arg("ST2"),  py::arg("I"))
        .def("KPisdisjanalyse",
             (void (TopOpeBRepBuild_Builder::*)( const TopAbs_State ,  const TopAbs_State ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRepBuild_Builder::*)( const TopAbs_State ,  const TopAbs_State ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&TopOpeBRepBuild_Builder::KPisdisjanalyse),
             R"#(None)#"  , py::arg("ST1"),  py::arg("ST2"),  py::arg("I"),  py::arg("IC1"),  py::arg("IC2"))
        .def("KPclassF",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_BlockIterator ,std::unique_ptr<TopOpeBRepBuild_BlockIterator>  >>(m.attr("TopOpeBRepBuild_BlockIterator"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_PaveSet ,std::unique_ptr<TopOpeBRepBuild_PaveSet>  , TopOpeBRepBuild_LoopSet >>(m.attr("TopOpeBRepBuild_PaveSet"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_ShellToSolid ,std::unique_ptr<TopOpeBRepBuild_ShellToSolid>  >>(m.attr("TopOpeBRepBuild_ShellToSolid"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_WireToFace ,std::unique_ptr<TopOpeBRepBuild_WireToFace>  >>(m.attr("TopOpeBRepBuild_WireToFace"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_SolidBuilder ,std::unique_ptr<TopOpeBRepBuild_SolidBuilder>  >>(m.attr("TopOpeBRepBuild_SolidBuilder"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_Area2dBuilder ,std::unique_ptr<TopOpeBRepBuild_Area2dBuilder>  , TopOpeBRepBuild_AreaBuilder >>(m.attr("TopOpeBRepBuild_Area2dBuilder"))
        .def(py::init<  >()  )
        .def(py::init< TopOpeBRepBuild_LoopSet &,TopOpeBRepBuild_LoopClassifier &,const Standard_Boolean >()  , py::arg("LS"),  py::arg("LC"),  py::arg("ForceClass")=static_cast<const Standard_Boolean>(Standard_False) )
        .def("InitAreaBuilder",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_FuseFace ,std::unique_ptr<TopOpeBRepBuild_FuseFace>  >>(m.attr("TopOpeBRepBuild_FuseFace"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_GTopo ,std::unique_ptr<TopOpeBRepBuild_GTopo>  >>(m.attr("TopOpeBRepBuild_GTopo"))
        .def(py::init<  >()  )
        ...
        .def("GState",
             ...
             R"#(None)#"  , py::arg("I"))
        .def("Index",
             (void (TopOpeBRepBuild_GTopo::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRepBuild_GTopo::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const>(&TopOpeBRepBuild_GTopo::Index),
             R"#(None)#"  , py::arg("II"),  py::arg("i1"),  py::arg("i2"))
        .def("DumpVal",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_CorrectFace2d ,std::unique_ptr<TopOpeBRepBuild_CorrectFace2d>  >>(m.attr("TopOpeBRepBuild_CorrectFace2d"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_ShapeListOfShape ,std::unique_ptr<TopOpeBRepBuild_ShapeListOfShape>  >>(m.attr("TopOpeBRepBuild_ShapeListOfShape"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
...
;
    ...
    register_default_constructor<TopOpeBRepBuild_GTool ,std::unique_ptr<TopOpeBRepBuild_GTool>>(m,"TopOpeBRepBuild_GTool");

    static_cast<py::class_<TopOpeBRepBuild_GTool ,std::unique_ptr<TopOpeBRepBuild_GTool>  >>(m.attr("TopOpeBRepBuild_GTool"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_Builder1 ,std::unique_ptr<TopOpeBRepBuild_Builder1>  , TopOpeBRepBuild_Builder >>(m.attr("TopOpeBRepBuild_Builder1"))
        .def(py::init< const TopOpeBRepDS_BuildTool & >()  , py::arg("BT") )
        .def("Clear",
        ...
        .def("PerformPieceIn2D",
             (void (TopOpeBRepBuild_Builder1::*)( const TopoDS_Edge & ,  const TopoDS_Edge & ,  const TopoDS_Face & ,  const TopoDS_Face & ,  const TopOpeBRepBuild_GTopo & ,  Standard_Boolean &  ) ) static_cast<void (TopOpeBRepBuild_Builder1::*)( const TopoDS_Edge & ,  const TopoDS_Edge & ,  const TopoDS_Face & ,  const TopoDS_Face & ,  const TopOpeBRepBuild_GTopo & ,  Standard_Boolean &  ) >(&TopOpeBRepBuild_Builder1::PerformPieceIn2D),
             R"#(None)#"  , py::arg("aPieceToPerform"),  py::arg("aOriginalEdge"),  py::arg("edgeFace"),  py::arg("toFace"),  py::arg("G"),  py::arg("keep"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_Area1dBuilder ,std::unique_ptr<TopOpeBRepBuild_Area1dBuilder>  , TopOpeBRepBuild_AreaBuilder >>(m.attr("TopOpeBRepBuild_Area1dBuilder"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_Area3dBuilder ,std::unique_ptr<TopOpeBRepBuild_Area3dBuilder>  , TopOpeBRepBuild_AreaBuilder >>(m.attr("TopOpeBRepBuild_Area3dBuilder"))
        .def(py::init<  >()  )
        .def(py::init< TopOpeBRepBuild_LoopSet &,TopOpeBRepBuild_LoopClassifier &,const Standard_Boolean >()  , py::arg("LS"),  py::arg("LC"),  py::arg("ForceClass")=static_cast<const Standard_Boolean>(Standard_False) )
        .def("InitAreaBuilder",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_BlockBuilder ,std::unique_ptr<TopOpeBRepBuild_BlockBuilder>  >>(m.attr("TopOpeBRepBuild_BlockBuilder"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_GIter ,std::unique_ptr<TopOpeBRepBuild_GIter>  >>(m.attr("TopOpeBRepBuild_GIter"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_WireEdgeSet ,std::unique_ptr<TopOpeBRepBuild_WireEdgeSet>  , TopOpeBRepBuild_ShapeSet >>(m.attr("TopOpeBRepBuild_WireEdgeSet"))
        ...
        .def_static("IsUVISO_s",
                    (void (*)( const TopoDS_Edge & ,  const TopoDS_Face & ,  Standard_Boolean & ,  Standard_Boolean &  ) ) static_cast<void (*)( const TopoDS_Edge & ,  const TopoDS_Face & ,  Standard_Boolean & ,  Standard_Boolean &  ) >(&TopOpeBRepBuild_WireEdgeSet::IsUVISO),
                    R"#(None)#"  , py::arg("E"),  py::arg("F"),  py::arg("uiso"),  py::arg("viso"))
;


    static_cast<py::class_<TopOpeBRepBuild_CompositeClassifier ,std::unique_ptr<TopOpeBRepBuild_CompositeClassifier> ,Py_TopOpeBRepBuild_CompositeClassifier , TopOpeBRepBuild_LoopClassifier >>(m.attr("TopOpeBRepBuild_CompositeClassifier"))
        .def("Compare",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_EdgeBuilder ,std::unique_ptr<TopOpeBRepBuild_EdgeBuilder>  , TopOpeBRepBuild_Area1dBuilder >>(m.attr("TopOpeBRepBuild_EdgeBuilder"))
        .def(py::init<  >()  )
        .def(py::init< TopOpeBRepBuild_PaveSet &,TopOpeBRepBuild_PaveClassifier &,const Standard_Boolean >()  , py::arg("LS"),  py::arg("LC"),  py::arg("ForceClass")=static_cast<const Standard_Boolean>(Standard_False) )
        .def("InitEdgeBuilder",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_PaveClassifier ,std::unique_ptr<TopOpeBRepBuild_PaveClassifier>  , TopOpeBRepBuild_LoopClassifier >>(m.attr("TopOpeBRepBuild_PaveClassifier"))
        .def(py::init< const TopoDS_Shape & >()  , py::arg("E") )
        .def("Compare",
...
;
    ...
    register_default_constructor<TopOpeBRepBuild_Tools2d ,std::unique_ptr<TopOpeBRepBuild_Tools2d>>(m,"TopOpeBRepBuild_Tools2d");

    static_cast<py::class_<TopOpeBRepBuild_Tools2d ,std::unique_ptr<TopOpeBRepBuild_Tools2d>  >>(m.attr("TopOpeBRepBuild_Tools2d"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_ShellFaceClassifier ,std::unique_ptr<TopOpeBRepBuild_ShellFaceClassifier>  , TopOpeBRepBuild_CompositeClassifier >>(m.attr("TopOpeBRepBuild_ShellFaceClassifier"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_FaceAreaBuilder ,std::unique_ptr<TopOpeBRepBuild_FaceAreaBuilder>  , TopOpeBRepBuild_Area2dBuilder >>(m.attr("TopOpeBRepBuild_FaceAreaBuilder"))
        .def(py::init<  >()  )
        .def(py::init< TopOpeBRepBuild_LoopSet &,TopOpeBRepBuild_LoopClassifier &,const Standard_Boolean >()  , py::arg("LS"),  py::arg("LC"),  py::arg("ForceClass")=static_cast<const Standard_Boolean>(Standard_False) )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_SolidAreaBuilder ,std::unique_ptr<TopOpeBRepBuild_SolidAreaBuilder>  , TopOpeBRepBuild_Area3dBuilder >>(m.attr("TopOpeBRepBuild_SolidAreaBuilder"))
        .def(py::init<  >()  )
        .def(py::init< TopOpeBRepBuild_LoopSet &,TopOpeBRepBuild_LoopClassifier &,const Standard_Boolean >()  , py::arg("LS"),  py::arg("LC"),  py::arg("ForceClass")=static_cast<const Standard_Boolean>(Standard_False) )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_ShellFaceSet ,std::unique_ptr<TopOpeBRepBuild_ShellFaceSet>  , TopOpeBRepBuild_ShapeSet >>(m.attr("TopOpeBRepBuild_ShellFaceSet"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_BuilderON ,std::unique_ptr<TopOpeBRepBuild_BuilderON>  >>(m.attr("TopOpeBRepBuild_BuilderON"))
        .def(py::init<  >()  )
        .def("GFillONCheckI",
...
;
    ...
    register_default_constructor<TopOpeBRepBuild_Tools ,std::unique_ptr<TopOpeBRepBuild_Tools>>(m,"TopOpeBRepBuild_Tools");

    static_cast<py::class_<TopOpeBRepBuild_Tools ,std::unique_ptr<TopOpeBRepBuild_Tools>  >>(m.attr("TopOpeBRepBuild_Tools"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_VertexInfo ,std::unique_ptr<TopOpeBRepBuild_VertexInfo>  >>(m.attr("TopOpeBRepBuild_VertexInfo"))
        .def(py::init<  >()  )
        .def("SetVertex",
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_FaceBuilder ,std::unique_ptr<TopOpeBRepBuild_FaceBuilder>  >>(m.attr("TopOpeBRepBuild_FaceBuilder"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepBuild_WireEdgeClassifier ,std::unique_ptr<TopOpeBRepBuild_WireEdgeClassifier>  , TopOpeBRepBuild_CompositeClassifier >>(m.attr("TopOpeBRepBuild_WireEdgeClassifier"))
