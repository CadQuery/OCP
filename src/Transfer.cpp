...
// classes
    ...
    static_cast<py::class_<Transfer_TransferIterator ,std::unique_ptr<Transfer_TransferIterator>  >>(m.attr("Transfer_TransferIterator"))
        .def(py::init<  >()  )
        .def("AddItem",
...
;
    ...
    register_default_constructor<Transfer_DataInfo ,std::unique_ptr<Transfer_DataInfo>>(m,"Transfer_DataInfo");

    static_cast<py::class_<Transfer_DataInfo ,std::unique_ptr<Transfer_DataInfo>  >>(m.attr("Transfer_DataInfo"))
        .def_static("Type_s",
...
;
    ...
    static_cast<py::class_<Transfer_TransferInput ,std::unique_ptr<Transfer_TransferInput>  >>(m.attr("Transfer_TransferInput"))
        .def(py::init<  >()  )
        .def("Entities",
...
;
    ...
    static_cast<py::class_<Transfer_TransferDispatch ,std::unique_ptr<Transfer_TransferDispatch>  , Interface_CopyTool >>(m.attr("Transfer_TransferDispatch"))
...
;
    ...
    register_default_constructor<Transfer_FindHasher ,std::unique_ptr<Transfer_FindHasher>>(m,"Transfer_FindHasher");

    static_cast<py::class_<Transfer_FindHasher ,std::unique_ptr<Transfer_FindHasher>  >>(m.attr("Transfer_FindHasher"))
...
;
    ...
    static_cast<py::class_<Transfer_IteratorOfProcessForTransient ,std::unique_ptr<Transfer_IteratorOfProcessForTransient>  , Transfer_TransferIterator >>(m.attr("Transfer_IteratorOfProcessForTransient"))
...
;
    ...
    static_cast<py::class_<Transfer_IteratorOfProcessForFinder ,std::unique_ptr<Transfer_IteratorOfProcessForFinder>  , Transfer_TransferIterator >>(m.attr("Transfer_IteratorOfProcessForFinder"))
        .def(py::init< const Standard_Boolean >()  , py::arg("withstarts") )
        .def("Add",
...
;
    ...
    static_cast<py::class_<Transfer_TransferOutput ,std::unique_ptr<Transfer_TransferOutput>  >>(m.attr("Transfer_TransferOutput"))
...
;
    ...
    static_cast<py::class_<Transfer_HSequenceOfFinder ,std::unique_ptr<Transfer_HSequenceOfFinder>  >>(m.attr("Transfer_HSequenceOfFinder"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Transfer_HSequenceOfBinder ,std::unique_ptr<Transfer_HSequenceOfBinder>  >>(m.attr("Transfer_HSequenceOfBinder"))
        .def(py::init<  >()  )
