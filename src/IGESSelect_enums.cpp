...
// classes forward declarations only
    ...
    py::class_<IGESSelect ,std::unique_ptr<IGESSelect>  >(m,"IGESSelect",R"#(This package defines the library of the most used tools for IGES Files : Selections & Modifiers specific to the IGES norm, and the most needed converters)#");
