...
// classes
    ...
    static_cast<py::class_<TopOpeBRepDS_InterferenceIterator ,std::unique_ptr<TopOpeBRepDS_InterferenceIterator>  >>(m.attr("TopOpeBRepDS_InterferenceIterator"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_GeometryData ,std::unique_ptr<TopOpeBRepDS_GeometryData>  >>(m.attr("TopOpeBRepDS_GeometryData"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_SurfaceExplorer ,std::unique_ptr<TopOpeBRepDS_SurfaceExplorer>  >>(m.attr("TopOpeBRepDS_SurfaceExplorer"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_BuildTool ,std::unique_ptr<TopOpeBRepDS_BuildTool>  >>(m.attr("TopOpeBRepDS_BuildTool"))
        .def(py::init<  >()  )
        ...
        .def("GetOrientedEdgeVertices",
             (void (TopOpeBRepDS_BuildTool::*)( TopoDS_Edge & ,  TopoDS_Vertex & ,  TopoDS_Vertex & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRepDS_BuildTool::*)( TopoDS_Edge & ,  TopoDS_Vertex & ,  TopoDS_Vertex & ,  Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRepDS_BuildTool::GetOrientedEdgeVertices),
             R"#(None)#"  , py::arg("E"),  py::arg("Vmin"),  py::arg("Vmax"),  py::arg("Parmin"),  py::arg("Parmax"))
        .def("UpdateEdgeCurveTol",
             (void (TopOpeBRepDS_BuildTool::*)( const TopoDS_Face & ,  const TopoDS_Face & ,  TopoDS_Edge & ,  const opencascade::handle<Geom_Curve> & ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRepDS_BuildTool::*)( const TopoDS_Face & ,  const TopoDS_Face & ,  TopoDS_Edge & ,  const opencascade::handle<Geom_Curve> & ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRepDS_BuildTool::UpdateEdgeCurveTol),
             R"#(None)#"  , py::arg("F1"),  py::arg("F2"),  py::arg("E"),  py::arg("C3Dnew"),  py::arg("tol3d"),  py::arg("tol2d1"),  py::arg("tol2d2"),  py::arg("newtol"),  py::arg("newparmin"),  py::arg("newparmax"))
        .def("ApproxCurves",
             (void (TopOpeBRepDS_BuildTool::*)( const TopOpeBRepDS_Curve & ,  TopoDS_Edge & ,  Standard_Integer & ,  const opencascade::handle<TopOpeBRepDS_HDataStructure> &  ) const) static_cast<void (TopOpeBRepDS_BuildTool::*)( const TopOpeBRepDS_Curve & ,  TopoDS_Edge & ,  Standard_Integer & ,  const opencascade::handle<TopOpeBRepDS_HDataStructure> &  ) const>(&TopOpeBRepDS_BuildTool::ApproxCurves),
             R"#(None)#"  , py::arg("C"),  py::arg("E"),  py::arg("inewC"),  py::arg("HDS"))
        .def("ComputePCurves",
        ...
        .def("RecomputeCurves",
             (void (TopOpeBRepDS_BuildTool::*)( const TopOpeBRepDS_Curve & ,  const TopoDS_Edge & ,  TopoDS_Edge & ,  Standard_Integer & ,  const opencascade::handle<TopOpeBRepDS_HDataStructure> &  ) const) static_cast<void (TopOpeBRepDS_BuildTool::*)( const TopOpeBRepDS_Curve & ,  const TopoDS_Edge & ,  TopoDS_Edge & ,  Standard_Integer & ,  const opencascade::handle<TopOpeBRepDS_HDataStructure> &  ) const>(&TopOpeBRepDS_BuildTool::RecomputeCurves),
             R"#(None)#"  , py::arg("C"),  py::arg("oldE"),  py::arg("E"),  py::arg("inewC"),  py::arg("HDS"))
        .def("CopyFace",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_TKI ,std::unique_ptr<TopOpeBRepDS_TKI>  >>(m.attr("TopOpeBRepDS_TKI"))
        .def(py::init<  >()  )
        .def("Clear",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_ShapeData ,std::unique_ptr<TopOpeBRepDS_ShapeData>  >>(m.attr("TopOpeBRepDS_ShapeData"))
        .def(py::init<  >()  )
        .def("Interferences",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Curve ,std::unique_ptr<TopOpeBRepDS_Curve>  >>(m.attr("TopOpeBRepDS_Curve"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Interference ,opencascade::handle<TopOpeBRepDS_Interference>  , Standard_Transient >>(m.attr("TopOpeBRepDS_Interference"))
        ...
        .def("Transition",
             ...
             R"#(None)#"  , py::arg("T"))
        .def("GKGSKS",
             (void (TopOpeBRepDS_Interference::*)( TopOpeBRepDS_Kind & ,  Standard_Integer & ,  TopOpeBRepDS_Kind & ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRepDS_Interference::*)( TopOpeBRepDS_Kind & ,  Standard_Integer & ,  TopOpeBRepDS_Kind & ,  Standard_Integer &  ) const>(&TopOpeBRepDS_Interference::GKGSKS),
             R"#(return GeometryType + Geometry + SupportType + Support)#"  , py::arg("GK"),  py::arg("G"),  py::arg("SK"),  py::arg("S"))
        .def("SupportType",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_CurveData ,std::unique_ptr<TopOpeBRepDS_CurveData>  , TopOpeBRepDS_GeometryData >>(m.attr("TopOpeBRepDS_CurveData"))
        .def(py::init<  >()  )
        .def(py::init< const TopOpeBRepDS_Curve & >()  , py::arg("C") )
;


    static_cast<py::class_<TopOpeBRepDS_SurfaceData ,std::unique_ptr<TopOpeBRepDS_SurfaceData>  , TopOpeBRepDS_GeometryData >>(m.attr("TopOpeBRepDS_SurfaceData"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_FaceInterferenceTool ,std::unique_ptr<TopOpeBRepDS_FaceInterferenceTool>  >>(m.attr("TopOpeBRepDS_FaceInterferenceTool"))
        .def("Init",
        ...
        .def("GetEdgePntPar",
             (void (TopOpeBRepDS_FaceInterferenceTool::*)( gp_Pnt & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRepDS_FaceInterferenceTool::*)( gp_Pnt & ,  Standard_Real &  ) const>(&TopOpeBRepDS_FaceInterferenceTool::GetEdgePntPar),
             R"#(None)#"  , py::arg("P"),  py::arg("par"))
        .def("IsEdgePntParDef",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_SurfaceIterator ,std::unique_ptr<TopOpeBRepDS_SurfaceIterator>  , TopOpeBRepDS_InterferenceIterator >>(m.attr("TopOpeBRepDS_SurfaceIterator"))
        .def(py::init<  const NCollection_List<opencascade::handle<TopOpeBRepDS_Interference> > & >()  , py::arg("L") )
        .def("Current",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Point ,std::unique_ptr<TopOpeBRepDS_Point>  >>(m.attr("TopOpeBRepDS_Point"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Filter ,std::unique_ptr<TopOpeBRepDS_Filter>  >>(m.attr("TopOpeBRepDS_Filter"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_EIR ,std::unique_ptr<TopOpeBRepDS_EIR>  >>(m.attr("TopOpeBRepDS_EIR"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_ShapeWithState ,std::unique_ptr<TopOpeBRepDS_ShapeWithState>  >>(m.attr("TopOpeBRepDS_ShapeWithState"))
        .def(py::init<  >()  )
        .def("Part",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_PointData ,std::unique_ptr<TopOpeBRepDS_PointData>  , TopOpeBRepDS_GeometryData >>(m.attr("TopOpeBRepDS_PointData"))
        .def(py::init<  >()  )
        ...
        .def("SetShapes",
             ...
             R"#(None)#"  , py::arg("I1"),  py::arg("I2"))
        .def("GetShapes",
             (void (TopOpeBRepDS_PointData::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (TopOpeBRepDS_PointData::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&TopOpeBRepDS_PointData::GetShapes),
             R"#(None)#"  , py::arg("I1"),  py::arg("I2"))
;

    register_default_constructor<TopOpeBRepDS ,std::unique_ptr<TopOpeBRepDS>>(m,"TopOpeBRepDS");

    static_cast<py::class_<TopOpeBRepDS ,std::unique_ptr<TopOpeBRepDS>  >>(m.attr("TopOpeBRepDS"))
        .def_static("SPrint_s",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Surface ,std::unique_ptr<TopOpeBRepDS_Surface>  >>(m.attr("TopOpeBRepDS_Surface"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<TopOpeBRepDS_InterferenceTool ,std::unique_ptr<TopOpeBRepDS_InterferenceTool>>(m,"TopOpeBRepDS_InterferenceTool");

    static_cast<py::class_<TopOpeBRepDS_InterferenceTool ,std::unique_ptr<TopOpeBRepDS_InterferenceTool>  >>(m.attr("TopOpeBRepDS_InterferenceTool"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Transition ,std::unique_ptr<TopOpeBRepDS_Transition>  >>(m.attr("TopOpeBRepDS_Transition"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Dumper ,std::unique_ptr<TopOpeBRepDS_Dumper>  >>(m.attr("TopOpeBRepDS_Dumper"))
        .def(py::init< const opencascade::handle<TopOpeBRepDS_HDataStructure> & >()  , py::arg("HDS") )
        .def("SDumpRefOri",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_PointExplorer ,std::unique_ptr<TopOpeBRepDS_PointExplorer>  >>(m.attr("TopOpeBRepDS_PointExplorer"))
        .def(py::init<  >()  )
        .def(py::init< const TopOpeBRepDS_DataStructure &,const Standard_Boolean >()  , py::arg("DS"),  py::arg("FindOnlyKeep")=static_cast<const Standard_Boolean>(Standard_True) )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_CurveIterator ,std::unique_ptr<TopOpeBRepDS_CurveIterator>  , TopOpeBRepDS_InterferenceIterator >>(m.attr("TopOpeBRepDS_CurveIterator"))
        .def(py::init<  const NCollection_List<opencascade::handle<TopOpeBRepDS_Interference> > & >()  , py::arg("L") )
        .def("MatchInterference",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_PointIterator ,std::unique_ptr<TopOpeBRepDS_PointIterator>  , TopOpeBRepDS_InterferenceIterator >>(m.attr("TopOpeBRepDS_PointIterator"))
        .def(py::init<  const NCollection_List<opencascade::handle<TopOpeBRepDS_Interference> > & >()  , py::arg("L") )
        .def("MatchInterference",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_ListOfShapeOn1State ,std::unique_ptr<TopOpeBRepDS_ListOfShapeOn1State>  >>(m.attr("TopOpeBRepDS_ListOfShapeOn1State"))
        .def(py::init<  >()  )
        .def("ListOnState",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_HArray1OfDataMapOfIntegerListOfInterference ,std::unique_ptr<TopOpeBRepDS_HArray1OfDataMapOfIntegerListOfInterference>  >>(m.attr("TopOpeBRepDS_HArray1OfDataMapOfIntegerListOfInterference"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_FIR ,std::unique_ptr<TopOpeBRepDS_FIR>  >>(m.attr("TopOpeBRepDS_FIR"))
        .def(py::init< const opencascade::handle<TopOpeBRepDS_HDataStructure> & >()  , py::arg("HDS") )
        .def("ProcessFaceInterferences",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_CurveExplorer ,std::unique_ptr<TopOpeBRepDS_CurveExplorer>  >>(m.attr("TopOpeBRepDS_CurveExplorer"))
        .def(py::init<  >()  )
        .def(py::init< const TopOpeBRepDS_DataStructure &,const Standard_Boolean >()  , py::arg("DS"),  py::arg("FindOnlyKeep")=static_cast<const Standard_Boolean>(Standard_True) )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_EdgeInterferenceTool ,std::unique_ptr<TopOpeBRepDS_EdgeInterferenceTool>  >>(m.attr("TopOpeBRepDS_EdgeInterferenceTool"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_HDataStructure ,opencascade::handle<TopOpeBRepDS_HDataStructure>  , Standard_Transient >>(m.attr("TopOpeBRepDS_HDataStructure"))
        ...
        .def("MinMaxOnParameter",
             (void (TopOpeBRepDS_HDataStructure::*)(  const NCollection_List<opencascade::handle<TopOpeBRepDS_Interference> > & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRepDS_HDataStructure::*)(  const NCollection_List<opencascade::handle<TopOpeBRepDS_Interference> > & ,  Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRepDS_HDataStructure::MinMaxOnParameter),
             R"#(None)#"  , py::arg("L"),  py::arg("Min"),  py::arg("Max"))
        .def("ScanInterfList",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Reducer ,std::unique_ptr<TopOpeBRepDS_Reducer>  >>(m.attr("TopOpeBRepDS_Reducer"))
        .def(py::init< const opencascade::handle<TopOpeBRepDS_HDataStructure> & >()  , py::arg("HDS") )
        .def("ProcessFaceInterferences",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_DataStructure ,std::unique_ptr<TopOpeBRepDS_DataStructure>  >>(m.attr("TopOpeBRepDS_DataStructure"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_GapFiller ,std::unique_ptr<TopOpeBRepDS_GapFiller>  >>(m.attr("TopOpeBRepDS_GapFiller"))
        .def(py::init< const opencascade::handle<TopOpeBRepDS_HDataStructure> & >()  , py::arg("HDS") )
        .def("Perform",
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Edge3dInterferenceTool ,std::unique_ptr<TopOpeBRepDS_Edge3dInterferenceTool>  >>(m.attr("TopOpeBRepDS_Edge3dInterferenceTool"))
        .def(py::init<  >()  )
        .def("InitPointVertex",
...
;
    ...
    register_default_constructor<TopOpeBRepDS_TOOL ,std::unique_ptr<TopOpeBRepDS_TOOL>>(m,"TopOpeBRepDS_TOOL");

    static_cast<py::class_<TopOpeBRepDS_TOOL ,std::unique_ptr<TopOpeBRepDS_TOOL>  >>(m.attr("TopOpeBRepDS_TOOL"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepDS_Explorer ,std::unique_ptr<TopOpeBRepDS_Explorer>  >>(m.attr("TopOpeBRepDS_Explorer"))
        .def(py::init<  >()  )
