...
// classes
    ...
    static_cast<py::class_<CDF_DirectoryIterator ,std::unique_ptr<CDF_DirectoryIterator>  >>(m.attr("CDF_DirectoryIterator"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<CDF_Store ,std::unique_ptr<CDF_Store>  >>(m.attr("CDF_Store"))
