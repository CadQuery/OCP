...
// classes forward declarations only
    py::class_<PLib ,std::unique_ptr<PLib>  >(m,"PLib",R"#(PLib means Polynomial functions library. This pk provides basic computation functions for polynomial functions. Note: weight arrays can be passed by pointer for some functions so that NULL pointer is valid. That means no weights passed.)#");
    py::class_<PLib_DoubleJacobiPolynomial ,std::unique_ptr<PLib_DoubleJacobiPolynomial>  >(m,"PLib_DoubleJacobiPolynomial",R"#(None)#");
