...
// classes
    ...
    static_cast<py::class_<TopExp_Explorer ,std::unique_ptr<TopExp_Explorer>  >>(m.attr("TopExp_Explorer"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<TopExp ,std::unique_ptr<TopExp>>(m,"TopExp");

    static_cast<py::class_<TopExp ,std::unique_ptr<TopExp>  >>(m.attr("TopExp"))
