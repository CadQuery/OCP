...
// classes
    ...
    static_cast<py::class_<BRepClass_FClassifier ,std::unique_ptr<BRepClass_FClassifier>  >>(m.attr("BRepClass_FClassifier"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepClass_Edge ,std::unique_ptr<BRepClass_Edge>  >>(m.attr("BRepClass_Edge"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepClass_FaceClassifier ,std::unique_ptr<BRepClass_FaceClassifier>  , BRepClass_FClassifier >>(m.attr("BRepClass_FaceClassifier"))
        .def(py::init<  >()  )
        .def(py::init< BRepClass_FaceExplorer &,const gp_Pnt2d &,const Standard_Real >()  , py::arg("F"),  py::arg("P"),  py::arg("Tol") )
...
;
    ...
    static_cast<py::class_<BRepClass_FacePassiveClassifier ,std::unique_ptr<BRepClass_FacePassiveClassifier>  >>(m.attr("BRepClass_FacePassiveClassifier"))
        .def(py::init<  >()  )
        .def("Reset",
...
;
    ...
    static_cast<py::class_<BRepClass_FClass2dOfFClassifier ,std::unique_ptr<BRepClass_FClass2dOfFClassifier>  >>(m.attr("BRepClass_FClass2dOfFClassifier"))
        .def(py::init<  >()  )
        .def("Reset",
...
;
    ...
    static_cast<py::class_<BRepClass_Intersector ,std::unique_ptr<BRepClass_Intersector>  , Geom2dInt_IntConicCurveOfGInter >>(m.attr("BRepClass_Intersector"))
        .def(py::init<  >()  )
        .def("Perform",
        ...
        .def("LocalGeometry",
             (void (BRepClass_Intersector::*)( const BRepClass_Edge & ,  const Standard_Real ,  gp_Dir2d & ,  gp_Dir2d & ,  Standard_Real &  ) const) static_cast<void (BRepClass_Intersector::*)( const BRepClass_Edge & ,  const Standard_Real ,  gp_Dir2d & ,  gp_Dir2d & ,  Standard_Real &  ) const>(&BRepClass_Intersector::LocalGeometry),
...
;
    ...
    static_cast<py::class_<BRepClass_FaceExplorer ,std::unique_ptr<BRepClass_FaceExplorer>  >>(m.attr("BRepClass_FaceExplorer"))
