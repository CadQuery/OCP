...
// classes
    ...
    static_cast<py::class_<ShapeUpgrade_ShapeDivide ,std::unique_ptr<ShapeUpgrade_ShapeDivide>  >>(m.attr("ShapeUpgrade_ShapeDivide"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ShapeUpgrade_ShapeDivideClosed ,std::unique_ptr<ShapeUpgrade_ShapeDivideClosed>  , ShapeUpgrade_ShapeDivide >>(m.attr("ShapeUpgrade_ShapeDivideClosed"))
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
...
;
    ...
    static_cast<py::class_<ShapeUpgrade_ShapeDivideArea ,std::unique_ptr<ShapeUpgrade_ShapeDivideArea>  , ShapeUpgrade_ShapeDivide >>(m.attr("ShapeUpgrade_ShapeDivideArea"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
        .def("MaxArea",
...
;
    ...
    static_cast<py::class_<ShapeUpgrade_ShapeConvertToBezier ,std::unique_ptr<ShapeUpgrade_ShapeConvertToBezier>  , ShapeUpgrade_ShapeDivide >>(m.attr("ShapeUpgrade_ShapeConvertToBezier"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
        .def("Set2dConversion",
...
;
    ...
    static_cast<py::class_<ShapeUpgrade_ShapeDivideAngle ,std::unique_ptr<ShapeUpgrade_ShapeDivideAngle>  , ShapeUpgrade_ShapeDivide >>(m.attr("ShapeUpgrade_ShapeDivideAngle"))
...
;
    ...
    register_default_constructor<ShapeUpgrade ,std::unique_ptr<ShapeUpgrade>>(m,"ShapeUpgrade");

    static_cast<py::class_<ShapeUpgrade ,std::unique_ptr<ShapeUpgrade>  >>(m.attr("ShapeUpgrade"))
...
;
    ...
    static_cast<py::class_<ShapeUpgrade_ShellSewing ,std::unique_ptr<ShapeUpgrade_ShellSewing>  >>(m.attr("ShapeUpgrade_ShellSewing"))
        .def(py::init<  >()  )
        .def("ApplySewing",
...
;
    ...
    static_cast<py::class_<ShapeUpgrade_ShapeDivideClosedEdges ,std::unique_ptr<ShapeUpgrade_ShapeDivideClosedEdges>  , ShapeUpgrade_ShapeDivide >>(m.attr("ShapeUpgrade_ShapeDivideClosedEdges"))
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
        .def("SetNbSplitPoints",
...
;
    ...
    static_cast<py::class_<ShapeUpgrade_ShapeDivideContinuity ,std::unique_ptr<ShapeUpgrade_ShapeDivideContinuity>  , ShapeUpgrade_ShapeDivide >>(m.attr("ShapeUpgrade_ShapeDivideContinuity"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Shape & >()  , py::arg("S") )
        .def("SetTolerance",
