...
// classes forward declarations only
    py::class_<IGESDimen_ToolCurveDimension ,std::unique_ptr<IGESDimen_ToolCurveDimension>  >(m,"IGESDimen_ToolCurveDimension",R"#(Tool to work on a CurveDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolGeneralLabel ,std::unique_ptr<IGESDimen_ToolGeneralLabel>  >(m,"IGESDimen_ToolGeneralLabel",R"#(Tool to work on a GeneralLabel. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolNewGeneralNote ,std::unique_ptr<IGESDimen_ToolNewGeneralNote>  >(m,"IGESDimen_ToolNewGeneralNote",R"#(Tool to work on a NewGeneralNote. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_ToolLinearDimension ,std::unique_ptr<IGESDimen_ToolLinearDimension>  >(m,"IGESDimen_ToolLinearDimension",R"#(Tool to work on a LinearDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolDimensionedGeometry ,std::unique_ptr<IGESDimen_ToolDimensionedGeometry>  >(m,"IGESDimen_ToolDimensionedGeometry",R"#(Tool to work on a DimensionedGeometry. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolGeneralNote ,std::unique_ptr<IGESDimen_ToolGeneralNote>  >(m,"IGESDimen_ToolGeneralNote",R"#(Tool to work on a GeneralNote. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolAngularDimension ,std::unique_ptr<IGESDimen_ToolAngularDimension>  >(m,"IGESDimen_ToolAngularDimension",R"#(Tool to work on a AngularDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolFlagNote ,std::unique_ptr<IGESDimen_ToolFlagNote>  >(m,"IGESDimen_ToolFlagNote",R"#(Tool to work on a FlagNote. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolSectionedArea ,std::unique_ptr<IGESDimen_ToolSectionedArea>  >(m,"IGESDimen_ToolSectionedArea",R"#(Tool to work on a SectionedArea. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolSection ,std::unique_ptr<IGESDimen_ToolSection>  >(m,"IGESDimen_ToolSection",R"#(Tool to work on a Section. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_ToolRadiusDimension ,std::unique_ptr<IGESDimen_ToolRadiusDimension>  >(m,"IGESDimen_ToolRadiusDimension",R"#(Tool to work on a RadiusDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_ToolPointDimension ,std::unique_ptr<IGESDimen_ToolPointDimension>  >(m,"IGESDimen_ToolPointDimension",R"#(Tool to work on a PointDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolGeneralSymbol ,std::unique_ptr<IGESDimen_ToolGeneralSymbol>  >(m,"IGESDimen_ToolGeneralSymbol",R"#(Tool to work on a GeneralSymbol. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolLeaderArrow ,std::unique_ptr<IGESDimen_ToolLeaderArrow>  >(m,"IGESDimen_ToolLeaderArrow",R"#(Tool to work on a LeaderArrow. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_ToolNewDimensionedGeometry ,std::unique_ptr<IGESDimen_ToolNewDimensionedGeometry>  >(m,"IGESDimen_ToolNewDimensionedGeometry",R"#(Tool to work on a NewDimensionedGeometry. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen ,std::unique_ptr<IGESDimen>  >(m,"IGESDimen",R"#(This package represents Entities applied to Dimensions ie. Annotation Entities and attached Properties and Associativities.)#");
    ...
    py::class_<IGESDimen_ToolWitnessLine ,std::unique_ptr<IGESDimen_ToolWitnessLine>  >(m,"IGESDimen_ToolWitnessLine",R"#(Tool to work on a WitnessLine. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_ToolDimensionTolerance ,std::unique_ptr<IGESDimen_ToolDimensionTolerance>  >(m,"IGESDimen_ToolDimensionTolerance",R"#(Tool to work on a DimensionTolerance. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_HArray1OfLeaderArrow ,std::unique_ptr<IGESDimen_HArray1OfLeaderArrow>  >(m,"IGESDimen_HArray1OfLeaderArrow",R"#()#");
    py::class_<IGESDimen_ToolBasicDimension ,std::unique_ptr<IGESDimen_ToolBasicDimension>  >(m,"IGESDimen_ToolBasicDimension",R"#(Tool to work on a BasicDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_ToolDimensionUnits ,std::unique_ptr<IGESDimen_ToolDimensionUnits>  >(m,"IGESDimen_ToolDimensionUnits",R"#(Tool to work on a DimensionUnits. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolDimensionDisplayData ,std::unique_ptr<IGESDimen_ToolDimensionDisplayData>  >(m,"IGESDimen_ToolDimensionDisplayData",R"#(Tool to work on a DimensionDisplayData. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDimen_ToolCenterLine ,std::unique_ptr<IGESDimen_ToolCenterLine>  >(m,"IGESDimen_ToolCenterLine",R"#(Tool to work on a CenterLine. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_ToolDiameterDimension ,std::unique_ptr<IGESDimen_ToolDiameterDimension>  >(m,"IGESDimen_ToolDiameterDimension",R"#(Tool to work on a DiameterDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_ToolOrdinateDimension ,std::unique_ptr<IGESDimen_ToolOrdinateDimension>  >(m,"IGESDimen_ToolOrdinateDimension",R"#(Tool to work on a OrdinateDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDimen_HArray1OfGeneralNote ,std::unique_ptr<IGESDimen_HArray1OfGeneralNote>  >(m,"IGESDimen_HArray1OfGeneralNote",R"#()#");
