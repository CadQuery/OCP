...
// classes
    ...
    static_cast<py::class_<BRepPrimAPI_MakeSweep ,std::unique_ptr<BRepPrimAPI_MakeSweep> ,Py_BRepPrimAPI_MakeSweep , BRepBuilderAPI_MakeShape >>(m.attr("BRepPrimAPI_MakeSweep"))
        .def("FirstShape",
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeHalfSpace ,std::unique_ptr<BRepPrimAPI_MakeHalfSpace>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepPrimAPI_MakeHalfSpace"))
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeOneAxis ,std::unique_ptr<BRepPrimAPI_MakeOneAxis> ,Py_BRepPrimAPI_MakeOneAxis , BRepBuilderAPI_MakeShape >>(m.attr("BRepPrimAPI_MakeOneAxis"))
        .def("OneAxis",
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeTorus ,std::unique_ptr<BRepPrimAPI_MakeTorus>  , BRepPrimAPI_MakeOneAxis >>(m.attr("BRepPrimAPI_MakeTorus"))
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeCone ,std::unique_ptr<BRepPrimAPI_MakeCone>  , BRepPrimAPI_MakeOneAxis >>(m.attr("BRepPrimAPI_MakeCone"))
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakePrism ,std::unique_ptr<BRepPrimAPI_MakePrism>  , BRepPrimAPI_MakeSweep >>(m.attr("BRepPrimAPI_MakePrism"))
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeCylinder ,std::unique_ptr<BRepPrimAPI_MakeCylinder>  , BRepPrimAPI_MakeOneAxis >>(m.attr("BRepPrimAPI_MakeCylinder"))
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeRevolution ,std::unique_ptr<BRepPrimAPI_MakeRevolution>  , BRepPrimAPI_MakeOneAxis >>(m.attr("BRepPrimAPI_MakeRevolution"))
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeRevol ,std::unique_ptr<BRepPrimAPI_MakeRevol>  , BRepPrimAPI_MakeSweep >>(m.attr("BRepPrimAPI_MakeRevol"))
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeBox ,std::unique_ptr<BRepPrimAPI_MakeBox>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepPrimAPI_MakeBox"))
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeWedge ,std::unique_ptr<BRepPrimAPI_MakeWedge>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepPrimAPI_MakeWedge"))
...
;
    ...
    static_cast<py::class_<BRepPrimAPI_MakeSphere ,std::unique_ptr<BRepPrimAPI_MakeSphere>  , BRepPrimAPI_MakeOneAxis >>(m.attr("BRepPrimAPI_MakeSphere"))
