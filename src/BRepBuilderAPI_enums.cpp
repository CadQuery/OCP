...
// classes forward declarations only
    py::class_<BRepBuilderAPI_Command ,std::unique_ptr<BRepBuilderAPI_Command>  >(m,"BRepBuilderAPI_Command",R"#(Root class for all commands in BRepBuilderAPI.)#");
