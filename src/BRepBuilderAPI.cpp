...
// classes
    ...
    static_cast<py::class_<BRepBuilderAPI_Command ,std::unique_ptr<BRepBuilderAPI_Command>  >>(m.attr("BRepBuilderAPI_Command"))
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_MakeShape ,std::unique_ptr<BRepBuilderAPI_MakeShape>  , BRepBuilderAPI_Command >>(m.attr("BRepBuilderAPI_MakeShape"))
        .def("Build",
...
;
    ...
    register_default_constructor<BRepBuilderAPI ,std::unique_ptr<BRepBuilderAPI>>(m,"BRepBuilderAPI");

    static_cast<py::class_<BRepBuilderAPI ,std::unique_ptr<BRepBuilderAPI>  >>(m.attr("BRepBuilderAPI"))
        .def_static("Plane_s",
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_ModifyShape ,std::unique_ptr<BRepBuilderAPI_ModifyShape>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepBuilderAPI_ModifyShape"))
        .def("Modified",
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_MakePolygon ,std::unique_ptr<BRepBuilderAPI_MakePolygon>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepBuilderAPI_MakePolygon"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_MakeShell ,std::unique_ptr<BRepBuilderAPI_MakeShell>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepBuilderAPI_MakeShell"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_MakeEdge2d ,std::unique_ptr<BRepBuilderAPI_MakeEdge2d>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepBuilderAPI_MakeEdge2d"))
        .def(py::init< const TopoDS_Vertex &,const TopoDS_Vertex & >()  , py::arg("V1"),  py::arg("V2") )
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_Transform ,std::unique_ptr<BRepBuilderAPI_Transform>  , BRepBuilderAPI_ModifyShape >>(m.attr("BRepBuilderAPI_Transform"))
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_GTransform ,std::unique_ptr<BRepBuilderAPI_GTransform>  , BRepBuilderAPI_ModifyShape >>(m.attr("BRepBuilderAPI_GTransform"))
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_MakeSolid ,std::unique_ptr<BRepBuilderAPI_MakeSolid>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepBuilderAPI_MakeSolid"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_MakeFace ,std::unique_ptr<BRepBuilderAPI_MakeFace>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepBuilderAPI_MakeFace"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_Collect ,std::unique_ptr<BRepBuilderAPI_Collect>  >>(m.attr("BRepBuilderAPI_Collect"))
        .def(py::init<  >()  )
        .def("Add",
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_MakeVertex ,std::unique_ptr<BRepBuilderAPI_MakeVertex>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepBuilderAPI_MakeVertex"))
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_MakeEdge ,std::unique_ptr<BRepBuilderAPI_MakeEdge>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepBuilderAPI_MakeEdge"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Vertex &,const TopoDS_Vertex & >()  , py::arg("V1"),  py::arg("V2") )
        .def(py::init< const gp_Pnt &,const gp_Pnt & >()  , py::arg("P1"),  py::arg("P2") )
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_MakeWire ,std::unique_ptr<BRepBuilderAPI_MakeWire>  , BRepBuilderAPI_MakeShape >>(m.attr("BRepBuilderAPI_MakeWire"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_NurbsConvert ,std::unique_ptr<BRepBuilderAPI_NurbsConvert>  , BRepBuilderAPI_ModifyShape >>(m.attr("BRepBuilderAPI_NurbsConvert"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_FindPlane ,std::unique_ptr<BRepBuilderAPI_FindPlane>  >>(m.attr("BRepBuilderAPI_FindPlane"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepBuilderAPI_Copy ,std::unique_ptr<BRepBuilderAPI_Copy>  , BRepBuilderAPI_ModifyShape >>(m.attr("BRepBuilderAPI_Copy"))
        .def(py::init<  >()  )
