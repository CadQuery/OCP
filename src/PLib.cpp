...
// classes
    ...
    register_default_constructor<PLib ,std::unique_ptr<PLib>>(m,"PLib");

    static_cast<py::class_<PLib ,std::unique_ptr<PLib>  >>(m.attr("PLib"))
        ...
        .def_static("RationalDerivative_s",
                    (void (*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  const Standard_Boolean  ) ) static_cast<void (*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  const Standard_Boolean  ) >(&PLib::RationalDerivative),
                    R"#(Computes the derivatives of a ratio at order <N> in dimension <Dimension>.)#"  , py::arg("Degree"),  py::arg("N"),  py::arg("Dimension"),  py::arg("Ders"),  py::arg("RDers"),  py::arg("All")=static_cast<const Standard_Boolean>(Standard_True))
        .def_static("RationalDerivatives_s",
                    (void (*)( const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&PLib::RationalDerivatives),
                    R"#(Computes DerivativesRequest derivatives of a ratio at of a BSpline function of degree <Degree> dimension <Dimension>.)#"  , py::arg("DerivativesRequest"),  py::arg("Dimension"),  py::arg("PolesDerivatives"),  py::arg("WeightsDerivatives"),  py::arg("RationalDerivates"))
        .def_static("EvalPolynomial_s",
                    (void (*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) >(&PLib::EvalPolynomial),
                    R"#(Performs Horner method with synthethic division for derivatives parameter <U>, with <Degree> and <Dimension>. PolynomialCoeff are stored in the following fashion c0(1) c0(2) .... c0(Dimension) c1(1) c1(2) .... c1(Dimension))#"  , py::arg("U"),  py::arg("DerivativeOrder"),  py::arg("Degree"),  py::arg("Dimension"),  py::arg("PolynomialCoeff"),  py::arg("Results"))
        .def_static("NoDerivativeEvalPolynomial_s",
                    (void (*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) >(&PLib::NoDerivativeEvalPolynomial),
                    R"#(Same as above with DerivativeOrder = 0;)#"  , py::arg("U"),  py::arg("Degree"),  py::arg("Dimension"),  py::arg("DegreeDimension"),  py::arg("PolynomialCoeff"),  py::arg("Results"))
        .def_static("EvalPoly2Var_s",
                    (void (*)( const Standard_Real ,  const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Real ,  const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) >(&PLib::EvalPoly2Var),
                    R"#(Applies EvalPolynomial twice to evaluate the derivative of orders UDerivativeOrder in U, VDerivativeOrder in V at parameters U,V)#"  , py::arg("U"),  py::arg("V"),  py::arg("UDerivativeOrder"),  py::arg("VDerivativeOrder"),  py::arg("UDegree"),  py::arg("VDegree"),  py::arg("Dimension"),  py::arg("PolynomialCoeff"),  py::arg("Results"))
        ...
        .def_static("JacobiParameters_s",
                    (void (*)( const GeomAbs_Shape ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (*)( const GeomAbs_Shape ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) >(&PLib::JacobiParameters),
        ...
        .def_static("EvalLength_s",
                    (void (*)( const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  const Standard_Real ,  const Standard_Real ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  const Standard_Real ,  const Standard_Real ,  Standard_Real &  ) >(&PLib::EvalLength),
                    R"#(None)#"  , py::arg("Degree"),  py::arg("Dimension"),  py::arg("PolynomialCoeff"),  py::arg("U1"),  py::arg("U2"),  py::arg("Length"))
        .def_static("EvalLength_s",
                    (void (*)( const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) >(&PLib::EvalLength),
                    R"#(None)#"  , py::arg("Degree"),  py::arg("Dimension"),  py::arg("PolynomialCoeff"),  py::arg("U1"),  py::arg("U2"),  py::arg("Tol"),  py::arg("Length"),  py::arg("Error"))
;


    static_cast<py::class_<PLib_DoubleJacobiPolynomial ,std::unique_ptr<PLib_DoubleJacobiPolynomial>  >>(m.attr("PLib_DoubleJacobiPolynomial"))
        .def(py::init<  >()  )
        ...
        .def("ReduceDegree",
             (void (PLib_DoubleJacobiPolynomial::*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,   const NCollection_Array1<Standard_Real> & ,  const Standard_Real ,  Standard_Real & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (PLib_DoubleJacobiPolynomial::*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,   const NCollection_Array1<Standard_Real> & ,  const Standard_Real ,  Standard_Real & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&PLib_DoubleJacobiPolynomial::ReduceDegree),
             R"#(None)#"  , py::arg("Dimension"),  py::arg("MinDegreeU"),  py::arg("MaxDegreeU"),  py::arg("MinDegreeV"),  py::arg("MaxDegreeV"),  py::arg("dJacCoeff"),  py::arg("JacCoeff"),  py::arg("EpmsCut"),  py::arg("MaxError"),  py::arg("NewDegreeU"),  py::arg("NewDegreeV"))
        .def("AverageError",
...
;
    ...
    static_cast<py::class_<PLib_Base ,opencascade::handle<PLib_Base> ,Py_PLib_Base , Standard_Transient >>(m.attr("PLib_Base"))
        ...
        .def("ReduceDegree",
             (void (PLib_Base::*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Integer & ,  Standard_Real &  ) const) static_cast<void (PLib_Base::*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Integer & ,  Standard_Real &  ) const>(&PLib_Base::ReduceDegree),
             R"#(Compute NewDegree <= MaxDegree so that MaxError is lower than Tol. MaxError can be greater than Tol if it is not possible to find a NewDegree <= MaxDegree. In this case NewDegree = MaxDegree)#"  , py::arg("Dimension"),  py::arg("MaxDegree"),  py::arg("Tol"),  py::arg("BaseCoeff"),  py::arg("NewDegree"),  py::arg("MaxError"))
        .def("DynamicType",
...
;
    ...
    static_cast<py::class_<PLib_HermitJacobi ,opencascade::handle<PLib_HermitJacobi>  , PLib_Base >>(m.attr("PLib_HermitJacobi"))
        ...
        .def("ReduceDegree",
             (void (PLib_HermitJacobi::*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Integer & ,  Standard_Real &  ) const) static_cast<void (PLib_HermitJacobi::*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Integer & ,  Standard_Real &  ) const>(&PLib_HermitJacobi::ReduceDegree),
             R"#(Compute NewDegree <= MaxDegree so that MaxError is lower than Tol. MaxError can be greater than Tol if it is not possible to find a NewDegree <= MaxDegree. In this case NewDegree = MaxDegree)#"  , py::arg("Dimension"),  py::arg("MaxDegree"),  py::arg("Tol"),  py::arg("HermJacCoeff"),  py::arg("NewDegree"),  py::arg("MaxError"))
        .def("AverageError",
...
;
    ...
    static_cast<py::class_<PLib_JacobiPolynomial ,opencascade::handle<PLib_JacobiPolynomial>  , PLib_Base >>(m.attr("PLib_JacobiPolynomial"))
        ...
        .def("ReduceDegree",
             (void (PLib_JacobiPolynomial::*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Integer & ,  Standard_Real &  ) const) static_cast<void (PLib_JacobiPolynomial::*)( const Standard_Integer ,  const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Integer & ,  Standard_Real &  ) const>(&PLib_JacobiPolynomial::ReduceDegree),
             R"#(Compute NewDegree <= MaxDegree so that MaxError is lower than Tol. MaxError can be greater than Tol if it is not possible to find a NewDegree <= MaxDegree. In this case NewDegree = MaxDegree)#"  , py::arg("Dimension"),  py::arg("MaxDegree"),  py::arg("Tol"),  py::arg("JacCoeff"),  py::arg("NewDegree"),  py::arg("MaxError"))
        .def("AverageError",
