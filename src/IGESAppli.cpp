...
;
    ...
    static_cast<py::class_<IGESAppli_ToolLevelFunction ,std::unique_ptr<IGESAppli_ToolLevelFunction>  >>(m.attr("IGESAppli_ToolLevelFunction"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolElementResults ,std::unique_ptr<IGESAppli_ToolElementResults>  >>(m.attr("IGESAppli_ToolElementResults"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    register_default_constructor<IGESAppli ,std::unique_ptr<IGESAppli>>(m,"IGESAppli");

    static_cast<py::class_<IGESAppli ,std::unique_ptr<IGESAppli>  >>(m.attr("IGESAppli"))
        .def_static("Init_s",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolDrilledHole ,std::unique_ptr<IGESAppli_ToolDrilledHole>  >>(m.attr("IGESAppli_ToolDrilledHole"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolLevelToPWBLayerMap ,std::unique_ptr<IGESAppli_ToolLevelToPWBLayerMap>  >>(m.attr("IGESAppli_ToolLevelToPWBLayerMap"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolPWBArtworkStackup ,std::unique_ptr<IGESAppli_ToolPWBArtworkStackup>  >>(m.attr("IGESAppli_ToolPWBArtworkStackup"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolPartNumber ,std::unique_ptr<IGESAppli_ToolPartNumber>  >>(m.attr("IGESAppli_ToolPartNumber"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_HArray1OfNode ,std::unique_ptr<IGESAppli_HArray1OfNode>  >>(m.attr("IGESAppli_HArray1OfNode"))
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolFiniteElement ,std::unique_ptr<IGESAppli_ToolFiniteElement>  >>(m.attr("IGESAppli_ToolFiniteElement"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolFlowLineSpec ,std::unique_ptr<IGESAppli_ToolFlowLineSpec>  >>(m.attr("IGESAppli_ToolFlowLineSpec"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolNode ,std::unique_ptr<IGESAppli_ToolNode>  >>(m.attr("IGESAppli_ToolNode"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolRegionRestriction ,std::unique_ptr<IGESAppli_ToolRegionRestriction>  >>(m.attr("IGESAppli_ToolRegionRestriction"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolPipingFlow ,std::unique_ptr<IGESAppli_ToolPipingFlow>  >>(m.attr("IGESAppli_ToolPipingFlow"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolNodalConstraint ,std::unique_ptr<IGESAppli_ToolNodalConstraint>  >>(m.attr("IGESAppli_ToolNodalConstraint"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_HArray1OfFlow ,std::unique_ptr<IGESAppli_HArray1OfFlow>  >>(m.attr("IGESAppli_HArray1OfFlow"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolPWBDrilledHole ,std::unique_ptr<IGESAppli_ToolPWBDrilledHole>  >>(m.attr("IGESAppli_ToolPWBDrilledHole"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolPinNumber ,std::unique_ptr<IGESAppli_ToolPinNumber>  >>(m.attr("IGESAppli_ToolPinNumber"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_HArray1OfFiniteElement ,std::unique_ptr<IGESAppli_HArray1OfFiniteElement>  >>(m.attr("IGESAppli_HArray1OfFiniteElement"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolLineWidening ,std::unique_ptr<IGESAppli_ToolLineWidening>  >>(m.attr("IGESAppli_ToolLineWidening"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolNodalResults ,std::unique_ptr<IGESAppli_ToolNodalResults>  >>(m.attr("IGESAppli_ToolNodalResults"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolFlow ,std::unique_ptr<IGESAppli_ToolFlow>  >>(m.attr("IGESAppli_ToolFlow"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolNodalDisplAndRot ,std::unique_ptr<IGESAppli_ToolNodalDisplAndRot>  >>(m.attr("IGESAppli_ToolNodalDisplAndRot"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESAppli_ToolReferenceDesignator ,std::unique_ptr<IGESAppli_ToolReferenceDesignator>  >>(m.attr("IGESAppli_ToolReferenceDesignator"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
