...
// classes forward declarations only
    ...
    py::class_<IGESAppli_ToolLevelFunction ,std::unique_ptr<IGESAppli_ToolLevelFunction>  >(m,"IGESAppli_ToolLevelFunction",R"#(Tool to work on a LevelFunction. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_ToolElementResults ,std::unique_ptr<IGESAppli_ToolElementResults>  >(m,"IGESAppli_ToolElementResults",R"#(Tool to work on a ElementResults. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli ,std::unique_ptr<IGESAppli>  >(m,"IGESAppli",R"#(This package represents collection of miscellaneous entities from IGES)#");
    py::class_<IGESAppli_ToolDrilledHole ,std::unique_ptr<IGESAppli_ToolDrilledHole>  >(m,"IGESAppli_ToolDrilledHole",R"#(Tool to work on a DrilledHole. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_ToolLevelToPWBLayerMap ,std::unique_ptr<IGESAppli_ToolLevelToPWBLayerMap>  >(m,"IGESAppli_ToolLevelToPWBLayerMap",R"#(Tool to work on a LevelToPWBLayerMap. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESAppli_ToolPWBArtworkStackup ,std::unique_ptr<IGESAppli_ToolPWBArtworkStackup>  >(m,"IGESAppli_ToolPWBArtworkStackup",R"#(Tool to work on a PWBArtworkStackup. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESAppli_ToolPartNumber ,std::unique_ptr<IGESAppli_ToolPartNumber>  >(m,"IGESAppli_ToolPartNumber",R"#(Tool to work on a PartNumber. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_HArray1OfNode ,std::unique_ptr<IGESAppli_HArray1OfNode>  >(m,"IGESAppli_HArray1OfNode",R"#()#");
    ...
    py::class_<IGESAppli_ToolFiniteElement ,std::unique_ptr<IGESAppli_ToolFiniteElement>  >(m,"IGESAppli_ToolFiniteElement",R"#(Tool to work on a FiniteElement. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESAppli_ToolFlowLineSpec ,std::unique_ptr<IGESAppli_ToolFlowLineSpec>  >(m,"IGESAppli_ToolFlowLineSpec",R"#(Tool to work on a FlowLineSpec. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_ToolNode ,std::unique_ptr<IGESAppli_ToolNode>  >(m,"IGESAppli_ToolNode",R"#(Tool to work on a Node. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESAppli_ToolRegionRestriction ,std::unique_ptr<IGESAppli_ToolRegionRestriction>  >(m,"IGESAppli_ToolRegionRestriction",R"#(Tool to work on a RegionRestriction. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_ToolPipingFlow ,std::unique_ptr<IGESAppli_ToolPipingFlow>  >(m,"IGESAppli_ToolPipingFlow",R"#(Tool to work on a PipingFlow. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESAppli_ToolNodalConstraint ,std::unique_ptr<IGESAppli_ToolNodalConstraint>  >(m,"IGESAppli_ToolNodalConstraint",R"#(Tool to work on a NodalConstraint. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_HArray1OfFlow ,std::unique_ptr<IGESAppli_HArray1OfFlow>  >(m,"IGESAppli_HArray1OfFlow",R"#()#");
    ...
    py::class_<IGESAppli_ToolPWBDrilledHole ,std::unique_ptr<IGESAppli_ToolPWBDrilledHole>  >(m,"IGESAppli_ToolPWBDrilledHole",R"#(Tool to work on a PWBDrilledHole. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESAppli_ToolPinNumber ,std::unique_ptr<IGESAppli_ToolPinNumber>  >(m,"IGESAppli_ToolPinNumber",R"#(Tool to work on a PinNumber. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_HArray1OfFiniteElement ,std::unique_ptr<IGESAppli_HArray1OfFiniteElement>  >(m,"IGESAppli_HArray1OfFiniteElement",R"#()#");
    py::class_<IGESAppli_ToolLineWidening ,std::unique_ptr<IGESAppli_ToolLineWidening>  >(m,"IGESAppli_ToolLineWidening",R"#(Tool to work on a LineWidening. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_ToolNodalResults ,std::unique_ptr<IGESAppli_ToolNodalResults>  >(m,"IGESAppli_ToolNodalResults",R"#(Tool to work on a NodalResults. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_ToolFlow ,std::unique_ptr<IGESAppli_ToolFlow>  >(m,"IGESAppli_ToolFlow",R"#(Tool to work on a Flow. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESAppli_ToolNodalDisplAndRot ,std::unique_ptr<IGESAppli_ToolNodalDisplAndRot>  >(m,"IGESAppli_ToolNodalDisplAndRot",R"#(Tool to work on a NodalDisplAndRot. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESAppli_ToolReferenceDesignator ,std::unique_ptr<IGESAppli_ToolReferenceDesignator>  >(m,"IGESAppli_ToolReferenceDesignator",R"#(Tool to work on a ReferenceDesignator. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
