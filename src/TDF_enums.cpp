...
// classes forward declarations only
    ...
    py::class_<TDF_CopyTool ,std::unique_ptr<TDF_CopyTool>  >(m,"TDF_CopyTool",R"#(This class provides services to build, copy or paste a set of information.)#");
    ...
    py::class_<TDF_ClosureMode ,std::unique_ptr<TDF_ClosureMode>  >(m,"TDF_ClosureMode",R"#(This class provides options closure management.)#");
    ...
    py::class_<TDF_ComparisonTool ,std::unique_ptr<TDF_ComparisonTool>  >(m,"TDF_ComparisonTool",R"#(This class provides services to compare sets of information. The use of this tool can works after a copy, acted by a CopyTool.)#");
    py::class_<TDF ,std::unique_ptr<TDF>  >(m,"TDF",R"#(This package provides data framework for binding features and data structures.)#");
    py::class_<TDF_HAttributeArray1 ,std::unique_ptr<TDF_HAttributeArray1>  >(m,"TDF_HAttributeArray1",R"#()#");
    ...
    py::class_<TDF_ClosureTool ,std::unique_ptr<TDF_ClosureTool>  >(m,"TDF_ClosureTool",R"#(This class provides services to build the closure of an information set. This class gives services around the transitive enclosure of a set of information, starting from a list of label. You can set closure options by using IDFilter (to select or exclude specific attribute IDs) and CopyOption objects and by giving to Closure method.)#");
    py::class_<TDF_LabelMapHasher ,std::unique_ptr<TDF_LabelMapHasher>  >(m,"TDF_LabelMapHasher",R"#(A label hasher for label maps.)#");
    py::class_<TDF_AttributeIterator ,std::unique_ptr<TDF_AttributeIterator>  >(m,"TDF_AttributeIterator",R"#(None)#");
    py::class_<TDF_CopyLabel ,std::unique_ptr<TDF_CopyLabel>  >(m,"TDF_CopyLabel",R"#(This class gives copy of source label hierarchy)#");
    ...
    py::class_<TDF_ChildIDIterator ,std::unique_ptr<TDF_ChildIDIterator>  >(m,"TDF_ChildIDIterator",R"#(Iterates on the children of a label, to find attributes having ID as Attribute ID.)#");
    py::class_<TDF_ChildIterator ,std::unique_ptr<TDF_ChildIterator>  >(m,"TDF_ChildIterator",R"#(Iterates on the children of a label, at the first level only. It is possible to ask the iterator to explore all the sub label levels of the given one, with the option "allLevels".)#");
    ...
    py::class_<TDF_IDFilter ,std::unique_ptr<TDF_IDFilter>  >(m,"TDF_IDFilter",R"#(This class offers filtering services around an ID list.)#");
    py::class_<TDF_Tool ,std::unique_ptr<TDF_Tool>  >(m,"TDF_Tool",R"#(This class provides general services for a data framework.)#");
...
// ./opencascade/TDF_AttributeDoubleMap.hxx
    preregister_template_NCollection_DoubleMap<opencascade::handle<TDF_Attribute>, opencascade::handle<TDF_Attribute>, TColStd_MapTransientHasher, TColStd_MapTransientHasher>(m,"TDF_AttributeDoubleMap");  
// ./opencascade/TDF_GUIDProgIDMap.hxx
