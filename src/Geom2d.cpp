...
// classes
    ...
    static_cast<py::class_<Geom2d_Transformation ,opencascade::handle<Geom2d_Transformation>  , Standard_Transient >>(m.attr("Geom2d_Transformation"))
        ...
        .def("Transforms",
             (void (Geom2d_Transformation::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom2d_Transformation::*)( Standard_Real & ,  Standard_Real &  ) const>(&Geom2d_Transformation::Transforms),
             R"#(Applies the transformation <me> to the triplet {X, Y}.)#"  , py::arg("X"),  py::arg("Y"))
        .def("Copy",
...
;
    ...
    static_cast<py::class_<Geom2d_Point ,opencascade::handle<Geom2d_Point> ,Py_Geom2d_Point , Geom2d_Geometry >>(m.attr("Geom2d_Point"))
        .def("Coord",
             (void (Geom2d_Point::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom2d_Point::*)( Standard_Real & ,  Standard_Real &  ) const>(&Geom2d_Point::Coord),
             R"#(returns the Coordinates of <me>.)#"  , py::arg("X"),  py::arg("Y"))
        .def("Pnt2d",
...
;
    ...
    static_cast<py::class_<Geom2d_Vector ,opencascade::handle<Geom2d_Vector> ,Py_Geom2d_Vector , Geom2d_Geometry >>(m.attr("Geom2d_Vector"))
        ...
        .def("Coord",
             (void (Geom2d_Vector::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom2d_Vector::*)( Standard_Real & ,  Standard_Real &  ) const>(&Geom2d_Vector::Coord),
             R"#(Returns the coordinates of <me>.)#"  , py::arg("X"),  py::arg("Y"))
        .def("Magnitude",
...
;
    ...
    static_cast<py::class_<Geom2d_CartesianPoint ,opencascade::handle<Geom2d_CartesianPoint>  , Geom2d_Point >>(m.attr("Geom2d_CartesianPoint"))
        ...
        .def("Coord",
             (void (Geom2d_CartesianPoint::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom2d_CartesianPoint::*)( Standard_Real & ,  Standard_Real &  ) const>(&Geom2d_CartesianPoint::Coord),
             R"#(Returns the coordinates of <me>.)#"  , py::arg("X"),  py::arg("Y"))
        .def("Pnt2d",
...
;
    ...
    static_cast<py::class_<Geom2d_BSplineCurve ,opencascade::handle<Geom2d_BSplineCurve>  , Geom2d_BoundedCurve >>(m.attr("Geom2d_BSplineCurve"))
        ...
        .def("PeriodicNormalization",
             (void (Geom2d_BSplineCurve::*)( Standard_Real &  ) const) static_cast<void (Geom2d_BSplineCurve::*)( Standard_Real &  ) const>(&Geom2d_BSplineCurve::PeriodicNormalization),
             R"#(Computes the parameter normalized within the "first" period of this BSpline curve, if it is periodic: the returned value is in the range Param1 and Param1 + Period, where: - Param1 is the "first parameter", and - Period the period of this BSpline curve. Note: If this curve is not periodic, U is not modified.)#"  , py::arg("U"))
        .def("SetPeriodic",
        ...
        .def("MovePoint",
             (void (Geom2d_BSplineCurve::*)( const Standard_Real ,  const gp_Pnt2d & ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (Geom2d_BSplineCurve::*)( const Standard_Real ,  const gp_Pnt2d & ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) >(&Geom2d_BSplineCurve::MovePoint),
        ...
        .def("MovePointAndTangent",
             (void (Geom2d_BSplineCurve::*)( const Standard_Real ,  const gp_Pnt2d & ,  const gp_Vec2d & ,  const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer &  ) ) static_cast<void (Geom2d_BSplineCurve::*)( const Standard_Real ,  const gp_Pnt2d & ,  const gp_Vec2d & ,  const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer &  ) >(&Geom2d_BSplineCurve::MovePointAndTangent),
        ...
        .def("LocateU",
             (void (Geom2d_BSplineCurve::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const) static_cast<void (Geom2d_BSplineCurve::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const>(&Geom2d_BSplineCurve::LocateU),
        ...
        .def("Resolution",
             (void (Geom2d_BSplineCurve::*)( const Standard_Real ,  Standard_Real &  ) ) static_cast<void (Geom2d_BSplineCurve::*)( const Standard_Real ,  Standard_Real &  ) >(&Geom2d_BSplineCurve::Resolution),
             R"#(Computes for this BSpline curve the parametric tolerance UTolerance for a given tolerance Tolerance3D (relative to dimensions in the plane). If f(t) is the equation of this BSpline curve, UTolerance ensures that: | t1 - t0| < Utolerance ===> |f(t1) - f(t0)| < ToleranceUV)#"  , py::arg("ToleranceUV"),  py::arg("UTolerance"))
        .def("Copy",
...
;
    ...
    static_cast<py::class_<Geom2d_BezierCurve ,opencascade::handle<Geom2d_BezierCurve>  , Geom2d_BoundedCurve >>(m.attr("Geom2d_BezierCurve"))
        ...
        .def("Resolution",
             (void (Geom2d_BezierCurve::*)( const Standard_Real ,  Standard_Real &  ) ) static_cast<void (Geom2d_BezierCurve::*)( const Standard_Real ,  Standard_Real &  ) >(&Geom2d_BezierCurve::Resolution),
             R"#(Computes for this Bezier curve the parametric tolerance UTolerance for a given tolerance Tolerance3D (relative to dimensions in the plane). If f(t) is the equation of this Bezier curve, UTolerance ensures that | t1 - t0| < Utolerance ===> |f(t1) - f(t0)| < ToleranceUV)#"  , py::arg("ToleranceUV"),  py::arg("UTolerance"))
        .def("Copy",
