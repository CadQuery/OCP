...
// classes forward declarations only
    py::class_<StepAP242_IdAttributeSelect ,std::unique_ptr<StepAP242_IdAttributeSelect>  , StepData_SelectType >(m,"StepAP242_IdAttributeSelect",R"#(None)#");
    ...
    py::class_<StepAP242_ItemIdentifiedRepresentationUsageDefinition ,std::unique_ptr<StepAP242_ItemIdentifiedRepresentationUsageDefinition>  , StepData_SelectType >(m,"StepAP242_ItemIdentifiedRepresentationUsageDefinition",R"#(None)#");
