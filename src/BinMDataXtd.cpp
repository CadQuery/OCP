...
;
    ...
    register_default_constructor<BinMDataXtd ,std::unique_ptr<BinMDataXtd>>(m,"BinMDataXtd");

    static_cast<py::class_<BinMDataXtd ,std::unique_ptr<BinMDataXtd>  >>(m.attr("BinMDataXtd"))
