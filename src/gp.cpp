...
// classes
    ...
    static_cast<py::class_<gp_Hypr ,std::unique_ptr<gp_Hypr>  >>(m.attr("gp_Hypr"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<gp_Torus ,std::unique_ptr<gp_Torus>  >>(m.attr("gp_Torus"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<gp_Ax22d ,std::unique_ptr<gp_Ax22d>  >>(m.attr("gp_Ax22d"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<gp_Vec ,std::unique_ptr<gp_Vec>  >>(m.attr("gp_Vec"))
        .def(py::init<  >()  )
        ...
        .def("Coord",
             (void (gp_Vec::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Vec::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Vec::Coord),
             R"#(For this vector returns its three coordinates Xv, Yv, and Zvinline)#"  , py::arg("Xv"),  py::arg("Yv"),  py::arg("Zv"))
        .def("X",
...
;
    ...
    static_cast<py::class_<gp_Ax2 ,std::unique_ptr<gp_Ax2>  >>(m.attr("gp_Ax2"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<gp_Circ2d ,std::unique_ptr<gp_Circ2d>  >>(m.attr("gp_Circ2d"))
        .def(py::init<  >()  )
        ...
        .def("Coefficients",
             (void (gp_Circ2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Circ2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Circ2d::Coefficients),
             R"#(Returns the normalized coefficients from the implicit equation of the circle : A * (X**2) + B * (Y**2) + 2*C*(X*Y) + 2*D*X + 2*E*Y + F = 0.0)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"),  py::arg("D"),  py::arg("E"),  py::arg("F"))
        .def("Contains",
...
;
    ...
    static_cast<py::class_<gp_Ax3 ,std::unique_ptr<gp_Ax3>  >>(m.attr("gp_Ax3"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<gp_Mat ,std::unique_ptr<gp_Mat>  >>(m.attr("gp_Mat"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<gp_Cone ,std::unique_ptr<gp_Cone>  >>(m.attr("gp_Cone"))
        .def(py::init<  >()  )
        ...
        .def("Coefficients",
             (void (gp_Cone::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Cone::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Cone::Coefficients),
             R"#(Computes the coefficients of the implicit equation of the quadric in the absolute cartesian coordinates system : A1.X**2 + A2.Y**2 + A3.Z**2 + 2.(B1.X.Y + B2.X.Z + B3.Y.Z) + 2.(C1.X + C2.Y + C3.Z) + D = 0.0)#"  , py::arg("A1"),  py::arg("A2"),  py::arg("A3"),  py::arg("B1"),  py::arg("B2"),  py::arg("B3"),  py::arg("C1"),  py::arg("C2"),  py::arg("C3"),  py::arg("D"))
        .def("Location",
...
;
    ...
    static_cast<py::class_<gp_Elips ,std::unique_ptr<gp_Elips>  >>(m.attr("gp_Elips"))
        .def(py::init<  >()  )
        .def(py::init< const gp_Ax2 &,const Standard_Real,const Standard_Real >()  , py::arg("A2"),  py::arg("MajorRadius"),  py::arg("MinorRadius") )
        .def("SetAxis",
...
;
    ...
    static_cast<py::class_<gp_Lin2d ,std::unique_ptr<gp_Lin2d>  >>(m.attr("gp_Lin2d"))
        .def(py::init<  >()  )
        ...
        .def("Coefficients",
             (void (gp_Lin2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Lin2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Lin2d::Coefficients),
             R"#(Returns the normalized coefficients of the line : A * X + B * Y + C = 0.)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"))
        .def("Direction",
...
;
    ...
    static_cast<py::class_<gp_Dir2d ,std::unique_ptr<gp_Dir2d>  >>(m.attr("gp_Dir2d"))
        .def(py::init<  >()  )
        ...
        .def("Coord",
             (void (gp_Dir2d::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Dir2d::*)( Standard_Real & ,  Standard_Real &  ) const>(&gp_Dir2d::Coord),
             R"#(For this unit vector returns its two coordinates Xv and Yv. Raises OutOfRange if Index != {1, 2}.)#"  , py::arg("Xv"),  py::arg("Yv"))
        .def("X",
...
;
    ...
    static_cast<py::class_<gp_Pnt2d ,std::unique_ptr<gp_Pnt2d>  >>(m.attr("gp_Pnt2d"))
        .def(py::init<  >()  )
        .def(py::init< const gp_XY & >()  , py::arg("Coord") )
        ...
        .def("Coord",
             (void (gp_Pnt2d::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Pnt2d::*)( Standard_Real & ,  Standard_Real &  ) const>(&gp_Pnt2d::Coord),
             R"#(For this point returns its two coordinates as a number pair.)#"  , py::arg("Xp"),  py::arg("Yp"))
        .def("X",
...
;
    ...
    static_cast<py::class_<gp_Ax2d ,std::unique_ptr<gp_Ax2d>  >>(m.attr("gp_Ax2d"))
        .def(py::init<  >()  )
        .def(py::init< const gp_Pnt2d &,const gp_Dir2d & >()  , py::arg("P"),  py::arg("V") )
        .def("SetLocation",
...
;
    ...
    static_cast<py::class_<gp_XY ,std::unique_ptr<gp_XY>  >>(m.attr("gp_XY"))
        .def(py::init<  >()  )
        ...
        .def("Coord",
             (void (gp_XY::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_XY::*)( Standard_Real & ,  Standard_Real &  ) const>(&gp_XY::Coord),
             R"#(For this number pair, returns its coordinates X and Y.)#"  , py::arg("X"),  py::arg("Y"))
        .def("X",
...
;
    ...
    static_cast<py::class_<gp_GTrsf2d ,std::unique_ptr<gp_GTrsf2d>  >>(m.attr("gp_GTrsf2d"))
        .def(py::init<  >()  )
        ...
        .def("Transformed",
             ...
             R"#(None)#"  , py::arg("Coord"))
        .def("Transforms",
             (void (gp_GTrsf2d::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_GTrsf2d::*)( Standard_Real & ,  Standard_Real &  ) const>(&gp_GTrsf2d::Transforms),
             R"#(Applies this transformation to the coordinates: - of the number pair Coord, or - X and Y.)#"  , py::arg("X"),  py::arg("Y"))
        .def("Trsf2d",
...
;
    ...
    static_cast<py::class_<gp_Pln ,std::unique_ptr<gp_Pln>  >>(m.attr("gp_Pln"))
        .def(py::init<  >()  )
        ...
        .def("Coefficients",
             (void (gp_Pln::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Pln::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Pln::Coefficients),
             R"#(Returns the coefficients of the plane's cartesian equation : A * X + B * Y + C * Z + D = 0.)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"),  py::arg("D"))
        .def("SetAxis",
...
;
    ...
    static_cast<py::class_<gp_Parab ,std::unique_ptr<gp_Parab>  >>(m.attr("gp_Parab"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<gp_Trsf ,std::unique_ptr<gp_Trsf>  >>(m.attr("gp_Trsf"))
        .def(py::init<  >()  )
        .def(py::init< const gp_Trsf2d & >()  , py::arg("T") )
        .def("SetMirror",
        ...
        .def("Powered",
             ...
             R"#(Computes the following composition of transformations <me> * <me> * .......* <me>, N time. if N = 0 <me> = Identity if N < 0 <me> = <me>.Inverse() *...........* <me>.Inverse().)#"  , py::arg("N"))
        .def("Transforms",
             (void (gp_Trsf::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Trsf::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Trsf::Transforms),
...
;
    ...
    static_cast<py::class_<gp_Quaternion ,std::unique_ptr<gp_Quaternion>  >>(m.attr("gp_Quaternion"))
        .def(py::init<  >()  )
        ...
        .def("GetVectorAndAngle",
             (void (gp_Quaternion::*)( gp_Vec & ,  Standard_Real &  ) const) static_cast<void (gp_Quaternion::*)( gp_Vec & ,  Standard_Real &  ) const>(&gp_Quaternion::GetVectorAndAngle),
             R"#(Convert a quaternion to Axis+Angle representation, preserve the axis direction and angle from -PI to +PI)#"  , py::arg("theAxis"),  py::arg("theAngle"))
        .def("SetMatrix",
        ...
        .def("GetEulerAngles",
             (void (gp_Quaternion::*)( const gp_EulerSequence ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Quaternion::*)( const gp_EulerSequence ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Quaternion::GetEulerAngles),
             R"#(Returns Euler angles describing current rotation)#"  , py::arg("theOrder"),  py::arg("theAlpha"),  py::arg("theBeta"),  py::arg("theGamma"))
        .def("Set",
...
;
    ...
    static_cast<py::class_<gp_XYZ ,std::unique_ptr<gp_XYZ>  >>(m.attr("gp_XYZ"))
        .def(py::init<  >()  )
        ...
        .def("ChangeCoord",
             ...
             R"#(None)#"  , py::arg("theIndex"))
        .def("Coord",
             (void (gp_XYZ::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_XYZ::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_XYZ::Coord),
             R"#(None)#"  , py::arg("X"),  py::arg("Y"),  py::arg("Z"))
        .def("GetData",
...
;
    ...
    static_cast<py::class_<gp_Lin ,std::unique_ptr<gp_Lin>  >>(m.attr("gp_Lin"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<gp_Trsf2d ,std::unique_ptr<gp_Trsf2d>  >>(m.attr("gp_Trsf2d"))
        .def(py::init<  >()  )
        ...
        .def("Powered",
             ...
             R"#(Computes the following composition of transformations <me> * <me> * .......* <me>, N time. if N = 0 <me> = Identity if N < 0 <me> = <me>.Inverse() *...........* <me>.Inverse().)#"  , py::arg("N"))
        .def("Transforms",
             (void (gp_Trsf2d::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Trsf2d::*)( Standard_Real & ,  Standard_Real &  ) const>(&gp_Trsf2d::Transforms),
...
;
    ...
    static_cast<py::class_<gp_Hypr2d ,std::unique_ptr<gp_Hypr2d>  >>(m.attr("gp_Hypr2d"))
        .def(py::init<  >()  )
        ...
        .def("Asymptote2",
             ...
             R"#(In the local coordinate system of the hyperbola the equation of the hyperbola is (X*X)/(A*A) - (Y*Y)/(B*B) = 1.0 and the equation of the first asymptote is Y = -(B/A)*X where A is the major radius of the hyperbola and B the minor radius of the hyperbola. Raises ConstructionError if MajorRadius = 0.0)#" )
        .def("Coefficients",
             (void (gp_Hypr2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Hypr2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Hypr2d::Coefficients),
             R"#(Computes the coefficients of the implicit equation of the hyperbola : A * (X**2) + B * (Y**2) + 2*C*(X*Y) + 2*D*X + 2*E*Y + F = 0.)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"),  py::arg("D"),  py::arg("E"),  py::arg("F"))
        .def("ConjugateBranch1",
...
;
    ...
    static_cast<py::class_<gp_Dir ,std::unique_ptr<gp_Dir>  >>(m.attr("gp_Dir"))
        .def(py::init<  >()  )
        ...
        .def("Coord",
             (void (gp_Dir::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Dir::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Dir::Coord),
             R"#(Returns for the unit vector its three coordinates Xv, Yv, and Zv.)#"  , py::arg("Xv"),  py::arg("Yv"),  py::arg("Zv"))
        .def("X",
...
;
    ...
    static_cast<py::class_<gp_Parab2d ,std::unique_ptr<gp_Parab2d>  >>(m.attr("gp_Parab2d"))
        .def(py::init<  >()  )
        ...
        .def("Coefficients",
             (void (gp_Parab2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Parab2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Parab2d::Coefficients),
             R"#(Computes the coefficients of the implicit equation of the parabola (in WCS - World Coordinate System). A * (X**2) + B * (Y**2) + 2*C*(X*Y) + 2*D*X + 2*E*Y + F = 0.)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"),  py::arg("D"),  py::arg("E"),  py::arg("F"))
        .def("Directrix",
...
;
    ...
    static_cast<py::class_<gp_Ax1 ,std::unique_ptr<gp_Ax1>  >>(m.attr("gp_Ax1"))
        .def(py::init<  >()  )
        .def(py::init< const gp_Pnt &,const gp_Dir & >()  , py::arg("P"),  py::arg("V") )
        .def("SetDirection",
...
;
    ...
    register_default_constructor<gp ,std::unique_ptr<gp>>(m,"gp");

    static_cast<py::class_<gp ,std::unique_ptr<gp>  >>(m.attr("gp"))
...
;
    ...
    static_cast<py::class_<gp_GTrsf ,std::unique_ptr<gp_GTrsf>  >>(m.attr("gp_GTrsf"))
        .def(py::init<  >()  )
        .def(py::init< const gp_Trsf & >()  , py::arg("T") )
        ...
        .def("Transforms",
             ...
             R"#(None)#"  , py::arg("Coord"))
        .def("Transforms",
             (void (gp_GTrsf::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_GTrsf::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_GTrsf::Transforms),
             R"#(Transforms a triplet XYZ with a GTrsf.)#"  , py::arg("X"),  py::arg("Y"),  py::arg("Z"))
        .def("Trsf",
...
;
    ...
    static_cast<py::class_<gp_Sphere ,std::unique_ptr<gp_Sphere>  >>(m.attr("gp_Sphere"))
        .def(py::init<  >()  )
        ...
        .def("Coefficients",
             (void (gp_Sphere::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Sphere::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Sphere::Coefficients),
             R"#(Computes the coefficients of the implicit equation of the quadric in the absolute cartesian coordinates system : A1.X**2 + A2.Y**2 + A3.Z**2 + 2.(B1.X.Y + B2.X.Z + B3.Y.Z) + 2.(C1.X + C2.Y + C3.Z) + D = 0.0)#"  , py::arg("A1"),  py::arg("A2"),  py::arg("A3"),  py::arg("B1"),  py::arg("B2"),  py::arg("B3"),  py::arg("C1"),  py::arg("C2"),  py::arg("C3"),  py::arg("D"))
        .def("UReverse",
...
;
    ...
    static_cast<py::class_<gp_Cylinder ,std::unique_ptr<gp_Cylinder>  >>(m.attr("gp_Cylinder"))
        .def(py::init<  >()  )
        .def(py::init< const gp_Ax3 &,const Standard_Real >()  , py::arg("A3"),  py::arg("Radius") )
        .def("SetAxis",
        ...
        .def("Coefficients",
             (void (gp_Cylinder::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Cylinder::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Cylinder::Coefficients),
             R"#(Computes the coefficients of the implicit equation of the quadric in the absolute cartesian coordinate system : A1.X**2 + A2.Y**2 + A3.Z**2 + 2.(B1.X.Y + B2.X.Z + B3.Y.Z) + 2.(C1.X + C2.Y + C3.Z) + D = 0.0)#"  , py::arg("A1"),  py::arg("A2"),  py::arg("A3"),  py::arg("B1"),  py::arg("B2"),  py::arg("B3"),  py::arg("C1"),  py::arg("C2"),  py::arg("C3"),  py::arg("D"))
        .def("Location",
...
;
    ...
    static_cast<py::class_<gp_Elips2d ,std::unique_ptr<gp_Elips2d>  >>(m.attr("gp_Elips2d"))
        .def(py::init<  >()  )
        .def(py::init< const gp_Ax2d &,const Standard_Real,const Standard_Real,const Standard_Boolean >()  , py::arg("MajorAxis"),  py::arg("MajorRadius"),  py::arg("MinorRadius"),  py::arg("Sense")=static_cast<const Standard_Boolean>(Standard_True) )
        .def(py::init< const gp_Ax22d &,const Standard_Real,const Standard_Real >()  , py::arg("A"),  py::arg("MajorRadius"),  py::arg("MinorRadius") )
        .def("SetLocation",
        ...
        .def("Area",
             ...
             R"#(Computes the area of the ellipse.)#" )
        .def("Coefficients",
             (void (gp_Elips2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Elips2d::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Elips2d::Coefficients),
             R"#(Returns the coefficients of the implicit equation of the ellipse. A * (X**2) + B * (Y**2) + 2*C*(X*Y) + 2*D*X + 2*E*Y + F = 0.)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"),  py::arg("D"),  py::arg("E"),  py::arg("F"))
        .def("Directrix1",
...
;
    ...
    static_cast<py::class_<gp_Pnt ,std::unique_ptr<gp_Pnt>  >>(m.attr("gp_Pnt"))
        .def(py::init<  >()  )
        .def(py::init< const gp_XYZ & >()  , py::arg("Coord") )
        ...
        .def("Coord",
             (void (gp_Pnt::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Pnt::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&gp_Pnt::Coord),
             R"#(For this point gives its three coordinates Xp, Yp and Zp.)#"  , py::arg("Xp"),  py::arg("Yp"),  py::arg("Zp"))
        .def("X",
...
;
    ...
    static_cast<py::class_<gp_Vec2d ,std::unique_ptr<gp_Vec2d>  >>(m.attr("gp_Vec2d"))
        .def(py::init<  >()  )
        ...
        .def("Coord",
             (void (gp_Vec2d::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (gp_Vec2d::*)( Standard_Real & ,  Standard_Real &  ) const>(&gp_Vec2d::Coord),
             R"#(For this vector, returns its two coordinates Xv and Yv)#"  , py::arg("Xv"),  py::arg("Yv"))
        .def("X",
...
;
    ...
    static_cast<py::class_<gp_Mat2d ,std::unique_ptr<gp_Mat2d>  >>(m.attr("gp_Mat2d"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<gp_Circ ,std::unique_ptr<gp_Circ>  >>(m.attr("gp_Circ"))
        .def(py::init<  >()  )
