...
template <typename T>
void preregister_template_math_SingleTab(py::object &m, const char *name){
    py::class_<math_SingleTab<T> ,std::unique_ptr<math_SingleTab<T>> >(m,name,R"#(None)#");
}

template <typename T>
void register_template_math_SingleTab(py::object &m, const char *name){
    static_cast<py::class_<math_SingleTab<T> ,std::unique_ptr<math_SingleTab<T>> >>(m.attr(name))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("LowerIndex"),  py::arg("UpperIndex") )
        .def(py::init< const Standard_Address,const Standard_Integer,const Standard_Integer >()  , py::arg("Tab"),  py::arg("LowerIndex"),  py::arg("UpperIndex") )
        .def(py::init< const math_SingleTab<T> & >()  , py::arg("Other") )
        .def("Init",
             (void (math_SingleTab<T>::*)( const T  ) ) &math_SingleTab<T>::Init,
             R"#(None)#"  , py::arg("InitValue"))
        .def("Copy",
             (void (math_SingleTab<T>::*)( math_SingleTab<T> &  ) const) &math_SingleTab<T>::Copy,
             R"#(None)#"  , py::arg("Other"))
        .def("SetLower",
             (void (math_SingleTab<T>::*)( const Standard_Integer  ) ) &math_SingleTab<T>::SetLower,
             R"#(None)#"  , py::arg("LowerIndex"))
        .def("Value",
             (T & (math_SingleTab<T>::*)( const Standard_Integer  ) const) &math_SingleTab<T>::Value,
             R"#(None)#"  , py::arg("Index"))
        .def("Free",
             (void (math_SingleTab<T>::*)() ) &math_SingleTab<T>::Free,
             R"#(None)#" )
    ;
};
