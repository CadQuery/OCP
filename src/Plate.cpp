...
// classes
    ...
    static_cast<py::class_<Plate_D2 ,std::unique_ptr<Plate_D2>  >>(m.attr("Plate_D2"))
        .def(py::init< const gp_XYZ &,const gp_XYZ &,const gp_XYZ & >()  , py::arg("duu"),  py::arg("duv"),  py::arg("dvv") )
        .def(py::init< const Plate_D2 & >()  , py::arg("ref") )
;


    static_cast<py::class_<Plate_PlaneConstraint ,std::unique_ptr<Plate_PlaneConstraint>  >>(m.attr("Plate_PlaneConstraint"))
...
;
    ...
    static_cast<py::class_<Plate_PinpointConstraint ,std::unique_ptr<Plate_PinpointConstraint>  >>(m.attr("Plate_PinpointConstraint"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Plate_Plate ,std::unique_ptr<Plate_Plate>  >>(m.attr("Plate_Plate"))
        .def(py::init<  >()  )
        ...
        .def("SolveTI",
             (void (Plate_Plate::*)( const Standard_Integer ,  const Standard_Real  ) ) static_cast<void (Plate_Plate::*)( const Standard_Integer ,  const Standard_Real  ) >(&Plate_Plate::SolveTI),
             R"#(None)#"  , py::arg("ord")=static_cast<const Standard_Integer>(4),  py::arg("anisotropie")=static_cast<const Standard_Real>(1.0))
        .def("IsDone",
        ...
        .def("Continuity",
             ...
             R"#(None)#" )
        .def("UVBox",
             (void (Plate_Plate::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Plate_Plate::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Plate_Plate::UVBox),
...
;
    ...
    static_cast<py::class_<Plate_SampledCurveConstraint ,std::unique_ptr<Plate_SampledCurveConstraint>  >>(m.attr("Plate_SampledCurveConstraint"))
...
;
    ...
    static_cast<py::class_<Plate_GlobalTranslationConstraint ,std::unique_ptr<Plate_GlobalTranslationConstraint>  >>(m.attr("Plate_GlobalTranslationConstraint"))
...
;
    ...
    static_cast<py::class_<Plate_LinearXYZConstraint ,std::unique_ptr<Plate_LinearXYZConstraint>  >>(m.attr("Plate_LinearXYZConstraint"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Plate_GtoCConstraint ,std::unique_ptr<Plate_GtoCConstraint>  >>(m.attr("Plate_GtoCConstraint"))
...
;
    ...
    static_cast<py::class_<Plate_D3 ,std::unique_ptr<Plate_D3>  >>(m.attr("Plate_D3"))
...
;
    ...
    static_cast<py::class_<Plate_HArray1OfPinpointConstraint ,std::unique_ptr<Plate_HArray1OfPinpointConstraint>  >>(m.attr("Plate_HArray1OfPinpointConstraint"))
...
;
    ...
    static_cast<py::class_<Plate_FreeGtoCConstraint ,std::unique_ptr<Plate_FreeGtoCConstraint>  >>(m.attr("Plate_FreeGtoCConstraint"))
...
;
    ...
    static_cast<py::class_<Plate_D1 ,std::unique_ptr<Plate_D1>  >>(m.attr("Plate_D1"))
...
;
    ...
    static_cast<py::class_<Plate_LinearScalarConstraint ,std::unique_ptr<Plate_LinearScalarConstraint>  >>(m.attr("Plate_LinearScalarConstraint"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Plate_LineConstraint ,std::unique_ptr<Plate_LineConstraint>  >>(m.attr("Plate_LineConstraint"))
