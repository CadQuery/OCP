...
// classes forward declarations only
    ...
    py::class_<BOPDS_Iterator , shared_ptr<BOPDS_Iterator>  >(m,"BOPDS_Iterator",R"#(The class BOPDS_Iterator is 1.to compute intersections between BRep sub-shapes of arguments of an operation (see the class BOPDS_DS) in terms of theirs bounding boxes 2.provides interface to iterare the pairs of intersected sub-shapes of given type)#");
