...
// classes
    ...
    register_default_constructor<GeomTools ,std::unique_ptr<GeomTools>>(m,"GeomTools");

    static_cast<py::class_<GeomTools ,std::unique_ptr<GeomTools>  >>(m.attr("GeomTools"))
        .def_static("Dump_s",
        ...
        .def_static("GetReal_s",
                    (void (*)( std::istream & ,  Standard_Real &  ) ) static_cast<void (*)( std::istream & ,  Standard_Real &  ) >(&GeomTools::GetReal),
                    R"#(Reads the Standard_Real value from the stream. Zero is read in case of error)#"  , py::arg("IS"),  py::arg("theValue"))
;


    static_cast<py::class_<GeomTools_SurfaceSet ,std::unique_ptr<GeomTools_SurfaceSet>  >>(m.attr("GeomTools_SurfaceSet"))
        .def(py::init<  >()  )
        .def("Clear",
...
;
    ...
    static_cast<py::class_<GeomTools_Curve2dSet ,std::unique_ptr<GeomTools_Curve2dSet>  >>(m.attr("GeomTools_Curve2dSet"))
        .def(py::init<  >()  )
        .def("Clear",
...
;
    ...
    static_cast<py::class_<GeomTools_CurveSet ,std::unique_ptr<GeomTools_CurveSet>  >>(m.attr("GeomTools_CurveSet"))
        .def(py::init<  >()  )
        .def("Clear",
