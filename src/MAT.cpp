...
;
    ...
    // methods using call by reference i.s.o. return
        .def("FusionOfBasicElts",
             []( MAT_Graph &self , const Standard_Integer IndexElt1,const Standard_Integer IndexElt2 ){ Standard_Boolean  MergeArc1; Standard_Integer  GeomIndexArc1; Standard_Integer  GeomIndexArc2; Standard_Boolean  MergeArc2; Standard_Integer  GeomIndexArc3; Standard_Integer  GeomIndexArc4; self.FusionOfBasicElts(IndexElt1,IndexElt2,MergeArc1,GeomIndexArc1,GeomIndexArc2,MergeArc2,GeomIndexArc3,GeomIndexArc4); return std::make_tuple(MergeArc1,GeomIndexArc1,GeomIndexArc2,MergeArc2,GeomIndexArc3,GeomIndexArc4); },
