...
// classes
    ...
    static_cast<py::class_<GeomFill_Filling ,std::unique_ptr<GeomFill_Filling>  >>(m.attr("GeomFill_Filling"))
        .def(py::init<  >()  )
        .def("NbUPoles",
...
;
    ...
    static_cast<py::class_<GeomFill_Profiler ,std::unique_ptr<GeomFill_Profiler>  >>(m.attr("GeomFill_Profiler"))
        .def(py::init<  >()  )
        .def("AddCurve",
...
;
    ...
    static_cast<py::class_<GeomFill_CircularBlendFunc ,opencascade::handle<GeomFill_CircularBlendFunc>  , Approx_SweepFunction >>(m.attr("GeomFill_CircularBlendFunc"))
        ...
        .def("SectionShape",
             (void (GeomFill_CircularBlendFunc::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_CircularBlendFunc::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_CircularBlendFunc::SectionShape),
...
;
    ...
    static_cast<py::class_<GeomFill_SweepSectionGenerator ,std::unique_ptr<GeomFill_SweepSectionGenerator>  >>(m.attr("GeomFill_SweepSectionGenerator"))
        .def(py::init<  >()  )
        ...
        .def("GetShape",
             (void (GeomFill_SweepSectionGenerator::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_SweepSectionGenerator::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_SweepSectionGenerator::GetShape),
...
;
    ...
    static_cast<py::class_<GeomFill_HArray1OfSectionLaw ,std::unique_ptr<GeomFill_HArray1OfSectionLaw>  >>(m.attr("GeomFill_HArray1OfSectionLaw"))
...
;
    ...
    static_cast<py::class_<GeomFill_Stretch ,std::unique_ptr<GeomFill_Stretch>  , GeomFill_Filling >>(m.attr("GeomFill_Stretch"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomFill_SnglrFunc ,std::unique_ptr<GeomFill_SnglrFunc>  , Adaptor3d_Curve >>(m.attr("GeomFill_SnglrFunc"))
...
;
    ...
    static_cast<py::class_<GeomFill_Coons ,std::unique_ptr<GeomFill_Coons>  , GeomFill_Filling >>(m.attr("GeomFill_Coons"))
        .def(py::init<  >()  )
        .def(py::init<  const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> & >()  , py::arg("P1"),  py::arg("P2"),  py::arg("P3"),  py::arg("P4") )
        .def(py::init<  const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Real> & >()  , py::arg("P1"),  py::arg("P2"),  py::arg("P3"),  py::arg("P4"),  py::arg("W1"),  py::arg("W2"),  py::arg("W3"),  py::arg("W4") )
        .def("Init",
...
;
    ...
    static_cast<py::class_<GeomFill_AppSweep ,std::unique_ptr<GeomFill_AppSweep>  , AppBlend_Approx >>(m.attr("GeomFill_AppSweep"))
        .def(py::init<  >()  )
        ...
        .def("CriteriumWeight",
             (void (GeomFill_AppSweep::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_AppSweep::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_AppSweep::CriteriumWeight),
             R"#(returns the Weights (as percent) associed to the criterium used in the optimization.)#"  , py::arg("W1"),  py::arg("W2"),  py::arg("W3"))
        .def("Perform",
        ...
        .def("IsDone",
             ...
             R"#(None)#" )
        .def("SurfShape",
             (void (GeomFill_AppSweep::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_AppSweep::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_AppSweep::SurfShape),
        ...
        .def("NbCurves2d",
             ...
             R"#(None)#" )
        .def("Curves2dShape",
             (void (GeomFill_AppSweep::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_AppSweep::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_AppSweep::Curves2dShape),
        ...
        .def("Curves2dMults",
             ...
             R"#(None)#" )
        .def("TolReached",
             (void (GeomFill_AppSweep::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_AppSweep::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_AppSweep::TolReached),
...
;
    ...
    static_cast<py::class_<GeomFill_ConstrainedFilling ,std::unique_ptr<GeomFill_ConstrainedFilling>  >>(m.attr("GeomFill_ConstrainedFilling"))
...
;
    ...
    static_cast<py::class_<GeomFill_HArray1OfLocationLaw ,std::unique_ptr<GeomFill_HArray1OfLocationLaw>  >>(m.attr("GeomFill_HArray1OfLocationLaw"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<GeomFill_Pipe ,std::unique_ptr<GeomFill_Pipe>  >>(m.attr("GeomFill_Pipe"))
        .def(py::init<  >()  )
        .def(py::init< const opencascade::handle<Geom_Curve> &,const Standard_Real >()  , py::arg("Path"),  py::arg("Radius") )
...
;
    ...
    static_cast<py::class_<GeomFill_PolynomialConvertor ,std::unique_ptr<GeomFill_PolynomialConvertor>  >>(m.attr("GeomFill_PolynomialConvertor"))
        .def(py::init<  >()  )
        .def("Initialized",
...
;
    ...
    static_cast<py::class_<GeomFill_SectionLaw ,opencascade::handle<GeomFill_SectionLaw> ,Py_GeomFill_SectionLaw , Standard_Transient >>(m.attr("GeomFill_SectionLaw"))
        ...
        .def("SectionShape",
             (void (GeomFill_SectionLaw::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_SectionLaw::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_SectionLaw::SectionShape),
             R"#(get the format of an section)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"))
        .def("Knots",
        ...
        .def("GetInterval",
             (void (GeomFill_SectionLaw::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_SectionLaw::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_SectionLaw::GetInterval),
             R"#(Gets the bounds of the parametric interval on the function)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetDomain",
             (void (GeomFill_SectionLaw::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_SectionLaw::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_SectionLaw::GetDomain),
             R"#(Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetTolerance",
...
;
    ...
    static_cast<py::class_<GeomFill_Curved ,std::unique_ptr<GeomFill_Curved>  , GeomFill_Filling >>(m.attr("GeomFill_Curved"))
        .def(py::init<  >()  )
        .def(py::init<  const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> & >()  , py::arg("P1"),  py::arg("P2"),  py::arg("P3"),  py::arg("P4") )
        .def(py::init<  const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<gp_Pnt> &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Real> & >()  , py::arg("P1"),  py::arg("P2"),  py::arg("P3"),  py::arg("P4"),  py::arg("W1"),  py::arg("W2"),  py::arg("W3"),  py::arg("W4") )
...
;
    ...
    static_cast<py::class_<GeomFill_FunctionGuide ,std::unique_ptr<GeomFill_FunctionGuide>  , math_FunctionSetWithDerivatives >>(m.attr("GeomFill_FunctionGuide"))
...
;
    ...
    static_cast<py::class_<GeomFill_CornerState ,std::unique_ptr<GeomFill_CornerState>  >>(m.attr("GeomFill_CornerState"))
        .def(py::init<  >()  )
        .def("Gap",
...
;
    ...
    static_cast<py::class_<GeomFill_Tensor ,std::unique_ptr<GeomFill_Tensor>  >>(m.attr("GeomFill_Tensor"))
...
;
    ...
    static_cast<py::class_<GeomFill_SectionGenerator ,std::unique_ptr<GeomFill_SectionGenerator>  , GeomFill_Profiler >>(m.attr("GeomFill_SectionGenerator"))
        .def(py::init<  >()  )
        .def("SetParam",
        ...
        .def("GetShape",
             (void (GeomFill_SectionGenerator::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_SectionGenerator::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_SectionGenerator::GetShape),
             R"#(None)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"),  py::arg("NbPoles2d"))
        .def("Knots",
...
;
    ...
    static_cast<py::class_<GeomFill_SectionPlacement ,std::unique_ptr<GeomFill_SectionPlacement>  >>(m.attr("GeomFill_SectionPlacement"))
...
;
    ...
    static_cast<py::class_<GeomFill_Generator ,std::unique_ptr<GeomFill_Generator>  , GeomFill_Profiler >>(m.attr("GeomFill_Generator"))
        .def(py::init<  >()  )
        .def("Perform",
...
;
    ...
    static_cast<py::class_<GeomFill_SweepFunction ,opencascade::handle<GeomFill_SweepFunction>  , Approx_SweepFunction >>(m.attr("GeomFill_SweepFunction"))
        ...
        .def("Nb2dCurves",
             ...
             R"#(get the number of 2d curves to approximate.)#" )
        .def("SectionShape",
             (void (GeomFill_SweepFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_SweepFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_SweepFunction::SectionShape),
             R"#(get the format of an section)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"))
        .def("Knots",
        ...
        .def("SetInterval",
             ...
             R"#(Sets the bounds of the parametric interval on the function This determines the derivatives in these values if the function is not Cn.)#"  , py::arg("First"),  py::arg("Last"))
        .def("Resolution",
             (void (GeomFill_SweepFunction::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_SweepFunction::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_SweepFunction::Resolution),
             R"#(Returns the resolutions in the sub-space 2d <Index> This information is usfull to find an good tolerance in 2d approximation. Warning: Used only if Nb2dCurve > 0)#"  , py::arg("Index"),  py::arg("Tol"),  py::arg("TolU"),  py::arg("TolV"))
        .def("GetTolerance",
...
;
    ...
    static_cast<py::class_<GeomFill_FunctionDraft ,std::unique_ptr<GeomFill_FunctionDraft>  , math_FunctionSetWithDerivatives >>(m.attr("GeomFill_FunctionDraft"))
...
;
    ...
    static_cast<py::class_<GeomFill_AppSurf ,std::unique_ptr<GeomFill_AppSurf>  , AppBlend_Approx >>(m.attr("GeomFill_AppSurf"))
        .def(py::init<  >()  )
        .def(py::init< const Standard_Integer,const Standard_Integer,const Standard_Real,const Standard_Real,const Standard_Integer,const Standard_Boolean >()  , py::arg("Degmin"),  py::arg("Degmax"),  py::arg("Tol3d"),  py::arg("Tol2d"),  py::arg("NbIt"),  py::arg("KnownParameters")=static_cast<const Standard_Boolean>(Standard_False) )
        .def("Init",
        ...
        .def("Continuity",
             ...
             R"#(returns the Continuity used in the approximation)#" )
        .def("CriteriumWeight",
             (void (GeomFill_AppSurf::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_AppSurf::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_AppSurf::CriteriumWeight),
             R"#(returns the Weights (as percent) associed to the criterium used in the optimization.)#"  , py::arg("W1"),  py::arg("W2"),  py::arg("W3"))
        .def("Perform",
        ...
        .def("IsDone",
             ...
             R"#(None)#" )
        .def("SurfShape",
             (void (GeomFill_AppSurf::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_AppSurf::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_AppSurf::SurfShape),
             R"#(None)#"  , py::arg("UDegree"),  py::arg("VDegree"),  py::arg("NbUPoles"),  py::arg("NbVPoles"),  py::arg("NbUKnots"),  py::arg("NbVKnots"))
        .def("Surface",
        ...
        .def("NbCurves2d",
             ...
             R"#(None)#" )
        .def("Curves2dShape",
             (void (GeomFill_AppSurf::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_AppSurf::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_AppSurf::Curves2dShape),
             R"#(None)#"  , py::arg("Degree"),  py::arg("NbPoles"),  py::arg("NbKnots"))
        .def("Curve2d",
        ...
        .def("Curves2dMults",
             ...
             R"#(None)#" )
        .def("TolReached",
             (void (GeomFill_AppSurf::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_AppSurf::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_AppSurf::TolReached),
             R"#(None)#"  , py::arg("Tol3d"),  py::arg("Tol2d"))
        .def("TolCurveOnSurf",
...
;
    ...
    static_cast<py::class_<GeomFill_PlanFunc ,std::unique_ptr<GeomFill_PlanFunc>  , math_FunctionWithDerivative >>(m.attr("GeomFill_PlanFunc"))
        ...
        .def("D2",
             (void (GeomFill_PlanFunc::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (GeomFill_PlanFunc::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&GeomFill_PlanFunc::D2),
             R"#(None)#"  , py::arg("X"),  py::arg("F"),  py::arg("D1"),  py::arg("D2"))
        .def("DEDT",
             (void (GeomFill_PlanFunc::*)( const Standard_Real ,  const gp_Vec & ,  const gp_Vec & ,  Standard_Real &  ) ) static_cast<void (GeomFill_PlanFunc::*)( const Standard_Real ,  const gp_Vec & ,  const gp_Vec & ,  Standard_Real &  ) >(&GeomFill_PlanFunc::DEDT),
             R"#(None)#"  , py::arg("X"),  py::arg("DP"),  py::arg("DV"),  py::arg("DF"))
        .def("D2E",
             (void (GeomFill_PlanFunc::*)( const Standard_Real ,  const gp_Vec & ,  const gp_Vec & ,  const gp_Vec & ,  const gp_Vec & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (GeomFill_PlanFunc::*)( const Standard_Real ,  const gp_Vec & ,  const gp_Vec & ,  const gp_Vec & ,  const gp_Vec & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&GeomFill_PlanFunc::D2E),
             R"#(None)#"  , py::arg("X"),  py::arg("DP"),  py::arg("D2P"),  py::arg("DV"),  py::arg("D2V"),  py::arg("DFDT"),  py::arg("D2FDT2"),  py::arg("D2FDTDX"))
;


    static_cast<py::class_<GeomFill_Sweep ,std::unique_ptr<GeomFill_Sweep>  >>(m.attr("GeomFill_Sweep"))
        ...
        .def("ErrorOnRestriction",
             (void (GeomFill_Sweep::*)( const Standard_Boolean ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_Sweep::*)( const Standard_Boolean ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_Sweep::ErrorOnRestriction),
             R"#(Gets the Approximation error.)#"  , py::arg("IsFirst"),  py::arg("UError"),  py::arg("VError"))
        .def("ErrorOnTrace",
             (void (GeomFill_Sweep::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_Sweep::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_Sweep::ErrorOnTrace),
             R"#(Gets the Approximation error.)#"  , py::arg("IndexOfTrace"),  py::arg("UError"),  py::arg("VError"))
        .def("Surface",
...
;
    ...
    static_cast<py::class_<GeomFill_LocationLaw ,opencascade::handle<GeomFill_LocationLaw> ,Py_GeomFill_LocationLaw , Standard_Transient >>(m.attr("GeomFill_LocationLaw"))
        ...
        .def("SetInterval",
             ...
             R"#(Sets the bounds of the parametric interval on the function This determines the derivatives in these values if the function is not Cn.)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetInterval",
             (void (GeomFill_LocationLaw::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_LocationLaw::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_LocationLaw::GetInterval),
             R"#(Gets the bounds of the parametric interval on the function)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetDomain",
             (void (GeomFill_LocationLaw::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_LocationLaw::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_LocationLaw::GetDomain),
             R"#(Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method)#"  , py::arg("First"),  py::arg("Last"))
        .def("Resolution",
             (void (GeomFill_LocationLaw::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_LocationLaw::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_LocationLaw::Resolution),
...
;
    ...
    static_cast<py::class_<GeomFill_LocFunction ,std::unique_ptr<GeomFill_LocFunction>  >>(m.attr("GeomFill_LocFunction"))
        ...
        .def("DN",
             (void (GeomFill_LocFunction::*)( const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Integer ,  Standard_Real & ,  Standard_Integer &  ) ) static_cast<void (GeomFill_LocFunction::*)( const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Integer ,  Standard_Real & ,  Standard_Integer &  ) >(&GeomFill_LocFunction::DN),
             R"#(None)#"  , py::arg("Param"),  py::arg("First"),  py::arg("Last"),  py::arg("Order"),  py::arg("Result"),  py::arg("Ier"))
;
    ...
    static_cast<py::class_<GeomFill_Boundary ,opencascade::handle<GeomFill_Boundary> ,Py_GeomFill_Boundary , Standard_Transient >>(m.attr("GeomFill_Boundary"))
        ...
        .def("Bounds",
             (void (GeomFill_Boundary::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_Boundary::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_Boundary::Bounds),
...
;
    ...
    register_default_constructor<GeomFill ,std::unique_ptr<GeomFill>>(m,"GeomFill");

    static_cast<py::class_<GeomFill ,std::unique_ptr<GeomFill>  >>(m.attr("GeomFill"))
        ...
        .def_static("GetShape_s",
                    (void (*)( const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Convert_ParameterisationType &  ) ) static_cast<void (*)( const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Convert_ParameterisationType &  ) >(&GeomFill::GetShape),
                    R"#(None)#"  , py::arg("MaxAng"),  py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"),  py::arg("TypeConv"))
        .def_static("Knots_s",
...
;
    ...
    static_cast<py::class_<GeomFill_TrihedronLaw ,opencascade::handle<GeomFill_TrihedronLaw> ,Py_GeomFill_TrihedronLaw , Standard_Transient >>(m.attr("GeomFill_TrihedronLaw"))
        ...
        .def("SetInterval",
             ...
             R"#(Sets the bounds of the parametric interval on the function This determines the derivatives in these values if the function is not Cn.)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetInterval",
             (void (GeomFill_TrihedronLaw::*)( Standard_Real & ,  Standard_Real &  ) ) static_cast<void (GeomFill_TrihedronLaw::*)( Standard_Real & ,  Standard_Real &  ) >(&GeomFill_TrihedronLaw::GetInterval),
             R"#(Gets the bounds of the parametric interval on the function)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetAverageLaw",
...
;
    ...
    static_cast<py::class_<GeomFill_HSequenceOfAx2 ,std::unique_ptr<GeomFill_HSequenceOfAx2>  >>(m.attr("GeomFill_HSequenceOfAx2"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomFill_LocationGuide ,opencascade::handle<GeomFill_LocationGuide>  , GeomFill_LocationLaw >>(m.attr("GeomFill_LocationGuide"))
        ...
        .def("Set",
             (void (GeomFill_LocationGuide::*)( const opencascade::handle<GeomFill_SectionLaw> & ,  const Standard_Boolean ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  Standard_Real &  ) ) static_cast<void (GeomFill_LocationGuide::*)( const opencascade::handle<GeomFill_SectionLaw> & ,  const Standard_Boolean ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  Standard_Real &  ) >(&GeomFill_LocationGuide::Set),
             R"#(None)#"  , py::arg("Section"),  py::arg("rotat"),  py::arg("SFirst"),  py::arg("SLast"),  py::arg("PrecAngle"),  py::arg("LastAngle"))
        .def("EraseRotation",
        ...
        .def("SetInterval",
             ...
             R"#(Sets the bounds of the parametric interval on the function This determines the derivatives in these values if the function is not Cn.)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetInterval",
             (void (GeomFill_LocationGuide::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_LocationGuide::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_LocationGuide::GetInterval),
             R"#(Gets the bounds of the parametric interval on the function)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetDomain",
             (void (GeomFill_LocationGuide::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_LocationGuide::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_LocationGuide::GetDomain),
             R"#(Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method)#"  , py::arg("First"),  py::arg("Last"))
        .def("SetTolerance",
             ...
             R"#(Is usefull, if (me) have to run numerical algorithm to perform D0, D1 or D2 The default implementation make nothing.)#"  , py::arg("Tol3d"),  py::arg("Tol2d"))
        .def("Resolution",
             (void (GeomFill_LocationGuide::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_LocationGuide::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_LocationGuide::Resolution),
             R"#(Returns the resolutions in the sub-space 2d <Index> This information is usfull to find an good tolerance in 2d approximation. Warning: Used only if Nb2dCurve > 0)#"  , py::arg("Index"),  py::arg("Tol"),  py::arg("TolU"),  py::arg("TolV"))
        .def("GetMaximalNorm",
...
;
    ...
    static_cast<py::class_<GeomFill_NSections ,opencascade::handle<GeomFill_NSections>  , GeomFill_SectionLaw >>(m.attr("GeomFill_NSections"))
        ...
        .def("SectionShape",
             (void (GeomFill_NSections::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_NSections::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_NSections::SectionShape),
             R"#(get the format of an section)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"))
        .def("Knots",
        ...
        .def("SetInterval",
             ...
             R"#(Sets the bounds of the parametric interval on the function This determines the derivatives in these values if the function is not Cn.)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetInterval",
             (void (GeomFill_NSections::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_NSections::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_NSections::GetInterval),
             R"#(Gets the bounds of the parametric interval on the function)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetDomain",
             (void (GeomFill_NSections::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_NSections::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_NSections::GetDomain),
             R"#(Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetTolerance",
...
;
    ...
    static_cast<py::class_<GeomFill_DegeneratedBound ,opencascade::handle<GeomFill_DegeneratedBound>  , GeomFill_Boundary >>(m.attr("GeomFill_DegeneratedBound"))
        ...
        .def("Reparametrize",
             ...
             R"#(None)#"  , py::arg("First"),  py::arg("Last"),  py::arg("HasDF"),  py::arg("HasDL"),  py::arg("DF"),  py::arg("DL"),  py::arg("Rev"))
        .def("Bounds",
             (void (GeomFill_DegeneratedBound::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_DegeneratedBound::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_DegeneratedBound::Bounds),
             R"#(None)#"  , py::arg("First"),  py::arg("Last"))
        .def("IsDegenerated",
...
;
    ...
    static_cast<py::class_<GeomFill_EvolvedSection ,opencascade::handle<GeomFill_EvolvedSection>  , GeomFill_SectionLaw >>(m.attr("GeomFill_EvolvedSection"))
        ...
        .def("BSplineSurface",
             ...
             R"#(give if possible an bspline Surface, like iso-v are the section. If it is not possible this methode have to get an Null Surface. Is it the default implementation.)#" )
        .def("SectionShape",
             (void (GeomFill_EvolvedSection::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_EvolvedSection::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_EvolvedSection::SectionShape),
             R"#(get the format of an section)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"))
        .def("Knots",
        ...
        .def("SetInterval",
             ...
             R"#(Sets the bounds of the parametric interval on the function This determines the derivatives in these values if the function is not Cn.)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetInterval",
             (void (GeomFill_EvolvedSection::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_EvolvedSection::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_EvolvedSection::GetInterval),
             R"#(Gets the bounds of the parametric interval on the function)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetDomain",
             (void (GeomFill_EvolvedSection::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_EvolvedSection::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_EvolvedSection::GetDomain),
             R"#(Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetTolerance",
...
;
    ...
    static_cast<py::class_<GeomFill_BezierCurves ,std::unique_ptr<GeomFill_BezierCurves>  >>(m.attr("GeomFill_BezierCurves"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomFill_QuasiAngularConvertor ,std::unique_ptr<GeomFill_QuasiAngularConvertor>  >>(m.attr("GeomFill_QuasiAngularConvertor"))
        .def(py::init<  >()  )
        .def("Initialized",
...
;
    ...
    static_cast<py::class_<GeomFill_LocationDraft ,opencascade::handle<GeomFill_LocationDraft>  , GeomFill_LocationLaw >>(m.attr("GeomFill_LocationDraft"))
        ...
        .def("SetInterval",
             ...
             R"#(Sets the bounds of the parametric interval on the function This determines the derivatives in these values if the function is not Cn.)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetInterval",
             (void (GeomFill_LocationDraft::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_LocationDraft::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_LocationDraft::GetInterval),
             R"#(Gets the bounds of the parametric interval on the function)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetDomain",
             (void (GeomFill_LocationDraft::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_LocationDraft::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_LocationDraft::GetDomain),
             R"#(Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method)#"  , py::arg("First"),  py::arg("Last"))
        .def("Resolution",
             (void (GeomFill_LocationDraft::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_LocationDraft::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_LocationDraft::Resolution),
             R"#(Returns the resolutions in the sub-space 2d <Index> This information is usfull to find an good tolerance in 2d approximation. Warning: Used only if Nb2dCurve > 0)#"  , py::arg("Index"),  py::arg("Tol"),  py::arg("TolU"),  py::arg("TolV"))
        .def("GetMaximalNorm",
...
;
    ...
    static_cast<py::class_<GeomFill_SimpleBound ,opencascade::handle<GeomFill_SimpleBound>  , GeomFill_Boundary >>(m.attr("GeomFill_SimpleBound"))
        ...
        .def("Reparametrize",
             ...
             R"#(None)#"  , py::arg("First"),  py::arg("Last"),  py::arg("HasDF"),  py::arg("HasDL"),  py::arg("DF"),  py::arg("DL"),  py::arg("Rev"))
        .def("Bounds",
             (void (GeomFill_SimpleBound::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_SimpleBound::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_SimpleBound::Bounds),
             R"#(None)#"  , py::arg("First"),  py::arg("Last"))
        .def("IsDegenerated",
...
;
    ...
    static_cast<py::class_<GeomFill_UniformSection ,opencascade::handle<GeomFill_UniformSection>  , GeomFill_SectionLaw >>(m.attr("GeomFill_UniformSection"))
        ...
        .def("BSplineSurface",
             ...
             R"#(give if possible an bspline Surface, like iso-v are the section. If it is not possible this methode have to get an Null Surface. Is it the default implementation.)#" )
        .def("SectionShape",
             (void (GeomFill_UniformSection::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (GeomFill_UniformSection::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&GeomFill_UniformSection::SectionShape),
             R"#(get the format of an section)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"))
        .def("Knots",
        ...
        .def("SetInterval",
             ...
             R"#(Sets the bounds of the parametric interval on the function This determines the derivatives in these values if the function is not Cn.)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetInterval",
             (void (GeomFill_UniformSection::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_UniformSection::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_UniformSection::GetInterval),
             R"#(Gets the bounds of the parametric interval on the function)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetDomain",
             (void (GeomFill_UniformSection::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_UniformSection::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_UniformSection::GetDomain),
             R"#(Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetTolerance",
...
;
    ...
    static_cast<py::class_<GeomFill_BoundWithSurf ,opencascade::handle<GeomFill_BoundWithSurf>  , GeomFill_Boundary >>(m.attr("GeomFill_BoundWithSurf"))
        ...
        .def("Reparametrize",
             ...
             R"#(None)#"  , py::arg("First"),  py::arg("Last"),  py::arg("HasDF"),  py::arg("HasDL"),  py::arg("DF"),  py::arg("DL"),  py::arg("Rev"))
        .def("Bounds",
             (void (GeomFill_BoundWithSurf::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_BoundWithSurf::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_BoundWithSurf::Bounds),
             R"#(None)#"  , py::arg("First"),  py::arg("Last"))
        .def("IsDegenerated",
...
;
    ...
    static_cast<py::class_<GeomFill_BSplineCurves ,std::unique_ptr<GeomFill_BSplineCurves>  >>(m.attr("GeomFill_BSplineCurves"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomFill_CurveAndTrihedron ,opencascade::handle<GeomFill_CurveAndTrihedron>  , GeomFill_LocationLaw >>(m.attr("GeomFill_CurveAndTrihedron"))
        ...
        .def("SetInterval",
             ...
             R"#(Sets the bounds of the parametric interval on the function This determines the derivatives in these values if the function is not Cn.)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetInterval",
             (void (GeomFill_CurveAndTrihedron::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_CurveAndTrihedron::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_CurveAndTrihedron::GetInterval),
             R"#(Gets the bounds of the parametric interval on the function)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetDomain",
             (void (GeomFill_CurveAndTrihedron::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomFill_CurveAndTrihedron::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomFill_CurveAndTrihedron::GetDomain),
             R"#(Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method)#"  , py::arg("First"),  py::arg("Last"))
        .def("GetMaximalNorm",
