...
// classes forward declarations only
    py::class_<ChFiDS_CommonPoint ,std::unique_ptr<ChFiDS_CommonPoint>  >(m,"ChFiDS_CommonPoint",R"#(point start/end of fillet common to 2 adjacent filets and to an edge on one of 2 faces participating in the construction of the fillet)#");
    ...
    py::class_<ChFiDS_HData ,std::unique_ptr<ChFiDS_HData>  >(m,"ChFiDS_HData",R"#()#");
    py::class_<ChFiDS_Map ,std::unique_ptr<ChFiDS_Map>  >(m,"ChFiDS_Map",R"#(Encapsulation of IndexedDataMapOfShapeListOfShape.)#");
    py::class_<ChFiDS_FaceInterference ,std::unique_ptr<ChFiDS_FaceInterference>  >(m,"ChFiDS_FaceInterference",R"#(interference face/fillet)#");
    py::class_<ChFiDS_Regul ,std::unique_ptr<ChFiDS_Regul>  >(m,"ChFiDS_Regul",R"#(Storage of a curve and its 2 faces or surfaces of support.)#");
    py::class_<ChFiDS_SecHArray1 ,std::unique_ptr<ChFiDS_SecHArray1>  >(m,"ChFiDS_SecHArray1",R"#()#");
    py::class_<ChFiDS_StripeMap ,std::unique_ptr<ChFiDS_StripeMap>  >(m,"ChFiDS_StripeMap",R"#(encapsulation of IndexedDataMapOfVertexListOfStripe)#");
    py::class_<ChFiDS_ElSpine ,std::unique_ptr<ChFiDS_ElSpine>  , Adaptor3d_Curve >(m,"ChFiDS_ElSpine",R"#(Elementary Spine for cheminements and approximations.)#");
    ...
    py::class_<ChFiDS_CircSection ,std::unique_ptr<ChFiDS_CircSection>  >(m,"ChFiDS_CircSection",R"#(A Section of fillet.)#");
