...
// classes forward declarations only
    ...
    py::class_<BRepAlgo_BooleanOperations , shared_ptr<BRepAlgo_BooleanOperations>  >(m,"BRepAlgo_BooleanOperations",R"#(None)#");
    py::class_<BRepAlgo_DSAccess , shared_ptr<BRepAlgo_DSAccess>  >(m,"BRepAlgo_DSAccess",R"#(None)#");
