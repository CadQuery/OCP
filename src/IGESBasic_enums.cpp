...
// classes forward declarations only
    py::class_<IGESBasic_ToolOrderedGroupWithoutBackP ,std::unique_ptr<IGESBasic_ToolOrderedGroupWithoutBackP>  >(m,"IGESBasic_ToolOrderedGroupWithoutBackP",R"#(Tool to work on a OrderedGroupWithoutBackP. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESBasic_ToolExternalRefFileName ,std::unique_ptr<IGESBasic_ToolExternalRefFileName>  >(m,"IGESBasic_ToolExternalRefFileName",R"#(Tool to work on a ExternalRefFileName. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESBasic_ToolGroup ,std::unique_ptr<IGESBasic_ToolGroup>  >(m,"IGESBasic_ToolGroup",R"#(Tool to work on a Group. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESBasic_HArray2OfHArray1OfReal ,std::unique_ptr<IGESBasic_HArray2OfHArray1OfReal>  >(m,"IGESBasic_HArray2OfHArray1OfReal",R"#()#");
    ...
    py::class_<IGESBasic_ToolSingularSubfigure ,std::unique_ptr<IGESBasic_ToolSingularSubfigure>  >(m,"IGESBasic_ToolSingularSubfigure",R"#(Tool to work on a SingularSubfigure. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESBasic_HArray1OfLineFontEntity ,std::unique_ptr<IGESBasic_HArray1OfLineFontEntity>  >(m,"IGESBasic_HArray1OfLineFontEntity",R"#()#");
    ...
    py::class_<IGESBasic_ToolGroupWithoutBackP ,std::unique_ptr<IGESBasic_ToolGroupWithoutBackP>  >(m,"IGESBasic_ToolGroupWithoutBackP",R"#(Tool to work on a GroupWithoutBackP. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESBasic_ToolHierarchy ,std::unique_ptr<IGESBasic_ToolHierarchy>  >(m,"IGESBasic_ToolHierarchy",R"#(Tool to work on a Hierarchy. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESBasic_ToolOrderedGroup ,std::unique_ptr<IGESBasic_ToolOrderedGroup>  >(m,"IGESBasic_ToolOrderedGroup",R"#(Tool to work on a OrderedGroup. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESBasic_ToolAssocGroupType ,std::unique_ptr<IGESBasic_ToolAssocGroupType>  >(m,"IGESBasic_ToolAssocGroupType",R"#(Tool to work on a AssocGroupType. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESBasic_ToolSubfigureDef ,std::unique_ptr<IGESBasic_ToolSubfigureDef>  >(m,"IGESBasic_ToolSubfigureDef",R"#(Tool to work on a SubfigureDef. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESBasic_ToolExternalReferenceFile ,std::unique_ptr<IGESBasic_ToolExternalReferenceFile>  >(m,"IGESBasic_ToolExternalReferenceFile",R"#(Tool to work on a ExternalReferenceFile. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESBasic ,std::unique_ptr<IGESBasic>  >(m,"IGESBasic",R"#(This package represents basic entities from IGES)#");
    py::class_<IGESBasic_ToolName ,std::unique_ptr<IGESBasic_ToolName>  >(m,"IGESBasic_ToolName",R"#(Tool to work on a Name. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESBasic_ToolSingleParent ,std::unique_ptr<IGESBasic_ToolSingleParent>  >(m,"IGESBasic_ToolSingleParent",R"#(Tool to work on a SingleParent. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESBasic_ToolExternalRefFile ,std::unique_ptr<IGESBasic_ToolExternalRefFile>  >(m,"IGESBasic_ToolExternalRefFile",R"#(Tool to work on a ExternalRefFile. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESBasic_ToolExternalRefName ,std::unique_ptr<IGESBasic_ToolExternalRefName>  >(m,"IGESBasic_ToolExternalRefName",R"#(Tool to work on a ExternalRefName. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESBasic_ToolExternalRefFileIndex ,std::unique_ptr<IGESBasic_ToolExternalRefFileIndex>  >(m,"IGESBasic_ToolExternalRefFileIndex",R"#(Tool to work on a ExternalRefFileIndex. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESBasic_ToolExternalRefLibName ,std::unique_ptr<IGESBasic_ToolExternalRefLibName>  >(m,"IGESBasic_ToolExternalRefLibName",R"#(Tool to work on a ExternalRefLibName. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
