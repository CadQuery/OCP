...
// classes
    ...
    static_cast<py::class_<Draft_FaceInfo ,std::unique_ptr<Draft_FaceInfo>  >>(m.attr("Draft_FaceInfo"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Draft_VertexInfo ,std::unique_ptr<Draft_VertexInfo>  >>(m.attr("Draft_VertexInfo"))
        .def(py::init<  >()  )
        .def("Add",
...
;
    ...
    static_cast<py::class_<Draft_EdgeInfo ,std::unique_ptr<Draft_EdgeInfo>  >>(m.attr("Draft_EdgeInfo"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<Draft ,std::unique_ptr<Draft>>(m,"Draft");

    static_cast<py::class_<Draft ,std::unique_ptr<Draft>  >>(m.attr("Draft"))
        .def_static("Angle_s",
