...
;
    ...
    register_default_constructor<BinMDataStd ,std::unique_ptr<BinMDataStd>>(m,"BinMDataStd");

    static_cast<py::class_<BinMDataStd ,std::unique_ptr<BinMDataStd>  >>(m.attr("BinMDataStd"))
