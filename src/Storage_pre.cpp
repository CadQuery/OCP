...
// classes forward declarations only
    ...
    py::class_<Storage_Bucket , shared_ptr<Storage_Bucket>  >(m,"Storage_Bucket",R"#(None)#");
    py::class_<Storage_BucketIterator , shared_ptr<Storage_BucketIterator>  >(m,"Storage_BucketIterator",R"#()#");
    py::class_<Storage_BucketOfPersistent , shared_ptr<Storage_BucketOfPersistent>  >(m,"Storage_BucketOfPersistent",R"#()#");
