...
// classes forward declarations only
    py::class_<OpenGl_Element ,std::unique_ptr<OpenGl_Element, py::nodelete> ,Py_OpenGl_Element >(m,"OpenGl_Element",R"#(Base interface for drawable elements.)#");
    py::class_<OpenGl_StateInterface ,std::unique_ptr<OpenGl_StateInterface>  >(m,"OpenGl_StateInterface",R"#(Defines interface for OpenGL state.)#");
    py::class_<OpenGl_AspectLine ,std::unique_ptr<OpenGl_AspectLine>  , OpenGl_Element >(m,"OpenGl_AspectLine",R"#(The element holding Graphic3d_AspectLine3d.)#");
    py::class_<OpenGl_StateCounter ,std::unique_ptr<OpenGl_StateCounter>  >(m,"OpenGl_StateCounter",R"#(Tool class to implement consistent state counter for objects inside the same driver instance.)#");
    ...
    py::class_<OpenGl_RaytraceMaterial ,std::unique_ptr<OpenGl_RaytraceMaterial>  >(m,"OpenGl_RaytraceMaterial",R"#(Stores properties of surface material.)#");
    py::class_<OpenGl_TriangleSet ,std::unique_ptr<OpenGl_TriangleSet>  >(m,"OpenGl_TriangleSet",R"#(Triangulation of single OpenGL primitive array.)#");
    ...
    py::class_<OpenGl_LayerList ,std::unique_ptr<OpenGl_LayerList>  >(m,"OpenGl_LayerList",R"#(Class defining the list of layers.)#");
    py::class_<OpenGl_VariableSetterSelector ,std::unique_ptr<OpenGl_VariableSetterSelector>  >(m,"OpenGl_VariableSetterSelector",R"#(Support tool for setting user-defined uniform variables.)#");
    py::class_<OpenGl_ClippingIterator ,std::unique_ptr<OpenGl_ClippingIterator>  >(m,"OpenGl_ClippingIterator",R"#(The iterator through clipping planes.The iterator through clipping planes.)#");
    ...
    py::class_<OpenGl_AspectText ,std::unique_ptr<OpenGl_AspectText>  , OpenGl_Element >(m,"OpenGl_AspectText",R"#(Text representation parameters)#");
    py::class_<OpenGl_StencilTest ,std::unique_ptr<OpenGl_StencilTest, py::nodelete>  , OpenGl_Element >(m,"OpenGl_StencilTest",R"#(None)#");
    ...
    py::class_<OpenGl_AspectMarker ,std::unique_ptr<OpenGl_AspectMarker>  , OpenGl_Element >(m,"OpenGl_AspectMarker",R"#(The element holding Graphic3d_AspectMarker3d.)#");
    py::class_<OpenGl_AspectFace ,std::unique_ptr<OpenGl_AspectFace>  , OpenGl_Element >(m,"OpenGl_AspectFace",R"#(The element holding Graphic3d_AspectFillArea3d.)#");
    ...
    py::class_<OpenGl_TextBuilder ,std::unique_ptr<OpenGl_TextBuilder>  >(m,"OpenGl_TextBuilder",R"#(This class generates primitive array required for rendering textured text using OpenGl_Font instance.)#");
    py::class_<OpenGl_PrimitiveArray ,std::unique_ptr<OpenGl_PrimitiveArray>  , OpenGl_Element >(m,"OpenGl_PrimitiveArray",R"#(Class for rendering of arbitrary primitive array.)#");
    py::class_<OpenGl_ProjectionState ,std::unique_ptr<OpenGl_ProjectionState>  , OpenGl_StateInterface >(m,"OpenGl_ProjectionState",R"#(Defines state of OCCT projection transformation.)#");
    py::class_<OpenGl_WorldViewState ,std::unique_ptr<OpenGl_WorldViewState>  , OpenGl_StateInterface >(m,"OpenGl_WorldViewState",R"#(Defines state of OCCT world-view transformation.)#");
    py::class_<OpenGl_ClippingState ,std::unique_ptr<OpenGl_ClippingState>  >(m,"OpenGl_ClippingState",R"#(Defines generic state of OCCT clipping state.)#");
    ...
    py::class_<OpenGl_BackgroundArray ,std::unique_ptr<OpenGl_BackgroundArray>  , OpenGl_PrimitiveArray >(m,"OpenGl_BackgroundArray",R"#(Tool class for generating reusable data for gradient or texture background rendering.)#");
    ...
    py::class_<OpenGl_RaytraceLight ,std::unique_ptr<OpenGl_RaytraceLight>  >(m,"OpenGl_RaytraceLight",R"#(Stores properties of OpenGL light source.)#");
    py::class_<OpenGl_Text ,std::unique_ptr<OpenGl_Text, py::nodelete>  , OpenGl_Element >(m,"OpenGl_Text",R"#(Text rendering)#");
    ...
    py::class_<OpenGl_Clipping ,std::unique_ptr<OpenGl_Clipping>  >(m,"OpenGl_Clipping",R"#(This class contains logics related to tracking and modification of clipping plane state for particular OpenGl context. It contains information about enabled clipping planes and provides method to change clippings in context. The methods should be executed within OpenGl context associated with instance of this class.)#");
    py::class_<OpenGl_BVHTreeSelector ,std::unique_ptr<OpenGl_BVHTreeSelector>  >(m,"OpenGl_BVHTreeSelector",R"#(BVHTreeSelector class provides a possibility to store parameters of view volume, such as its vertices and equations, and contains methods detecting if given AABB overlaps view volume.)#");
    py::class_<OpenGl_GraduatedTrihedron ,std::unique_ptr<OpenGl_GraduatedTrihedron>  , OpenGl_Element >(m,"OpenGl_GraduatedTrihedron",R"#(This class allows to render Graduated Trihedron, i.e. trihedron with grid. it is based on Graphic3d_GraduatedTrihedron parameters and support its customization on construction level only.)#");
    ...
    py::class_<OpenGl_HaltonSampler ,std::unique_ptr<OpenGl_HaltonSampler>  >(m,"OpenGl_HaltonSampler",R"#(Compute points of the Halton sequence with with digit-permutations for different bases.)#");
    ...
    py::class_<OpenGl_BVHClipPrimitiveSet ,std::unique_ptr<OpenGl_BVHClipPrimitiveSet>  >(m,"OpenGl_BVHClipPrimitiveSet",R"#(Set of OpenGl_Structures for building BVH tree.)#");
    py::class_<OpenGl_LightSourceState ,std::unique_ptr<OpenGl_LightSourceState>  , OpenGl_StateInterface >(m,"OpenGl_LightSourceState",R"#(Defines state of OCCT light sources.)#");
    py::class_<OpenGl_Flipper ,std::unique_ptr<OpenGl_Flipper>  , OpenGl_Element >(m,"OpenGl_Flipper",R"#(Being rendered, the elements modifies current model-view matrix such that the axes of the specified reference system (in model space) become oriented in the following way: - X - heads to the right side of view. - Y - heads to the up side of view. - N(Z) - heads towards the screen. Originally, this element serves for need of flipping the 3D text of dimension presentations.)#");
    ...
    py::class_<OpenGl_RaytraceGeometry ,std::unique_ptr<OpenGl_RaytraceGeometry>  >(m,"OpenGl_RaytraceGeometry",R"#(Stores geometry of ray-tracing scene.)#");
    ...
    py::class_<OpenGl_MaterialState ,std::unique_ptr<OpenGl_MaterialState>  , OpenGl_StateInterface >(m,"OpenGl_MaterialState",R"#(Defines generic state of material properties.)#");
    ...
    py::class_<OpenGl_OitState ,std::unique_ptr<OpenGl_OitState>  , OpenGl_StateInterface >(m,"OpenGl_OitState",R"#(Defines generic state of order-independent transparency rendering properties.)#");
    py::class_<OpenGl_CappingAlgo ,std::unique_ptr<OpenGl_CappingAlgo>  >(m,"OpenGl_CappingAlgo",R"#(Capping surface rendering algorithm.)#");
    py::class_<OpenGl_FrameStatsPrs ,std::unique_ptr<OpenGl_FrameStatsPrs>  , OpenGl_Text >(m,"OpenGl_FrameStatsPrs",R"#(Element rendering frame statistics.)#");
    ...
    py::class_<OpenGl_ModelWorldState ,std::unique_ptr<OpenGl_ModelWorldState>  , OpenGl_StateInterface >(m,"OpenGl_ModelWorldState",R"#(Defines state of OCCT model-world transformation.)#");
    ...
    py::class_<OpenGl_TextureFormat ,std::unique_ptr<OpenGl_TextureFormat>  >(m,"OpenGl_TextureFormat",R"#(Stores parameters of OpenGL texture format.)#");
