...
// classes
    ...
    static_cast<py::class_<StepData_FieldList ,std::unique_ptr<StepData_FieldList>  >>(m.attr("StepData_FieldList"))
        .def(py::init<  >()  )
        .def("NbFields",
...
;
    ...
    static_cast<py::class_<StepData_FieldListN ,std::unique_ptr<StepData_FieldListN>  , StepData_FieldList >>(m.attr("StepData_FieldListN"))
...
;
    ...
    register_default_constructor<StepData ,std::unique_ptr<StepData>>(m,"StepData");

    static_cast<py::class_<StepData ,std::unique_ptr<StepData>  >>(m.attr("StepData"))
...
;
    ...
    static_cast<py::class_<StepData_HeaderTool ,std::unique_ptr<StepData_HeaderTool>  >>(m.attr("StepData_HeaderTool"))
...
;
    ...
    static_cast<py::class_<StepData_FieldListD ,std::unique_ptr<StepData_FieldListD>  , StepData_FieldList >>(m.attr("StepData_FieldListD"))
        .def(py::init< const Standard_Integer >()  , py::arg("nb") )
        .def("SetNb",
...
;
    ...
    static_cast<py::class_<StepData_SelectType ,std::unique_ptr<StepData_SelectType> ,Py_StepData_SelectType >>(m.attr("StepData_SelectType"))
        .def("CaseNum",
...
;
    ...
    static_cast<py::class_<StepData_StepWriter ,std::unique_ptr<StepData_StepWriter>  >>(m.attr("StepData_StepWriter"))
...
;
    ...
    static_cast<py::class_<StepData_WriterLib ,std::unique_ptr<StepData_WriterLib>  >>(m.attr("StepData_WriterLib"))
...
;
    ...
    static_cast<py::class_<StepData_HArray1OfField ,std::unique_ptr<StepData_HArray1OfField>  >>(m.attr("StepData_HArray1OfField"))
...
;
    ...
    static_cast<py::class_<StepData_Field ,std::unique_ptr<StepData_Field>  >>(m.attr("StepData_Field"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<StepData_StepDumper ,std::unique_ptr<StepData_StepDumper>  >>(m.attr("StepData_StepDumper"))
...
;
    ...
    static_cast<py::class_<StepData_StepReaderTool ,std::unique_ptr<StepData_StepReaderTool>  , Interface_FileReaderTool >>(m.attr("StepData_StepReaderTool"))
...
;
    ...
    static_cast<py::class_<StepData_EnumTool ,std::unique_ptr<StepData_EnumTool>  >>(m.attr("StepData_EnumTool"))
        ...
        .def("AddDefinition",
             ...
             R"#(Processes a definition, splits it according blanks if any empty definitions are ignored A null definition can be input by given "$" :the corresponding position is attached to "null/undefined" value (as one particular item of the enumeration list) See also IsSet)#"  , py::arg("term"))
        .def("IsSet",
             (Standard_Boolean (StepData_EnumTool::*)() const) static_cast<Standard_Boolean (StepData_EnumTool::*)() const>(&StepData_EnumTool::IsSet),
             R"#(Returns True if at least one definition has been entered after creation time (i.e. by AddDefinition only))#" )
        .def("MaxValue",
             (Standard_Integer (StepData_EnumTool::*)() const) static_cast<Standard_Integer (StepData_EnumTool::*)() const>(&StepData_EnumTool::MaxValue),
             R"#(Returns the maximum integer for a suitable value Remark : while values begin at zero, MaxValue is the count of recorded values minus one)#" )
        .def("Optional",
             (void (StepData_EnumTool::*)( const Standard_Boolean  ) ) static_cast<void (StepData_EnumTool::*)( const Standard_Boolean  ) >(&StepData_EnumTool::Optional),
             R"#(Sets or Unsets the EnumTool to accept undefined value (for optional field). Ignored if no null value is defined (by "$") Can be changed during execution (to read each field), Default is True (if a null value is defined))#"  , py::arg("mode"))
        .def("NullValue",
             (Standard_Integer (StepData_EnumTool::*)() const) static_cast<Standard_Integer (StepData_EnumTool::*)() const>(&StepData_EnumTool::NullValue),
             R"#(Returns the value attached to "null/undefined value" If none is specified or if Optional has been set to False, returns -1 Null Value has been specified by definition "$")#" )
        .def("Text",
             (const TCollection_AsciiString & (StepData_EnumTool::*)( const Standard_Integer  ) const) static_cast<const TCollection_AsciiString & (StepData_EnumTool::*)( const Standard_Integer  ) const>(&StepData_EnumTool::Text),
             R"#(Returns the text which corresponds to a given numeric value It is limited by dots If num is out of range, returns an empty string)#"  , py::arg("num"))
        .def("Value",
             (Standard_Integer (StepData_EnumTool::*)( const Standard_CString  ) const) static_cast<Standard_Integer (StepData_EnumTool::*)( const Standard_CString  ) const>(&StepData_EnumTool::Value),
             R"#(Returns the numeric value found for a text The text must be in capitals and limited by dots A non-suitable text gives a negative value to be returned)#"  , py::arg("txt"))
        .def("Value",
             (Standard_Integer (StepData_EnumTool::*)( const TCollection_AsciiString &  ) const) static_cast<Standard_Integer (StepData_EnumTool::*)( const TCollection_AsciiString &  ) const>(&StepData_EnumTool::Value),
             R"#(Same as above but works on an AsciiString)#"  , py::arg("txt"))
;
...
;
    ...
    static_cast<py::class_<StepData_FieldList1 ,std::unique_ptr<StepData_FieldList1>  , StepData_FieldList >>(m.attr("StepData_FieldList1"))
        .def(py::init<  >()  )
        .def("NbFields",
