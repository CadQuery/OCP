...
// classes
    ...
    static_cast<py::class_<BRepLib_Command ,std::unique_ptr<BRepLib_Command>  >>(m.attr("BRepLib_Command"))
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<BRepLib_MakeShape ,std::unique_ptr<BRepLib_MakeShape>  , BRepLib_Command >>(m.attr("BRepLib_MakeShape"))
        .def("Build",
...
;
    ...
    static_cast<py::class_<BRepLib_MakeEdge ,std::unique_ptr<BRepLib_MakeEdge>  , BRepLib_MakeShape >>(m.attr("BRepLib_MakeEdge"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepLib_MakeWire ,std::unique_ptr<BRepLib_MakeWire>  , BRepLib_MakeShape >>(m.attr("BRepLib_MakeWire"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepLib_MakeVertex ,std::unique_ptr<BRepLib_MakeVertex>  , BRepLib_MakeShape >>(m.attr("BRepLib_MakeVertex"))
...
;
    ...
    static_cast<py::class_<BRepLib_MakeFace ,std::unique_ptr<BRepLib_MakeFace>  , BRepLib_MakeShape >>(m.attr("BRepLib_MakeFace"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepLib_FuseEdges ,std::unique_ptr<BRepLib_FuseEdges>  >>(m.attr("BRepLib_FuseEdges"))
...
;
    ...
    static_cast<py::class_<BRepLib_MakeShell ,std::unique_ptr<BRepLib_MakeShell>  , BRepLib_MakeShape >>(m.attr("BRepLib_MakeShell"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepLib_MakeSolid ,std::unique_ptr<BRepLib_MakeSolid>  , BRepLib_MakeShape >>(m.attr("BRepLib_MakeSolid"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<BRepLib ,std::unique_ptr<BRepLib>>(m,"BRepLib");

    static_cast<py::class_<BRepLib ,std::unique_ptr<BRepLib>  >>(m.attr("BRepLib"))
        ...
        .def_static("BuildPCurveForEdgeOnPlane_s",
                    (void (*)( const TopoDS_Edge & ,  const TopoDS_Face & ,  opencascade::handle<Geom2d_Curve> & ,  Standard_Boolean &  ) ) static_cast<void (*)( const TopoDS_Edge & ,  const TopoDS_Face & ,  opencascade::handle<Geom2d_Curve> & ,  Standard_Boolean &  ) >(&BRepLib::BuildPCurveForEdgeOnPlane),
                    R"#(Builds pcurve of edge on face if the surface is plane, but does not update the edge. The output are the pcurve and the flag telling that pcurve was built.)#"  , py::arg("theE"),  py::arg("theF"),  py::arg("aC2D"),  py::arg("bToUpdate"))
        ...
        .def_static("BoundingVertex_s",
                    (void (*)( const NCollection_List<TopoDS_Shape> & ,  gp_Pnt & ,  Standard_Real &  ) ) static_cast<void (*)( const NCollection_List<TopoDS_Shape> & ,  gp_Pnt & ,  Standard_Real &  ) >(&BRepLib::BoundingVertex),
                    R"#(Calculates the bounding sphere around the set of vertexes from the theLV list. Returns the center (theNewCenter) and the radius (theNewTol) of this sphere. This can be used to construct the new vertex which covers the given set of other vertices.)#"  , py::arg("theLV"),  py::arg("theNewCenter"),  py::arg("theNewTol"))
...
;
    ...
    static_cast<py::class_<BRepLib_FindSurface ,std::unique_ptr<BRepLib_FindSurface>  >>(m.attr("BRepLib_FindSurface"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepLib_MakeEdge2d ,std::unique_ptr<BRepLib_MakeEdge2d>  , BRepLib_MakeShape >>(m.attr("BRepLib_MakeEdge2d"))
        .def(py::init< const TopoDS_Vertex &,const TopoDS_Vertex & >()  , py::arg("V1"),  py::arg("V2") )
...
;
    ...
    static_cast<py::class_<BRepLib_MakePolygon ,std::unique_ptr<BRepLib_MakePolygon>  , BRepLib_MakeShape >>(m.attr("BRepLib_MakePolygon"))
        .def(py::init<  >()  )
        .def(py::init< const gp_Pnt &,const gp_Pnt & >()  , py::arg("P1"),  py::arg("P2") )
