...
;
    ...
    // static methods using call by reference i.s.o. return
        .def_static("SamplePoint_s",
                    []( const opencascade::handle<Adaptor3d_HSurface> & S,const Standard_Integer Index ){ Standard_Real  U; Standard_Real  V; Contap_HContTool::SamplePoint(S,Index,U,V); return std::make_tuple(U,V); },
                    R"#(None)#"  , py::arg("S"),  py::arg("Index"))
        .def_static("Bounds_s",
                    []( const opencascade::handle<Adaptor2d_HCurve2d> & C ){ Standard_Real  Ufirst; Standard_Real  Ulast; Contap_HContTool::Bounds(C,Ufirst,Ulast); return std::make_tuple(Ufirst,Ulast); },
