...
// classes
    ...
    static_cast<py::class_<GProp_GProps ,std::unique_ptr<GProp_GProps>  >>(m.attr("GProp_GProps"))
        .def(py::init<  >()  )
        ...
        .def("StaticMoments",
             (void (GProp_GProps::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GProp_GProps::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GProp_GProps::StaticMoments),
             R"#(Returns Ix, Iy, Iz, the static moments of inertia of the current system; i.e. the moments of inertia about the three axes of the Cartesian coordinate system.)#"  , py::arg("Ix"),  py::arg("Iy"),  py::arg("Iz"))
        .def("MomentOfInertia",
...
;
    ...
    static_cast<py::class_<GProp_CelGProps ,std::unique_ptr<GProp_CelGProps>  , GProp_GProps >>(m.attr("GProp_CelGProps"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GProp_PrincipalProps ,std::unique_ptr<GProp_PrincipalProps>  >>(m.attr("GProp_PrincipalProps"))
        .def(py::init<  >()  )
        .def("HasSymmetryAxis",
        ...
        .def("Moments",
             (void (GProp_PrincipalProps::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GProp_PrincipalProps::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GProp_PrincipalProps::Moments),
        ...
        .def("RadiusOfGyration",
             (void (GProp_PrincipalProps::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GProp_PrincipalProps::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GProp_PrincipalProps::RadiusOfGyration),
...
;
    ...
    static_cast<py::class_<GProp_SelGProps ,std::unique_ptr<GProp_SelGProps>  , GProp_GProps >>(m.attr("GProp_SelGProps"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<GProp ,std::unique_ptr<GProp>>(m,"GProp");

    static_cast<py::class_<GProp ,std::unique_ptr<GProp>  >>(m.attr("GProp"))
...
;
    ...
    static_cast<py::class_<GProp_VelGProps ,std::unique_ptr<GProp_VelGProps>  , GProp_GProps >>(m.attr("GProp_VelGProps"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GProp_PEquation ,std::unique_ptr<GProp_PEquation>  >>(m.attr("GProp_PEquation"))
...
;
    ...
    static_cast<py::class_<GProp_PGProps ,std::unique_ptr<GProp_PGProps>  , GProp_GProps >>(m.attr("GProp_PGProps"))
        .def(py::init<  >()  )
        ...
        .def_static("Barycentre_s",
                    ...
                    R"#(Computes the barycentre of a set of points. The density of the points is defaulted to 1.)#"  , py::arg("Pnts"))
        .def_static("Barycentre_s",
                    (void (*)(  const NCollection_Array1<gp_Pnt> & ,   const NCollection_Array1<Standard_Real> & ,  Standard_Real & ,  gp_Pnt &  ) ) static_cast<void (*)(  const NCollection_Array1<gp_Pnt> & ,   const NCollection_Array1<Standard_Real> & ,  Standard_Real & ,  gp_Pnt &  ) >(&GProp_PGProps::Barycentre),
                    R"#(Computes the barycentre of a set of points. A density is associated with each point.)#"  , py::arg("Pnts"),  py::arg("Density"),  py::arg("Mass"),  py::arg("G"))
        .def_static("Barycentre_s",
                    (void (*)(  const NCollection_Array2<gp_Pnt> & ,   const NCollection_Array2<Standard_Real> & ,  Standard_Real & ,  gp_Pnt &  ) ) static_cast<void (*)(  const NCollection_Array2<gp_Pnt> & ,   const NCollection_Array2<Standard_Real> & ,  Standard_Real & ,  gp_Pnt &  ) >(&GProp_PGProps::Barycentre),
                    R"#(Computes the barycentre of a set of points. A density is associated with each point.)#"  , py::arg("Pnts"),  py::arg("Density"),  py::arg("Mass"),  py::arg("G"))
;
