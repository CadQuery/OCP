...
void preregister_template_Prs3d_Point(py::object &m, const char *name){
    py::class_<Prs3d_Point<AnyPoint,PointTool> ,std::unique_ptr<Prs3d_Point<AnyPoint,PointTool>> >(m,name,R"#(None)#");
}

template <typename AnyPoint,typename PointTool>
void register_template_Prs3d_Point(py::object &m, const char *name){
    static_cast<py::class_<Prs3d_Point<AnyPoint,PointTool> ,std::unique_ptr<Prs3d_Point<AnyPoint,PointTool>> >>(m.attr(name))
        .def_static("Add_s",
