...
// classes forward declarations only
    py::class_<Transfer_TransferIterator ,std::unique_ptr<Transfer_TransferIterator>  >(m,"Transfer_TransferIterator",R"#(Defines an Iterator on the result of a Transfer Available for Normal Results or not (Erroneous Transfer) It gives several kinds of Informations, and allows to consider various criteria (criteria are cumulative))#");
    py::class_<Transfer_DataInfo ,std::unique_ptr<Transfer_DataInfo>  >(m,"Transfer_DataInfo",R"#(Gives informations on an object Used as template to instantiate Mapper and SimpleBinder This class is for Transient)#");
    ...
    py::class_<Transfer_TransferInput ,std::unique_ptr<Transfer_TransferInput>  >(m,"Transfer_TransferInput",R"#(A TransferInput is a Tool which fills an InterfaceModel with the result of the Transfer of CasCade Objects, once determined The Result comes from a TransferProcess, either from Transient (the Complete Result is considered, it must contain only Transient Objects))#");
    ...
    py::class_<Transfer_FindHasher ,std::unique_ptr<Transfer_FindHasher>  >(m,"Transfer_FindHasher",R"#(FindHasher defines HashCode for Finder, which is : ask a Finder its HashCode ! Because this is the Finder itself which brings the HashCode for its Key)#");
    ...
    py::class_<Transfer_IteratorOfProcessForTransient ,std::unique_ptr<Transfer_IteratorOfProcessForTransient>  , Transfer_TransferIterator >(m,"Transfer_IteratorOfProcessForTransient",R"#(None)#");
    py::class_<Transfer_IteratorOfProcessForFinder ,std::unique_ptr<Transfer_IteratorOfProcessForFinder>  , Transfer_TransferIterator >(m,"Transfer_IteratorOfProcessForFinder",R"#(None)#");
    ...
    py::class_<Transfer_HSequenceOfFinder ,std::unique_ptr<Transfer_HSequenceOfFinder>  >(m,"Transfer_HSequenceOfFinder",R"#()#");
    ...
    py::class_<Transfer_HSequenceOfBinder ,std::unique_ptr<Transfer_HSequenceOfBinder>  >(m,"Transfer_HSequenceOfBinder",R"#()#");
