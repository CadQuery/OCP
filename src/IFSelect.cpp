...
;
    ...
    static_cast<py::class_<IFSelect_ContextWrite ,std::unique_ptr<IFSelect_ContextWrite>  >>(m.attr("IFSelect_ContextWrite"))
...
;
    ...
    static_cast<py::class_<IFSelect_ShareOutResult ,std::unique_ptr<IFSelect_ShareOutResult>  >>(m.attr("IFSelect_ShareOutResult"))
        ...
        .def("PacketsInDispatch",
             (void (IFSelect_ShareOutResult::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (IFSelect_ShareOutResult::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&IFSelect_ShareOutResult::PacketsInDispatch),
             R"#(Returns Number (rank) of current Packet in current Dispatch, and total count of Packets in current Dispatch, as arguments)#"  , py::arg("numpack"),  py::arg("nbpacks"))
        .def("PacketRoot",
...
;
    ...
    static_cast<py::class_<IFSelect_HSeqOfSelection ,std::unique_ptr<IFSelect_HSeqOfSelection>  >>(m.attr("IFSelect_HSeqOfSelection"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<IFSelect_Functions ,std::unique_ptr<IFSelect_Functions>>(m,"IFSelect_Functions");

    static_cast<py::class_<IFSelect_Functions ,std::unique_ptr<IFSelect_Functions>  >>(m.attr("IFSelect_Functions"))
...
;
    ...
    static_cast<py::class_<IFSelect_SelectionIterator ,std::unique_ptr<IFSelect_SelectionIterator>  >>(m.attr("IFSelect_SelectionIterator"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IFSelect_WorkLibrary ,opencascade::handle<IFSelect_WorkLibrary> ,Py_IFSelect_WorkLibrary , Standard_Transient >>(m.attr("IFSelect_WorkLibrary"))
        ...
        .def("DumpLevels",
             (void (IFSelect_WorkLibrary::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (IFSelect_WorkLibrary::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&IFSelect_WorkLibrary::DumpLevels),
             R"#(Returns the recorded default and maximum dump levels If none was recorded, max is returned negative, def as zero)#"  , py::arg("def"),  py::arg("max"))
        .def("SetDumpHelp",
...
;
    ...
    register_default_constructor<IFSelect ,std::unique_ptr<IFSelect>>(m,"IFSelect");

    static_cast<py::class_<IFSelect ,std::unique_ptr<IFSelect>  >>(m.attr("IFSelect"))
...
;
    ...
    static_cast<py::class_<IFSelect_SessionFile ,std::unique_ptr<IFSelect_SessionFile>  >>(m.attr("IFSelect_SessionFile"))
...
;
    ...
    static_cast<py::class_<IFSelect_ContextModif ,std::unique_ptr<IFSelect_ContextModif>  >>(m.attr("IFSelect_ContextModif"))
