...
// classes forward declarations only
    ...
    py::class_<TObj_HSequenceOfObject ,std::unique_ptr<TObj_HSequenceOfObject>  >(m,"TObj_HSequenceOfObject",R"#()#");
