...
// classes forward declarations only
    ...
    py::class_<StdStorage_Bucket , shared_ptr<StdStorage_Bucket>  >(m,"StdStorage_Bucket",R"#(None)#");
    py::class_<StdStorage_BucketIterator , shared_ptr<StdStorage_BucketIterator>  >(m,"StdStorage_BucketIterator",R"#()#");
    py::class_<StdStorage_BucketOfPersistent , shared_ptr<StdStorage_BucketOfPersistent>  >(m,"StdStorage_BucketOfPersistent",R"#()#");
