...
;
    ...
    static_cast<py::class_<TFunction_HArray1OfDataMapOfGUIDDriver ,std::unique_ptr<TFunction_HArray1OfDataMapOfGUIDDriver>  >>(m.attr("TFunction_HArray1OfDataMapOfGUIDDriver"))
...
;
    ...
    static_cast<py::class_<TFunction_IFunction ,std::unique_ptr<TFunction_IFunction>  >>(m.attr("TFunction_IFunction"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TFunction_Iterator ,std::unique_ptr<TFunction_Iterator>  >>(m.attr("TFunction_Iterator"))
        .def(py::init<  >()  )
