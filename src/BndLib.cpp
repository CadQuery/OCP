...
// classes
    ...
    register_default_constructor<BndLib ,std::unique_ptr<BndLib>>(m,"BndLib");

    static_cast<py::class_<BndLib ,std::unique_ptr<BndLib>  >>(m.attr("BndLib"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<BndLib_Add3dCurve ,std::unique_ptr<BndLib_Add3dCurve>>(m,"BndLib_Add3dCurve");

    static_cast<py::class_<BndLib_Add3dCurve ,std::unique_ptr<BndLib_Add3dCurve>  >>(m.attr("BndLib_Add3dCurve"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<BndLib_AddSurface ,std::unique_ptr<BndLib_AddSurface>>(m,"BndLib_AddSurface");

    static_cast<py::class_<BndLib_AddSurface ,std::unique_ptr<BndLib_AddSurface>  >>(m.attr("BndLib_AddSurface"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<BndLib_Add2dCurve ,std::unique_ptr<BndLib_Add2dCurve>>(m,"BndLib_Add2dCurve");

    static_cast<py::class_<BndLib_Add2dCurve ,std::unique_ptr<BndLib_Add2dCurve>  >>(m.attr("BndLib_Add2dCurve"))
        .def_static("Add_s",
