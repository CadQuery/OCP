...
;
    ...
    static_cast<py::class_<BiTgte_Blend ,std::unique_ptr<BiTgte_Blend>  >>(m.attr("BiTgte_Blend"))
        .def(py::init<  >()  )
        ...
        .def("IndicesOfBranche",
             (void (BiTgte_Blend::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (BiTgte_Blend::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const>(&BiTgte_Blend::IndicesOfBranche),
             R"#(Set in <From>,<To> the indices of the faces of the branche <Index>.)#"  , py::arg("Index"),  py::arg("From"),  py::arg("To"))
        .def("ComputeCenters",
...
;
    ...
    static_cast<py::class_<BiTgte_CurveOnVertex ,std::unique_ptr<BiTgte_CurveOnVertex>  , Adaptor3d_Curve >>(m.attr("BiTgte_CurveOnVertex"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BiTgte_CurveOnEdge ,std::unique_ptr<BiTgte_CurveOnEdge>  , Adaptor3d_Curve >>(m.attr("BiTgte_CurveOnEdge"))
        .def(py::init<  >()  )
