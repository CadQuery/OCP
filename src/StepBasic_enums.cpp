...
// classes forward declarations only
    ...
    py::class_<StepBasic_HArray1OfProductContext ,std::unique_ptr<StepBasic_HArray1OfProductContext>  >(m,"StepBasic_HArray1OfProductContext",R"#()#");
    ...
    py::class_<StepBasic_HArray1OfPerson ,std::unique_ptr<StepBasic_HArray1OfPerson>  >(m,"StepBasic_HArray1OfPerson",R"#()#");
    ...
    py::class_<StepBasic_HArray1OfOrganization ,std::unique_ptr<StepBasic_HArray1OfOrganization>  >(m,"StepBasic_HArray1OfOrganization",R"#()#");
    ...
    py::class_<StepBasic_HArray1OfProductDefinition ,std::unique_ptr<StepBasic_HArray1OfProductDefinition>  >(m,"StepBasic_HArray1OfProductDefinition",R"#()#");
    py::class_<StepBasic_PersonOrganizationSelect ,std::unique_ptr<StepBasic_PersonOrganizationSelect>  , StepData_SelectType >(m,"StepBasic_PersonOrganizationSelect",R"#(None)#");
    ...
    py::class_<StepBasic_DateTimeSelect ,std::unique_ptr<StepBasic_DateTimeSelect>  , StepData_SelectType >(m,"StepBasic_DateTimeSelect",R"#(None)#");
    ...
    py::class_<StepBasic_ProductOrFormationOrDefinition ,std::unique_ptr<StepBasic_ProductOrFormationOrDefinition>  , StepData_SelectType >(m,"StepBasic_ProductOrFormationOrDefinition",R"#(Representation of STEP SELECT type ProductOrFormationOrDefinition)#");
    ...
    py::class_<StepBasic_HArray1OfApproval ,std::unique_ptr<StepBasic_HArray1OfApproval>  >(m,"StepBasic_HArray1OfApproval",R"#()#");
    ...
    py::class_<StepBasic_HArray1OfDocument ,std::unique_ptr<StepBasic_HArray1OfDocument>  >(m,"StepBasic_HArray1OfDocument",R"#()#");
    ...
    py::class_<StepBasic_HArray1OfDerivedUnitElement ,std::unique_ptr<StepBasic_HArray1OfDerivedUnitElement>  >(m,"StepBasic_HArray1OfDerivedUnitElement",R"#()#");
    ...
    py::class_<StepBasic_Unit ,std::unique_ptr<StepBasic_Unit>  , StepData_SelectType >(m,"StepBasic_Unit",R"#(Implements a select type unit (NamedUnit or DerivedUnit))#");
    ...
    py::class_<StepBasic_HArray1OfProduct ,std::unique_ptr<StepBasic_HArray1OfProduct>  >(m,"StepBasic_HArray1OfProduct",R"#()#");
    ...
    py::class_<StepBasic_ProductDefinitionOrReference ,std::unique_ptr<StepBasic_ProductDefinitionOrReference>  , StepData_SelectType >(m,"StepBasic_ProductDefinitionOrReference",R"#(None)#");
    ...
    py::class_<StepBasic_SourceItem ,std::unique_ptr<StepBasic_SourceItem>  , StepData_SelectType >(m,"StepBasic_SourceItem",R"#(Representation of STEP SELECT type SourceItem)#");
    ...
    py::class_<StepBasic_SizeSelect ,std::unique_ptr<StepBasic_SizeSelect>  , StepData_SelectType >(m,"StepBasic_SizeSelect",R"#(None)#");
    ...
    py::class_<StepBasic_HArray1OfNamedUnit ,std::unique_ptr<StepBasic_HArray1OfNamedUnit>  >(m,"StepBasic_HArray1OfNamedUnit",R"#()#");
    ...
    py::class_<StepBasic_RoleSelect ,std::unique_ptr<StepBasic_RoleSelect>  , StepData_SelectType >(m,"StepBasic_RoleSelect",R"#(Representation of STEP SELECT type RoleSelect)#");
    py::class_<StepBasic_HArray1OfUncertaintyMeasureWithUnit ,std::unique_ptr<StepBasic_HArray1OfUncertaintyMeasureWithUnit>  >(m,"StepBasic_HArray1OfUncertaintyMeasureWithUnit",R"#()#");
