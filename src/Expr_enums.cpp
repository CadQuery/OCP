...
// classes forward declarations only
    ...
    py::class_<Expr ,std::unique_ptr<Expr>  >(m,"Expr",R"#(This package describes the data structure of any expression, relation or function used in mathematics. It also describes the assignment of variables. Standard mathematical functions are implemented such as trigonometrics, hyperbolics, and log functions.)#");
    py::class_<Expr_UnknownIterator ,std::unique_ptr<Expr_UnknownIterator>  >(m,"Expr_UnknownIterator",R"#(Describes an iterator on NamedUnknowns contained in any GeneralExpression.)#");
    ...
    py::class_<Expr_RUIterator ,std::unique_ptr<Expr_RUIterator>  >(m,"Expr_RUIterator",R"#(Iterates on NamedUnknowns in a GeneralRelation.)#");
    py::class_<Expr_UnaryMinus ,opencascade::handle<Expr_UnaryMinus>  , Expr_UnaryExpression >(m,"Expr_UnaryMinus",R"#()#");
    py::class_<Expr_RelationIterator ,std::unique_ptr<Expr_RelationIterator>  >(m,"Expr_RelationIterator",R"#(Iterates on every basic relation contained in a GeneralRelation.)#");
