...
// classes
    ...
    // methods using call by reference i.s.o. return
        .def("Tangency1",
             []( GccAna_Circ2d2TanOn &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency1(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
        ...
        .def("Tangency2",
             []( GccAna_Circ2d2TanOn &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency2(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
        ...
        .def("CenterOn3",
             []( GccAna_Circ2d2TanOn &self , const Standard_Integer Index,gp_Pnt2d & PntArg ){ Standard_Real  ParArg; self.CenterOn3(Index,ParArg,PntArg); return std::make_tuple(ParArg); },
             R"#(Returns the informations about the center (on the curv) of the result number Index and the third argument. ParArg is the intrinsic parameter of the point PntArg on the third argument. Exceptions Standard_OutOfRange if Index is less than zero or greater than the number of solutions computed by this algorithm. StdFail_NotDone if the construction fails.)#"  , py::arg("Index"),  py::arg("PntArg"))
    // static methods
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Tangency1",
             []( GccAna_Circ2d2TanRad &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency1(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
        ...
        .def("Tangency2",
             []( GccAna_Circ2d2TanRad &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency2(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Tangency1",
             []( GccAna_Circ2d3Tan &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency1(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the tangency point between the result number Index and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntArg on the argument curv. Raises OutOfRange if Index is greater than the number of solutions. It raises NotDone if the algorithm failed.)#"  , py::arg("Index"),  py::arg("PntSol"))
        .def("Tangency2",
             []( GccAna_Circ2d3Tan &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency2(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the tangency point between the result number Index and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point Pntsol on the argument curv. Raises OutOfRange if Index is greater than the number of solutions. It raises NotDone if the algorithm failed.)#"  , py::arg("Index"),  py::arg("PntSol"))
        .def("Tangency3",
             []( GccAna_Circ2d3Tan &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency3(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the tangency point between the result number Index and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point Pntsol on the argument curv. Raises OutOfRange if Index is greater than the number of solutions. It raises NotDone if the algorithm failed.)#"  , py::arg("Index"),  py::arg("PntSol"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Tangency1",
             []( GccAna_Circ2dTanCen &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency1(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Tangency1",
             []( GccAna_Circ2dTanOnRad &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency1(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the tangency point between the result number Index and the first argument. ParSol is the intrinsic parameter of the point on the solution curv. ParArg is the intrinsic parameter of the point on the argument curv. PntSol is the tangency point on the solution curv. PntArg is the tangency point on the argument curv. Raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("PntSol"))
        .def("CenterOn3",
             []( GccAna_Circ2dTanOnRad &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParArg; self.CenterOn3(Index,ParArg,PntSol); return std::make_tuple(ParArg); },
             R"#(Returns informations about the center (on the curv) of the result. ParArg is the intrinsic parameter of the point on the argument curv. PntSol is the center point of the solution curv. Raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("PntSol"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
    // additional methods and static methods
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Tangency1",
             []( GccAna_Lin2d2Tan &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency1(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the tangency point between the result number Index and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv. Raises OutOfRange is raised if Index is greater than the number of solutions. It raises NotDone if the algorithm failed.)#"  , py::arg("Index"),  py::arg("PntSol"))
        .def("Tangency2",
             []( GccAna_Lin2d2Tan &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency2(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the tangency point between the result number Index and the second argument. ParSol is the intrinsic parameter of the point ParSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv. Raises OutOfRange is raised if Index is greater than the number of solutions. It raises NotDone if the algorithm failed.)#"  , py::arg("Index"),  py::arg("PntSol"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
    // additional methods and static methods
;
    ...
    // methods using call by reference i.s.o. return
        .def("Intersection1",
             []( GccAna_Lin2dBisec &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Intersection1(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the intersection point between the result number Index and the first argument. Raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("PntSol"))
        .def("Intersection2",
             []( GccAna_Lin2dBisec &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Intersection2(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the intersection point between the result number Index and the second argument. Raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("PntSol"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
    // additional methods and static methods
;
    ...
    // methods using call by reference i.s.o. return
        .def("Tangency1",
             []( GccAna_Lin2dTanObl &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency1(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the tangency point between the result number Index and the first argument. ParSol is the intrinsic parameter of the point ParSol on the solution curv. ParArg is the intrinsic parameter of the point ParArg on the argument curv. Raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("PntSol"))
        .def("Intersection2",
             []( GccAna_Lin2dTanObl &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Intersection2(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the intersection between the result number Index and the third argument. Raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("PntSol"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
    // additional methods and static methods
;
    ...
    // methods using call by reference i.s.o. return
        .def("Tangency1",
             []( GccAna_Lin2dTanPar &self , const Standard_Integer Index,gp_Pnt2d & Pnt ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency1(Index,ParSol,ParArg,Pnt); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the tangency point between the result number Index and the first argument. ParSol is the intrinsic parameter of the point on the solution curv. ParArg is the intrinsic parameter of the point on the argument curv. ParArg is equal 0 when the solution is passing thrue a point. Raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("Pnt"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
    // additional methods and static methods
;
    ...
    // methods using call by reference i.s.o. return
        .def("Tangency1",
             []( GccAna_Lin2dTanPer &self , const Standard_Integer Index,gp_Pnt2d & Pnt ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Tangency1(Index,ParSol,ParArg,Pnt); return std::make_tuple(ParSol,ParArg); },
        ...
        .def("Intersection2",
             []( GccAna_Lin2dTanPer &self , const Standard_Integer Index,gp_Pnt2d & PntSol ){ Standard_Real  ParSol; Standard_Real  ParArg; self.Intersection2(Index,ParSol,ParArg,PntSol); return std::make_tuple(ParSol,ParArg); },
             R"#(Returns informations about the intersection between the solution number Index and the second argument. It returns the first intersection in a case of Lin2dTanPer which is perpendicular to a circle . ParSol is the intrinsic parameter of the point on the solution curv. ParArg is the intrinsic parameter of the point on the argument curv. Raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("PntSol"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
    // additional methods and static methods
