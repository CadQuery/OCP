...
// classes
    ...
    static_cast<py::class_<math_Function ,std::unique_ptr<math_Function> ,Py_math_Function >>(m.attr("math_Function"))
        .def("Value",
...
;
    ...
    static_cast<py::class_<math_MultipleVarFunction ,std::unique_ptr<math_MultipleVarFunction> ,Py_math_MultipleVarFunction >>(m.attr("math_MultipleVarFunction"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<math_FunctionSet ,std::unique_ptr<math_FunctionSet> ,Py_math_FunctionSet >>(m.attr("math_FunctionSet"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<math_ValueAndWeight ,std::unique_ptr<math_ValueAndWeight>  >>(m.attr("math_ValueAndWeight"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<math_GaussMultipleIntegration ,std::unique_ptr<math_GaussMultipleIntegration>  >>(m.attr("math_GaussMultipleIntegration"))
...
;
    ...
    static_cast<py::class_<math_BracketedRoot ,std::unique_ptr<math_BracketedRoot>  >>(m.attr("math_BracketedRoot"))
...
;
    ...
    static_cast<py::class_<math_FunctionRoot ,std::unique_ptr<math_FunctionRoot>  >>(m.attr("math_FunctionRoot"))
...
;
    ...
    register_default_constructor<math ,std::unique_ptr<math>>(m,"math");

    static_cast<py::class_<math ,std::unique_ptr<math>  >>(m.attr("math"))
...
;
    ...
    static_cast<py::class_<math_FRPR ,std::unique_ptr<math_FRPR>  >>(m.attr("math_FRPR"))
...
;
    ...
    static_cast<py::class_<math_Powell ,std::unique_ptr<math_Powell>  >>(m.attr("math_Powell"))
...
;
    ...
    static_cast<py::class_<math_FunctionSample ,std::unique_ptr<math_FunctionSample>  >>(m.attr("math_FunctionSample"))
        .def(py::init< const Standard_Real,const Standard_Real,const Standard_Integer >()  , py::arg("A"),  py::arg("B"),  py::arg("N") )
        .def("Bounds",
             (void (math_FunctionSample::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (math_FunctionSample::*)( Standard_Real & ,  Standard_Real &  ) const>(&math_FunctionSample::Bounds),
             R"#(Returns the bounds of parameters.)#"  , py::arg("A"),  py::arg("B"))
        .def("NbPoints",
...
;
    ...
    static_cast<py::class_<math_Uzawa ,std::unique_ptr<math_Uzawa>  >>(m.attr("math_Uzawa"))
...
;
    ...
    static_cast<py::class_<math_TrigonometricFunctionRoots ,std::unique_ptr<math_TrigonometricFunctionRoots>  >>(m.attr("math_TrigonometricFunctionRoots"))
...
;
    ...
    static_cast<py::class_<math_GaussSetIntegration ,std::unique_ptr<math_GaussSetIntegration>  >>(m.attr("math_GaussSetIntegration"))
...
;
    ...
    static_cast<py::class_<math_MultipleVarFunctionWithGradient ,std::unique_ptr<math_MultipleVarFunctionWithGradient> ,Py_math_MultipleVarFunctionWithGradient , math_MultipleVarFunction >>(m.attr("math_MultipleVarFunctionWithGradient"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<math_FunctionWithDerivative ,std::unique_ptr<math_FunctionWithDerivative> ,Py_math_FunctionWithDerivative , math_Function >>(m.attr("math_FunctionWithDerivative"))
        .def("Value",
...
;
    ...
    static_cast<py::class_<math_GaussSingleIntegration ,std::unique_ptr<math_GaussSingleIntegration>  >>(m.attr("math_GaussSingleIntegration"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<math_BissecNewton ,std::unique_ptr<math_BissecNewton>  >>(m.attr("math_BissecNewton"))
...
;
    ...
    static_cast<py::class_<math_Householder ,std::unique_ptr<math_Householder>  >>(m.attr("math_Householder"))
...
;
    ...
    static_cast<py::class_<math_Vector ,std::unique_ptr<math_Vector>  >>(m.attr("math_Vector"))
...
;
    ...
    static_cast<py::class_<math_Jacobi ,std::unique_ptr<math_Jacobi>  >>(m.attr("math_Jacobi"))
...
;
    ...
    static_cast<py::class_<math_NewtonFunctionRoot ,std::unique_ptr<math_NewtonFunctionRoot>  >>(m.attr("math_NewtonFunctionRoot"))
...
;
    ...
    static_cast<py::class_<math_BrentMinimum ,std::unique_ptr<math_BrentMinimum>  >>(m.attr("math_BrentMinimum"))
...
;
    ...
    static_cast<py::class_<math_Matrix ,std::unique_ptr<math_Matrix>  >>(m.attr("math_Matrix"))
...
;
    ...
    static_cast<py::class_<math_SVD ,std::unique_ptr<math_SVD>  >>(m.attr("math_SVD"))
        .def(py::init< const math_Matrix & >()  , py::arg("A") )
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<math_Crout ,std::unique_ptr<math_Crout>  >>(m.attr("math_Crout"))
...
;
    ...
    static_cast<py::class_<math_ComputeKronrodPointsAndWeights ,std::unique_ptr<math_ComputeKronrodPointsAndWeights>  >>(m.attr("math_ComputeKronrodPointsAndWeights"))
...
;
    ...
    static_cast<py::class_<math_NewtonMinimum ,std::unique_ptr<math_NewtonMinimum>  >>(m.attr("math_NewtonMinimum"))
...
;
    ...
    static_cast<py::class_<math_FunctionRoots ,std::unique_ptr<math_FunctionRoots>  >>(m.attr("math_FunctionRoots"))
...
;
    ...
    static_cast<py::class_<math_ComputeGaussPointsAndWeights ,std::unique_ptr<math_ComputeGaussPointsAndWeights>  >>(m.attr("math_ComputeGaussPointsAndWeights"))
        .def(py::init< const Standard_Integer >()  , py::arg("Number") )
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<math_DirectPolynomialRoots ,std::unique_ptr<math_DirectPolynomialRoots>  >>(m.attr("math_DirectPolynomialRoots"))
...
;
    ...
    static_cast<py::class_<math_FunctionAllRoots ,std::unique_ptr<math_FunctionAllRoots>  >>(m.attr("math_FunctionAllRoots"))
        ...
        .def("GetInterval",
             (void (math_FunctionAllRoots::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (math_FunctionAllRoots::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&math_FunctionAllRoots::GetInterval),
             R"#(Returns the interval of parameter of range Index. An exception is raised if IsDone returns False; An exception is raised if Index<=0 or Index >Nbintervals.)#"  , py::arg("Index"),  py::arg("A"),  py::arg("B"))
        .def("GetIntervalState",
             (void (math_FunctionAllRoots::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (math_FunctionAllRoots::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const>(&math_FunctionAllRoots::GetIntervalState),
             R"#(returns the State Number associated to the interval Index. An exception is raised if IsDone returns False; An exception is raised if Index<=0 or Index >Nbintervals.)#"  , py::arg("Index"),  py::arg("IFirst"),  py::arg("ILast"))
        .def("NbPoints",
...
;
    ...
    static_cast<py::class_<math_KronrodSingleIntegration ,std::unique_ptr<math_KronrodSingleIntegration>  >>(m.attr("math_KronrodSingleIntegration"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<math_FunctionSetRoot ,std::unique_ptr<math_FunctionSetRoot>  >>(m.attr("math_FunctionSetRoot"))
...
;
    ...
    static_cast<py::class_<math_FunctionSetWithDerivatives ,std::unique_ptr<math_FunctionSetWithDerivatives> ,Py_math_FunctionSetWithDerivatives , math_FunctionSet >>(m.attr("math_FunctionSetWithDerivatives"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<math_EigenValuesSearcher ,std::unique_ptr<math_EigenValuesSearcher>  >>(m.attr("math_EigenValuesSearcher"))
...
;
    ...
    static_cast<py::class_<math_Gauss ,std::unique_ptr<math_Gauss>  >>(m.attr("math_Gauss"))
        .def(py::init< const math_Matrix &,const Standard_Real >()  , py::arg("A"),  py::arg("MinPivot")=static_cast<const Standard_Real>(1.0e-20) )
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<math_MultipleVarFunctionWithHessian ,std::unique_ptr<math_MultipleVarFunctionWithHessian> ,Py_math_MultipleVarFunctionWithHessian , math_MultipleVarFunctionWithGradient >>(m.attr("math_MultipleVarFunctionWithHessian"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<math_BracketMinimum ,std::unique_ptr<math_BracketMinimum>  >>(m.attr("math_BracketMinimum"))
        .def(py::init< const Standard_Real,const Standard_Real >()  , py::arg("A"),  py::arg("B") )
        ...
        .def("IsDone",
             ...
             R"#(Returns true if the computations are successful, otherwise returns false.)#" )
        .def("Values",
             (void (math_BracketMinimum::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (math_BracketMinimum::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&math_BracketMinimum::Values),
             R"#(Returns the bracketed triplet of abscissae. Exceptions StdFail_NotDone if the algorithm fails (and IsDone returns false).)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"))
        .def("FunctionValues",
             (void (math_BracketMinimum::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (math_BracketMinimum::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&math_BracketMinimum::FunctionValues),
             R"#(returns the bracketed triplet function values. Exceptions StdFail_NotDone if the algorithm fails (and IsDone returns false).)#"  , py::arg("FA"),  py::arg("FB"),  py::arg("FC"))
        .def("Dump",
...
;
    ...
    static_cast<py::class_<math_NewtonFunctionSetRoot ,std::unique_ptr<math_NewtonFunctionSetRoot>  >>(m.attr("math_NewtonFunctionSetRoot"))
...
;
    ...
    static_cast<py::class_<math_GaussLeastSquare ,std::unique_ptr<math_GaussLeastSquare>  >>(m.attr("math_GaussLeastSquare"))
        .def(py::init< const math_Matrix &,const Standard_Real >()  , py::arg("A"),  py::arg("MinPivot")=static_cast<const Standard_Real>(1.0e-20) )
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<math_IntegerVector ,std::unique_ptr<math_IntegerVector>  >>(m.attr("math_IntegerVector"))
...
;
    ...
    static_cast<py::class_<math_DoubleTab ,std::unique_ptr<math_DoubleTab>  >>(m.attr("math_DoubleTab"))
        .def(py::init< const Standard_Integer,const Standard_Integer,const Standard_Integer,const Standard_Integer >()  , py::arg("LowerRow"),  py::arg("UpperRow"),  py::arg("LowerCol"),  py::arg("UpperCol") )
        .def(py::init< const Standard_Address,const Standard_Integer,const Standard_Integer,const Standard_Integer,const Standard_Integer >()  , py::arg("Tab"),  py::arg("LowerRow"),  py::arg("UpperRow"),  py::arg("LowerCol"),  py::arg("UpperCol") )
...
;
    ...
    static_cast<py::class_<math_BFGS ,std::unique_ptr<math_BFGS>  >>(m.attr("math_BFGS"))
