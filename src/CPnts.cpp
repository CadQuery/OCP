...
// classes
    ...
    static_cast<py::class_<CPnts_UniformDeflection ,std::unique_ptr<CPnts_UniformDeflection>  >>(m.attr("CPnts_UniformDeflection"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<CPnts_MyGaussFunction ,std::unique_ptr<CPnts_MyGaussFunction>  , math_Function >>(m.attr("CPnts_MyGaussFunction"))
        .def(py::init<  >()  )
        .def("Value",
...
;
    ...
    static_cast<py::class_<CPnts_MyRootFunction ,std::unique_ptr<CPnts_MyRootFunction>  , math_FunctionWithDerivative >>(m.attr("CPnts_MyRootFunction"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<CPnts_AbscissaPoint ,std::unique_ptr<CPnts_AbscissaPoint>  >>(m.attr("CPnts_AbscissaPoint"))
        .def(py::init<  >()  )
