...
;
    ...
    static_cast<py::class_<IGESGraph_ToolUniformRectGrid ,std::unique_ptr<IGESGraph_ToolUniformRectGrid>  >>(m.attr("IGESGraph_ToolUniformRectGrid"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolLineFontDefTemplate ,std::unique_ptr<IGESGraph_ToolLineFontDefTemplate>  >>(m.attr("IGESGraph_ToolLineFontDefTemplate"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolLineFontPredefined ,std::unique_ptr<IGESGraph_ToolLineFontPredefined>  >>(m.attr("IGESGraph_ToolLineFontPredefined"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolLineFontDefPattern ,std::unique_ptr<IGESGraph_ToolLineFontDefPattern>  >>(m.attr("IGESGraph_ToolLineFontDefPattern"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_HArray1OfColor ,std::unique_ptr<IGESGraph_HArray1OfColor>  >>(m.attr("IGESGraph_HArray1OfColor"))
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolNominalSize ,std::unique_ptr<IGESGraph_ToolNominalSize>  >>(m.attr("IGESGraph_ToolNominalSize"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolIntercharacterSpacing ,std::unique_ptr<IGESGraph_ToolIntercharacterSpacing>  >>(m.attr("IGESGraph_ToolIntercharacterSpacing"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolTextFontDef ,std::unique_ptr<IGESGraph_ToolTextFontDef>  >>(m.attr("IGESGraph_ToolTextFontDef"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    register_default_constructor<IGESGraph ,std::unique_ptr<IGESGraph>>(m,"IGESGraph");

    static_cast<py::class_<IGESGraph ,std::unique_ptr<IGESGraph>  >>(m.attr("IGESGraph"))
        .def_static("Init_s",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolDrawingSize ,std::unique_ptr<IGESGraph_ToolDrawingSize>  >>(m.attr("IGESGraph_ToolDrawingSize"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolPick ,std::unique_ptr<IGESGraph_ToolPick>  >>(m.attr("IGESGraph_ToolPick"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolDrawingUnits ,std::unique_ptr<IGESGraph_ToolDrawingUnits>  >>(m.attr("IGESGraph_ToolDrawingUnits"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolHighLight ,std::unique_ptr<IGESGraph_ToolHighLight>  >>(m.attr("IGESGraph_ToolHighLight"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_HArray1OfTextDisplayTemplate ,std::unique_ptr<IGESGraph_HArray1OfTextDisplayTemplate>  >>(m.attr("IGESGraph_HArray1OfTextDisplayTemplate"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<IGESGraph_HArray1OfTextFontDef ,std::unique_ptr<IGESGraph_HArray1OfTextFontDef>  >>(m.attr("IGESGraph_HArray1OfTextFontDef"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<IGESGraph_Color ,opencascade::handle<IGESGraph_Color>  , IGESData_ColorEntity >>(m.attr("IGESGraph_Color"))
        ...
        .def("RGBIntensity",
             (void (IGESGraph_Color::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGraph_Color::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGraph_Color::RGBIntensity),
             R"#(None)#"  , py::arg("Red"),  py::arg("Green"),  py::arg("Blue"))
        .def("CMYIntensity",
             (void (IGESGraph_Color::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGraph_Color::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGraph_Color::CMYIntensity),
             R"#(None)#"  , py::arg("Cyan"),  py::arg("Magenta"),  py::arg("Yellow"))
        .def("HLSPercentage",
             (void (IGESGraph_Color::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGraph_Color::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGraph_Color::HLSPercentage),
             R"#(None)#"  , py::arg("Hue"),  py::arg("Lightness"),  py::arg("Saturation"))
        .def("HasColorName",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolColor ,std::unique_ptr<IGESGraph_ToolColor>  >>(m.attr("IGESGraph_ToolColor"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolDefinitionLevel ,std::unique_ptr<IGESGraph_ToolDefinitionLevel>  >>(m.attr("IGESGraph_ToolDefinitionLevel"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_ToolTextDisplayTemplate ,std::unique_ptr<IGESGraph_ToolTextDisplayTemplate>  >>(m.attr("IGESGraph_ToolTextDisplayTemplate"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGraph_TextFontDef ,opencascade::handle<IGESGraph_TextFontDef>  , IGESData_IGESEntity >>(m.attr("IGESGraph_TextFontDef"))
        ...
        .def("NextCharOrigin",
             (void (IGESGraph_TextFontDef::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (IGESGraph_TextFontDef::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const>(&IGESGraph_TextFontDef::NextCharOrigin),
             R"#(returns grid location of origin of character next to Chnum'th char. Exception OutOfRange is raised if Chnum <= 0 or Chnum > NbCharacters)#"  , py::arg("Chnum"),  py::arg("NX"),  py::arg("NY"))
        .def("NbPenMotions",
        ...
        .def("NextPenPosition",
             (void (IGESGraph_TextFontDef::*)( const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (IGESGraph_TextFontDef::*)( const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) const>(&IGESGraph_TextFontDef::NextPenPosition),
             R"#(None)#"  , py::arg("Chnum"),  py::arg("Motionnum"),  py::arg("IX"),  py::arg("IY"))
        .def("DynamicType",
