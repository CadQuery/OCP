...
// classes
    ...
    register_default_constructor<LProp3d_SurfaceTool ,std::unique_ptr<LProp3d_SurfaceTool>>(m,"LProp3d_SurfaceTool");

    static_cast<py::class_<LProp3d_SurfaceTool ,std::unique_ptr<LProp3d_SurfaceTool>  >>(m.attr("LProp3d_SurfaceTool"))
        .def_static("Value_s",
        ...
        .def_static("Bounds_s",
                    (void (*)( const opencascade::handle<Adaptor3d_HSurface> & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const opencascade::handle<Adaptor3d_HSurface> & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&LProp3d_SurfaceTool::Bounds),
                    R"#(returns the bounds of the HSurface.)#"  , py::arg("S"),  py::arg("U1"),  py::arg("V1"),  py::arg("U2"),  py::arg("V2"))
;

    register_default_constructor<LProp3d_CurveTool ,std::unique_ptr<LProp3d_CurveTool>>(m,"LProp3d_CurveTool");

    static_cast<py::class_<LProp3d_CurveTool ,std::unique_ptr<LProp3d_CurveTool>  >>(m.attr("LProp3d_CurveTool"))
        .def_static("Value_s",
...
;
    ...
    static_cast<py::class_<LProp3d_SLProps ,std::unique_ptr<LProp3d_SLProps>  >>(m.attr("LProp3d_SLProps"))
...
;
    ...
    static_cast<py::class_<LProp3d_CLProps ,std::unique_ptr<LProp3d_CLProps>  >>(m.attr("LProp3d_CLProps"))
