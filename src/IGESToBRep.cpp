...
// classes
    ...
    static_cast<py::class_<IGESToBRep_CurveAndSurface ,std::unique_ptr<IGESToBRep_CurveAndSurface>  >>(m.attr("IGESToBRep_CurveAndSurface"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IGESToBRep_BasicSurface ,std::unique_ptr<IGESToBRep_BasicSurface>  , IGESToBRep_CurveAndSurface >>(m.attr("IGESToBRep_BasicSurface"))
        .def(py::init<  >()  )
        .def(py::init< const IGESToBRep_CurveAndSurface & >()  , py::arg("CS") )
        .def(py::init< const Standard_Real,const Standard_Real,const Standard_Real,const Standard_Boolean,const Standard_Boolean,const Standard_Boolean >()  , py::arg("eps"),  py::arg("epsGeom"),  py::arg("epsCoeff"),  py::arg("mode"),  py::arg("modeapprox"),  py::arg("optimized") )
...
;
    ...
    static_cast<py::class_<IGESToBRep_TopoSurface ,std::unique_ptr<IGESToBRep_TopoSurface>  , IGESToBRep_CurveAndSurface >>(m.attr("IGESToBRep_TopoSurface"))
        .def(py::init<  >()  )
        .def(py::init< const IGESToBRep_CurveAndSurface & >()  , py::arg("CS") )
        .def(py::init< const Standard_Real,const Standard_Real,const Standard_Real,const Standard_Boolean,const Standard_Boolean,const Standard_Boolean >()  , py::arg("eps"),  py::arg("epsGeom"),  py::arg("epsCoeff"),  py::arg("mode"),  py::arg("modeapprox"),  py::arg("optimized") )
...
;
    ...
    static_cast<py::class_<IGESToBRep_TopoCurve ,std::unique_ptr<IGESToBRep_TopoCurve>  , IGESToBRep_CurveAndSurface >>(m.attr("IGESToBRep_TopoCurve"))
        .def(py::init<  >()  )
        .def(py::init< const IGESToBRep_CurveAndSurface & >()  , py::arg("CS") )
...
;
    ...
    static_cast<py::class_<IGESToBRep_BasicCurve ,std::unique_ptr<IGESToBRep_BasicCurve>  , IGESToBRep_CurveAndSurface >>(m.attr("IGESToBRep_BasicCurve"))
        .def(py::init<  >()  )
        .def(py::init< const IGESToBRep_CurveAndSurface & >()  , py::arg("CS") )
        .def(py::init< const Standard_Real,const Standard_Real,const Standard_Real,const Standard_Boolean,const Standard_Boolean,const Standard_Boolean >()  , py::arg("eps"),  py::arg("epsGeom"),  py::arg("epsCoeff"),  py::arg("mode"),  py::arg("modeapprox"),  py::arg("optimized") )
...
;
    ...
    static_cast<py::class_<IGESToBRep_BRepEntity ,std::unique_ptr<IGESToBRep_BRepEntity>  , IGESToBRep_CurveAndSurface >>(m.attr("IGESToBRep_BRepEntity"))
        .def(py::init<  >()  )
        .def(py::init< const IGESToBRep_CurveAndSurface & >()  , py::arg("CS") )
        .def(py::init< const Standard_Real,const Standard_Real,const Standard_Real,const Standard_Boolean,const Standard_Boolean,const Standard_Boolean >()  , py::arg("eps"),  py::arg("epsGeom"),  py::arg("epsCoeff"),  py::arg("mode"),  py::arg("modeapprox"),  py::arg("optimized") )
...
;
    ...
    register_default_constructor<IGESToBRep ,std::unique_ptr<IGESToBRep>>(m,"IGESToBRep");

    static_cast<py::class_<IGESToBRep ,std::unique_ptr<IGESToBRep>  >>(m.attr("IGESToBRep"))
        .def_static("Init_s",
...
;
    ...
    static_cast<py::class_<IGESToBRep_Reader ,std::unique_ptr<IGESToBRep_Reader>  >>(m.attr("IGESToBRep_Reader"))
        .def(py::init<  >()  )
        .def("LoadFile",
