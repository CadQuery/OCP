...
// classes
    ...
    static_cast<py::class_<IGESBasic_ToolOrderedGroupWithoutBackP ,std::unique_ptr<IGESBasic_ToolOrderedGroupWithoutBackP>  >>(m.attr("IGESBasic_ToolOrderedGroupWithoutBackP"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolExternalRefFileName ,std::unique_ptr<IGESBasic_ToolExternalRefFileName>  >>(m.attr("IGESBasic_ToolExternalRefFileName"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolGroup ,std::unique_ptr<IGESBasic_ToolGroup>  >>(m.attr("IGESBasic_ToolGroup"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_HArray2OfHArray1OfReal ,std::unique_ptr<IGESBasic_HArray2OfHArray1OfReal>  >>(m.attr("IGESBasic_HArray2OfHArray1OfReal"))
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolSingularSubfigure ,std::unique_ptr<IGESBasic_ToolSingularSubfigure>  >>(m.attr("IGESBasic_ToolSingularSubfigure"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_HArray1OfLineFontEntity ,std::unique_ptr<IGESBasic_HArray1OfLineFontEntity>  >>(m.attr("IGESBasic_HArray1OfLineFontEntity"))
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolGroupWithoutBackP ,std::unique_ptr<IGESBasic_ToolGroupWithoutBackP>  >>(m.attr("IGESBasic_ToolGroupWithoutBackP"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolHierarchy ,std::unique_ptr<IGESBasic_ToolHierarchy>  >>(m.attr("IGESBasic_ToolHierarchy"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolOrderedGroup ,std::unique_ptr<IGESBasic_ToolOrderedGroup>  >>(m.attr("IGESBasic_ToolOrderedGroup"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolAssocGroupType ,std::unique_ptr<IGESBasic_ToolAssocGroupType>  >>(m.attr("IGESBasic_ToolAssocGroupType"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolSubfigureDef ,std::unique_ptr<IGESBasic_ToolSubfigureDef>  >>(m.attr("IGESBasic_ToolSubfigureDef"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolExternalReferenceFile ,std::unique_ptr<IGESBasic_ToolExternalReferenceFile>  >>(m.attr("IGESBasic_ToolExternalReferenceFile"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    register_default_constructor<IGESBasic ,std::unique_ptr<IGESBasic>>(m,"IGESBasic");

    static_cast<py::class_<IGESBasic ,std::unique_ptr<IGESBasic>  >>(m.attr("IGESBasic"))
        .def_static("Init_s",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolName ,std::unique_ptr<IGESBasic_ToolName>  >>(m.attr("IGESBasic_ToolName"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolSingleParent ,std::unique_ptr<IGESBasic_ToolSingleParent>  >>(m.attr("IGESBasic_ToolSingleParent"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolExternalRefFile ,std::unique_ptr<IGESBasic_ToolExternalRefFile>  >>(m.attr("IGESBasic_ToolExternalRefFile"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolExternalRefName ,std::unique_ptr<IGESBasic_ToolExternalRefName>  >>(m.attr("IGESBasic_ToolExternalRefName"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolExternalRefFileIndex ,std::unique_ptr<IGESBasic_ToolExternalRefFileIndex>  >>(m.attr("IGESBasic_ToolExternalRefFileIndex"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESBasic_ToolExternalRefLibName ,std::unique_ptr<IGESBasic_ToolExternalRefLibName>  >>(m.attr("IGESBasic_ToolExternalRefLibName"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
