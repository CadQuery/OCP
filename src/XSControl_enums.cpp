...
// classes forward declarations only
    ...
    py::class_<XSControl_Utils ,std::unique_ptr<XSControl_Utils>  >(m,"XSControl_Utils",R"#(This class provides various useful utility routines, to facilitate handling of most common data structures : transients (type, type name ...), strings (ascii or extended, pointed or handled or ...), shapes (reading, writing, testing ...), sequences & arrays (of strings, of transients, of shapes ...), ...)#");
    py::class_<XSControl ,std::unique_ptr<XSControl>  >(m,"XSControl",R"#(This package provides complements to IFSelect & Co for control of a session)#");
    py::class_<XSControl_Functions ,std::unique_ptr<XSControl_Functions>  >(m,"XSControl_Functions",R"#(Functions from XSControl gives access to actions which can be commanded with the resources provided by XSControl: especially Controller and Transfer)#");
