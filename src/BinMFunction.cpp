...
;
    ...
    register_default_constructor<BinMFunction ,std::unique_ptr<BinMFunction>>(m,"BinMFunction");

    static_cast<py::class_<BinMFunction ,std::unique_ptr<BinMFunction>  >>(m.attr("BinMFunction"))
