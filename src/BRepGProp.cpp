...
// classes
    ...
    static_cast<py::class_<BRepGProp_TFunction ,std::unique_ptr<BRepGProp_TFunction>  , math_Function >>(m.attr("BRepGProp_TFunction"))
...
;
    ...
    static_cast<py::class_<BRepGProp_Vinert ,std::unique_ptr<BRepGProp_Vinert>  , GProp_GProps >>(m.attr("BRepGProp_Vinert"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepGProp_UFunction ,std::unique_ptr<BRepGProp_UFunction>  , math_Function >>(m.attr("BRepGProp_UFunction"))
...
;
    ...
    static_cast<py::class_<BRepGProp_Sinert ,std::unique_ptr<BRepGProp_Sinert>  , GProp_GProps >>(m.attr("BRepGProp_Sinert"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<BRepGProp_EdgeTool ,std::unique_ptr<BRepGProp_EdgeTool>>(m,"BRepGProp_EdgeTool");

    static_cast<py::class_<BRepGProp_EdgeTool ,std::unique_ptr<BRepGProp_EdgeTool>  >>(m.attr("BRepGProp_EdgeTool"))
...
;
    ...
    static_cast<py::class_<BRepGProp_Domain ,std::unique_ptr<BRepGProp_Domain>  >>(m.attr("BRepGProp_Domain"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepGProp_VinertGK ,std::unique_ptr<BRepGProp_VinertGK>  , GProp_GProps >>(m.attr("BRepGProp_VinertGK"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<BRepGProp ,std::unique_ptr<BRepGProp>>(m,"BRepGProp");

    static_cast<py::class_<BRepGProp ,std::unique_ptr<BRepGProp>  >>(m.attr("BRepGProp"))
...
;
    ...
    static_cast<py::class_<BRepGProp_Face ,std::unique_ptr<BRepGProp_Face>  >>(m.attr("BRepGProp_Face"))
        ...
        .def("Bounds",
             (void (BRepGProp_Face::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (BRepGProp_Face::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&BRepGProp_Face::Bounds),
             R"#(Returns the parametric bounds of the Face.)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Normal",
...
;
    ...
    static_cast<py::class_<BRepGProp_Cinert ,std::unique_ptr<BRepGProp_Cinert>  , GProp_GProps >>(m.attr("BRepGProp_Cinert"))
        .def(py::init<  >()  )
