...
// classes forward declarations only
    ...
    py::class_<IGESGeom_HArray1OfBoundary ,std::unique_ptr<IGESGeom_HArray1OfBoundary>  >(m,"IGESGeom_HArray1OfBoundary",R"#()#");
    ...
    py::class_<IGESGeom_ToolSurfaceOfRevolution ,std::unique_ptr<IGESGeom_ToolSurfaceOfRevolution>  >(m,"IGESGeom_ToolSurfaceOfRevolution",R"#(Tool to work on a SurfaceOfRevolution. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_ToolCircularArc ,std::unique_ptr<IGESGeom_ToolCircularArc>  >(m,"IGESGeom_ToolCircularArc",R"#(Tool to work on a CircularArc. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_ToolCopiousData ,std::unique_ptr<IGESGeom_ToolCopiousData>  >(m,"IGESGeom_ToolCopiousData",R"#(Tool to work on a CopiousData. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolTransformationMatrix ,std::unique_ptr<IGESGeom_ToolTransformationMatrix>  >(m,"IGESGeom_ToolTransformationMatrix",R"#(Tool to work on a TransformationMatrix. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolBSplineCurve ,std::unique_ptr<IGESGeom_ToolBSplineCurve>  >(m,"IGESGeom_ToolBSplineCurve",R"#(Tool to work on a BSplineCurve. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_ToolSplineCurve ,std::unique_ptr<IGESGeom_ToolSplineCurve>  >(m,"IGESGeom_ToolSplineCurve",R"#(Tool to work on a SplineCurve. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolOffsetSurface ,std::unique_ptr<IGESGeom_ToolOffsetSurface>  >(m,"IGESGeom_ToolOffsetSurface",R"#(Tool to work on a OffsetSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolBoundary ,std::unique_ptr<IGESGeom_ToolBoundary>  >(m,"IGESGeom_ToolBoundary",R"#(Tool to work on a Boundary. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_ToolBoundedSurface ,std::unique_ptr<IGESGeom_ToolBoundedSurface>  >(m,"IGESGeom_ToolBoundedSurface",R"#(Tool to work on a BoundedSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_ToolDirection ,std::unique_ptr<IGESGeom_ToolDirection>  >(m,"IGESGeom_ToolDirection",R"#(Tool to work on a Direction. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_ToolPlane ,std::unique_ptr<IGESGeom_ToolPlane>  >(m,"IGESGeom_ToolPlane",R"#(Tool to work on a Plane. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolTrimmedSurface ,std::unique_ptr<IGESGeom_ToolTrimmedSurface>  >(m,"IGESGeom_ToolTrimmedSurface",R"#(Tool to work on a TrimmedSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_HArray1OfTransformationMatrix ,std::unique_ptr<IGESGeom_HArray1OfTransformationMatrix>  >(m,"IGESGeom_HArray1OfTransformationMatrix",R"#()#");
    py::class_<IGESGeom_ToolPoint ,std::unique_ptr<IGESGeom_ToolPoint>  >(m,"IGESGeom_ToolPoint",R"#(Tool to work on a Point. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_HArray1OfCurveOnSurface ,std::unique_ptr<IGESGeom_HArray1OfCurveOnSurface>  >(m,"IGESGeom_HArray1OfCurveOnSurface",R"#()#");
    py::class_<IGESGeom_ToolRuledSurface ,std::unique_ptr<IGESGeom_ToolRuledSurface>  >(m,"IGESGeom_ToolRuledSurface",R"#(Tool to work on a RuledSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_ToolConicArc ,std::unique_ptr<IGESGeom_ToolConicArc>  >(m,"IGESGeom_ToolConicArc",R"#(Tool to work on a ConicArc. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolLine ,std::unique_ptr<IGESGeom_ToolLine>  >(m,"IGESGeom_ToolLine",R"#(Tool to work on a Line. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom ,std::unique_ptr<IGESGeom>  >(m,"IGESGeom",R"#(This package consists of B-Rep and CSG Solid entities)#");
    ...
    py::class_<IGESGeom_ToolSplineSurface ,std::unique_ptr<IGESGeom_ToolSplineSurface>  >(m,"IGESGeom_ToolSplineSurface",R"#(Tool to work on a SplineSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_ToolCurveOnSurface ,std::unique_ptr<IGESGeom_ToolCurveOnSurface>  >(m,"IGESGeom_ToolCurveOnSurface",R"#(Tool to work on a CurveOnSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolOffsetCurve ,std::unique_ptr<IGESGeom_ToolOffsetCurve>  >(m,"IGESGeom_ToolOffsetCurve",R"#(Tool to work on a OffsetCurve. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolBSplineSurface ,std::unique_ptr<IGESGeom_ToolBSplineSurface>  >(m,"IGESGeom_ToolBSplineSurface",R"#(Tool to work on a BSplineSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGeom_ToolCompositeCurve ,std::unique_ptr<IGESGeom_ToolCompositeCurve>  >(m,"IGESGeom_ToolCompositeCurve",R"#(Tool to work on a CompositeCurve. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolTabulatedCylinder ,std::unique_ptr<IGESGeom_ToolTabulatedCylinder>  >(m,"IGESGeom_ToolTabulatedCylinder",R"#(Tool to work on a TabulatedCylinder. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGeom_ToolFlash ,std::unique_ptr<IGESGeom_ToolFlash>  >(m,"IGESGeom_ToolFlash",R"#(Tool to work on a Flash. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
