...
// classes forward declarations only
    py::class_<Units_Sentence ,std::unique_ptr<Units_Sentence>  >(m,"Units_Sentence",R"#(This class describes all the methods to create and compute an expression contained in a string.)#");
    py::class_<Units ,std::unique_ptr<Units>  >(m,"Units",R"#(This package provides all the facilities to create and question a dictionary of units, and also to manipulate measurements which are real values with units.)#");
    ...
    py::class_<Units_MathSentence ,std::unique_ptr<Units_MathSentence>  , Units_Sentence >(m,"Units_MathSentence",R"#(This class defines all the methods to create and compute an algebraic formula.)#");
    py::class_<Units_Explorer ,std::unique_ptr<Units_Explorer>  >(m,"Units_Explorer",R"#(This class provides all the services to explore UnitsSystem or UnitsDictionary.)#");
    py::class_<Units_TokensSequence ,std::unique_ptr<Units_TokensSequence>  >(m,"Units_TokensSequence",R"#()#");
    py::class_<Units_Measurement ,std::unique_ptr<Units_Measurement>  >(m,"Units_Measurement",R"#(This class defines a measurement which is the association of a real value and a unit.)#");
    py::class_<Units_QuantitiesSequence ,std::unique_ptr<Units_QuantitiesSequence>  >(m,"Units_QuantitiesSequence",R"#()#");
    py::class_<Units_UnitSentence ,std::unique_ptr<Units_UnitSentence>  , Units_Sentence >(m,"Units_UnitSentence",R"#(This class describes all the facilities to manipulate and compute units contained in a string expression.)#");
    ...
    py::class_<Units_UnitsSequence ,std::unique_ptr<Units_UnitsSequence>  >(m,"Units_UnitsSequence",R"#()#");
