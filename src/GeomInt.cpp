...
// classes
    ...
    static_cast<py::class_<GeomInt_MyGradientOfTheComputeLineBezierOfWLApprox ,std::unique_ptr<GeomInt_MyGradientOfTheComputeLineBezierOfWLApprox>  >>(m.attr("GeomInt_MyGradientOfTheComputeLineBezierOfWLApprox"))
...
;
    ...
    register_default_constructor<GeomInt_TheMultiLineToolOfWLApprox ,std::unique_ptr<GeomInt_TheMultiLineToolOfWLApprox>>(m,"GeomInt_TheMultiLineToolOfWLApprox");

    static_cast<py::class_<GeomInt_TheMultiLineToolOfWLApprox ,std::unique_ptr<GeomInt_TheMultiLineToolOfWLApprox>  >>(m.attr("GeomInt_TheMultiLineToolOfWLApprox"))
...
;
    ...
    static_cast<py::class_<GeomInt_LineConstructor ,std::unique_ptr<GeomInt_LineConstructor>  >>(m.attr("GeomInt_LineConstructor"))
        .def(py::init<  >()  )
        .def("Load",
        ...
        .def("Part",
             (void (GeomInt_LineConstructor::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomInt_LineConstructor::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomInt_LineConstructor::Part),
             R"#(Return first and last parameters for given index of split)#"  , py::arg("I"),  py::arg("WFirst"),  py::arg("WLast"))
        .def("Load",
             (void (GeomInt_LineConstructor::*)( const opencascade::handle<Adaptor3d_TopolTool> & ,  const opencascade::handle<Adaptor3d_TopolTool> & ,  const opencascade::handle<GeomAdaptor_HSurface> & ,  const opencascade::handle<GeomAdaptor_HSurface> &  ) ) static_cast<void (GeomInt_LineConstructor::*)( const opencascade::handle<Adaptor3d_TopolTool> & ,  const opencascade::handle<Adaptor3d_TopolTool> & ,  const opencascade::handle<GeomAdaptor_HSurface> & ,  const opencascade::handle<GeomAdaptor_HSurface> &  ) >(&GeomInt_LineConstructor::Load),
             R"#(Initializes me by two surfaces and corresponding tools which represent boundaries of surfaces)#"  , py::arg("D1"),  py::arg("D2"),  py::arg("S1"),  py::arg("S2"))
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<GeomInt_Gradient_BFGSOfMyGradientbisOfTheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_Gradient_BFGSOfMyGradientbisOfTheComputeLineOfWLApprox>  , math_BFGS >>(m.attr("GeomInt_Gradient_BFGSOfMyGradientbisOfTheComputeLineOfWLApprox"))
...
;
    ...
    static_cast<py::class_<GeomInt_BSpGradient_BFGSOfMyBSplGradientOfTheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_BSpGradient_BFGSOfMyBSplGradientOfTheComputeLineOfWLApprox>  , math_BFGS >>(m.attr("GeomInt_BSpGradient_BFGSOfMyBSplGradientOfTheComputeLineOfWLApprox"))
        .def(py::init< math_MultipleVarFunctionWithGradient &,const math_Vector &,const Standard_Real,const Standard_Real,const Standard_Real,const Standard_Integer >()  , py::arg("F"),  py::arg("StartingPoint"),  py::arg("Tolerance3d"),  py::arg("Tolerance2d"),  py::arg("Eps"),  py::arg("NbIterations")=static_cast<const Standard_Integer>(200) )
        .def("IsSolutionReached",
...
;
    ...
    static_cast<py::class_<GeomInt_TheMultiLineOfWLApprox ,std::unique_ptr<GeomInt_TheMultiLineOfWLApprox>  >>(m.attr("GeomInt_TheMultiLineOfWLApprox"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomInt_ParameterAndOrientation ,std::unique_ptr<GeomInt_ParameterAndOrientation>  >>(m.attr("GeomInt_ParameterAndOrientation"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomInt_ResConstraintOfMyGradientbisOfTheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_ResConstraintOfMyGradientbisOfTheComputeLineOfWLApprox>  >>(m.attr("GeomInt_ResConstraintOfMyGradientbisOfTheComputeLineOfWLApprox"))
...
;
    ...
    static_cast<py::class_<GeomInt_ThePrmPrmSvSurfacesOfWLApprox ,std::unique_ptr<GeomInt_ThePrmPrmSvSurfacesOfWLApprox>  >>(m.attr("GeomInt_ThePrmPrmSvSurfacesOfWLApprox"))
...
;
    ...
    static_cast<py::class_<GeomInt_TheZerImpFuncOfTheImpPrmSvSurfacesOfWLApprox ,std::unique_ptr<GeomInt_TheZerImpFuncOfTheImpPrmSvSurfacesOfWLApprox>  , math_FunctionSetWithDerivatives >>(m.attr("GeomInt_TheZerImpFuncOfTheImpPrmSvSurfacesOfWLApprox"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomInt_MyBSplGradientOfTheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_MyBSplGradientOfTheComputeLineOfWLApprox>  >>(m.attr("GeomInt_MyBSplGradientOfTheComputeLineOfWLApprox"))
...
;
    ...
    static_cast<py::class_<GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox>  >>(m.attr("GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox"))
        ...
        .def("ErrorGradient",
             (void (GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox::*)( math_Vector & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox::*)( math_Vector & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox::ErrorGradient),
        ...
        .def("Error",
             (void (GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&GeomInt_BSpParLeastSquareOfMyBSplGradientOfTheComputeLineOfWLApprox::Error),
...
;
    ...
    static_cast<py::class_<GeomInt_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfWLApprox ,std::unique_ptr<GeomInt_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfWLApprox>  >>(m.attr("GeomInt_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfWLApprox"))
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &,const Standard_Integer,const Standard_Integer,const AppParCurves_Constraint,const AppParCurves_Constraint,const math_Vector &,const Standard_Integer >()  , py::arg("SSP"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("FirstCons"),  py::arg("LastCons"),  py::arg("Parameters"),  py::arg("NbPol") )
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &,const Standard_Integer,const Standard_Integer,const AppParCurves_Constraint,const AppParCurves_Constraint,const Standard_Integer >()  , py::arg("SSP"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("FirstCons"),  py::arg("LastCons"),  py::arg("NbPol") )
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Integer> &,const Standard_Integer,const Standard_Integer,const AppParCurves_Constraint,const AppParCurves_Constraint,const math_Vector &,const Standard_Integer >()  , py::arg("SSP"),  py::arg("Knots"),  py::arg("Mults"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("FirstCons"),  py::arg("LastCons"),  py::arg("Parameters"),  py::arg("NbPol") )
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Integer> &,const Standard_Integer,const Standard_Integer,const AppParCurves_Constraint,const AppParCurves_Constraint,const Standard_Integer >()  , py::arg("SSP"),  py::arg("Knots"),  py::arg("Mults"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("FirstCons"),  py::arg("LastCons"),  py::arg("NbPol") )
        ...
        .def("DerivativeFunctionMatrix",
             ...
             R"#(returns the derivative function matrix used to approximate the set.)#" )
        .def("ErrorGradient",
             (void (GeomInt_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfWLApprox::*)( math_Vector & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (GeomInt_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfWLApprox::*)( math_Vector & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&GeomInt_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfWLApprox::ErrorGradient),
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances. Grad is the derivative vector of the function F.)#"  , py::arg("Grad"),  py::arg("F"),  py::arg("MaxE3d"),  py::arg("MaxE2d"))
        .def("Distance",
             ...
             R"#(returns the distances between the points of the multiline and the approximation curves.)#" )
        .def("Error",
             (void (GeomInt_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfWLApprox::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (GeomInt_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfWLApprox::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&GeomInt_ParLeastSquareOfMyGradientOfTheComputeLineBezierOfWLApprox::Error),
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances.)#"  , py::arg("F"),  py::arg("MaxE3d"),  py::arg("MaxE2d"))
        .def("FirstLambda",
...
;
    ...
    static_cast<py::class_<GeomInt_TheComputeLineBezierOfWLApprox ,std::unique_ptr<GeomInt_TheComputeLineBezierOfWLApprox>  >>(m.attr("GeomInt_TheComputeLineBezierOfWLApprox"))
        ...
        .def("Error",
             (void (GeomInt_TheComputeLineBezierOfWLApprox::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomInt_TheComputeLineBezierOfWLApprox::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomInt_TheComputeLineBezierOfWLApprox::Error),
...
;
    ...
    static_cast<py::class_<GeomInt_TheImpPrmSvSurfacesOfWLApprox ,std::unique_ptr<GeomInt_TheImpPrmSvSurfacesOfWLApprox>  >>(m.attr("GeomInt_TheImpPrmSvSurfacesOfWLApprox"))
        ...
        .def("FillInitialVectorOfSolution",
             (Standard_Boolean (GeomInt_TheImpPrmSvSurfacesOfWLApprox::*)( const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  math_Vector & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<Standard_Boolean (GeomInt_TheImpPrmSvSurfacesOfWLApprox::*)( const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  math_Vector & ,  Standard_Real & ,  Standard_Real &  ) >(&GeomInt_TheImpPrmSvSurfacesOfWLApprox::FillInitialVectorOfSolution),
...
;
    ...
    static_cast<py::class_<GeomInt_TheFunctionOfTheInt2SOfThePrmPrmSvSurfacesOfWLApprox ,std::unique_ptr<GeomInt_TheFunctionOfTheInt2SOfThePrmPrmSvSurfacesOfWLApprox>  , math_FunctionSetWithDerivatives >>(m.attr("GeomInt_TheFunctionOfTheInt2SOfThePrmPrmSvSurfacesOfWLApprox"))
...
;
    ...
    register_default_constructor<GeomInt ,std::unique_ptr<GeomInt>>(m,"GeomInt");

    static_cast<py::class_<GeomInt ,std::unique_ptr<GeomInt>  >>(m.attr("GeomInt"))
...
;
    ...
    static_cast<py::class_<GeomInt_WLApprox ,std::unique_ptr<GeomInt_WLApprox>  >>(m.attr("GeomInt_WLApprox"))
        .def(py::init<  >()  )
        .def("Perform",
...
;
    ...
    register_default_constructor<GeomInt_LineTool ,std::unique_ptr<GeomInt_LineTool>>(m,"GeomInt_LineTool");

    static_cast<py::class_<GeomInt_LineTool ,std::unique_ptr<GeomInt_LineTool>  >>(m.attr("GeomInt_LineTool"))
...
;
    ...
    static_cast<py::class_<GeomInt_IntSS ,std::unique_ptr<GeomInt_IntSS>  >>(m.attr("GeomInt_IntSS"))
        .def(py::init<  >()  )
        ...
        .def_static("TreatRLine_s",
                    (void (*)( const opencascade::handle<IntPatch_RLine> & ,  const opencascade::handle<GeomAdaptor_HSurface> & ,  const opencascade::handle<GeomAdaptor_HSurface> & ,  opencascade::handle<Geom_Curve> & ,  opencascade::handle<Geom2d_Curve> & ,  opencascade::handle<Geom2d_Curve> & ,  Standard_Real &  ) ) static_cast<void (*)( const opencascade::handle<IntPatch_RLine> & ,  const opencascade::handle<GeomAdaptor_HSurface> & ,  const opencascade::handle<GeomAdaptor_HSurface> & ,  opencascade::handle<Geom_Curve> & ,  opencascade::handle<Geom2d_Curve> & ,  opencascade::handle<Geom2d_Curve> & ,  Standard_Real &  ) >(&GeomInt_IntSS::TreatRLine),
                    R"#(converts RLine to Geom(2d)_Curve.)#"  , py::arg("theRL"),  py::arg("theHS1"),  py::arg("theHS2"),  py::arg("theC3d"),  py::arg("theC2d1"),  py::arg("theC2d2"),  py::arg("theTolReached"))
        .def_static("BuildPCurves_s",
                    (void (*)( const Standard_Real ,  const Standard_Real ,  Standard_Real & ,  const opencascade::handle<Geom_Surface> & ,  const opencascade::handle<Geom_Curve> & ,  opencascade::handle<Geom2d_Curve> &  ) ) static_cast<void (*)( const Standard_Real ,  const Standard_Real ,  Standard_Real & ,  const opencascade::handle<Geom_Surface> & ,  const opencascade::handle<Geom_Curve> & ,  opencascade::handle<Geom2d_Curve> &  ) >(&GeomInt_IntSS::BuildPCurves),
                    R"#(creates 2D-curve on given surface from given 3D-curve)#"  , py::arg("f"),  py::arg("l"),  py::arg("Tol"),  py::arg("S"),  py::arg("C"),  py::arg("C2d"))
...
;
    ...
    static_cast<py::class_<GeomInt_TheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_TheComputeLineOfWLApprox>  >>(m.attr("GeomInt_TheComputeLineOfWLApprox"))
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &,const Standard_Integer,const Standard_Integer,const Standard_Real,const Standard_Real,const Standard_Integer,const Standard_Boolean,const Approx_ParametrizationType,const Standard_Boolean >()  , py::arg("Line"),  py::arg("degreemin")=static_cast<const Standard_Integer>(4),  py::arg("degreemax")=static_cast<const Standard_Integer>(8),  py::arg("Tolerance3d")=static_cast<const Standard_Real>(1.0e-3),  py::arg("Tolerance2d")=static_cast<const Standard_Real>(1.0e-6),  py::arg("NbIterations")=static_cast<const Standard_Integer>(5),  py::arg("cutting")=static_cast<const Standard_Boolean>(Standard_True),  py::arg("parametrization")=static_cast<const Approx_ParametrizationType>(Approx_ChordLength),  py::arg("Squares")=static_cast<const Standard_Boolean>(Standard_False) )
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &,const math_Vector &,const Standard_Integer,const Standard_Integer,const Standard_Real,const Standard_Real,const Standard_Integer,const Standard_Boolean,const Standard_Boolean >()  , py::arg("Line"),  py::arg("Parameters"),  py::arg("degreemin")=static_cast<const Standard_Integer>(4),  py::arg("degreemax")=static_cast<const Standard_Integer>(8),  py::arg("Tolerance3d")=static_cast<const Standard_Real>(1.0e-03),  py::arg("Tolerance2d")=static_cast<const Standard_Real>(1.0e-06),  py::arg("NbIterations")=static_cast<const Standard_Integer>(5),  py::arg("cutting")=static_cast<const Standard_Boolean>(Standard_True),  py::arg("Squares")=static_cast<const Standard_Boolean>(Standard_False) )
        .def(py::init< const math_Vector &,const Standard_Integer,const Standard_Integer,const Standard_Real,const Standard_Real,const Standard_Integer,const Standard_Boolean,const Standard_Boolean >()  , py::arg("Parameters"),  py::arg("degreemin")=static_cast<const Standard_Integer>(4),  py::arg("degreemax")=static_cast<const Standard_Integer>(8),  py::arg("Tolerance3d")=static_cast<const Standard_Real>(1.0e-03),  py::arg("Tolerance2d")=static_cast<const Standard_Real>(1.0e-06),  py::arg("NbIterations")=static_cast<const Standard_Integer>(5),  py::arg("cutting")=static_cast<const Standard_Boolean>(Standard_True),  py::arg("Squares")=static_cast<const Standard_Boolean>(Standard_False) )
        .def(py::init< const Standard_Integer,const Standard_Integer,const Standard_Real,const Standard_Real,const Standard_Integer,const Standard_Boolean,const Approx_ParametrizationType,const Standard_Boolean >()  , py::arg("degreemin")=static_cast<const Standard_Integer>(4),  py::arg("degreemax")=static_cast<const Standard_Integer>(8),  py::arg("Tolerance3d")=static_cast<const Standard_Real>(1.0e-03),  py::arg("Tolerance2d")=static_cast<const Standard_Real>(1.0e-06),  py::arg("NbIterations")=static_cast<const Standard_Integer>(5),  py::arg("cutting")=static_cast<const Standard_Boolean>(Standard_True),  py::arg("parametrization")=static_cast<const Approx_ParametrizationType>(Approx_ChordLength),  py::arg("Squares")=static_cast<const Standard_Boolean>(Standard_False) )
        ...
        .def("IsToleranceReached",
             ...
             R"#(returns False if the status NoPointsAdded has been sent.)#" )
        .def("Error",
             (void (GeomInt_TheComputeLineOfWLApprox::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomInt_TheComputeLineOfWLApprox::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomInt_TheComputeLineOfWLApprox::Error),
...
;
    ...
    static_cast<py::class_<GeomInt_BSpParFunctionOfMyBSplGradientOfTheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_BSpParFunctionOfMyBSplGradientOfTheComputeLineOfWLApprox>  , math_MultipleVarFunctionWithGradient >>(m.attr("GeomInt_BSpParFunctionOfMyBSplGradientOfTheComputeLineOfWLApprox"))
...
;
    ...
    static_cast<py::class_<GeomInt_ParFunctionOfMyGradientbisOfTheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_ParFunctionOfMyGradientbisOfTheComputeLineOfWLApprox>  , math_MultipleVarFunctionWithGradient >>(m.attr("GeomInt_ParFunctionOfMyGradientbisOfTheComputeLineOfWLApprox"))
...
;
    ...
    static_cast<py::class_<GeomInt_TheInt2SOfThePrmPrmSvSurfacesOfWLApprox ,std::unique_ptr<GeomInt_TheInt2SOfThePrmPrmSvSurfacesOfWLApprox>  >>(m.attr("GeomInt_TheInt2SOfThePrmPrmSvSurfacesOfWLApprox"))
...
;
    ...
    static_cast<py::class_<GeomInt_ParFunctionOfMyGradientOfTheComputeLineBezierOfWLApprox ,std::unique_ptr<GeomInt_ParFunctionOfMyGradientOfTheComputeLineBezierOfWLApprox>  , math_MultipleVarFunctionWithGradient >>(m.attr("GeomInt_ParFunctionOfMyGradientOfTheComputeLineBezierOfWLApprox"))
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &,const Standard_Integer,const Standard_Integer,const opencascade::handle<AppParCurves_HArray1OfConstraintCouple> &,const math_Vector &,const Standard_Integer >()  , py::arg("SSP"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("TheConstraints"),  py::arg("Parameters"),  py::arg("Deg") )
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<GeomInt_Gradient_BFGSOfMyGradientOfTheComputeLineBezierOfWLApprox ,std::unique_ptr<GeomInt_Gradient_BFGSOfMyGradientOfTheComputeLineBezierOfWLApprox>  , math_BFGS >>(m.attr("GeomInt_Gradient_BFGSOfMyGradientOfTheComputeLineBezierOfWLApprox"))
        .def(py::init< math_MultipleVarFunctionWithGradient &,const math_Vector &,const Standard_Real,const Standard_Real,const Standard_Real,const Standard_Integer >()  , py::arg("F"),  py::arg("StartingPoint"),  py::arg("Tolerance3d"),  py::arg("Tolerance2d"),  py::arg("Eps"),  py::arg("NbIterations")=static_cast<const Standard_Integer>(200) )
        .def("IsSolutionReached",
...
;
    ...
    static_cast<py::class_<GeomInt_MyGradientbisOfTheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_MyGradientbisOfTheComputeLineOfWLApprox>  >>(m.attr("GeomInt_MyGradientbisOfTheComputeLineOfWLApprox"))
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &,const Standard_Integer,const Standard_Integer,const opencascade::handle<AppParCurves_HArray1OfConstraintCouple> &,math_Vector &,const Standard_Integer,const Standard_Real,const Standard_Real,const Standard_Integer >()  , py::arg("SSP"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("TheConstraints"),  py::arg("Parameters"),  py::arg("Deg"),  py::arg("Tol3d"),  py::arg("Tol2d"),  py::arg("NbIterations")=static_cast<const Standard_Integer>(200) )
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<GeomInt_ResConstraintOfMyGradientOfTheComputeLineBezierOfWLApprox ,std::unique_ptr<GeomInt_ResConstraintOfMyGradientOfTheComputeLineBezierOfWLApprox>  >>(m.attr("GeomInt_ResConstraintOfMyGradientOfTheComputeLineBezierOfWLApprox"))
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &,AppParCurves_MultiCurve &,const Standard_Integer,const Standard_Integer,const opencascade::handle<AppParCurves_HArray1OfConstraintCouple> &,const math_Matrix &,const math_Matrix &,const Standard_Real >()  , py::arg("SSP"),  py::arg("SCurv"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("Constraints"),  py::arg("Bern"),  py::arg("DerivativeBern"),  py::arg("Tolerance")=static_cast<const Standard_Real>(1.0e-10) )
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox ,std::unique_ptr<GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox>  >>(m.attr("GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox"))
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &,const Standard_Integer,const Standard_Integer,const AppParCurves_Constraint,const AppParCurves_Constraint,const math_Vector &,const Standard_Integer >()  , py::arg("SSP"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("FirstCons"),  py::arg("LastCons"),  py::arg("Parameters"),  py::arg("NbPol") )
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &,const Standard_Integer,const Standard_Integer,const AppParCurves_Constraint,const AppParCurves_Constraint,const Standard_Integer >()  , py::arg("SSP"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("FirstCons"),  py::arg("LastCons"),  py::arg("NbPol") )
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Integer> &,const Standard_Integer,const Standard_Integer,const AppParCurves_Constraint,const AppParCurves_Constraint,const math_Vector &,const Standard_Integer >()  , py::arg("SSP"),  py::arg("Knots"),  py::arg("Mults"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("FirstCons"),  py::arg("LastCons"),  py::arg("Parameters"),  py::arg("NbPol") )
        .def(py::init< const GeomInt_TheMultiLineOfWLApprox &, const NCollection_Array1<Standard_Real> &, const NCollection_Array1<Standard_Integer> &,const Standard_Integer,const Standard_Integer,const AppParCurves_Constraint,const AppParCurves_Constraint,const Standard_Integer >()  , py::arg("SSP"),  py::arg("Knots"),  py::arg("Mults"),  py::arg("FirstPoint"),  py::arg("LastPoint"),  py::arg("FirstCons"),  py::arg("LastCons"),  py::arg("NbPol") )
        ...
        .def("DerivativeFunctionMatrix",
             ...
             R"#(returns the derivative function matrix used to approximate the set.)#" )
        .def("ErrorGradient",
             (void (GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox::*)( math_Vector & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox::*)( math_Vector & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox::ErrorGradient),
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances. Grad is the derivative vector of the function F.)#"  , py::arg("Grad"),  py::arg("F"),  py::arg("MaxE3d"),  py::arg("MaxE2d"))
        .def("Distance",
             ...
             R"#(returns the distances between the points of the multiline and the approximation curves.)#" )
        .def("Error",
             (void (GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&GeomInt_ParLeastSquareOfMyGradientbisOfTheComputeLineOfWLApprox::Error),
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances.)#"  , py::arg("F"),  py::arg("MaxE3d"),  py::arg("MaxE2d"))
        .def("FirstLambda",
