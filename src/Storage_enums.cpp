...
// classes forward declarations only
    ...
    py::class_<Storage_BucketOfPersistent ,std::unique_ptr<Storage_BucketOfPersistent>  >(m,"Storage_BucketOfPersistent",R"#()#");
    py::class_<Storage_Bucket ,std::unique_ptr<Storage_Bucket>  >(m,"Storage_Bucket",R"#(None)#");
    ...
    py::class_<Storage_HPArray ,std::unique_ptr<Storage_HPArray>  >(m,"Storage_HPArray",R"#()#");
    py::class_<Storage_HeaderData ,opencascade::handle<Storage_HeaderData>  , Standard_Transient >(m,"Storage_HeaderData",R"#()#");
    py::class_<Storage_HArrayOfCallBack ,std::unique_ptr<Storage_HArrayOfCallBack>  >(m,"Storage_HArrayOfCallBack",R"#()#");
    ...
    py::class_<Storage_BucketIterator ,std::unique_ptr<Storage_BucketIterator>  >(m,"Storage_BucketIterator",R"#()#");
    py::class_<Storage_HSeqOfRoot ,std::unique_ptr<Storage_HSeqOfRoot>  >(m,"Storage_HSeqOfRoot",R"#()#");
    ...
    py::class_<Storage_HArrayOfSchema ,std::unique_ptr<Storage_HArrayOfSchema>  >(m,"Storage_HArrayOfSchema",R"#()#");
