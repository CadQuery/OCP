...
;
    ...
    static_cast<py::class_<TCollection_BaseSequence ,std::unique_ptr<TCollection_BaseSequence>  >>(m.attr("TCollection_BaseSequence"))
        .def("IsEmpty",
...
;
    ...
    static_cast<py::class_<TCollection_ExtendedString ,std::unique_ptr<TCollection_ExtendedString>  >>(m.attr("TCollection_ExtendedString"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TCollection_BasicMap ,std::unique_ptr<TCollection_BasicMap>  >>(m.attr("TCollection_BasicMap"))
        .def("NbBuckets",
...
;
    ...
    register_default_constructor<TCollection ,std::unique_ptr<TCollection>>(m,"TCollection");

    static_cast<py::class_<TCollection ,std::unique_ptr<TCollection>  >>(m.attr("TCollection"))
...
;
    ...
    static_cast<py::class_<TCollection_AsciiString ,std::unique_ptr<TCollection_AsciiString>  >>(m.attr("TCollection_AsciiString"))
        .def(py::init<  >()  )
        .def(py::init< const Standard_CString >()  , py::arg("message") )
...
;
    ...
    static_cast<py::class_<TCollection_BasicMapIterator ,std::unique_ptr<TCollection_BasicMapIterator>  >>(m.attr("TCollection_BasicMapIterator"))
        .def("Reset",
