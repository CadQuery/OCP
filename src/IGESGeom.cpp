...
// classes
    ...
    static_cast<py::class_<IGESGeom_Plane ,opencascade::handle<IGESGeom_Plane>  , IGESData_IGESEntity >>(m.attr("IGESGeom_Plane"))
        ...
        .def("Equation",
             (void (IGESGeom_Plane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_Plane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_Plane::Equation),
             R"#(None)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"),  py::arg("D"))
        .def("TransformedEquation",
             (void (IGESGeom_Plane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_Plane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_Plane::TransformedEquation),
             R"#(None)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"),  py::arg("D"))
...
;
    ...
    static_cast<py::class_<IGESGeom_HArray1OfBoundary ,std::unique_ptr<IGESGeom_HArray1OfBoundary>  >>(m.attr("IGESGeom_HArray1OfBoundary"))
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolSurfaceOfRevolution ,std::unique_ptr<IGESGeom_ToolSurfaceOfRevolution>  >>(m.attr("IGESGeom_ToolSurfaceOfRevolution"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolCircularArc ,std::unique_ptr<IGESGeom_ToolCircularArc>  >>(m.attr("IGESGeom_ToolCircularArc"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolCopiousData ,std::unique_ptr<IGESGeom_ToolCopiousData>  >>(m.attr("IGESGeom_ToolCopiousData"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolTransformationMatrix ,std::unique_ptr<IGESGeom_ToolTransformationMatrix>  >>(m.attr("IGESGeom_ToolTransformationMatrix"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolBSplineCurve ,std::unique_ptr<IGESGeom_ToolBSplineCurve>  >>(m.attr("IGESGeom_ToolBSplineCurve"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolSplineCurve ,std::unique_ptr<IGESGeom_ToolSplineCurve>  >>(m.attr("IGESGeom_ToolSplineCurve"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolOffsetSurface ,std::unique_ptr<IGESGeom_ToolOffsetSurface>  >>(m.attr("IGESGeom_ToolOffsetSurface"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolBoundary ,std::unique_ptr<IGESGeom_ToolBoundary>  >>(m.attr("IGESGeom_ToolBoundary"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_SplineCurve ,opencascade::handle<IGESGeom_SplineCurve>  , IGESData_IGESEntity >>(m.attr("IGESGeom_SplineCurve"))
        ...
        .def("XCoordPolynomial",
             (void (IGESGeom_SplineCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_SplineCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_SplineCurve::XCoordPolynomial),
             R"#(returns X coordinate polynomial for segment referred to by Index raises exception if Index <= 0 or Index > NbSegments())#"  , py::arg("Index"),  py::arg("AX"),  py::arg("BX"),  py::arg("CX"),  py::arg("DX"))
        .def("YCoordPolynomial",
             (void (IGESGeom_SplineCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_SplineCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_SplineCurve::YCoordPolynomial),
             R"#(returns Y coordinate polynomial for segment referred to by Index raises exception if Index <= 0 or Index > NbSegments())#"  , py::arg("Index"),  py::arg("AY"),  py::arg("BY"),  py::arg("CY"),  py::arg("DY"))
        .def("ZCoordPolynomial",
             (void (IGESGeom_SplineCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_SplineCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_SplineCurve::ZCoordPolynomial),
             R"#(returns Z coordinate polynomial for segment referred to by Index raises exception if Index <= 0 or Index > NbSegments())#"  , py::arg("Index"),  py::arg("AZ"),  py::arg("BZ"),  py::arg("CZ"),  py::arg("DZ"))
        .def("XValues",
             (void (IGESGeom_SplineCurve::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_SplineCurve::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_SplineCurve::XValues),
             R"#(returns the value of X polynomial, the values of 1st, 2nd and 3rd derivatives of the X polynomial at the terminate point)#"  , py::arg("TPX0"),  py::arg("TPX1"),  py::arg("TPX2"),  py::arg("TPX3"))
        .def("YValues",
             (void (IGESGeom_SplineCurve::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_SplineCurve::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_SplineCurve::YValues),
             R"#(returns the value of Y polynomial, the values of 1st, 2nd and 3rd derivatives of the Y polynomial at the termminate point)#"  , py::arg("TPY0"),  py::arg("TPY1"),  py::arg("TPY2"),  py::arg("TPY3"))
        .def("ZValues",
             (void (IGESGeom_SplineCurve::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_SplineCurve::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_SplineCurve::ZValues),
             R"#(returns the value of Z polynomial, the values of 1st, 2nd and 3rd derivatives of the Z polynomial at the termminate point)#"  , py::arg("TPZ0"),  py::arg("TPZ1"),  py::arg("TPZ2"),  py::arg("TPZ3"))
        .def("DynamicType",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolBoundedSurface ,std::unique_ptr<IGESGeom_ToolBoundedSurface>  >>(m.attr("IGESGeom_ToolBoundedSurface"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolDirection ,std::unique_ptr<IGESGeom_ToolDirection>  >>(m.attr("IGESGeom_ToolDirection"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolPlane ,std::unique_ptr<IGESGeom_ToolPlane>  >>(m.attr("IGESGeom_ToolPlane"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolTrimmedSurface ,std::unique_ptr<IGESGeom_ToolTrimmedSurface>  >>(m.attr("IGESGeom_ToolTrimmedSurface"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ConicArc ,opencascade::handle<IGESGeom_ConicArc>  , IGESData_IGESEntity >>(m.attr("IGESGeom_ConicArc"))
        ...
        .def("Equation",
             (void (IGESGeom_ConicArc::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_ConicArc::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_ConicArc::Equation),
             R"#(None)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"),  py::arg("D"),  py::arg("E"),  py::arg("F"))
        .def("ZPlane",
        ...
        .def("TransformedAxis",
             ...
             R"#(Z-Axis after applying Trans. Matrix)#" )
        .def("Definition",
             (void (IGESGeom_ConicArc::*)( gp_Pnt & ,  gp_Dir & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_ConicArc::*)( gp_Pnt & ,  gp_Dir & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_ConicArc::Definition),
        ...
        .def("TransformedDefinition",
             (void (IGESGeom_ConicArc::*)( gp_Pnt & ,  gp_Dir & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_ConicArc::*)( gp_Pnt & ,  gp_Dir & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_ConicArc::TransformedDefinition),
             R"#(Same as Definition, but the Location is applied on the Center and the MainAxis)#"  , py::arg("Center"),  py::arg("MainAxis"),  py::arg("rmin"),  py::arg("rmax"))
        .def("ComputedDefinition",
             (void (IGESGeom_ConicArc::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_ConicArc::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_ConicArc::ComputedDefinition),
             R"#(Computes and returns the coordinates of the definition of a comic from its equation. Used by Definition & TransformedDefinition, or may be called directly if needed)#"  , py::arg("Xcen"),  py::arg("Ycen"),  py::arg("Xax"),  py::arg("Yax"),  py::arg("Rmin"),  py::arg("Rmax"))
        .def("DynamicType",
...
;
    ...
    static_cast<py::class_<IGESGeom_HArray1OfTransformationMatrix ,std::unique_ptr<IGESGeom_HArray1OfTransformationMatrix>  >>(m.attr("IGESGeom_HArray1OfTransformationMatrix"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolPoint ,std::unique_ptr<IGESGeom_ToolPoint>  >>(m.attr("IGESGeom_ToolPoint"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_HArray1OfCurveOnSurface ,std::unique_ptr<IGESGeom_HArray1OfCurveOnSurface>  >>(m.attr("IGESGeom_HArray1OfCurveOnSurface"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolRuledSurface ,std::unique_ptr<IGESGeom_ToolRuledSurface>  >>(m.attr("IGESGeom_ToolRuledSurface"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolConicArc ,std::unique_ptr<IGESGeom_ToolConicArc>  >>(m.attr("IGESGeom_ToolConicArc"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolLine ,std::unique_ptr<IGESGeom_ToolLine>  >>(m.attr("IGESGeom_ToolLine"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    register_default_constructor<IGESGeom ,std::unique_ptr<IGESGeom>>(m,"IGESGeom");

    static_cast<py::class_<IGESGeom ,std::unique_ptr<IGESGeom>  >>(m.attr("IGESGeom"))
        .def_static("Init_s",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolSplineSurface ,std::unique_ptr<IGESGeom_ToolSplineSurface>  >>(m.attr("IGESGeom_ToolSplineSurface"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolCurveOnSurface ,std::unique_ptr<IGESGeom_ToolCurveOnSurface>  >>(m.attr("IGESGeom_ToolCurveOnSurface"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolOffsetCurve ,std::unique_ptr<IGESGeom_ToolOffsetCurve>  >>(m.attr("IGESGeom_ToolOffsetCurve"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolBSplineSurface ,std::unique_ptr<IGESGeom_ToolBSplineSurface>  >>(m.attr("IGESGeom_ToolBSplineSurface"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolCompositeCurve ,std::unique_ptr<IGESGeom_ToolCompositeCurve>  >>(m.attr("IGESGeom_ToolCompositeCurve"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolTabulatedCylinder ,std::unique_ptr<IGESGeom_ToolTabulatedCylinder>  >>(m.attr("IGESGeom_ToolTabulatedCylinder"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_ToolFlash ,std::unique_ptr<IGESGeom_ToolFlash>  >>(m.attr("IGESGeom_ToolFlash"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESGeom_OffsetCurve ,opencascade::handle<IGESGeom_OffsetCurve>  , IGESData_IGESEntity >>(m.attr("IGESGeom_OffsetCurve"))
        ...
        .def("Parameters",
             (void (IGESGeom_OffsetCurve::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESGeom_OffsetCurve::*)( Standard_Real & ,  Standard_Real &  ) const>(&IGESGeom_OffsetCurve::Parameters),
             R"#(None)#"  , py::arg("StartParam"),  py::arg("EndParam"))
        .def("StartParameter",
