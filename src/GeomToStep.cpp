...
// classes
    ...
    register_default_constructor<GeomToStep_Root ,std::unique_ptr<GeomToStep_Root>>(m,"GeomToStep_Root");

    static_cast<py::class_<GeomToStep_Root ,std::unique_ptr<GeomToStep_Root>  >>(m.attr("GeomToStep_Root"))
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeConicalSurface ,std::unique_ptr<GeomToStep_MakeConicalSurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeConicalSurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeSurfaceOfLinearExtrusion ,std::unique_ptr<GeomToStep_MakeSurfaceOfLinearExtrusion>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeSurfaceOfLinearExtrusion"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeCartesianPoint ,std::unique_ptr<GeomToStep_MakeCartesianPoint>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeCartesianPoint"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeCircle ,std::unique_ptr<GeomToStep_MakeCircle>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeCircle"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeBoundedSurface ,std::unique_ptr<GeomToStep_MakeBoundedSurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeBoundedSurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeAxis1Placement ,std::unique_ptr<GeomToStep_MakeAxis1Placement>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeAxis1Placement"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeSphericalSurface ,std::unique_ptr<GeomToStep_MakeSphericalSurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeSphericalSurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeBSplineCurveWithKnotsAndRationalBSplineCurve ,std::unique_ptr<GeomToStep_MakeBSplineCurveWithKnotsAndRationalBSplineCurve>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeBSplineCurveWithKnotsAndRationalBSplineCurve"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeToroidalSurface ,std::unique_ptr<GeomToStep_MakeToroidalSurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeToroidalSurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeSurface ,std::unique_ptr<GeomToStep_MakeSurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeSurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeCylindricalSurface ,std::unique_ptr<GeomToStep_MakeCylindricalSurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeCylindricalSurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeAxis2Placement3d ,std::unique_ptr<GeomToStep_MakeAxis2Placement3d>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeAxis2Placement3d"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeRectangularTrimmedSurface ,std::unique_ptr<GeomToStep_MakeRectangularTrimmedSurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeRectangularTrimmedSurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeBSplineSurfaceWithKnotsAndRationalBSplineSurface ,std::unique_ptr<GeomToStep_MakeBSplineSurfaceWithKnotsAndRationalBSplineSurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeBSplineSurfaceWithKnotsAndRationalBSplineSurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeAxis2Placement2d ,std::unique_ptr<GeomToStep_MakeAxis2Placement2d>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeAxis2Placement2d"))
        .def(py::init< const gp_Ax2 & >()  , py::arg("A") )
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeDirection ,std::unique_ptr<GeomToStep_MakeDirection>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeDirection"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakePlane ,std::unique_ptr<GeomToStep_MakePlane>  , GeomToStep_Root >>(m.attr("GeomToStep_MakePlane"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeEllipse ,std::unique_ptr<GeomToStep_MakeEllipse>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeEllipse"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeVector ,std::unique_ptr<GeomToStep_MakeVector>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeVector"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeLine ,std::unique_ptr<GeomToStep_MakeLine>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeLine"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeConic ,std::unique_ptr<GeomToStep_MakeConic>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeConic"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeParabola ,std::unique_ptr<GeomToStep_MakeParabola>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeParabola"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeCurve ,std::unique_ptr<GeomToStep_MakeCurve>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeCurve"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeSurfaceOfRevolution ,std::unique_ptr<GeomToStep_MakeSurfaceOfRevolution>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeSurfaceOfRevolution"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeHyperbola ,std::unique_ptr<GeomToStep_MakeHyperbola>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeHyperbola"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeElementarySurface ,std::unique_ptr<GeomToStep_MakeElementarySurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeElementarySurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeBSplineSurfaceWithKnots ,std::unique_ptr<GeomToStep_MakeBSplineSurfaceWithKnots>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeBSplineSurfaceWithKnots"))
        .def(py::init< const opencascade::handle<Geom_BSplineSurface> & >()  , py::arg("Bsplin") )
        .def("Value",
...
;
    ...
    static_cast<py::class_<GeomToStep_MakePolyline ,std::unique_ptr<GeomToStep_MakePolyline>  , GeomToStep_Root >>(m.attr("GeomToStep_MakePolyline"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeBoundedCurve ,std::unique_ptr<GeomToStep_MakeBoundedCurve>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeBoundedCurve"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeSweptSurface ,std::unique_ptr<GeomToStep_MakeSweptSurface>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeSweptSurface"))
...
;
    ...
    static_cast<py::class_<GeomToStep_MakeBSplineCurveWithKnots ,std::unique_ptr<GeomToStep_MakeBSplineCurveWithKnots>  , GeomToStep_Root >>(m.attr("GeomToStep_MakeBSplineCurveWithKnots"))
        .def(py::init< const opencascade::handle<Geom_BSplineCurve> & >()  , py::arg("Bsplin") )
        .def(py::init< const opencascade::handle<Geom2d_BSplineCurve> & >()  , py::arg("Bsplin") )
        .def("Value",
