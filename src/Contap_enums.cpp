...
// classes forward declarations only
    py::class_<Contap_TheSearchInside ,std::unique_ptr<Contap_TheSearchInside>  >(m,"Contap_TheSearchInside",R"#(None)#");
    py::class_<Contap_TheHSequenceOfPoint ,std::unique_ptr<Contap_TheHSequenceOfPoint>  >(m,"Contap_TheHSequenceOfPoint",R"#()#");
    py::class_<Contap_Line ,std::unique_ptr<Contap_Line>  >(m,"Contap_Line",R"#(None)#");
    py::class_<Contap_SurfProps ,std::unique_ptr<Contap_SurfProps>  >(m,"Contap_SurfProps",R"#(Internal tool used to compute the normal and its derivatives.)#");
    py::class_<Contap_HCurve2dTool ,std::unique_ptr<Contap_HCurve2dTool>  >(m,"Contap_HCurve2dTool",R"#(None)#");
    py::class_<Contap_ArcFunction ,std::unique_ptr<Contap_ArcFunction>  , math_FunctionWithDerivative >(m,"Contap_ArcFunction",R"#(None)#");
    py::class_<Contap_TheSegmentOfTheSearch ,std::unique_ptr<Contap_TheSegmentOfTheSearch>  >(m,"Contap_TheSegmentOfTheSearch",R"#(None)#");
    py::class_<Contap_TheIWalking ,std::unique_ptr<Contap_TheIWalking>  >(m,"Contap_TheIWalking",R"#(None)#");
    py::class_<Contap_TheSearch ,std::unique_ptr<Contap_TheSearch>  >(m,"Contap_TheSearch",R"#(None)#");
    py::class_<Contap_ContAna ,std::unique_ptr<Contap_ContAna>  >(m,"Contap_ContAna",R"#(This class provides the computation of the contours for quadric surfaces.)#");
    py::class_<Contap_ThePathPointOfTheSearch ,std::unique_ptr<Contap_ThePathPointOfTheSearch>  >(m,"Contap_ThePathPointOfTheSearch",R"#(None)#");
    py::class_<Contap_SurfFunction ,std::unique_ptr<Contap_SurfFunction>  , math_FunctionSetWithDerivatives >(m,"Contap_SurfFunction",R"#(This class describes the function on a parametric surface. the form of the function is F(u,v) = 0 where u and v are the parameteric coordinates of a point on the surface, to compute the contours of the surface.)#");
    py::class_<Contap_Point ,std::unique_ptr<Contap_Point>  >(m,"Contap_Point",R"#(Definition of a vertex on the contour line. Most of the time, such a point is an intersection between the contour and a restriction of the surface. When it is not tyhe method IsOnArc return False. Such a point is contains geometrical informations (see the Value method) and logical informations.)#");
    py::class_<Contap_HContTool ,std::unique_ptr<Contap_HContTool>  >(m,"Contap_HContTool",R"#(Tool for the intersection between 2 surfaces. Regroupe pour l instant les methodes hors Adaptor3d...)#");
    ...
    py::class_<Contap_Contour ,std::unique_ptr<Contap_Contour>  >(m,"Contap_Contour",R"#(None)#");
