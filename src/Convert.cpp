...
// classes
    ...
    static_cast<py::class_<Convert_ElementarySurfaceToBSplineSurface ,std::unique_ptr<Convert_ElementarySurfaceToBSplineSurface>  >>(m.attr("Convert_ElementarySurfaceToBSplineSurface"))
        .def("UDegree",
...
;
    ...
    static_cast<py::class_<Convert_ConicToBSplineCurve ,std::unique_ptr<Convert_ConicToBSplineCurve>  >>(m.attr("Convert_ConicToBSplineCurve"))
        .def("Degree",
        ...
        .def("BuildCosAndSin",
             (void (Convert_ConicToBSplineCurve::*)( const Convert_ParameterisationType ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  Standard_Integer & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfInteger> &  ) const) static_cast<void (Convert_ConicToBSplineCurve::*)( const Convert_ParameterisationType ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  Standard_Integer & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfInteger> &  ) const>(&Convert_ConicToBSplineCurve::BuildCosAndSin),
             R"#(None)#"  , py::arg("Parametrisation"),  py::arg("CosNumerator"),  py::arg("SinNumerator"),  py::arg("Denominator"),  py::arg("Degree"),  py::arg("Knots"),  py::arg("Mults"))
        .def("BuildCosAndSin",
             (void (Convert_ConicToBSplineCurve::*)( const Convert_ParameterisationType ,  const Standard_Real ,  const Standard_Real ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  Standard_Integer & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfInteger> &  ) const) static_cast<void (Convert_ConicToBSplineCurve::*)( const Convert_ParameterisationType ,  const Standard_Real ,  const Standard_Real ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  Standard_Integer & ,  opencascade::handle<TColStd_HArray1OfReal> & ,  opencascade::handle<TColStd_HArray1OfInteger> &  ) const>(&Convert_ConicToBSplineCurve::BuildCosAndSin),
             R"#(None)#"  , py::arg("Parametrisation"),  py::arg("UFirst"),  py::arg("ULast"),  py::arg("CosNumerator"),  py::arg("SinNumerator"),  py::arg("Denominator"),  py::arg("Degree"),  py::arg("Knots"),  py::arg("Mults"))
;


    static_cast<py::class_<Convert_SphereToBSplineSurface ,std::unique_ptr<Convert_SphereToBSplineSurface>  , Convert_ElementarySurfaceToBSplineSurface >>(m.attr("Convert_SphereToBSplineSurface"))
...
;
    ...
    static_cast<py::class_<Convert_CompBezierCurves2dToBSplineCurve2d ,std::unique_ptr<Convert_CompBezierCurves2dToBSplineCurve2d>  >>(m.attr("Convert_CompBezierCurves2dToBSplineCurve2d"))
...
;
    ...
    static_cast<py::class_<Convert_HyperbolaToBSplineCurve ,std::unique_ptr<Convert_HyperbolaToBSplineCurve>  , Convert_ConicToBSplineCurve >>(m.attr("Convert_HyperbolaToBSplineCurve"))
        .def(py::init< const gp_Hypr2d &,const Standard_Real,const Standard_Real >()  , py::arg("H"),  py::arg("U1"),  py::arg("U2") )
;


    static_cast<py::class_<Convert_EllipseToBSplineCurve ,std::unique_ptr<Convert_EllipseToBSplineCurve>  , Convert_ConicToBSplineCurve >>(m.attr("Convert_EllipseToBSplineCurve"))
...
;
    ...
    static_cast<py::class_<Convert_ParabolaToBSplineCurve ,std::unique_ptr<Convert_ParabolaToBSplineCurve>  , Convert_ConicToBSplineCurve >>(m.attr("Convert_ParabolaToBSplineCurve"))
        .def(py::init< const gp_Parab2d &,const Standard_Real,const Standard_Real >()  , py::arg("Prb"),  py::arg("U1"),  py::arg("U2") )
;


    static_cast<py::class_<Convert_CylinderToBSplineSurface ,std::unique_ptr<Convert_CylinderToBSplineSurface>  , Convert_ElementarySurfaceToBSplineSurface >>(m.attr("Convert_CylinderToBSplineSurface"))
...
;
    ...
    static_cast<py::class_<Convert_CircleToBSplineCurve ,std::unique_ptr<Convert_CircleToBSplineCurve>  , Convert_ConicToBSplineCurve >>(m.attr("Convert_CircleToBSplineCurve"))
...
;
    ...
    static_cast<py::class_<Convert_GridPolynomialToPoles ,std::unique_ptr<Convert_GridPolynomialToPoles>  >>(m.attr("Convert_GridPolynomialToPoles"))
...
;
    ...
    static_cast<py::class_<Convert_TorusToBSplineSurface ,std::unique_ptr<Convert_TorusToBSplineSurface>  , Convert_ElementarySurfaceToBSplineSurface >>(m.attr("Convert_TorusToBSplineSurface"))
...
;
    ...
    static_cast<py::class_<Convert_ConeToBSplineSurface ,std::unique_ptr<Convert_ConeToBSplineSurface>  , Convert_ElementarySurfaceToBSplineSurface >>(m.attr("Convert_ConeToBSplineSurface"))
...
;
    ...
    static_cast<py::class_<Convert_CompPolynomialToPoles ,std::unique_ptr<Convert_CompPolynomialToPoles>  >>(m.attr("Convert_CompPolynomialToPoles"))
...
;
    ...
    static_cast<py::class_<Convert_CompBezierCurvesToBSplineCurve ,std::unique_ptr<Convert_CompBezierCurvesToBSplineCurve>  >>(m.attr("Convert_CompBezierCurvesToBSplineCurve"))
        .def(py::init< const Standard_Real >()  , py::arg("AngularTolerance")=static_cast<const Standard_Real>(1.0e-4) )
        .def("AddCurve",
