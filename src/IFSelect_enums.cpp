...
// classes forward declarations only
    ...
    py::class_<IFSelect_ContextWrite ,std::unique_ptr<IFSelect_ContextWrite>  >(m,"IFSelect_ContextWrite",R"#(This class gathers various informations used by File Modifiers apart from the writer object, which is specific of the norm and of the physical format)#");
    py::class_<IFSelect_ShareOutResult ,std::unique_ptr<IFSelect_ShareOutResult>  >(m,"IFSelect_ShareOutResult",R"#(This class gives results computed from a ShareOut : simulation before transfer, helps to list entities ... Transfer itself will later be performed, either by a TransferCopy to simply divide up a file, or a TransferDispatch which can be parametred with more details)#");
    ...
    py::class_<IFSelect_HSeqOfSelection ,std::unique_ptr<IFSelect_HSeqOfSelection>  >(m,"IFSelect_HSeqOfSelection",R"#()#");
    py::class_<IFSelect_Functions ,std::unique_ptr<IFSelect_Functions>  >(m,"IFSelect_Functions",R"#(Functions gives access to all the actions which can be commanded with the resources provided by IFSelect : especially WorkSession and various types of Selections and Dispatches)#");
    py::class_<IFSelect_SelectionIterator ,std::unique_ptr<IFSelect_SelectionIterator>  >(m,"IFSelect_SelectionIterator",R"#(Defines an Iterator on a list of Selections)#");
    ...
    py::class_<IFSelect ,std::unique_ptr<IFSelect>  >(m,"IFSelect",R"#(Gives tools to manage Selecting a group of Entities processed by an Interface, for instance to divide up an original Model (from a File) to several smaller ones They use description of an Interface Model as a graph)#");
    ...
    py::class_<IFSelect_ContextModif ,std::unique_ptr<IFSelect_ContextModif>  >(m,"IFSelect_ContextModif",R"#(This class gathers various informations used by Model Modifiers apart from the target model itself, and the CopyTool which must be passed directly.)#");
