...
;
    ...
    static_cast<py::class_<TNaming_IteratorOnShapesSet ,std::unique_ptr<TNaming_IteratorOnShapesSet>  >>(m.attr("TNaming_IteratorOnShapesSet"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TNaming_Identifier ,std::unique_ptr<TNaming_Identifier>  >>(m.attr("TNaming_Identifier"))
...
;
    ...
    static_cast<py::class_<TNaming_Localizer ,std::unique_ptr<TNaming_Localizer>  >>(m.attr("TNaming_Localizer"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TNaming_Iterator ,std::unique_ptr<TNaming_Iterator>  >>(m.attr("TNaming_Iterator"))
...
;
    ...
    static_cast<py::class_<TNaming_Builder ,std::unique_ptr<TNaming_Builder>  >>(m.attr("TNaming_Builder"))
        .def(py::init< const TDF_Label & >()  , py::arg("aLabel") )
        .def("Generated",
...
;
    ...
    static_cast<py::class_<TNaming_Scope ,std::unique_ptr<TNaming_Scope>  >>(m.attr("TNaming_Scope"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TNaming_ShapesSet ,std::unique_ptr<TNaming_ShapesSet>  >>(m.attr("TNaming_ShapesSet"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TNaming_RefShape ,std::unique_ptr<TNaming_RefShape>  >>(m.attr("TNaming_RefShape"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TNaming_Name ,std::unique_ptr<TNaming_Name>  >>(m.attr("TNaming_Name"))
        .def(py::init<  >()  )
        .def("Type",
...
;
    ...
    static_cast<py::class_<TNaming_SameShapeIterator ,std::unique_ptr<TNaming_SameShapeIterator>  >>(m.attr("TNaming_SameShapeIterator"))
...
;
    ...
    register_default_constructor<TNaming_Tool ,std::unique_ptr<TNaming_Tool>>(m,"TNaming_Tool");

    static_cast<py::class_<TNaming_Tool ,std::unique_ptr<TNaming_Tool>  >>(m.attr("TNaming_Tool"))
...
;
    ...
    static_cast<py::class_<TNaming_Selector ,std::unique_ptr<TNaming_Selector>  >>(m.attr("TNaming_Selector"))
        .def(py::init< const TDF_Label & >()  , py::arg("aLabel") )
        .def("Select",
...
;
    ...
    register_default_constructor<TNaming_UsedShapes ,opencascade::handle<TNaming_UsedShapes>>(m,"TNaming_UsedShapes");
...
;
    ...
    register_default_constructor<TNaming_CopyShape ,std::unique_ptr<TNaming_CopyShape>>(m,"TNaming_CopyShape");

    static_cast<py::class_<TNaming_CopyShape ,std::unique_ptr<TNaming_CopyShape>  >>(m.attr("TNaming_CopyShape"))
...
;
    ...
    static_cast<py::class_<TNaming_Translator ,std::unique_ptr<TNaming_Translator>  >>(m.attr("TNaming_Translator"))
        .def(py::init<  >()  )
        .def("Add",
...
;
    ...
    static_cast<py::class_<TNaming_OldShapeIterator ,std::unique_ptr<TNaming_OldShapeIterator>  >>(m.attr("TNaming_OldShapeIterator"))
...
;
    ...
    static_cast<py::class_<TNaming_NewShapeIterator ,std::unique_ptr<TNaming_NewShapeIterator>  >>(m.attr("TNaming_NewShapeIterator"))
        .def(py::init< const TopoDS_Shape &,const Standard_Integer,const TDF_Label & >()  , py::arg("aShape"),  py::arg("Transaction"),  py::arg("access") )
        .def(py::init< const TopoDS_Shape &,const TDF_Label & >()  , py::arg("aShape"),  py::arg("access") )
...
;
    ...
    register_default_constructor<TNaming_NamingTool ,std::unique_ptr<TNaming_NamingTool>>(m,"TNaming_NamingTool");

    static_cast<py::class_<TNaming_NamingTool ,std::unique_ptr<TNaming_NamingTool>  >>(m.attr("TNaming_NamingTool"))
        .def_static("CurrentShape_s",
...
;
    ...
    register_default_constructor<TNaming ,std::unique_ptr<TNaming>>(m,"TNaming");

    static_cast<py::class_<TNaming ,std::unique_ptr<TNaming>  >>(m.attr("TNaming"))
