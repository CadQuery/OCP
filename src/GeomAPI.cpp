...
// classes
    ...
    static_cast<py::class_<GeomAPI_Interpolate ,std::unique_ptr<GeomAPI_Interpolate>  >>(m.attr("GeomAPI_Interpolate"))
...
;
    ...
    static_cast<py::class_<GeomAPI_ExtremaCurveSurface ,std::unique_ptr<GeomAPI_ExtremaCurveSurface>  >>(m.attr("GeomAPI_ExtremaCurveSurface"))
        .def(py::init<  >()  )
        ...
        .def("Parameters",
             (void (GeomAPI_ExtremaCurveSurface::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_ExtremaCurveSurface::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_ExtremaCurveSurface::Parameters),
        ...
        .def("LowerDistanceParameters",
             (void (GeomAPI_ExtremaCurveSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_ExtremaCurveSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_ExtremaCurveSurface::LowerDistanceParameters),
             R"#(Returns the parameters W of the point on the curve and (U,V) of the point on the surface, which are the ends of the shortest extremum computed by this algorithm. Exceptions - StdFail_NotDone if this algorithm fails.)#"  , py::arg("W"),  py::arg("U"),  py::arg("V"))
        .def("LowerDistance",
...
;
    ...
    register_default_constructor<GeomAPI ,std::unique_ptr<GeomAPI>>(m,"GeomAPI");

    static_cast<py::class_<GeomAPI ,std::unique_ptr<GeomAPI>  >>(m.attr("GeomAPI"))
        .def_static("To2d_s",
...
;
    ...
    static_cast<py::class_<GeomAPI_ExtremaSurfaceSurface ,std::unique_ptr<GeomAPI_ExtremaSurfaceSurface>  >>(m.attr("GeomAPI_ExtremaSurfaceSurface"))
        .def(py::init<  >()  )
        ...
        .def("Parameters",
             (void (GeomAPI_ExtremaSurfaceSurface::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_ExtremaSurfaceSurface::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_ExtremaSurfaceSurface::Parameters),
        ...
        .def("LowerDistanceParameters",
             (void (GeomAPI_ExtremaSurfaceSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_ExtremaSurfaceSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_ExtremaSurfaceSurface::LowerDistanceParameters),
             R"#(Returns the parameters (U1,V1) of the point on the first surface and (U2,V2) of the point on the second surface, which are the ends of the shortest extremum computed by this algorithm. Exceptions - StdFail_NotDone if this algorithm fails.)#"  , py::arg("U1"),  py::arg("V1"),  py::arg("U2"),  py::arg("V2"))
        .def("LowerDistance",
...
;
    ...
    static_cast<py::class_<GeomAPI_PointsToBSpline ,std::unique_ptr<GeomAPI_PointsToBSpline>  >>(m.attr("GeomAPI_PointsToBSpline"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomAPI_IntSS ,std::unique_ptr<GeomAPI_IntSS>  >>(m.attr("GeomAPI_IntSS"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomAPI_ExtremaCurveCurve ,std::unique_ptr<GeomAPI_ExtremaCurveCurve>  >>(m.attr("GeomAPI_ExtremaCurveCurve"))
        .def(py::init<  >()  )
        ...
        .def("Parameters",
             (void (GeomAPI_ExtremaCurveCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_ExtremaCurveCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_ExtremaCurveCurve::Parameters),
        ...
        .def("LowerDistanceParameters",
             (void (GeomAPI_ExtremaCurveCurve::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_ExtremaCurveCurve::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_ExtremaCurveCurve::LowerDistanceParameters),
...
;
    ...
    static_cast<py::class_<GeomAPI_IntCS ,std::unique_ptr<GeomAPI_IntCS>  >>(m.attr("GeomAPI_IntCS"))
        .def(py::init<  >()  )
        ...
        .def("Parameters",
             (void (GeomAPI_IntCS::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_IntCS::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_IntCS::Parameters),
        ...
        .def("Parameters",
             (void (GeomAPI_IntCS::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_IntCS::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_IntCS::Parameters),
...
;
    ...
    static_cast<py::class_<GeomAPI_ProjectPointOnSurf ,std::unique_ptr<GeomAPI_ProjectPointOnSurf>  >>(m.attr("GeomAPI_ProjectPointOnSurf"))
        .def(py::init<  >()  )
        ...
        .def("Parameters",
             (void (GeomAPI_ProjectPointOnSurf::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_ProjectPointOnSurf::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_ProjectPointOnSurf::Parameters),
             R"#(Returns the parameters (U,V) on the surface of the orthogonal projection. Index is a number of a computed point. Exceptions Standard_OutOfRange if Index is not in the range [ 1,NbPoints ], where NbPoints is the number of solution points.)#"  , py::arg("Index"),  py::arg("U"),  py::arg("V"))
        .def("Distance",
        ...
        .def("LowerDistanceParameters",
             (void (GeomAPI_ProjectPointOnSurf::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomAPI_ProjectPointOnSurf::*)( Standard_Real & ,  Standard_Real &  ) const>(&GeomAPI_ProjectPointOnSurf::LowerDistanceParameters),
             R"#(Returns the parameters (U,V) on the surface of the nearest computed orthogonal projection of the point. Exceptions StdFail_NotDone if projection fails.)#"  , py::arg("U"),  py::arg("V"))
        .def("LowerDistance",
...
;
    ...
    static_cast<py::class_<GeomAPI_ProjectPointOnCurve ,std::unique_ptr<GeomAPI_ProjectPointOnCurve>  >>(m.attr("GeomAPI_ProjectPointOnCurve"))
        .def(py::init<  >()  )
        ...
        .def("Parameter",
             (void (GeomAPI_ProjectPointOnCurve::*)( const Standard_Integer ,  Standard_Real &  ) const) static_cast<void (GeomAPI_ProjectPointOnCurve::*)( const Standard_Integer ,  Standard_Real &  ) const>(&GeomAPI_ProjectPointOnCurve::Parameter),
             R"#(Returns the parameter on the curve of the point, which is the orthogonal projection. Index is a number of a computed point. Exceptions Standard_OutOfRange if Index is not in the range [ 1,NbPoints ], where NbPoints is the number of solution points.-)#"  , py::arg("Index"),  py::arg("U"))
        .def("Distance",
...
;
    ...
    static_cast<py::class_<GeomAPI_PointsToBSplineSurface ,std::unique_ptr<GeomAPI_PointsToBSplineSurface>  >>(m.attr("GeomAPI_PointsToBSplineSurface"))
        .def(py::init<  >()  )
