...
// classes forward declarations only
    ...
    py::class_<Graphic3d_BvhCStructureSet , shared_ptr<Graphic3d_BvhCStructureSet>  >(m,"Graphic3d_BvhCStructureSet",R"#(Set of OpenGl_Structures for building BVH tree.)#");
    py::class_<Graphic3d_BvhCStructureSetTrsfPers , shared_ptr<Graphic3d_BvhCStructureSetTrsfPers>  >(m,"Graphic3d_BvhCStructureSetTrsfPers",R"#(Set of transformation persistent OpenGl_Structure for building BVH tree. Provides built-in mechanism to invalidate tree when world view projection state changes. Due to frequent invalidation of BVH tree the choice of BVH tree builder is made in favor of BVH linear builder (quick rebuild).)#");
