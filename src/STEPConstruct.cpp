...
// classes
    ...
    static_cast<py::class_<STEPConstruct_Tool ,std::unique_ptr<STEPConstruct_Tool>  >>(m.attr("STEPConstruct_Tool"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<STEPConstruct_Part ,std::unique_ptr<STEPConstruct_Part>  >>(m.attr("STEPConstruct_Part"))
        .def(py::init<  >()  )
        .def("MakeSDR",
...
;
    ...
    static_cast<py::class_<STEPConstruct_Assembly ,std::unique_ptr<STEPConstruct_Assembly>  >>(m.attr("STEPConstruct_Assembly"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    register_default_constructor<STEPConstruct ,std::unique_ptr<STEPConstruct>>(m,"STEPConstruct");

    static_cast<py::class_<STEPConstruct ,std::unique_ptr<STEPConstruct>  >>(m.attr("STEPConstruct"))
...
;
    ...
    static_cast<py::class_<STEPConstruct_ExternRefs ,std::unique_ptr<STEPConstruct_ExternRefs>  , STEPConstruct_Tool >>(m.attr("STEPConstruct_ExternRefs"))
        .def(py::init<  >()  )
        .def(py::init< const opencascade::handle<XSControl_WorkSession> & >()  , py::arg("WS") )
        .def("Init",
...
;
    ...
    static_cast<py::class_<STEPConstruct_ValidationProps ,std::unique_ptr<STEPConstruct_ValidationProps>  , STEPConstruct_Tool >>(m.attr("STEPConstruct_ValidationProps"))
        .def(py::init<  >()  )
        .def(py::init< const opencascade::handle<XSControl_WorkSession> & >()  , py::arg("WS") )
        .def("Init",
...
;
    ...
    static_cast<py::class_<STEPConstruct_UnitContext ,std::unique_ptr<STEPConstruct_UnitContext>  >>(m.attr("STEPConstruct_UnitContext"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<STEPConstruct_ContextTool ,std::unique_ptr<STEPConstruct_ContextTool>  >>(m.attr("STEPConstruct_ContextTool"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<STEPConstruct_AP203Context ,std::unique_ptr<STEPConstruct_AP203Context>  >>(m.attr("STEPConstruct_AP203Context"))
        .def(py::init<  >()  )
        .def("DefaultApproval",
...
;
    ...
    static_cast<py::class_<STEPConstruct_Styles ,std::unique_ptr<STEPConstruct_Styles>  , STEPConstruct_Tool >>(m.attr("STEPConstruct_Styles"))
        .def(py::init<  >()  )
        .def(py::init< const opencascade::handle<XSControl_WorkSession> & >()  , py::arg("WS") )
        .def("Init",
...
;
    ...
    register_default_constructor<STEPConstruct_PointHasher ,std::unique_ptr<STEPConstruct_PointHasher>>(m,"STEPConstruct_PointHasher");

    static_cast<py::class_<STEPConstruct_PointHasher ,std::unique_ptr<STEPConstruct_PointHasher>  >>(m.attr("STEPConstruct_PointHasher"))
