...
// classes
    ...
    static_cast<py::class_<GeomPlate_PlateG0Criterion ,std::unique_ptr<GeomPlate_PlateG0Criterion>  , AdvApp2Var_Criterion >>(m.attr("GeomPlate_PlateG0Criterion"))
...
;
    ...
    static_cast<py::class_<GeomPlate_HArray1OfHCurve ,std::unique_ptr<GeomPlate_HArray1OfHCurve>  >>(m.attr("GeomPlate_HArray1OfHCurve"))
...
;
    ...
    static_cast<py::class_<GeomPlate_BuildPlateSurface ,std::unique_ptr<GeomPlate_BuildPlateSurface>  >>(m.attr("GeomPlate_BuildPlateSurface"))
...
;
    ...
    static_cast<py::class_<GeomPlate_Aij ,std::unique_ptr<GeomPlate_Aij>  >>(m.attr("GeomPlate_Aij"))
        .def(py::init<  >()  )
        .def(py::init< const Standard_Integer,const Standard_Integer,const gp_Vec & >()  , py::arg("anInd1"),  py::arg("anInd2"),  py::arg("aVec") )
;


    static_cast<py::class_<GeomPlate_BuildAveragePlane ,std::unique_ptr<GeomPlate_BuildAveragePlane>  >>(m.attr("GeomPlate_BuildAveragePlane"))
        ...
        .def("MinMaxBox",
             (void (GeomPlate_BuildAveragePlane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomPlate_BuildAveragePlane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomPlate_BuildAveragePlane::MinMaxBox),
             R"#(computes the minimal box to include all normal projection points of the initial array on the plane.)#"  , py::arg("Umin"),  py::arg("Umax"),  py::arg("Vmin"),  py::arg("Vmax"))
...
;
    ...
    static_cast<py::class_<GeomPlate_Surface ,opencascade::handle<GeomPlate_Surface>  , Geom_Surface >>(m.attr("GeomPlate_Surface"))
        ...
        .def("TransformParameters",
             (void (GeomPlate_Surface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const) static_cast<void (GeomPlate_Surface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const>(&GeomPlate_Surface::TransformParameters),
        ...
        .def("Bounds",
             (void (GeomPlate_Surface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomPlate_Surface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomPlate_Surface::Bounds),
        ...
        .def("RealBounds",
             (void (GeomPlate_Surface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (GeomPlate_Surface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&GeomPlate_Surface::RealBounds),
             R"#(None)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Constraints",
...
;
    ...
    static_cast<py::class_<GeomPlate_HArray1OfSequenceOfReal ,std::unique_ptr<GeomPlate_HArray1OfSequenceOfReal>  >>(m.attr("GeomPlate_HArray1OfSequenceOfReal"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<GeomPlate_HSequenceOfPointConstraint ,std::unique_ptr<GeomPlate_HSequenceOfPointConstraint>  >>(m.attr("GeomPlate_HSequenceOfPointConstraint"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomPlate_HSequenceOfCurveConstraint ,std::unique_ptr<GeomPlate_HSequenceOfCurveConstraint>  >>(m.attr("GeomPlate_HSequenceOfCurveConstraint"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GeomPlate_PlateG1Criterion ,std::unique_ptr<GeomPlate_PlateG1Criterion>  , AdvApp2Var_Criterion >>(m.attr("GeomPlate_PlateG1Criterion"))
...
;
    ...
    static_cast<py::class_<GeomPlate_MakeApprox ,std::unique_ptr<GeomPlate_MakeApprox>  >>(m.attr("GeomPlate_MakeApprox"))
