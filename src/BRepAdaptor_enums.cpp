...
// classes forward declarations only
    ...
    py::class_<BRepAdaptor_CompCurve ,std::unique_ptr<BRepAdaptor_CompCurve>  , Adaptor3d_Curve >(m,"BRepAdaptor_CompCurve",R"#(The Curve from BRepAdaptor allows to use a Wire of the BRep topology like a 3D curve. Warning: With this class of curve, C0 and C1 continuities are not assumed. So be careful with some algorithm! Please note that BRepAdaptor_CompCurve cannot be periodic curve at all (even if it contains single periodic edge).)#");
    py::class_<BRepAdaptor_Surface ,std::unique_ptr<BRepAdaptor_Surface>  , Adaptor3d_Surface >(m,"BRepAdaptor_Surface",R"#(The Surface from BRepAdaptor allows to use a Face of the BRep topology look like a 3D surface.)#");
    py::class_<BRepAdaptor_HCompCurve ,opencascade::handle<BRepAdaptor_HCompCurve>  , Adaptor3d_HCurve >(m,"BRepAdaptor_HCompCurve",R"#()#");
    py::class_<BRepAdaptor_Curve2d ,std::unique_ptr<BRepAdaptor_Curve2d>  , Geom2dAdaptor_Curve >(m,"BRepAdaptor_Curve2d",R"#(The Curve2d from BRepAdaptor allows to use an Edge on a Face like a 2d curve. (curve in the parametric space).)#");
    py::class_<BRepAdaptor_Curve ,std::unique_ptr<BRepAdaptor_Curve>  , Adaptor3d_Curve >(m,"BRepAdaptor_Curve",R"#(The Curve from BRepAdaptor allows to use an Edge of the BRep topology like a 3D curve.)#");
    py::class_<BRepAdaptor_HArray1OfCurve ,std::unique_ptr<BRepAdaptor_HArray1OfCurve>  >(m,"BRepAdaptor_HArray1OfCurve",R"#()#");
