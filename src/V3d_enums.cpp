...
// enums
    ...
    py::enum_<V3d_TypeOfOrientation>(m, "V3d_TypeOfOrientation",R"#(Determines the type of orientation.)#")
        ...
        .value("V3d_XnegYnegZneg",V3d_TypeOfOrientation::V3d_XnegYnegZneg).export_values();
...
// classes forward declarations only
    py::class_<V3d ,std::unique_ptr<V3d>  >(m,"V3d",R"#(This package contains the set of commands and services of the 3D Viewer. It provides a set of high level commands to control the views and viewing modes.)#");
