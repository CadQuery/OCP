...
// classes forward declarations only
    py::class_<TDocStd_XLinkIterator ,std::unique_ptr<TDocStd_XLinkIterator>  >(m,"TDocStd_XLinkIterator",R"#(Iterates on Reference attributes. This is an iterator giving all the external references of a Document.)#");
    ...
    py::class_<TDocStd_PathParser ,std::unique_ptr<TDocStd_PathParser>  >(m,"TDocStd_PathParser",R"#(parse an OS path)#");
    ...
    py::class_<TDocStd ,std::unique_ptr<TDocStd>  >(m,"TDocStd",R"#(This package define CAF main classes.)#");
    ...
    py::class_<TDocStd_Context ,std::unique_ptr<TDocStd_Context>  >(m,"TDocStd_Context",R"#(None)#");
