...
// classes
    ...
    static_cast<py::class_<HLRAlgo_EdgeIterator ,std::unique_ptr<HLRAlgo_EdgeIterator>  >>(m.attr("HLRAlgo_EdgeIterator"))
        .def(py::init<  >()  )
        .def("InitHidden",
        ...
        .def("NextHidden",
             ...
             R"#(None)#" )
        .def("Hidden",
             (void (HLRAlgo_EdgeIterator::*)( Standard_Real & ,  Standard_ShortReal & ,  Standard_Real & ,  Standard_ShortReal &  ) const) static_cast<void (HLRAlgo_EdgeIterator::*)( Standard_Real & ,  Standard_ShortReal & ,  Standard_Real & ,  Standard_ShortReal &  ) const>(&HLRAlgo_EdgeIterator::Hidden),
             R"#(Returns the bounds and the tolerances of the current Hidden Interval)#"  , py::arg("Start"),  py::arg("TolStart"),  py::arg("End"),  py::arg("TolEnd"))
        .def("InitVisible",
        ...
        .def("NextVisible",
             ...
             R"#(None)#" )
        .def("Visible",
             (void (HLRAlgo_EdgeIterator::*)( Standard_Real & ,  Standard_ShortReal & ,  Standard_Real & ,  Standard_ShortReal &  ) ) static_cast<void (HLRAlgo_EdgeIterator::*)( Standard_Real & ,  Standard_ShortReal & ,  Standard_Real & ,  Standard_ShortReal &  ) >(&HLRAlgo_EdgeIterator::Visible),
             R"#(Returns the bounds and the tolerances of the current Visible Interval)#"  , py::arg("Start"),  py::arg("TolStart"),  py::arg("End"),  py::arg("TolEnd"))
        .def("MoreHidden",
             (Standard_Boolean (HLRAlgo_EdgeIterator::*)() const) static_cast<Standard_Boolean (HLRAlgo_EdgeIterator::*)() const>(&HLRAlgo_EdgeIterator::MoreHidden),
             R"#(None)#" )
        .def("Hidden",
...
;
    ...
    static_cast<py::class_<HLRAlgo_EdgeStatus ,std::unique_ptr<HLRAlgo_EdgeStatus>  >>(m.attr("HLRAlgo_EdgeStatus"))
        .def(py::init<  >()  )
        ...
        .def("Bounds",
             (void (HLRAlgo_EdgeStatus::*)( Standard_Real & ,  Standard_ShortReal & ,  Standard_Real & ,  Standard_ShortReal &  ) const) static_cast<void (HLRAlgo_EdgeStatus::*)( Standard_Real & ,  Standard_ShortReal & ,  Standard_Real & ,  Standard_ShortReal &  ) const>(&HLRAlgo_EdgeStatus::Bounds),
             R"#(None)#"  , py::arg("theStart"),  py::arg("theTolStart"),  py::arg("theEnd"),  py::arg("theTolEnd"))
        .def("NbVisiblePart",
             ...
             R"#(None)#" )
        .def("VisiblePart",
             (void (HLRAlgo_EdgeStatus::*)( const Standard_Integer ,  Standard_Real & ,  Standard_ShortReal & ,  Standard_Real & ,  Standard_ShortReal &  ) const) static_cast<void (HLRAlgo_EdgeStatus::*)( const Standard_Integer ,  Standard_Real & ,  Standard_ShortReal & ,  Standard_Real & ,  Standard_ShortReal &  ) const>(&HLRAlgo_EdgeStatus::VisiblePart),
             R"#(None)#"  , py::arg("Index"),  py::arg("Start"),  py::arg("TolStart"),  py::arg("End"),  py::arg("TolEnd"))
        .def("Hide",
...
;
    ...
    static_cast<py::class_<HLRAlgo_HArray1OfPHDat ,std::unique_ptr<HLRAlgo_HArray1OfPHDat>  >>(m.attr("HLRAlgo_HArray1OfPHDat"))
...
;
    ...
    static_cast<py::class_<HLRAlgo_Interference ,std::unique_ptr<HLRAlgo_Interference>  >>(m.attr("HLRAlgo_Interference"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<HLRAlgo_HArray1OfPINod ,std::unique_ptr<HLRAlgo_HArray1OfPINod>  >>(m.attr("HLRAlgo_HArray1OfPINod"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<HLRAlgo_HArray1OfTData ,std::unique_ptr<HLRAlgo_HArray1OfTData>  >>(m.attr("HLRAlgo_HArray1OfTData"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    register_default_constructor<HLRAlgo ,std::unique_ptr<HLRAlgo>>(m,"HLRAlgo");

    static_cast<py::class_<HLRAlgo ,std::unique_ptr<HLRAlgo>  >>(m.attr("HLRAlgo"))
...
;
    ...
    static_cast<py::class_<HLRAlgo_HArray1OfPISeg ,std::unique_ptr<HLRAlgo_HArray1OfPISeg>  >>(m.attr("HLRAlgo_HArray1OfPISeg"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<HLRAlgo_Projector ,std::unique_ptr<HLRAlgo_Projector>  >>(m.attr("HLRAlgo_Projector"))
        .def(py::init<  >()  )
        ...
        .def("Project",
             (void (HLRAlgo_Projector::*)( const gp_Pnt & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (HLRAlgo_Projector::*)( const gp_Pnt & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&HLRAlgo_Projector::Project),
             R"#(Transform and apply perspective if needed.)#"  , py::arg("P"),  py::arg("X"),  py::arg("Y"),  py::arg("Z"))
        .def("Project",
...
;
    ...
    static_cast<py::class_<HLRAlgo_PolyHidingData ,std::unique_ptr<HLRAlgo_PolyHidingData>  >>(m.attr("HLRAlgo_PolyHidingData"))
        .def(py::init<  >()  )
        .def("Set",
...
;
    ...
    static_cast<py::class_<HLRAlgo_Coincidence ,std::unique_ptr<HLRAlgo_Coincidence>  >>(m.attr("HLRAlgo_Coincidence"))
        .def(py::init<  >()  )
        .def("Set2D",
        ...
        .def("Value2D",
             (void (HLRAlgo_Coincidence::*)( Standard_Integer & ,  Standard_Real &  ) const) static_cast<void (HLRAlgo_Coincidence::*)( Standard_Integer & ,  Standard_Real &  ) const>(&HLRAlgo_Coincidence::Value2D),
             R"#(None)#"  , py::arg("FE"),  py::arg("Param"))
        .def("State3D",
...
;
    ...
    static_cast<py::class_<HLRAlgo_Intersection ,std::unique_ptr<HLRAlgo_Intersection>  >>(m.attr("HLRAlgo_Intersection"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<HLRAlgo_BiPoint ,std::unique_ptr<HLRAlgo_BiPoint>  >>(m.attr("HLRAlgo_BiPoint"))
        .def(py::init<  >()  )
