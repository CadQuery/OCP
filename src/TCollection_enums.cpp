...
// classes forward declarations only
    ...
    py::class_<TCollection_BasicMapIterator ,std::unique_ptr<TCollection_BasicMapIterator>  >(m,"TCollection_BasicMapIterator",R"#(This class provides basic services for the iterators on Maps. The iterators are inherited from this one.)#");
