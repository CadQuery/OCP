...
// classes forward declarations only
    py::class_<ShapeConstruct ,std::unique_ptr<ShapeConstruct>  >(m,"ShapeConstruct",R"#(This package provides new algorithms for constructing new geometrical objects and topological shapes. It complements and extends algorithms available in Open CASCADE topological and geometrical toolkist. The functionality provided by this package are the following: projecting curves on surface, adjusting curve to have given start and end points. P)#");
    ...
    py::class_<ShapeConstruct_Curve ,std::unique_ptr<ShapeConstruct_Curve>  >(m,"ShapeConstruct_Curve",R"#(Adjusts curve to have start and end points at the given points (currently works on lines and B-Splines only))#");
    py::class_<ShapeConstruct_MakeTriangulation ,std::unique_ptr<ShapeConstruct_MakeTriangulation>  , BRepBuilderAPI_MakeShape >(m,"ShapeConstruct_MakeTriangulation",R"#(None)#");
