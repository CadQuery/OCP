...
// classes
    ...
    static_cast<py::class_<BRepFill_Sweep ,std::unique_ptr<BRepFill_Sweep>  >>(m.attr("BRepFill_Sweep"))
...
;
    ...
    static_cast<py::class_<BRepFill_LocationLaw ,opencascade::handle<BRepFill_LocationLaw>  , Standard_Transient >>(m.attr("BRepFill_LocationLaw"))
        ...
        .def("CurvilinearBounds",
             (void (BRepFill_LocationLaw::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (BRepFill_LocationLaw::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&BRepFill_LocationLaw::CurvilinearBounds),
             R"#(Return the Curvilinear Bounds of the <Index> Law)#"  , py::arg("Index"),  py::arg("First"),  py::arg("Last"))
        .def("IsClosed",
        ...
        .def("Parameter",
             (void (BRepFill_LocationLaw::*)( const Standard_Real ,  Standard_Integer & ,  Standard_Real &  ) ) static_cast<void (BRepFill_LocationLaw::*)( const Standard_Real ,  Standard_Integer & ,  Standard_Real &  ) >(&BRepFill_LocationLaw::Parameter),
             R"#(Find the index Law and the parmaeter, for a given Curnilinear abscissa)#"  , py::arg("Abscissa"),  py::arg("Index"),  py::arg("Param"))
        .def("Abscissa",
...
;
    ...
    static_cast<py::class_<BRepFill_OffsetAncestors ,std::unique_ptr<BRepFill_OffsetAncestors>  >>(m.attr("BRepFill_OffsetAncestors"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepFill_Generator ,std::unique_ptr<BRepFill_Generator>  >>(m.attr("BRepFill_Generator"))
        .def(py::init<  >()  )
        .def("AddWire",
...
;
    ...
    static_cast<py::class_<BRepFill_CompatibleWires ,std::unique_ptr<BRepFill_CompatibleWires>  >>(m.attr("BRepFill_CompatibleWires"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepFill_Draft ,std::unique_ptr<BRepFill_Draft>  >>(m.attr("BRepFill_Draft"))
...
;
    ...
    static_cast<py::class_<BRepFill_MultiLine ,std::unique_ptr<BRepFill_MultiLine>  , AppCont_Function >>(m.attr("BRepFill_MultiLine"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepFill_TrimSurfaceTool ,std::unique_ptr<BRepFill_TrimSurfaceTool>  >>(m.attr("BRepFill_TrimSurfaceTool"))
...
;
    ...
    register_default_constructor<BRepFill ,std::unique_ptr<BRepFill>>(m,"BRepFill");

    static_cast<py::class_<BRepFill ,std::unique_ptr<BRepFill>  >>(m.attr("BRepFill"))
        .def_static("Face_s",
        ...
        .def_static("Axe_s",
                    (void (*)( const TopoDS_Shape & ,  const TopoDS_Wire & ,  gp_Ax3 & ,  Standard_Boolean & ,  const Standard_Real  ) ) static_cast<void (*)( const TopoDS_Shape & ,  const TopoDS_Wire & ,  gp_Ax3 & ,  Standard_Boolean & ,  const Standard_Real  ) >(&BRepFill::Axe),
...
;
    ...
    static_cast<py::class_<BRepFill_TrimEdgeTool ,std::unique_ptr<BRepFill_TrimEdgeTool>  >>(m.attr("BRepFill_TrimEdgeTool"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepFill_TrimShellCorner ,std::unique_ptr<BRepFill_TrimShellCorner>  >>(m.attr("BRepFill_TrimShellCorner"))
...
;
    ...
    static_cast<py::class_<BRepFill_ApproxSeewing ,std::unique_ptr<BRepFill_ApproxSeewing>  >>(m.attr("BRepFill_ApproxSeewing"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepFill_ComputeCLine ,std::unique_ptr<BRepFill_ComputeCLine>  >>(m.attr("BRepFill_ComputeCLine"))
        ...
        .def("Error",
             (void (BRepFill_ComputeCLine::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (BRepFill_ComputeCLine::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&BRepFill_ComputeCLine::Error),
        ...
        .def("Parameters",
             (void (BRepFill_ComputeCLine::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (BRepFill_ComputeCLine::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&BRepFill_ComputeCLine::Parameters),
...
;
    ...
    static_cast<py::class_<BRepFill_SectionPlacement ,std::unique_ptr<BRepFill_SectionPlacement>  >>(m.attr("BRepFill_SectionPlacement"))
...
;
    ...
    static_cast<py::class_<BRepFill_Pipe ,std::unique_ptr<BRepFill_Pipe>  >>(m.attr("BRepFill_Pipe"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepFill_FaceAndOrder ,std::unique_ptr<BRepFill_FaceAndOrder>  >>(m.attr("BRepFill_FaceAndOrder"))
        .def(py::init<  >()  )
        .def(py::init< const TopoDS_Face &,const GeomAbs_Shape >()  , py::arg("aFace"),  py::arg("anOrder") )
;


    static_cast<py::class_<BRepFill_Section ,std::unique_ptr<BRepFill_Section>  >>(m.attr("BRepFill_Section"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepFill_Filling ,std::unique_ptr<BRepFill_Filling>  >>(m.attr("BRepFill_Filling"))
...
;
    ...
    static_cast<py::class_<BRepFill_OffsetWire ,std::unique_ptr<BRepFill_OffsetWire>  >>(m.attr("BRepFill_OffsetWire"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepFill_Evolved ,std::unique_ptr<BRepFill_Evolved>  >>(m.attr("BRepFill_Evolved"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepFill_EdgeFaceAndOrder ,std::unique_ptr<BRepFill_EdgeFaceAndOrder>  >>(m.attr("BRepFill_EdgeFaceAndOrder"))
        .def(py::init<  >()  )
