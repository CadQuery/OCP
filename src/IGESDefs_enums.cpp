...
// classes forward declarations only
    py::class_<IGESDefs_ToolMacroDef ,std::unique_ptr<IGESDefs_ToolMacroDef>  >(m,"IGESDefs_ToolMacroDef",R"#(Tool to work on a MacroDef. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDefs_HArray1OfTabularData ,std::unique_ptr<IGESDefs_HArray1OfTabularData>  >(m,"IGESDefs_HArray1OfTabularData",R"#()#");
    py::class_<IGESDefs_ToolAttributeDef ,std::unique_ptr<IGESDefs_ToolAttributeDef>  >(m,"IGESDefs_ToolAttributeDef",R"#(Tool to work on a AttributeDef. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDefs_ToolUnitsData ,std::unique_ptr<IGESDefs_ToolUnitsData>  >(m,"IGESDefs_ToolUnitsData",R"#(Tool to work on a UnitsData. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDefs_ToolAssociativityDef ,std::unique_ptr<IGESDefs_ToolAssociativityDef>  >(m,"IGESDefs_ToolAssociativityDef",R"#(Tool to work on a AssociativityDef. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDefs ,std::unique_ptr<IGESDefs>  >(m,"IGESDefs",R"#(To embody general definitions of Entities (Parameters, Tables ...))#");
    ...
    py::class_<IGESDefs_ToolAttributeTable ,std::unique_ptr<IGESDefs_ToolAttributeTable>  >(m,"IGESDefs_ToolAttributeTable",R"#(Tool to work on a AttributeTable. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESDefs_ToolGenericData ,std::unique_ptr<IGESDefs_ToolGenericData>  >(m,"IGESDefs_ToolGenericData",R"#(Tool to work on a GenericData. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESDefs_ToolTabularData ,std::unique_ptr<IGESDefs_ToolTabularData>  >(m,"IGESDefs_ToolTabularData",R"#(Tool to work on a TabularData. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
