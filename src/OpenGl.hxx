...
void preregister_template_OpenGl_TmplCore20(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore20<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore20<theBaseClass_t>> >(m,name,R"#(OpenGL 2.0 core based on 1.5 version.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore20(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore20<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore20<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore44(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore44<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore44<theBaseClass_t>> >(m,name,R"#(OpenGL 4.4 definition.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore44(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore44<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore44<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_MatrixState(py::object &m, const char *name){
    py::class_<OpenGl_MatrixState<T> ,std::unique_ptr<OpenGl_MatrixState<T>> >(m,name,R"#(Software implementation for OpenGL matrix stack.)#");
}

template <typename T>
void register_template_OpenGl_MatrixState(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_MatrixState<T> ,std::unique_ptr<OpenGl_MatrixState<T>> >>(m.attr(name))
        .def(py::init<  >()  )
        .def("Push",
...
void preregister_template_OpenGl_TmplCore40(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore40<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore40<theBaseClass_t>> >(m,name,R"#(OpenGL 4.0 definition.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore40(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore40<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore40<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore21(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore21<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore21<theBaseClass_t>> >(m,name,R"#(OpenGL 2.1 core based on 2.0 version.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore21(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore21<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore21<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_VariableSetter(py::object &m, const char *name){
    py::class_<OpenGl_VariableSetter<T> ,std::unique_ptr<OpenGl_VariableSetter<T>> >(m,name,R"#(None)#");
}

template <typename T>
void register_template_OpenGl_VariableSetter(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_VariableSetter<T> ,std::unique_ptr<OpenGl_VariableSetter<T>> >>(m.attr(name))
        .def("Set",
...
void preregister_template_OpenGl_TmplCore12(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore12<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore12<theBaseClass_t>> >(m,name,R"#(OpenGL 1.2 core based on 1.1 version.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore12(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore12<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore12<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore15(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore15<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore15<theBaseClass_t>> >(m,name,R"#(OpenGL 1.5 core based on 1.4 version.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore15(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore15<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore15<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore41(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore41<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore41<theBaseClass_t>> >(m,name,R"#(OpenGL 4.1 definition.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore41(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore41<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore41<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore33(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore33<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore33<theBaseClass_t>> >(m,name,R"#(OpenGL 3.3 definition.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore33(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore33<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore33<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore43(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore43<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore43<theBaseClass_t>> >(m,name,R"#(OpenGL 4.3 definition.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore43(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore43<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore43<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TextureFormatSelector(py::object &m, const char *name){
    py::class_<OpenGl_TextureFormatSelector<T> ,std::unique_ptr<OpenGl_TextureFormatSelector<T>> >(m,name,R"#(Selects preferable texture format for specified parameters.)#");
}

template <typename T>
void register_template_OpenGl_TextureFormatSelector(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TextureFormatSelector<T> ,std::unique_ptr<OpenGl_TextureFormatSelector<T>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore14(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore14<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore14<theBaseClass_t>> >(m,name,R"#(OpenGL 1.4 core based on 1.3 version.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore14(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore14<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore14<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore31(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore31<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore31<theBaseClass_t>> >(m,name,R"#(OpenGL 3.1 definition.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore31(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore31<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore31<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void register_template_OpenGl_TmplCore30(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore30<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore30<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore32(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore32<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore32<theBaseClass_t>> >(m,name,R"#(OpenGL 3.2 definition.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore32(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore32<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore32<theBaseClass_t>> >>(m.attr(name))
    ;
};
...
void preregister_template_OpenGl_TmplCore42(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore42<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore42<theBaseClass_t>> >(m,name,R"#(OpenGL 4.2 definition.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore42(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore42<theBaseClass_t> ,std::unique_ptr<OpenGl_TmplCore42<theBaseClass_t>> >>(m.attr(name))
    ;
};
