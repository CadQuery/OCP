...
// classes
    ...
    static_cast<py::class_<TopOpeBRepTool_face ,std::unique_ptr<TopOpeBRepTool_face>  >>(m.attr("TopOpeBRepTool_face"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_CurveTool ,std::unique_ptr<TopOpeBRepTool_CurveTool>  >>(m.attr("TopOpeBRepTool_CurveTool"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_makeTransition ,std::unique_ptr<TopOpeBRepTool_makeTransition>  >>(m.attr("TopOpeBRepTool_makeTransition"))
        .def(py::init<  >()  )
        .def("Initialize",
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_CORRISO ,std::unique_ptr<TopOpeBRepTool_CORRISO>  >>(m.attr("TopOpeBRepTool_CORRISO"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_ShapeClassifier ,std::unique_ptr<TopOpeBRepTool_ShapeClassifier>  >>(m.attr("TopOpeBRepTool_ShapeClassifier"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_mkTondgE ,std::unique_ptr<TopOpeBRepTool_mkTondgE>  >>(m.attr("TopOpeBRepTool_mkTondgE"))
        .def(py::init<  >()  )
        .def("Initialize",
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_C2DF ,std::unique_ptr<TopOpeBRepTool_C2DF>  >>(m.attr("TopOpeBRepTool_C2DF"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<TopOpeBRepTool_ShapeTool ,std::unique_ptr<TopOpeBRepTool_ShapeTool>>(m,"TopOpeBRepTool_ShapeTool");

    static_cast<py::class_<TopOpeBRepTool_ShapeTool ,std::unique_ptr<TopOpeBRepTool_ShapeTool>  >>(m.attr("TopOpeBRepTool_ShapeTool"))
        ...
        .def_static("UVBOUNDS_s",
                    (void (*)( const opencascade::handle<Geom_Surface> & ,  Standard_Boolean & ,  Standard_Boolean & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const opencascade::handle<Geom_Surface> & ,  Standard_Boolean & ,  Standard_Boolean & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&TopOpeBRepTool_ShapeTool::UVBOUNDS),
                    R"#(None)#"  , py::arg("S"),  py::arg("UPeri"),  py::arg("VPeri"),  py::arg("Umin"),  py::arg("Umax"),  py::arg("Vmin"),  py::arg("Vmax"))
        .def_static("UVBOUNDS_s",
                    (void (*)( const TopoDS_Face & ,  Standard_Boolean & ,  Standard_Boolean & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const TopoDS_Face & ,  Standard_Boolean & ,  Standard_Boolean & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&TopOpeBRepTool_ShapeTool::UVBOUNDS),
                    R"#(None)#"  , py::arg("F"),  py::arg("UPeri"),  py::arg("VPeri"),  py::arg("Umin"),  py::arg("Umax"),  py::arg("Vmin"),  py::arg("Vmax"))
        .def_static("AdjustOnPeriodic_s",
                    (void (*)( const TopoDS_Shape & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const TopoDS_Shape & ,  Standard_Real & ,  Standard_Real &  ) >(&TopOpeBRepTool_ShapeTool::AdjustOnPeriodic),
                    R"#(ajust u,v values in UVBounds of the domain of the geometric shape <S>, according to Uperiodicity and VPeriodicity of the domain. <S> is assumed to be a face. u and/or v is/are not modified when the domain is not periodic in U and/or V .)#"  , py::arg("S"),  py::arg("u"),  py::arg("v"))
        .def_static("Closed_s",
...
;
    ...
    register_default_constructor<TopOpeBRepTool_TOOL ,std::unique_ptr<TopOpeBRepTool_TOOL>>(m,"TopOpeBRepTool_TOOL");

    static_cast<py::class_<TopOpeBRepTool_TOOL ,std::unique_ptr<TopOpeBRepTool_TOOL>  >>(m.attr("TopOpeBRepTool_TOOL"))
        ...
        .def_static("stuvF_s",
                    (void (*)( const gp_Pnt2d & ,  const TopoDS_Face & ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (*)( const gp_Pnt2d & ,  const TopoDS_Face & ,  Standard_Integer & ,  Standard_Integer &  ) >(&TopOpeBRepTool_TOOL::stuvF),
                    R"#(None)#"  , py::arg("uv"),  py::arg("F"),  py::arg("onU"),  py::arg("onV"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_GeomTool ,std::unique_ptr<TopOpeBRepTool_GeomTool>  >>(m.attr("TopOpeBRepTool_GeomTool"))
        ...
        .def("Define",
             ...
             R"#(None)#"  , py::arg("GT"))
        .def("GetTolerances",
             (void (TopOpeBRepTool_GeomTool::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (TopOpeBRepTool_GeomTool::*)( Standard_Real & ,  Standard_Real &  ) const>(&TopOpeBRepTool_GeomTool::GetTolerances),
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_REGUW ,std::unique_ptr<TopOpeBRepTool_REGUW>  >>(m.attr("TopOpeBRepTool_REGUW"))
        .def(py::init< const TopoDS_Face & >()  , py::arg("FRef") )
        .def("Fref",
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_connexity ,std::unique_ptr<TopOpeBRepTool_connexity>  >>(m.attr("TopOpeBRepTool_connexity"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_CLASSI ,std::unique_ptr<TopOpeBRepTool_CLASSI>  >>(m.attr("TopOpeBRepTool_CLASSI"))
        .def(py::init<  >()  )
        .def("Init2d",
...
;
    ...
    register_default_constructor<TopOpeBRepTool_AncestorsTool ,std::unique_ptr<TopOpeBRepTool_AncestorsTool>>(m,"TopOpeBRepTool_AncestorsTool");

    static_cast<py::class_<TopOpeBRepTool_AncestorsTool ,std::unique_ptr<TopOpeBRepTool_AncestorsTool>  >>(m.attr("TopOpeBRepTool_AncestorsTool"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_REGUS ,std::unique_ptr<TopOpeBRepTool_REGUS>  >>(m.attr("TopOpeBRepTool_REGUS"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    register_default_constructor<TopOpeBRepTool ,std::unique_ptr<TopOpeBRepTool>>(m,"TopOpeBRepTool");

    static_cast<py::class_<TopOpeBRepTool ,std::unique_ptr<TopOpeBRepTool>  >>(m.attr("TopOpeBRepTool"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_BoxSort ,std::unique_ptr<TopOpeBRepTool_BoxSort>  >>(m.attr("TopOpeBRepTool_BoxSort"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_FuseEdges ,std::unique_ptr<TopOpeBRepTool_FuseEdges>  >>(m.attr("TopOpeBRepTool_FuseEdges"))
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_SolidClassifier ,std::unique_ptr<TopOpeBRepTool_SolidClassifier>  >>(m.attr("TopOpeBRepTool_SolidClassifier"))
        .def(py::init<  >()  )
        .def("Clear",
...
;
    ...
    static_cast<py::class_<TopOpeBRepTool_PurgeInternalEdges ,std::unique_ptr<TopOpeBRepTool_PurgeInternalEdges>  >>(m.attr("TopOpeBRepTool_PurgeInternalEdges"))
