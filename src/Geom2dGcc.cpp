...
// classes
    ...
    static_cast<py::class_<Geom2dGcc_Circ2d2TanOnIter ,std::unique_ptr<Geom2dGcc_Circ2d2TanOnIter>  >>(m.attr("Geom2dGcc_Circ2d2TanOnIter"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Circ2d2TanOnIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanOnIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanOnIter::Tangency1),
             R"#(Returns information about the tangency point between the result and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv. It raises NotDone if the construction algorithm didn't succeed.)#"  , py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("Tangency2",
             (void (Geom2dGcc_Circ2d2TanOnIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanOnIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanOnIter::Tangency2),
             R"#(Returns information about the tangency point between the result and the second argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv. It raises NotDone if the construction algorithm didn't succeed.)#"  , py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("CenterOn3",
             (void (Geom2dGcc_Circ2d2TanOnIter::*)( Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanOnIter::*)( Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanOnIter::CenterOn3),
             R"#(Returns information about the center (on the curv) of the result and the third argument. It raises NotDone if the construction algorithm didn't succeed.)#"  , py::arg("ParArg"),  py::arg("PntSol"))
        .def("IsTheSame1",
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2d2TanRad ,std::unique_ptr<Geom2dGcc_Circ2d2TanRad>  >>(m.attr("Geom2dGcc_Circ2d2TanRad"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Circ2d2TanRad::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanRad::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanRad::Tangency1),
        ...
        .def("Tangency2",
             (void (Geom2dGcc_Circ2d2TanRad::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanRad::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanRad::Tangency2),
...
;
    ...
    static_cast<py::class_<Geom2dGcc_QualifiedCurve ,std::unique_ptr<Geom2dGcc_QualifiedCurve>  >>(m.attr("Geom2dGcc_QualifiedCurve"))
...
;
    ...
    static_cast<py::class_<Geom2dGcc_FunctionTanCuCuCu ,std::unique_ptr<Geom2dGcc_FunctionTanCuCuCu>  , math_FunctionSetWithDerivatives >>(m.attr("Geom2dGcc_FunctionTanCuCuCu"))
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2d2TanRadGeo ,std::unique_ptr<Geom2dGcc_Circ2d2TanRadGeo>  >>(m.attr("Geom2dGcc_Circ2d2TanRadGeo"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Circ2d2TanRadGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanRadGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanRadGeo::Tangency1),
             R"#(Returns information about the tangency point between the result number Index and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution. ParArg is the intrinsic parameter of the point PntSol on the first argument. It raises OutOfRange if Index is greater than the number of solutions. It raises NotDone if the construction algorithm did not succeed.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("Tangency2",
             (void (Geom2dGcc_Circ2d2TanRadGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanRadGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanRadGeo::Tangency2),
             R"#(Returns information about the tangency point between the result number Index and the second argument. ParSol is the intrinsic parameter of the point PntSol on the solution. ParArg is the intrinsic parameter of the point PntArg on the second argument. It raises OutOfRange if Index is greater than the number of solutions. It raises NotDone if the construction algorithm did not succeed.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("IsTheSame1",
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Lin2d2Tan ,std::unique_ptr<Geom2dGcc_Lin2d2Tan>  >>(m.attr("Geom2dGcc_Lin2d2Tan"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Lin2d2Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Lin2d2Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Lin2d2Tan::Tangency1),
        ...
        .def("Tangency2",
             (void (Geom2dGcc_Lin2d2Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Lin2d2Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Lin2d2Tan::Tangency2),
             R"#(Returns informations about the tangency point between the result and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv. Exceptions Standard_OutOfRange if Index is less than zero or greater than the number of solutions computed by this algorithm. StdFail_NotDone if the construction fails.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
;


    static_cast<py::class_<Geom2dGcc_QCurve ,std::unique_ptr<Geom2dGcc_QCurve>  >>(m.attr("Geom2dGcc_QCurve"))
        .def(py::init< const Geom2dAdaptor_Curve &,const GccEnt_Position >()  , py::arg("Curve"),  py::arg("Qualifier") )
        .def("Qualified",
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2d3TanIter ,std::unique_ptr<Geom2dGcc_Circ2d3TanIter>  >>(m.attr("Geom2dGcc_Circ2d3TanIter"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Circ2d3TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d3TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d3TanIter::Tangency1),
        ...
        .def("Tangency2",
             (void (Geom2dGcc_Circ2d3TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d3TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d3TanIter::Tangency2),
        ...
        .def("Tangency3",
             (void (Geom2dGcc_Circ2d3TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d3TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d3TanIter::Tangency3),
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Lin2dTanOblIter ,std::unique_ptr<Geom2dGcc_Lin2dTanOblIter>  >>(m.attr("Geom2dGcc_Lin2dTanOblIter"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Lin2dTanOblIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Lin2dTanOblIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Lin2dTanOblIter::Tangency1),
             R"#(None)#"  , py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("Intersection2",
             (void (Geom2dGcc_Lin2dTanOblIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Lin2dTanOblIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Lin2dTanOblIter::Intersection2),
             R"#(None)#"  , py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("IsParallel2",
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2d3Tan ,std::unique_ptr<Geom2dGcc_Circ2d3Tan>  >>(m.attr("Geom2dGcc_Circ2d3Tan"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Circ2d3Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d3Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d3Tan::Tangency1),
             R"#(Returns informations about the tangency point between the result and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("Tangency2",
             (void (Geom2dGcc_Circ2d3Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d3Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d3Tan::Tangency2),
             R"#(Returns informations about the tangency point between the result and the second argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("Tangency3",
             (void (Geom2dGcc_Circ2d3Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d3Tan::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d3Tan::Tangency3),
             R"#(Returns informations about the tangency point between the result and the third argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("IsTheSame1",
...
;
    ...
    register_default_constructor<Geom2dGcc ,std::unique_ptr<Geom2dGcc>>(m,"Geom2dGcc");

    static_cast<py::class_<Geom2dGcc ,std::unique_ptr<Geom2dGcc>  >>(m.attr("Geom2dGcc"))
...
;
    ...
    static_cast<py::class_<Geom2dGcc_FunctionTanCirCu ,std::unique_ptr<Geom2dGcc_FunctionTanCirCu>  , math_FunctionWithDerivative >>(m.attr("Geom2dGcc_FunctionTanCirCu"))
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Lin2d2TanIter ,std::unique_ptr<Geom2dGcc_Lin2d2TanIter>  >>(m.attr("Geom2dGcc_Lin2d2TanIter"))
        ...
        .def("WhichQualifier",
             ...
             R"#(None)#"  , py::arg("Qualif1"),  py::arg("Qualif2"))
        .def("Tangency1",
             (void (Geom2dGcc_Lin2d2TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Lin2d2TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Lin2d2TanIter::Tangency1),
             R"#(Returns informations about the tangency point between the result and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv.)#"  , py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("Tangency2",
             (void (Geom2dGcc_Lin2d2TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Lin2d2TanIter::*)( Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Lin2d2TanIter::Tangency2),
             R"#(None)#"  , py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
;


    static_cast<py::class_<Geom2dGcc_FunctionTanObl ,std::unique_ptr<Geom2dGcc_FunctionTanObl>  , math_FunctionWithDerivative >>(m.attr("Geom2dGcc_FunctionTanObl"))
...
;
    ...
    static_cast<py::class_<Geom2dGcc_FunctionTanCuCu ,std::unique_ptr<Geom2dGcc_FunctionTanCuCu>  , math_FunctionSetWithDerivatives >>(m.attr("Geom2dGcc_FunctionTanCuCu"))
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2dTanCenGeo ,std::unique_ptr<Geom2dGcc_Circ2dTanCenGeo>  >>(m.attr("Geom2dGcc_Circ2dTanCenGeo"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Circ2dTanCenGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2dTanCenGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2dTanCenGeo::Tangency1),
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2d2TanOnGeo ,std::unique_ptr<Geom2dGcc_Circ2d2TanOnGeo>  >>(m.attr("Geom2dGcc_Circ2d2TanOnGeo"))
        ...
        .def("WhichQualifier",
             ...
             R"#(It returns the informations about the qualifiers of the tangency arguments concerning the solution number Index. It returns the real qualifiers (the qualifiers given to the constructor method in case of enclosed, enclosing and outside and the qualifiers computedin case of unqualified).)#"  , py::arg("Index"),  py::arg("Qualif1"),  py::arg("Qualif2"))
        .def("Tangency1",
             (void (Geom2dGcc_Circ2d2TanOnGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanOnGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanOnGeo::Tangency1),
        ...
        .def("Tangency2",
             (void (Geom2dGcc_Circ2d2TanOnGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanOnGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanOnGeo::Tangency2),
        ...
        .def("CenterOn3",
             (void (Geom2dGcc_Circ2d2TanOnGeo::*)( const Standard_Integer ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanOnGeo::*)( const Standard_Integer ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanOnGeo::CenterOn3),
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2dTanCen ,std::unique_ptr<Geom2dGcc_Circ2dTanCen>  >>(m.attr("Geom2dGcc_Circ2dTanCen"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Circ2dTanCen::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2dTanCen::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2dTanCen::Tangency1),
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Lin2dTanObl ,std::unique_ptr<Geom2dGcc_Lin2dTanObl>  >>(m.attr("Geom2dGcc_Lin2dTanObl"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Lin2dTanObl::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Lin2dTanObl::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Lin2dTanObl::Tangency1),
             R"#(Returns informations about the tangency point between the result and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("Intersection2",
             (void (Geom2dGcc_Lin2dTanObl::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Lin2dTanObl::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Lin2dTanObl::Intersection2),
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2dTanOnRadGeo ,std::unique_ptr<Geom2dGcc_Circ2dTanOnRadGeo>  >>(m.attr("Geom2dGcc_Circ2dTanOnRadGeo"))
        ...
        .def("WhichQualifier",
             ...
             R"#(None)#"  , py::arg("Index"),  py::arg("Qualif1"))
        .def("Tangency1",
             (void (Geom2dGcc_Circ2dTanOnRadGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2dTanOnRadGeo::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2dTanOnRadGeo::Tangency1),
             R"#(Returns informations about the tangency point between the result number Index and the first argument. ParSol is the intrinsic parameter of the point on the solution curv. ParArg is the intrinsic parameter of the point on the argument curv. PntSol is the tangency point on the solution curv. PntArg is the tangency point on the argument curv. It raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("CenterOn3",
             (void (Geom2dGcc_Circ2dTanOnRadGeo::*)( const Standard_Integer ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2dTanOnRadGeo::*)( const Standard_Integer ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2dTanOnRadGeo::CenterOn3),
             R"#(Returns informations about the center (on the curv) of the result. ParArg is the intrinsic parameter of the point on the argument curv. PntSol is the center point of the solution curv. It raises NotDone if the construction algorithm didn't succeed. It raises OutOfRange if Index is greater than the number of solutions.)#"  , py::arg("Index"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("IsTheSame1",
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2dTanOnRad ,std::unique_ptr<Geom2dGcc_Circ2dTanOnRad>  >>(m.attr("Geom2dGcc_Circ2dTanOnRad"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Circ2dTanOnRad::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2dTanOnRad::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2dTanOnRad::Tangency1),
        ...
        .def("CenterOn3",
             (void (Geom2dGcc_Circ2dTanOnRad::*)( const Standard_Integer ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2dTanOnRad::*)( const Standard_Integer ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2dTanOnRad::CenterOn3),
...
;
    ...
    register_default_constructor<Geom2dGcc_CurveTool ,std::unique_ptr<Geom2dGcc_CurveTool>>(m,"Geom2dGcc_CurveTool");

    static_cast<py::class_<Geom2dGcc_CurveTool ,std::unique_ptr<Geom2dGcc_CurveTool>  >>(m.attr("Geom2dGcc_CurveTool"))
...
;
    ...
    static_cast<py::class_<Geom2dGcc_FunctionTanCuPnt ,std::unique_ptr<Geom2dGcc_FunctionTanCuPnt>  , math_FunctionWithDerivative >>(m.attr("Geom2dGcc_FunctionTanCuPnt"))
...
;
    ...
    static_cast<py::class_<Geom2dGcc_FunctionTanCuCuOnCu ,std::unique_ptr<Geom2dGcc_FunctionTanCuCuOnCu>  , math_FunctionSetWithDerivatives >>(m.attr("Geom2dGcc_FunctionTanCuCuOnCu"))
...
;
    ...
    static_cast<py::class_<Geom2dGcc_Circ2d2TanOn ,std::unique_ptr<Geom2dGcc_Circ2d2TanOn>  >>(m.attr("Geom2dGcc_Circ2d2TanOn"))
        ...
        .def("Tangency1",
             (void (Geom2dGcc_Circ2d2TanOn::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanOn::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanOn::Tangency1),
             R"#(Returns informations about the tangency point between the result and the first argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("Tangency2",
             (void (Geom2dGcc_Circ2d2TanOn::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanOn::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanOn::Tangency2),
             R"#(Returns informations about the tangency point between the result and the second argument. ParSol is the intrinsic parameter of the point PntSol on the solution curv. ParArg is the intrinsic parameter of the point PntSol on the argument curv.)#"  , py::arg("Index"),  py::arg("ParSol"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("CenterOn3",
             (void (Geom2dGcc_Circ2d2TanOn::*)( const Standard_Integer ,  Standard_Real & ,  gp_Pnt2d &  ) const) static_cast<void (Geom2dGcc_Circ2d2TanOn::*)( const Standard_Integer ,  Standard_Real & ,  gp_Pnt2d &  ) const>(&Geom2dGcc_Circ2d2TanOn::CenterOn3),
             R"#(Returns the center PntSol of the solution of index Index computed by this algorithm. ParArg is the parameter of the point PntSol on the third argument. Exceptions Standard_OutOfRange if Index is less than zero or greater than the number of solutions computed by this algorithm. StdFail_NotDone if the construction fails.)#"  , py::arg("Index"),  py::arg("ParArg"),  py::arg("PntSol"))
        .def("IsTheSame1",
