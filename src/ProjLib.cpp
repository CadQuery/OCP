...
// classes
    ...
    static_cast<py::class_<ProjLib_Projector ,std::unique_ptr<ProjLib_Projector>  >>(m.attr("ProjLib_Projector"))
        .def(py::init<  >()  )
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<ProjLib_Cylinder ,std::unique_ptr<ProjLib_Cylinder>  , ProjLib_Projector >>(m.attr("ProjLib_Cylinder"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ProjLib_ProjectedCurve ,std::unique_ptr<ProjLib_ProjectedCurve>  , Adaptor2d_Curve2d >>(m.attr("ProjLib_ProjectedCurve"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ProjLib_Plane ,std::unique_ptr<ProjLib_Plane>  , ProjLib_Projector >>(m.attr("ProjLib_Plane"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ProjLib_ComputeApproxOnPolarSurface ,std::unique_ptr<ProjLib_ComputeApproxOnPolarSurface>  >>(m.attr("ProjLib_ComputeApproxOnPolarSurface"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ProjLib_CompProjectedCurve ,std::unique_ptr<ProjLib_CompProjectedCurve>  , Adaptor2d_Curve2d >>(m.attr("ProjLib_CompProjectedCurve"))
        .def(py::init<  >()  )
        ...
        .def("GetCurve",
             ...
             R"#(None)#" )
        .def("GetTolerance",
             (void (ProjLib_CompProjectedCurve::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (ProjLib_CompProjectedCurve::*)( Standard_Real & ,  Standard_Real &  ) const>(&ProjLib_CompProjectedCurve::GetTolerance),
             R"#(None)#"  , py::arg("TolU"),  py::arg("TolV"))
        .def("NbCurves",
        ...
        .def("Bounds",
             (void (ProjLib_CompProjectedCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (ProjLib_CompProjectedCurve::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&ProjLib_CompProjectedCurve::Bounds),
             R"#(returns the bounds of the continuous part corresponding to Index)#"  , py::arg("Index"),  py::arg("Udeb"),  py::arg("Ufin"))
        .def("IsSinglePnt",
...
;
    ...
    static_cast<py::class_<ProjLib_PrjResolve ,std::unique_ptr<ProjLib_PrjResolve>  >>(m.attr("ProjLib_PrjResolve"))
...
;
    ...
    static_cast<py::class_<ProjLib_Cone ,std::unique_ptr<ProjLib_Cone>  , ProjLib_Projector >>(m.attr("ProjLib_Cone"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ProjLib_ProjectOnSurface ,std::unique_ptr<ProjLib_ProjectOnSurface>  >>(m.attr("ProjLib_ProjectOnSurface"))
        .def(py::init<  >()  )
        .def(py::init< const opencascade::handle<Adaptor3d_HSurface> & >()  , py::arg("S") )
        .def("Load",
...
;
    ...
    register_default_constructor<ProjLib ,std::unique_ptr<ProjLib>>(m,"ProjLib");

    static_cast<py::class_<ProjLib ,std::unique_ptr<ProjLib>  >>(m.attr("ProjLib"))
...
;
    ...
    static_cast<py::class_<ProjLib_PrjFunc ,std::unique_ptr<ProjLib_PrjFunc>  , math_FunctionSetWithDerivatives >>(m.attr("ProjLib_PrjFunc"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<ProjLib_HSequenceOfHSequenceOfPnt ,std::unique_ptr<ProjLib_HSequenceOfHSequenceOfPnt>  >>(m.attr("ProjLib_HSequenceOfHSequenceOfPnt"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ProjLib_ProjectOnPlane ,std::unique_ptr<ProjLib_ProjectOnPlane>  , Adaptor3d_Curve >>(m.attr("ProjLib_ProjectOnPlane"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ProjLib_Sphere ,std::unique_ptr<ProjLib_Sphere>  , ProjLib_Projector >>(m.attr("ProjLib_Sphere"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ProjLib_ComputeApprox ,std::unique_ptr<ProjLib_ComputeApprox>  >>(m.attr("ProjLib_ComputeApprox"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<ProjLib_Torus ,std::unique_ptr<ProjLib_Torus>  , ProjLib_Projector >>(m.attr("ProjLib_Torus"))
        .def(py::init<  >()  )
