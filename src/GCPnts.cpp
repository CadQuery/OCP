...
// classes
    ...
    static_cast<py::class_<GCPnts_TangentialDeflection ,std::unique_ptr<GCPnts_TangentialDeflection>  >>(m.attr("GCPnts_TangentialDeflection"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GCPnts_QuasiUniformAbscissa ,std::unique_ptr<GCPnts_QuasiUniformAbscissa>  >>(m.attr("GCPnts_QuasiUniformAbscissa"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GCPnts_UniformDeflection ,std::unique_ptr<GCPnts_UniformDeflection>  >>(m.attr("GCPnts_UniformDeflection"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GCPnts_UniformAbscissa ,std::unique_ptr<GCPnts_UniformAbscissa>  >>(m.attr("GCPnts_UniformAbscissa"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GCPnts_AbscissaPoint ,std::unique_ptr<GCPnts_AbscissaPoint>  >>(m.attr("GCPnts_AbscissaPoint"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<GCPnts_QuasiUniformDeflection ,std::unique_ptr<GCPnts_QuasiUniformDeflection>  >>(m.attr("GCPnts_QuasiUniformDeflection"))
        .def(py::init<  >()  )
