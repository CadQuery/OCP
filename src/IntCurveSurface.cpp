...
// classes
    ...
    static_cast<py::class_<IntCurveSurface_Intersection ,std::unique_ptr<IntCurveSurface_Intersection, py::nodelete>  >>(m.attr("IntCurveSurface_Intersection"))
        .def("IsDone",
...
;
    ...
    static_cast<py::class_<IntCurveSurface_TheExactHInter ,std::unique_ptr<IntCurveSurface_TheExactHInter>  >>(m.attr("IntCurveSurface_TheExactHInter"))
        ...
        .def("ParameterOnSurface",
             (void (IntCurveSurface_TheExactHInter::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IntCurveSurface_TheExactHInter::*)( Standard_Real & ,  Standard_Real &  ) const>(&IntCurveSurface_TheExactHInter::ParameterOnSurface),
...
;
    ...
    static_cast<py::class_<IntCurveSurface_TheInterferenceOfHInter ,std::unique_ptr<IntCurveSurface_TheInterferenceOfHInter>  , Intf_Interference >>(m.attr("IntCurveSurface_TheInterferenceOfHInter"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IntCurveSurface_ThePolyhedronOfHInter ,std::unique_ptr<IntCurveSurface_ThePolyhedronOfHInter>  >>(m.attr("IntCurveSurface_ThePolyhedronOfHInter"))
        ...
        .def("Size",
             (void (IntCurveSurface_ThePolyhedronOfHInter::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (IntCurveSurface_ThePolyhedronOfHInter::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&IntCurveSurface_ThePolyhedronOfHInter::Size),
        ...
        .def("Triangle",
             (void (IntCurveSurface_ThePolyhedronOfHInter::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (IntCurveSurface_ThePolyhedronOfHInter::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&IntCurveSurface_ThePolyhedronOfHInter::Triangle),
        ...
        .def("DeflectionOverEstimation",
             ...
             R"#(None)#" )
        .def("PlaneEquation",
             (void (IntCurveSurface_ThePolyhedronOfHInter::*)( const Standard_Integer ,  gp_XYZ & ,  Standard_Real &  ) const) static_cast<void (IntCurveSurface_ThePolyhedronOfHInter::*)( const Standard_Integer ,  gp_XYZ & ,  Standard_Real &  ) const>(&IntCurveSurface_ThePolyhedronOfHInter::PlaneEquation),
        ...
        .def("Parameters",
             (void (IntCurveSurface_ThePolyhedronOfHInter::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IntCurveSurface_ThePolyhedronOfHInter::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&IntCurveSurface_ThePolyhedronOfHInter::Parameters),
...
;
    ...
    static_cast<py::class_<IntCurveSurface_IntersectionSegment ,std::unique_ptr<IntCurveSurface_IntersectionSegment>  >>(m.attr("IntCurveSurface_IntersectionSegment"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IntCurveSurface_HInter ,std::unique_ptr<IntCurveSurface_HInter>  , IntCurveSurface_Intersection >>(m.attr("IntCurveSurface_HInter"))
        .def(py::init<  >()  )
        .def("Perform",
...
;
    ...
    static_cast<py::class_<IntCurveSurface_IntersectionPoint ,std::unique_ptr<IntCurveSurface_IntersectionPoint>  >>(m.attr("IntCurveSurface_IntersectionPoint"))
        .def(py::init<  >()  )
        ...
        .def("Values",
             (void (IntCurveSurface_IntersectionPoint::*)( gp_Pnt & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  IntCurveSurface_TransitionOnCurve &  ) const) static_cast<void (IntCurveSurface_IntersectionPoint::*)( gp_Pnt & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  IntCurveSurface_TransitionOnCurve &  ) const>(&IntCurveSurface_IntersectionPoint::Values),
             R"#(Get the fields of the current IntersectionPoint.)#"  , py::arg("P"),  py::arg("USurf"),  py::arg("VSurf"),  py::arg("UCurv"),  py::arg("TrCurv"))
        .def("Pnt",
...
;
    ...
    static_cast<py::class_<IntCurveSurface_ThePolygonOfHInter ,std::unique_ptr<IntCurveSurface_ThePolygonOfHInter>  >>(m.attr("IntCurveSurface_ThePolygonOfHInter"))
...
;
    ...
    register_default_constructor<IntCurveSurface_ThePolygonToolOfHInter ,std::unique_ptr<IntCurveSurface_ThePolygonToolOfHInter>>(m,"IntCurveSurface_ThePolygonToolOfHInter");

    static_cast<py::class_<IntCurveSurface_ThePolygonToolOfHInter ,std::unique_ptr<IntCurveSurface_ThePolygonToolOfHInter>  >>(m.attr("IntCurveSurface_ThePolygonToolOfHInter"))
...
;
    ...
    static_cast<py::class_<IntCurveSurface_TheQuadCurvFuncOfTheQuadCurvExactHInter ,std::unique_ptr<IntCurveSurface_TheQuadCurvFuncOfTheQuadCurvExactHInter>  , math_FunctionWithDerivative >>(m.attr("IntCurveSurface_TheQuadCurvFuncOfTheQuadCurvExactHInter"))
...
;
    ...
    static_cast<py::class_<IntCurveSurface_TheQuadCurvExactHInter ,std::unique_ptr<IntCurveSurface_TheQuadCurvExactHInter>  >>(m.attr("IntCurveSurface_TheQuadCurvExactHInter"))
        ...
        .def("NbIntervals",
             ...
             R"#(None)#" )
        .def("Intervals",
             (void (IntCurveSurface_TheQuadCurvExactHInter::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IntCurveSurface_TheQuadCurvExactHInter::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&IntCurveSurface_TheQuadCurvExactHInter::Intervals),
             R"#(U1 and U2 are the parameters of a segment on the curve.)#"  , py::arg("Index"),  py::arg("U1"),  py::arg("U2"))
;

    register_default_constructor<IntCurveSurface_TheHCurveTool ,std::unique_ptr<IntCurveSurface_TheHCurveTool>>(m,"IntCurveSurface_TheHCurveTool");

    static_cast<py::class_<IntCurveSurface_TheHCurveTool ,std::unique_ptr<IntCurveSurface_TheHCurveTool>  >>(m.attr("IntCurveSurface_TheHCurveTool"))
...
;
    ...
    static_cast<py::class_<IntCurveSurface_TheCSFunctionOfHInter ,std::unique_ptr<IntCurveSurface_TheCSFunctionOfHInter>  , math_FunctionSetWithDerivatives >>(m.attr("IntCurveSurface_TheCSFunctionOfHInter"))
        .def(py::init< const opencascade::handle<Adaptor3d_HSurface> &,const opencascade::handle<Adaptor3d_HCurve> & >()  , py::arg("S"),  py::arg("C") )
        .def("NbVariables",
...
;
    ...
    register_default_constructor<IntCurveSurface_ThePolyhedronToolOfHInter ,std::unique_ptr<IntCurveSurface_ThePolyhedronToolOfHInter>>(m,"IntCurveSurface_ThePolyhedronToolOfHInter");

    static_cast<py::class_<IntCurveSurface_ThePolyhedronToolOfHInter ,std::unique_ptr<IntCurveSurface_ThePolyhedronToolOfHInter>  >>(m.attr("IntCurveSurface_ThePolyhedronToolOfHInter"))
        .def_static("Bounding_s",
        ...
        .def_static("Triangle_s",
                    (void (*)( const IntCurveSurface_ThePolyhedronOfHInter & ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (*)( const IntCurveSurface_ThePolyhedronOfHInter & ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) >(&IntCurveSurface_ThePolyhedronToolOfHInter::Triangle),
