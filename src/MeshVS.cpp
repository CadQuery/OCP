...
;
    ...
    static_cast<py::class_<MeshVS_HArray1OfSequenceOfInteger ,std::unique_ptr<MeshVS_HArray1OfSequenceOfInteger>  >>(m.attr("MeshVS_HArray1OfSequenceOfInteger"))
...
;
    ...
    register_default_constructor<MeshVS_Tool ,std::unique_ptr<MeshVS_Tool>>(m,"MeshVS_Tool");

    static_cast<py::class_<MeshVS_Tool ,std::unique_ptr<MeshVS_Tool>  >>(m.attr("MeshVS_Tool"))
...
;
    ...
    static_cast<py::class_<MeshVS_MeshPrsBuilder ,opencascade::handle<MeshVS_MeshPrsBuilder>  , MeshVS_PrsBuilder >>(m.attr("MeshVS_MeshPrsBuilder"))
        ...
        .def_static("HowManyPrimitives_s",
                    (void (*)( const opencascade::handle<MeshVS_HArray1OfSequenceOfInteger> & ,  const Standard_Boolean ,  const Standard_Boolean ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (*)( const opencascade::handle<MeshVS_HArray1OfSequenceOfInteger> & ,  const Standard_Boolean ,  const Standard_Boolean ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) >(&MeshVS_MeshPrsBuilder::HowManyPrimitives),
                    R"#(Calculate how many polygons or polylines are necessary to draw passed topology)#"  , py::arg("Topo"),  py::arg("AsPolygons"),  py::arg("IsSelect"),  py::arg("NbNodes"),  py::arg("Vertices"),  py::arg("Bounds"))
        .def_static("get_type_name_s",
...
;
    ...
    static_cast<py::class_<MeshVS_VectorPrsBuilder ,opencascade::handle<MeshVS_VectorPrsBuilder>  , MeshVS_PrsBuilder >>(m.attr("MeshVS_VectorPrsBuilder"))
        ...
        .def("GetMinMaxVectorValue",
             (void (MeshVS_VectorPrsBuilder::*)( const Standard_Boolean ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (MeshVS_VectorPrsBuilder::*)( const Standard_Boolean ,  Standard_Real & ,  Standard_Real &  ) const>(&MeshVS_VectorPrsBuilder::GetMinMaxVectorValue),
             R"#(Calculates minimal and maximal length of vectors in map ( nodal, if IsElement = False or elemental, if IsElement = True ))#"  , py::arg("IsElement"),  py::arg("MinValue"),  py::arg("MaxValue"))
