...
// classes
    ...
    static_cast<py::class_<FilletSurf_InternalBuilder ,std::unique_ptr<FilletSurf_InternalBuilder>  , ChFi3d_FilBuilder >>(m.attr("FilletSurf_InternalBuilder"))
...
;
    ...
    static_cast<py::class_<FilletSurf_Builder ,std::unique_ptr<FilletSurf_Builder>  >>(m.attr("FilletSurf_Builder"))
