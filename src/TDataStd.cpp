...
;
    ...
    static_cast<py::class_<TDataStd_ChildNodeIterator ,std::unique_ptr<TDataStd_ChildNodeIterator>  >>(m.attr("TDataStd_ChildNodeIterator"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<TDataStd ,std::unique_ptr<TDataStd>>(m,"TDataStd");

    static_cast<py::class_<TDataStd ,std::unique_ptr<TDataStd>  >>(m.attr("TDataStd"))
        .def_static("IDList_s",
...
;
    ...
    static_cast<py::class_<TDataStd_HLabelArray1 ,std::unique_ptr<TDataStd_HLabelArray1>  >>(m.attr("TDataStd_HLabelArray1"))
