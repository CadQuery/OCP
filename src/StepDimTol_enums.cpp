...
// classes forward declarations only
    py::class_<StepDimTol_HArray1OfGeometricToleranceModifier ,std::unique_ptr<StepDimTol_HArray1OfGeometricToleranceModifier>  >(m,"StepDimTol_HArray1OfGeometricToleranceModifier",R"#()#");
    py::class_<StepDimTol_GeometricToleranceTarget ,std::unique_ptr<StepDimTol_GeometricToleranceTarget>  , StepData_SelectType >(m,"StepDimTol_GeometricToleranceTarget",R"#(None)#");
    py::class_<StepDimTol_ToleranceZoneTarget ,std::unique_ptr<StepDimTol_ToleranceZoneTarget>  , StepData_SelectType >(m,"StepDimTol_ToleranceZoneTarget",R"#(None)#");
    ...
    py::class_<StepDimTol_HArray1OfDatumReferenceCompartment ,std::unique_ptr<StepDimTol_HArray1OfDatumReferenceCompartment>  >(m,"StepDimTol_HArray1OfDatumReferenceCompartment",R"#()#");
    ...
    py::class_<StepDimTol_HArray1OfDatumReferenceModifier ,std::unique_ptr<StepDimTol_HArray1OfDatumReferenceModifier>  >(m,"StepDimTol_HArray1OfDatumReferenceModifier",R"#()#");
    py::class_<StepDimTol_ShapeToleranceSelect ,std::unique_ptr<StepDimTol_ShapeToleranceSelect>  , StepData_SelectType >(m,"StepDimTol_ShapeToleranceSelect",R"#(Representation of STEP SELECT type ShapeToleranceSelect)#");
    ...
    py::class_<StepDimTol_HArray1OfToleranceZoneTarget ,std::unique_ptr<StepDimTol_HArray1OfToleranceZoneTarget>  >(m,"StepDimTol_HArray1OfToleranceZoneTarget",R"#()#");
    py::class_<StepDimTol_DatumSystemOrReference ,std::unique_ptr<StepDimTol_DatumSystemOrReference>  , StepData_SelectType >(m,"StepDimTol_DatumSystemOrReference",R"#(None)#");
    ...
    py::class_<StepDimTol_DatumOrCommonDatum ,std::unique_ptr<StepDimTol_DatumOrCommonDatum>  , StepData_SelectType >(m,"StepDimTol_DatumOrCommonDatum",R"#(None)#");
    ...
    py::class_<StepDimTol_DatumReferenceModifier ,std::unique_ptr<StepDimTol_DatumReferenceModifier>  , StepData_SelectType >(m,"StepDimTol_DatumReferenceModifier",R"#(None)#");
    ...
    py::class_<StepDimTol_HArray1OfDatumSystemOrReference ,std::unique_ptr<StepDimTol_HArray1OfDatumSystemOrReference>  >(m,"StepDimTol_HArray1OfDatumSystemOrReference",R"#()#");
    py::class_<StepDimTol_HArray1OfDatumReferenceElement ,std::unique_ptr<StepDimTol_HArray1OfDatumReferenceElement>  >(m,"StepDimTol_HArray1OfDatumReferenceElement",R"#()#");
    ...
    py::class_<StepDimTol_HArray1OfDatumReference ,std::unique_ptr<StepDimTol_HArray1OfDatumReference>  >(m,"StepDimTol_HArray1OfDatumReference",R"#()#");
