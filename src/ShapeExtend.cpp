...
;
    ...
    static_cast<py::class_<ShapeExtend_CompositeSurface ,opencascade::handle<ShapeExtend_CompositeSurface>  , Geom_Surface >>(m.attr("ShapeExtend_CompositeSurface"))
        ...
        .def("LocateUVPoint",
             (void (ShapeExtend_CompositeSurface::*)( const gp_Pnt2d & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (ShapeExtend_CompositeSurface::*)( const gp_Pnt2d & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&ShapeExtend_CompositeSurface::LocateUVPoint),
             R"#(Returns number of row and col of surface that contains given point)#"  , py::arg("pnt"),  py::arg("i"),  py::arg("j"))
        .def("Patch",
        ...
        .def("Bounds",
             (void (ShapeExtend_CompositeSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (ShapeExtend_CompositeSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&ShapeExtend_CompositeSurface::Bounds),
             R"#(Returns the parametric bounds of grid)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("IsUClosed",
...
;
    ...
    register_default_constructor<ShapeExtend ,std::unique_ptr<ShapeExtend>>(m,"ShapeExtend");

    static_cast<py::class_<ShapeExtend ,std::unique_ptr<ShapeExtend>  >>(m.attr("ShapeExtend"))
        .def_static("Init_s",
...
;
    ...
    static_cast<py::class_<ShapeExtend_Explorer ,std::unique_ptr<ShapeExtend_Explorer>  >>(m.attr("ShapeExtend_Explorer"))
        .def(py::init<  >()  )
        .def("CompoundFromSeq",
