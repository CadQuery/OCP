...
// classes
    ...
    static_cast<py::class_<TopLoc_ItemLocation ,std::unique_ptr<TopLoc_ItemLocation>  >>(m.attr("TopLoc_ItemLocation"))
        .def(py::init< const opencascade::handle<TopLoc_Datum3D> &,const Standard_Integer >()  , py::arg("D"),  py::arg("P") )
;


    static_cast<py::class_<TopLoc_Location ,std::unique_ptr<TopLoc_Location>  >>(m.attr("TopLoc_Location"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TopLoc_SListOfItemLocation ,std::unique_ptr<TopLoc_SListOfItemLocation>  >>(m.attr("TopLoc_SListOfItemLocation"))
        .def(py::init<  >()  )
