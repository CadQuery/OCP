...
void preregister_template_BOPTools_Functor(py::object &m, const char *name){
    py::class_<BOPTools_Functor<TypeSolver,TypeSolverVector> ,std::unique_ptr<BOPTools_Functor<TypeSolver,TypeSolverVector>> >(m,name,R"#(None)#");
}

template <typename TypeSolver,typename TypeSolverVector>
void register_template_BOPTools_Functor(py::object &m, const char *name){
    static_cast<py::class_<BOPTools_Functor<TypeSolver,TypeSolverVector> ,std::unique_ptr<BOPTools_Functor<TypeSolver,TypeSolverVector>> >>(m.attr(name))
...
void preregister_template_BOPTools_Cnt(py::object &m, const char *name){
    py::class_<BOPTools_Cnt<TypeFunctor,TypeSolverVector> ,std::unique_ptr<BOPTools_Cnt<TypeFunctor,TypeSolverVector>> >(m,name,R"#(None)#");
}

template <typename TypeFunctor,typename TypeSolverVector>
void register_template_BOPTools_Cnt(py::object &m, const char *name){
    static_cast<py::class_<BOPTools_Cnt<TypeFunctor,TypeSolverVector> ,std::unique_ptr<BOPTools_Cnt<TypeFunctor,TypeSolverVector>> >>(m.attr(name))
...
void preregister_template_BOPTools_ContextFunctor(py::object &m, const char *name){
    py::class_<BOPTools_ContextFunctor<TypeSolver,TypeSolverVector,TypeContext,TN> ,std::unique_ptr<BOPTools_ContextFunctor<TypeSolver,TypeSolverVector,TypeContext,TN>> >(m,name,R"#(None)#");
}

template <typename TypeSolver,typename TypeSolverVector,typename TypeContext,typename TN>
void register_template_BOPTools_ContextFunctor(py::object &m, const char *name){
    static_cast<py::class_<BOPTools_ContextFunctor<TypeSolver,TypeSolverVector,TypeContext,TN> ,std::unique_ptr<BOPTools_ContextFunctor<TypeSolver,TypeSolverVector,TypeContext,TN>> >>(m.attr(name))
...
void preregister_template_BOPTools_ContextCnt(py::object &m, const char *name){
    py::class_<BOPTools_ContextCnt<TypeFunctor,TypeSolverVector,TypeContext> ,std::unique_ptr<BOPTools_ContextCnt<TypeFunctor,TypeSolverVector,TypeContext>> >(m,name,R"#(None)#");
}

template <typename TypeFunctor,typename TypeSolverVector,typename TypeContext>
void register_template_BOPTools_ContextCnt(py::object &m, const char *name){
    static_cast<py::class_<BOPTools_ContextCnt<TypeFunctor,TypeSolverVector,TypeContext> ,std::unique_ptr<BOPTools_ContextCnt<TypeFunctor,TypeSolverVector,TypeContext>> >>(m.attr(name))
        .def_static("Perform_s",
...
void preregister_template_BOPTools_BoxSelector(py::object &m, const char *name){
    py::class_<BOPTools_BoxSelector<BoxType> ,std::unique_ptr<BOPTools_BoxSelector<BoxType>> >(m,name,R"#(Template Selector for the unbalanced binary tree of overlapped bounding boxes.)#");
}

template <typename BoxType>
void register_template_BOPTools_BoxSelector(py::object &m, const char *name){
    static_cast<py::class_<BOPTools_BoxSelector<BoxType> ,std::unique_ptr<BOPTools_BoxSelector<BoxType>> >>(m.attr(name))
        .def(py::init<  >()  )
        .def("Reject",
