...
// classes
    ...
    static_cast<py::class_<IGESDefs_ToolMacroDef ,std::unique_ptr<IGESDefs_ToolMacroDef>  >>(m.attr("IGESDefs_ToolMacroDef"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDefs_HArray1OfTabularData ,std::unique_ptr<IGESDefs_HArray1OfTabularData>  >>(m.attr("IGESDefs_HArray1OfTabularData"))
...
;
    ...
    static_cast<py::class_<IGESDefs_ToolAttributeDef ,std::unique_ptr<IGESDefs_ToolAttributeDef>  >>(m.attr("IGESDefs_ToolAttributeDef"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDefs_ToolUnitsData ,std::unique_ptr<IGESDefs_ToolUnitsData>  >>(m.attr("IGESDefs_ToolUnitsData"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDefs_ToolAssociativityDef ,std::unique_ptr<IGESDefs_ToolAssociativityDef>  >>(m.attr("IGESDefs_ToolAssociativityDef"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    register_default_constructor<IGESDefs ,std::unique_ptr<IGESDefs>>(m,"IGESDefs");

    static_cast<py::class_<IGESDefs ,std::unique_ptr<IGESDefs>  >>(m.attr("IGESDefs"))
        .def_static("Init_s",
...
;
    ...
    static_cast<py::class_<IGESDefs_ToolAttributeTable ,std::unique_ptr<IGESDefs_ToolAttributeTable>  >>(m.attr("IGESDefs_ToolAttributeTable"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDefs_ToolGenericData ,std::unique_ptr<IGESDefs_ToolGenericData>  >>(m.attr("IGESDefs_ToolGenericData"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDefs_ToolTabularData ,std::unique_ptr<IGESDefs_ToolTabularData>  >>(m.attr("IGESDefs_ToolTabularData"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
