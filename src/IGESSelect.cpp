...
;
    ...
    register_default_constructor<IGESSelect ,std::unique_ptr<IGESSelect>>(m,"IGESSelect");

    static_cast<py::class_<IGESSelect ,std::unique_ptr<IGESSelect>  >>(m.attr("IGESSelect"))
        .def_static("Run_s",
...
;
    ...
    static_cast<py::class_<IGESSelect_FloatFormat ,opencascade::handle<IGESSelect_FloatFormat>  , IGESSelect_FileModifier >>(m.attr("IGESSelect_FloatFormat"))
        ...
        .def("Format",
             (void (IGESSelect_FloatFormat::*)( Standard_Boolean & ,  TCollection_AsciiString & ,  Standard_Boolean & ,  TCollection_AsciiString & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IGESSelect_FloatFormat::*)( Standard_Boolean & ,  TCollection_AsciiString & ,  Standard_Boolean & ,  TCollection_AsciiString & ,  Standard_Real & ,  Standard_Real &  ) const>(&IGESSelect_FloatFormat::Format),
