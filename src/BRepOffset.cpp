...
;
    ...
    static_cast<py::class_<BRepOffset_Interval ,std::unique_ptr<BRepOffset_Interval>  >>(m.attr("BRepOffset_Interval"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepOffset_Offset ,std::unique_ptr<BRepOffset_Offset>  >>(m.attr("BRepOffset_Offset"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepOffset_MakeLoops ,std::unique_ptr<BRepOffset_MakeLoops>  >>(m.attr("BRepOffset_MakeLoops"))
        .def(py::init<  >()  )
        .def("Build",
...
;
    ...
    register_default_constructor<BRepOffset_Inter2d ,std::unique_ptr<BRepOffset_Inter2d>>(m,"BRepOffset_Inter2d");

    static_cast<py::class_<BRepOffset_Inter2d ,std::unique_ptr<BRepOffset_Inter2d>  >>(m.attr("BRepOffset_Inter2d"))
...
;
    ...
    static_cast<py::class_<BRepOffset_Analyse ,std::unique_ptr<BRepOffset_Analyse>  >>(m.attr("BRepOffset_Analyse"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<BRepOffset_Inter3d ,std::unique_ptr<BRepOffset_Inter3d>  >>(m.attr("BRepOffset_Inter3d"))
...
;
    ...
    register_default_constructor<BRepOffset_Tool ,std::unique_ptr<BRepOffset_Tool>>(m,"BRepOffset_Tool");

    static_cast<py::class_<BRepOffset_Tool ,std::unique_ptr<BRepOffset_Tool>  >>(m.attr("BRepOffset_Tool"))
        ...
        .def_static("CheckBounds_s",
                    (void (*)( const TopoDS_Face & ,  const BRepOffset_Analyse & ,  Standard_Boolean & ,  Standard_Boolean & ,  Standard_Boolean &  ) ) static_cast<void (*)( const TopoDS_Face & ,  const BRepOffset_Analyse & ,  Standard_Boolean & ,  Standard_Boolean & ,  Standard_Boolean &  ) >(&BRepOffset_Tool::CheckBounds),
                    R"#(None)#"  , py::arg("F"),  py::arg("Analyse"),  py::arg("enlargeU"),  py::arg("enlargeVfirst"),  py::arg("enlargeVlast"))
...
;
    ...
    static_cast<py::class_<BRepOffset_MakeOffset ,std::unique_ptr<BRepOffset_MakeOffset>  >>(m.attr("BRepOffset_MakeOffset"))
        .def(py::init<  >()  )
