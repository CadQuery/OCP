...
;
    ...
    register_default_constructor<Expr ,std::unique_ptr<Expr>>(m,"Expr");

    static_cast<py::class_<Expr ,std::unique_ptr<Expr>  >>(m.attr("Expr"))
...
;
    ...
    static_cast<py::class_<Expr_UnknownIterator ,std::unique_ptr<Expr_UnknownIterator>  >>(m.attr("Expr_UnknownIterator"))
...
;
    ...
    static_cast<py::class_<Expr_RUIterator ,std::unique_ptr<Expr_RUIterator>  >>(m.attr("Expr_RUIterator"))
...
;
    ...
    static_cast<py::class_<Expr_RelationIterator ,std::unique_ptr<Expr_RelationIterator>  >>(m.attr("Expr_RelationIterator"))
        .def(py::init< const opencascade::handle<Expr_GeneralRelation> & >()  , py::arg("rel") )
        .def("More",
