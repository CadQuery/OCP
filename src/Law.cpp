...
// classes
    ...
    static_cast<py::class_<Law_BSplineKnotSplitting ,std::unique_ptr<Law_BSplineKnotSplitting>  >>(m.attr("Law_BSplineKnotSplitting"))
...
;
    ...
    static_cast<py::class_<Law_Interpolate ,std::unique_ptr<Law_Interpolate>  >>(m.attr("Law_Interpolate"))
...
;
    ...
    static_cast<py::class_<Law_BSpline ,opencascade::handle<Law_BSpline>  , Standard_Transient >>(m.attr("Law_BSpline"))
        ...
        .def("PeriodicNormalization",
             (void (Law_BSpline::*)( Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( Standard_Real &  ) const>(&Law_BSpline::PeriodicNormalization),
        ...
        .def("Value",
             ...
             R"#(None)#"  , py::arg("U"))
        .def("D0",
             (void (Law_BSpline::*)( const Standard_Real ,  Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  Standard_Real &  ) const>(&Law_BSpline::D0),
             R"#(None)#"  , py::arg("U"),  py::arg("P"))
        .def("D1",
             (void (Law_BSpline::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const>(&Law_BSpline::D1),
             R"#(None)#"  , py::arg("U"),  py::arg("P"),  py::arg("V1"))
        .def("D2",
             (void (Law_BSpline::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Law_BSpline::D2),
             R"#(None)#"  , py::arg("U"),  py::arg("P"),  py::arg("V1"),  py::arg("V2"))
        .def("D3",
             (void (Law_BSpline::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Law_BSpline::D3),
        ...
        .def("LocalD0",
             (void (Law_BSpline::*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real &  ) const>(&Law_BSpline::LocalD0),
             R"#(None)#"  , py::arg("U"),  py::arg("FromK1"),  py::arg("ToK2"),  py::arg("P"))
        .def("LocalD1",
             (void (Law_BSpline::*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&Law_BSpline::LocalD1),
             R"#(None)#"  , py::arg("U"),  py::arg("FromK1"),  py::arg("ToK2"),  py::arg("P"),  py::arg("V1"))
        .def("LocalD2",
             (void (Law_BSpline::*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Law_BSpline::LocalD2),
             R"#(None)#"  , py::arg("U"),  py::arg("FromK1"),  py::arg("ToK2"),  py::arg("P"),  py::arg("V1"),  py::arg("V2"))
        .def("LocalD3",
             (void (Law_BSpline::*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Law_BSpline::LocalD3),
             R"#(None)#"  , py::arg("U"),  py::arg("FromK1"),  py::arg("ToK2"),  py::arg("P"),  py::arg("V1"),  py::arg("V2"),  py::arg("V3"))
        .def("LocalDN",
        ...
        .def("LocateU",
             (void (Law_BSpline::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const>(&Law_BSpline::LocateU),
        ...
        .def("MovePointAndTangent",
             (void (Law_BSpline::*)( const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer &  ) ) static_cast<void (Law_BSpline::*)( const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer &  ) >(&Law_BSpline::MovePointAndTangent),
        ...
        .def("Resolution",
             (void (Law_BSpline::*)( const Standard_Real ,  Standard_Real &  ) const) static_cast<void (Law_BSpline::*)( const Standard_Real ,  Standard_Real &  ) const>(&Law_BSpline::Resolution),
             R"#(given Tolerance3D returns UTolerance such that if f(t) is the curve we have | t1 - t0| < Utolerance ===> |f(t1) - f(t0)| < Tolerance3D)#"  , py::arg("Tolerance3D"),  py::arg("UTolerance"))
        .def("Copy",
...
;
    ...
    register_default_constructor<Law ,std::unique_ptr<Law>>(m,"Law");

    static_cast<py::class_<Law ,std::unique_ptr<Law>  >>(m.attr("Law"))
        .def_static("MixBnd_s",
...
;
    ...
    static_cast<py::class_<Law_Function ,opencascade::handle<Law_Function> ,Py_Law_Function , Standard_Transient >>(m.attr("Law_Function"))
        ...
        .def("D1",
             (void (Law_Function::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Function::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) >(&Law_Function::D1),
             R"#(Returns the value F and the first derivative D of the function at the point of parameter X.)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"))
        .def("D2",
             (void (Law_Function::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Function::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&Law_Function::D2),
             R"#(Returns the value, first and seconde derivatives at parameter X.)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"),  py::arg("D2"))
        .def("Trim",
        ...
        .def("Bounds",
             (void (Law_Function::*)( Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Function::*)( Standard_Real & ,  Standard_Real &  ) >(&Law_Function::Bounds),
             R"#(Returns the parametric bounds of the function.)#"  , py::arg("PFirst"),  py::arg("PLast"))
        .def("DynamicType",
...
;
    ...
    static_cast<py::class_<Law_Constant ,opencascade::handle<Law_Constant>  , Law_Function >>(m.attr("Law_Constant"))
        ...
        .def("D1",
             (void (Law_Constant::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Constant::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) >(&Law_Constant::D1),
             R"#(Returns the value and the first derivative at parameter X.)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"))
        .def("D2",
             (void (Law_Constant::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Constant::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&Law_Constant::D2),
             R"#(Returns the value, first and second derivatives at parameter X.)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"),  py::arg("D2"))
        .def("Trim",
        ...
        .def("Bounds",
             (void (Law_Constant::*)( Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Constant::*)( Standard_Real & ,  Standard_Real &  ) >(&Law_Constant::Bounds),
             R"#(Returns the parametric bounds of the function.)#"  , py::arg("PFirst"),  py::arg("PLast"))
        .def("DynamicType",
...
;
    ...
    static_cast<py::class_<Law_Composite ,opencascade::handle<Law_Composite>  , Law_Function >>(m.attr("Law_Composite"))
        ...
        .def("Value",
             ...
             R"#(Returns the value at parameter X.)#"  , py::arg("X"))
        .def("D1",
             (void (Law_Composite::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Composite::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) >(&Law_Composite::D1),
             R"#(Returns the value and the first derivative at parameter X.)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"))
        .def("D2",
             (void (Law_Composite::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Composite::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&Law_Composite::D2),
             R"#(Returns the value, first and second derivatives at parameter X.)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"),  py::arg("D2"))
        .def("Trim",
             ...
             R"#(Returns a law equivalent of <me> between parameters <First> and <Last>. <Tol> is used to test for 3d points confusion. It is usfule to determines the derivatives in these values <First> and <Last> if the Law is not Cn.)#"  , py::arg("PFirst"),  py::arg("PLast"),  py::arg("Tol"))
        .def("Bounds",
             (void (Law_Composite::*)( Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Composite::*)( Standard_Real & ,  Standard_Real &  ) >(&Law_Composite::Bounds),
             R"#(Returns the parametric bounds of the function.)#"  , py::arg("PFirst"),  py::arg("PLast"))
...
;
    ...
    static_cast<py::class_<Law_BSpFunc ,opencascade::handle<Law_BSpFunc>  , Law_Function >>(m.attr("Law_BSpFunc"))
        ...
        .def("Value",
             ...
             R"#(None)#"  , py::arg("X"))
        .def("D1",
             (void (Law_BSpFunc::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_BSpFunc::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) >(&Law_BSpFunc::D1),
             R"#(None)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"))
        .def("D2",
             (void (Law_BSpFunc::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_BSpFunc::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&Law_BSpFunc::D2),
             R"#(None)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"),  py::arg("D2"))
        .def("Trim",
             ...
             R"#(Returns a law equivalent of <me> between parameters <First> and <Last>. <Tol> is used to test for 3d points confusion. It is usfule to determines the derivatives in these values <First> and <Last> if the Law is not Cn.)#"  , py::arg("PFirst"),  py::arg("PLast"),  py::arg("Tol"))
        .def("Bounds",
             (void (Law_BSpFunc::*)( Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_BSpFunc::*)( Standard_Real & ,  Standard_Real &  ) >(&Law_BSpFunc::Bounds),
...
;
    ...
    static_cast<py::class_<Law_Linear ,opencascade::handle<Law_Linear>  , Law_Function >>(m.attr("Law_Linear"))
        ...
        .def("D1",
             (void (Law_Linear::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Linear::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) >(&Law_Linear::D1),
             R"#(Returns the value F and the first derivative D of this function at the point of parameter X.)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"))
        .def("D2",
             (void (Law_Linear::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Linear::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&Law_Linear::D2),
             R"#(Returns the value, first and second derivatives at parameter X.)#"  , py::arg("X"),  py::arg("F"),  py::arg("D"),  py::arg("D2"))
        .def("Trim",
             ...
             R"#(Returns a law equivalent of <me> between parameters <First> and <Last>. <Tol> is used to test for 3d points confusion. It is usfule to determines the derivatives in these values <First> and <Last> if the Law is not Cn.)#"  , py::arg("PFirst"),  py::arg("PLast"),  py::arg("Tol"))
        .def("Bounds",
             (void (Law_Linear::*)( Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Law_Linear::*)( Standard_Real & ,  Standard_Real &  ) >(&Law_Linear::Bounds),
             R"#(Returns the parametric bounds of the function.)#"  , py::arg("PFirst"),  py::arg("PLast"))
        .def("DynamicType",
