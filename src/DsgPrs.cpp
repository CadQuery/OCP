...
// classes
    ...
    register_default_constructor<DsgPrs_ShapeDirPresentation ,std::unique_ptr<DsgPrs_ShapeDirPresentation>>(m,"DsgPrs_ShapeDirPresentation");

    static_cast<py::class_<DsgPrs_ShapeDirPresentation ,std::unique_ptr<DsgPrs_ShapeDirPresentation>  >>(m.attr("DsgPrs_ShapeDirPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_EqualRadiusPresentation ,std::unique_ptr<DsgPrs_EqualRadiusPresentation>>(m,"DsgPrs_EqualRadiusPresentation");

    static_cast<py::class_<DsgPrs_EqualRadiusPresentation ,std::unique_ptr<DsgPrs_EqualRadiusPresentation>  >>(m.attr("DsgPrs_EqualRadiusPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_EllipseRadiusPresentation ,std::unique_ptr<DsgPrs_EllipseRadiusPresentation>>(m,"DsgPrs_EllipseRadiusPresentation");

    static_cast<py::class_<DsgPrs_EllipseRadiusPresentation ,std::unique_ptr<DsgPrs_EllipseRadiusPresentation>  >>(m.attr("DsgPrs_EllipseRadiusPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_ShadedPlanePresentation ,std::unique_ptr<DsgPrs_ShadedPlanePresentation>>(m,"DsgPrs_ShadedPlanePresentation");

    static_cast<py::class_<DsgPrs_ShadedPlanePresentation ,std::unique_ptr<DsgPrs_ShadedPlanePresentation>  >>(m.attr("DsgPrs_ShadedPlanePresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_IdenticPresentation ,std::unique_ptr<DsgPrs_IdenticPresentation>>(m,"DsgPrs_IdenticPresentation");

    static_cast<py::class_<DsgPrs_IdenticPresentation ,std::unique_ptr<DsgPrs_IdenticPresentation>  >>(m.attr("DsgPrs_IdenticPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_SymbPresentation ,std::unique_ptr<DsgPrs_SymbPresentation>>(m,"DsgPrs_SymbPresentation");

    static_cast<py::class_<DsgPrs_SymbPresentation ,std::unique_ptr<DsgPrs_SymbPresentation>  >>(m.attr("DsgPrs_SymbPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_XYZPlanePresentation ,std::unique_ptr<DsgPrs_XYZPlanePresentation>>(m,"DsgPrs_XYZPlanePresentation");

    static_cast<py::class_<DsgPrs_XYZPlanePresentation ,std::unique_ptr<DsgPrs_XYZPlanePresentation>  >>(m.attr("DsgPrs_XYZPlanePresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_MidPointPresentation ,std::unique_ptr<DsgPrs_MidPointPresentation>>(m,"DsgPrs_MidPointPresentation");

    static_cast<py::class_<DsgPrs_MidPointPresentation ,std::unique_ptr<DsgPrs_MidPointPresentation>  >>(m.attr("DsgPrs_MidPointPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs ,std::unique_ptr<DsgPrs>>(m,"DsgPrs");

    static_cast<py::class_<DsgPrs ,std::unique_ptr<DsgPrs>  >>(m.attr("DsgPrs"))
        ...
        .def_static("ComputeCurvilinearFacesLengthPresentation_s",
                    (void (*)( const Standard_Real ,  const Standard_Real ,  const opencascade::handle<Geom_Surface> & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Dir & ,  gp_Pnt & ,  gp_Dir & ,  opencascade::handle<Geom_Curve> & ,  opencascade::handle<Geom_Curve> & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Real ,  const Standard_Real ,  const opencascade::handle<Geom_Surface> & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Dir & ,  gp_Pnt & ,  gp_Dir & ,  opencascade::handle<Geom_Curve> & ,  opencascade::handle<Geom_Curve> & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&DsgPrs::ComputeCurvilinearFacesLengthPresentation),
                    R"#(None)#"  , py::arg("FirstArrowLength"),  py::arg("SecondArrowLength"),  py::arg("SecondSurf"),  py::arg("AttachmentPoint1"),  py::arg("AttachmentPoint2"),  py::arg("DirAttach"),  py::arg("EndOfArrow2"),  py::arg("DirOfArrow1"),  py::arg("VCurve"),  py::arg("UCurve"),  py::arg("FirstU"),  py::arg("deltaU"),  py::arg("FirstV"),  py::arg("deltaV"))
        .def_static("ComputeFacesAnglePresentation_s",
                    (void (*)( const Standard_Real ,  const Standard_Real ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Dir & ,  const gp_Dir & ,  const gp_Dir & ,  const Standard_Boolean ,  const gp_Ax1 & ,  const gp_Pnt & ,  gp_Circ & ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt & ,  gp_Pnt & ,  gp_Dir & ,  gp_Dir & ,  gp_Pnt & ,  gp_Circ & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Real ,  const Standard_Real ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Dir & ,  const gp_Dir & ,  const gp_Dir & ,  const Standard_Boolean ,  const gp_Ax1 & ,  const gp_Pnt & ,  gp_Circ & ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt & ,  gp_Pnt & ,  gp_Dir & ,  gp_Dir & ,  gp_Pnt & ,  gp_Circ & ,  Standard_Real & ,  Standard_Real &  ) >(&DsgPrs::ComputeFacesAnglePresentation),
        ...
        .def_static("ComputeFilletRadiusPresentation_s",
                    (void (*)( const Standard_Real ,  const Standard_Real ,  const gp_Pnt & ,  const gp_Dir & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const Standard_Boolean ,  Standard_Boolean & ,  gp_Circ & ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt & ,  gp_Dir & ,  gp_Pnt &  ) ) static_cast<void (*)( const Standard_Real ,  const Standard_Real ,  const gp_Pnt & ,  const gp_Dir & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const Standard_Boolean ,  Standard_Boolean & ,  gp_Circ & ,  Standard_Real & ,  Standard_Real & ,  gp_Pnt & ,  gp_Dir & ,  gp_Pnt &  ) >(&DsgPrs::ComputeFilletRadiusPresentation),
...
;
    ...
    register_default_constructor<DsgPrs_DiameterPresentation ,std::unique_ptr<DsgPrs_DiameterPresentation>>(m,"DsgPrs_DiameterPresentation");

    static_cast<py::class_<DsgPrs_DiameterPresentation ,std::unique_ptr<DsgPrs_DiameterPresentation>  >>(m.attr("DsgPrs_DiameterPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_RadiusPresentation ,std::unique_ptr<DsgPrs_RadiusPresentation>>(m,"DsgPrs_RadiusPresentation");

    static_cast<py::class_<DsgPrs_RadiusPresentation ,std::unique_ptr<DsgPrs_RadiusPresentation>  >>(m.attr("DsgPrs_RadiusPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_XYZAxisPresentation ,std::unique_ptr<DsgPrs_XYZAxisPresentation>>(m,"DsgPrs_XYZAxisPresentation");

    static_cast<py::class_<DsgPrs_XYZAxisPresentation ,std::unique_ptr<DsgPrs_XYZAxisPresentation>  >>(m.attr("DsgPrs_XYZAxisPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_TangentPresentation ,std::unique_ptr<DsgPrs_TangentPresentation>>(m,"DsgPrs_TangentPresentation");

    static_cast<py::class_<DsgPrs_TangentPresentation ,std::unique_ptr<DsgPrs_TangentPresentation>  >>(m.attr("DsgPrs_TangentPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_ConcentricPresentation ,std::unique_ptr<DsgPrs_ConcentricPresentation>>(m,"DsgPrs_ConcentricPresentation");

    static_cast<py::class_<DsgPrs_ConcentricPresentation ,std::unique_ptr<DsgPrs_ConcentricPresentation>  >>(m.attr("DsgPrs_ConcentricPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_Chamf2dPresentation ,std::unique_ptr<DsgPrs_Chamf2dPresentation>>(m,"DsgPrs_Chamf2dPresentation");

    static_cast<py::class_<DsgPrs_Chamf2dPresentation ,std::unique_ptr<DsgPrs_Chamf2dPresentation>  >>(m.attr("DsgPrs_Chamf2dPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_LengthPresentation ,std::unique_ptr<DsgPrs_LengthPresentation>>(m,"DsgPrs_LengthPresentation");

    static_cast<py::class_<DsgPrs_LengthPresentation ,std::unique_ptr<DsgPrs_LengthPresentation>  >>(m.attr("DsgPrs_LengthPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_FilletRadiusPresentation ,std::unique_ptr<DsgPrs_FilletRadiusPresentation>>(m,"DsgPrs_FilletRadiusPresentation");

    static_cast<py::class_<DsgPrs_FilletRadiusPresentation ,std::unique_ptr<DsgPrs_FilletRadiusPresentation>  >>(m.attr("DsgPrs_FilletRadiusPresentation"))
        .def_static("Add_s",
                    (void (*)( const opencascade::handle<Prs3d_Presentation> & ,  const opencascade::handle<Prs3d_Drawer> & ,  const Standard_Real ,  const TCollection_ExtendedString & ,  const gp_Pnt & ,  const gp_Dir & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const DsgPrs_ArrowSide ,  const Standard_Boolean ,  gp_Pnt & ,  gp_Pnt & ,  opencascade::handle<Geom_TrimmedCurve> & ,  Standard_Boolean &  ) ) static_cast<void (*)( const opencascade::handle<Prs3d_Presentation> & ,  const opencascade::handle<Prs3d_Drawer> & ,  const Standard_Real ,  const TCollection_ExtendedString & ,  const gp_Pnt & ,  const gp_Dir & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const gp_Pnt & ,  const DsgPrs_ArrowSide ,  const Standard_Boolean ,  gp_Pnt & ,  gp_Pnt & ,  opencascade::handle<Geom_TrimmedCurve> & ,  Standard_Boolean &  ) >(&DsgPrs_FilletRadiusPresentation::Add),
...
;
    ...
    register_default_constructor<DsgPrs_DatumPrs ,std::unique_ptr<DsgPrs_DatumPrs>>(m,"DsgPrs_DatumPrs");

    static_cast<py::class_<DsgPrs_DatumPrs ,std::unique_ptr<DsgPrs_DatumPrs>  , Prs3d_Root >>(m.attr("DsgPrs_DatumPrs"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_EqualDistancePresentation ,std::unique_ptr<DsgPrs_EqualDistancePresentation>>(m,"DsgPrs_EqualDistancePresentation");

    static_cast<py::class_<DsgPrs_EqualDistancePresentation ,std::unique_ptr<DsgPrs_EqualDistancePresentation>  >>(m.attr("DsgPrs_EqualDistancePresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_PerpenPresentation ,std::unique_ptr<DsgPrs_PerpenPresentation>>(m,"DsgPrs_PerpenPresentation");

    static_cast<py::class_<DsgPrs_PerpenPresentation ,std::unique_ptr<DsgPrs_PerpenPresentation>  >>(m.attr("DsgPrs_PerpenPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_OffsetPresentation ,std::unique_ptr<DsgPrs_OffsetPresentation>>(m,"DsgPrs_OffsetPresentation");

    static_cast<py::class_<DsgPrs_OffsetPresentation ,std::unique_ptr<DsgPrs_OffsetPresentation>  >>(m.attr("DsgPrs_OffsetPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_SymmetricPresentation ,std::unique_ptr<DsgPrs_SymmetricPresentation>>(m,"DsgPrs_SymmetricPresentation");

    static_cast<py::class_<DsgPrs_SymmetricPresentation ,std::unique_ptr<DsgPrs_SymmetricPresentation>  >>(m.attr("DsgPrs_SymmetricPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_AnglePresentation ,std::unique_ptr<DsgPrs_AnglePresentation>>(m,"DsgPrs_AnglePresentation");

    static_cast<py::class_<DsgPrs_AnglePresentation ,std::unique_ptr<DsgPrs_AnglePresentation>  >>(m.attr("DsgPrs_AnglePresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_FixPresentation ,std::unique_ptr<DsgPrs_FixPresentation>>(m,"DsgPrs_FixPresentation");

    static_cast<py::class_<DsgPrs_FixPresentation ,std::unique_ptr<DsgPrs_FixPresentation>  >>(m.attr("DsgPrs_FixPresentation"))
        .def_static("Add_s",
...
;
    ...
    register_default_constructor<DsgPrs_ParalPresentation ,std::unique_ptr<DsgPrs_ParalPresentation>>(m,"DsgPrs_ParalPresentation");

    static_cast<py::class_<DsgPrs_ParalPresentation ,std::unique_ptr<DsgPrs_ParalPresentation>  >>(m.attr("DsgPrs_ParalPresentation"))
        .def_static("Add_s",
