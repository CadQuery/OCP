...
// classes forward declarations only
    ...
    py::class_<GeomAdaptor ,std::unique_ptr<GeomAdaptor>  >(m,"GeomAdaptor",R"#(this package contains the geometric definition of curve and surface necessary to use algorithmes.)#");
