...
// classes
    ...
    static_cast<py::class_<IGESData_SpecificLib ,std::unique_ptr<IGESData_SpecificLib>  >>(m.attr("IGESData_SpecificLib"))
...
;
    ...
    register_default_constructor<IGESData_IGESEntity ,opencascade::handle<IGESData_IGESEntity>>(m,"IGESData_IGESEntity");
...
;
    ...
    static_cast<py::class_<IGESData_WriterLib ,std::unique_ptr<IGESData_WriterLib>  >>(m.attr("IGESData_WriterLib"))
        .def(py::init< const opencascade::handle<IGESData_Protocol> & >()  , py::arg("aprotocol") )
        .def(py::init<  >()  )
        .def("AddProtocol",
...
;
    ...
    static_cast<py::class_<IGESData_ParamReader ,std::unique_ptr<IGESData_ParamReader>  >>(m.attr("IGESData_ParamReader"))
...
;
    ...
    static_cast<py::class_<IGESData_GlobalSection ,std::unique_ptr<IGESData_GlobalSection>  >>(m.attr("IGESData_GlobalSection"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<IGESData_DefSwitch ,std::unique_ptr<IGESData_DefSwitch>  >>(m.attr("IGESData_DefSwitch"))
        .def(py::init<  >()  )
        .def("SetVoid",
...
;
    ...
    static_cast<py::class_<IGESData_IGESWriter ,std::unique_ptr<IGESData_IGESWriter>  >>(m.attr("IGESData_IGESWriter"))
...
;
    ...
    static_cast<py::class_<IGESData_DirChecker ,std::unique_ptr<IGESData_DirChecker>  >>(m.attr("IGESData_DirChecker"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IGESData_IGESReaderTool ,std::unique_ptr<IGESData_IGESReaderTool>  , Interface_FileReaderTool >>(m.attr("IGESData_IGESReaderTool"))
...
;
    ...
    static_cast<py::class_<IGESData_HArray1OfIGESEntity ,std::unique_ptr<IGESData_HArray1OfIGESEntity>  >>(m.attr("IGESData_HArray1OfIGESEntity"))
...
;
    ...
    static_cast<py::class_<IGESData_DirPart ,std::unique_ptr<IGESData_DirPart>  >>(m.attr("IGESData_DirPart"))
        .def(py::init<  >()  )
        .def("Init",
        ...
        .def("Values",
             (void (IGESData_DirPart::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_CString ,  const Standard_CString ,  const Standard_CString ,  const Standard_CString  ) const) static_cast<void (IGESData_DirPart::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_CString ,  const Standard_CString ,  const Standard_CString ,  const Standard_CString  ) const>(&IGESData_DirPart::Values),
             R"#(returns values recorded in DirPart (content of cstrings are modified))#"  , py::arg("i1"),  py::arg("i2"),  py::arg("i3"),  py::arg("i4"),  py::arg("i5"),  py::arg("i6"),  py::arg("i7"),  py::arg("i8"),  py::arg("i9"),  py::arg("i19"),  py::arg("i11"),  py::arg("i12"),  py::arg("i13"),  py::arg("i14"),  py::arg("i15"),  py::arg("i16"),  py::arg("i17"),  py::arg("res1"),  py::arg("res2"),  py::arg("label"),  py::arg("subscript"))
        .def("Type",
...
;
    ...
    static_cast<py::class_<IGESData_IGESType ,std::unique_ptr<IGESData_IGESType>  >>(m.attr("IGESData_IGESType"))
        .def(py::init<  >()  )
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("atype"),  py::arg("aform") )
        .def("Type",
...
;
    ...
    register_default_constructor<IGESData ,std::unique_ptr<IGESData>>(m,"IGESData");

    static_cast<py::class_<IGESData ,std::unique_ptr<IGESData>  >>(m.attr("IGESData"))
        .def_static("Init_s",
...
;
    ...
    static_cast<py::class_<IGESData_IGESDumper ,std::unique_ptr<IGESData_IGESDumper>  >>(m.attr("IGESData_IGESDumper"))
...
;
    ...
    static_cast<py::class_<IGESData_BasicEditor ,std::unique_ptr<IGESData_BasicEditor>  >>(m.attr("IGESData_BasicEditor"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IGESData_ParamCursor ,std::unique_ptr<IGESData_ParamCursor>  >>(m.attr("IGESData_ParamCursor"))
