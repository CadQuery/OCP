...
// classes forward declarations only
    py::class_<gce_Root ,std::unique_ptr<gce_Root>  >(m,"gce_Root",R"#(This class implements the common services for all classes of gce which report error.)#");
    py::class_<gce_MakeScale ,std::unique_ptr<gce_MakeScale>  >(m,"gce_MakeScale",R"#(Implements an elementary construction algorithm for a scaling transformation in 3D space. The result is a gp_Trsf transformation. A MakeScale object provides a framework for: - defining the construction of the transformation, - implementing the construction algorithm, and - consulting the result.)#");
    py::class_<gce_MakeMirror2d ,std::unique_ptr<gce_MakeMirror2d>  >(m,"gce_MakeMirror2d",R"#(This class implements elementary construction algorithms for a symmetrical transformation in 2D space about a point or axis. The result is a gp_Trsf2d transformation. A MakeMirror2d object provides a framework for: - defining the construction of the transformation, - implementing the construction algorithm, and consulting the result.)#");
    py::class_<gce_MakeTranslation ,std::unique_ptr<gce_MakeTranslation>  >(m,"gce_MakeTranslation",R"#(This class implements elementary construction algorithms for a translation in 3D space. The result is a gp_Trsf transformation. A MakeTranslation object provides a framework for: - defining the construction of the transformation, - implementing the construction algorithm, and - consulting the result.)#");
    py::class_<gce_MakeLin ,std::unique_ptr<gce_MakeLin>  , gce_Root >(m,"gce_MakeLin",R"#(This class implements the following algorithms used to create a Lin from gp. * Create a Lin parallel to another and passing through a point. * Create a Lin passing through 2 points. * Create a lin from its axis (Ax1 from gp). * Create a lin from a point and a direction.)#");
    py::class_<gce_MakeLin2d ,std::unique_ptr<gce_MakeLin2d>  , gce_Root >(m,"gce_MakeLin2d",R"#(This class implements the following algorithms used to create Lin2d from gp.)#");
    py::class_<gce_MakeCirc2d ,std::unique_ptr<gce_MakeCirc2d>  , gce_Root >(m,"gce_MakeCirc2d",R"#(This class implements the following algorithms used to create Circ2d from gp.)#");
    py::class_<gce_MakeElips ,std::unique_ptr<gce_MakeElips>  , gce_Root >(m,"gce_MakeElips",R"#(This class implements the following algorithms used to create an ellipse from gp.)#");
    py::class_<gce_MakeCirc ,std::unique_ptr<gce_MakeCirc>  , gce_Root >(m,"gce_MakeCirc",R"#(This class implements the following algorithms used to create Circ from gp.)#");
    py::class_<gce_MakeCone ,std::unique_ptr<gce_MakeCone>  , gce_Root >(m,"gce_MakeCone",R"#(This class implements the following algorithms used to create a Cone from gp. * Create a Cone coaxial to another and passing through a point. * Create a Cone coaxial to another at a distance <Dist>. * Create a Cone by 4 points. * Create a Cone by its axis and 2 points. * Create a Cone by 2 points and 2 radius. * Create a Cone by an Ax2 an angle and the radius of its reference section.)#");
