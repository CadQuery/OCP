...
;
    ...
    static_cast<py::class_<TDF_Label ,std::unique_ptr<TDF_Label>  >>(m.attr("TDF_Label"))
        .def(py::init<  >()  )
        .def("Nullify",
...
;
    ...
    register_default_constructor<TDF_CopyTool ,std::unique_ptr<TDF_CopyTool>>(m,"TDF_CopyTool");

    static_cast<py::class_<TDF_CopyTool ,std::unique_ptr<TDF_CopyTool>  >>(m.attr("TDF_CopyTool"))
        .def_static("Copy_s",
...
;
    ...
    static_cast<py::class_<TDF_ClosureMode ,std::unique_ptr<TDF_ClosureMode>  >>(m.attr("TDF_ClosureMode"))
...
;
    ...
    register_default_constructor<TDF_ComparisonTool ,std::unique_ptr<TDF_ComparisonTool>>(m,"TDF_ComparisonTool");

    static_cast<py::class_<TDF_ComparisonTool ,std::unique_ptr<TDF_ComparisonTool>  >>(m.attr("TDF_ComparisonTool"))
...
;
    ...
    register_default_constructor<TDF ,std::unique_ptr<TDF>>(m,"TDF");

    static_cast<py::class_<TDF ,std::unique_ptr<TDF>  >>(m.attr("TDF"))
...
;
    ...
    static_cast<py::class_<TDF_HAttributeArray1 ,std::unique_ptr<TDF_HAttributeArray1>  >>(m.attr("TDF_HAttributeArray1"))
...
;
    ...
    register_default_constructor<TDF_DeltaOnModification ,opencascade::handle<TDF_DeltaOnModification>>(m,"TDF_DeltaOnModification");
...
;
    ...
    static_cast<py::class_<TDF_Transaction ,std::unique_ptr<TDF_Transaction>  >>(m.attr("TDF_Transaction"))
...
;
    ...
    register_default_constructor<TDF_ClosureTool ,std::unique_ptr<TDF_ClosureTool>>(m,"TDF_ClosureTool");

    static_cast<py::class_<TDF_ClosureTool ,std::unique_ptr<TDF_ClosureTool>  >>(m.attr("TDF_ClosureTool"))
...
;
    ...
    static_cast<py::class_<TDF_CopyLabel ,std::unique_ptr<TDF_CopyLabel>  >>(m.attr("TDF_CopyLabel"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TDF_ChildIDIterator ,std::unique_ptr<TDF_ChildIDIterator>  >>(m.attr("TDF_ChildIDIterator"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TDF_ChildIterator ,std::unique_ptr<TDF_ChildIterator>  >>(m.attr("TDF_ChildIterator"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<TDF_IDFilter ,std::unique_ptr<TDF_IDFilter>  >>(m.attr("TDF_IDFilter"))
...
;
    ...
    register_default_constructor<TDF_Tool ,std::unique_ptr<TDF_Tool>>(m,"TDF_Tool");

    static_cast<py::class_<TDF_Tool ,std::unique_ptr<TDF_Tool>  >>(m.attr("TDF_Tool"))
