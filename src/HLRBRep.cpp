...
// classes
    ...
    register_default_constructor<HLRBRep_SLPropsATool ,std::unique_ptr<HLRBRep_SLPropsATool>>(m,"HLRBRep_SLPropsATool");

    static_cast<py::class_<HLRBRep_SLPropsATool ,std::unique_ptr<HLRBRep_SLPropsATool>  >>(m.attr("HLRBRep_SLPropsATool"))
        .def_static("Value_s",
        ...
        .def_static("Bounds_s",
                    (void (*)( const Standard_Address ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Address ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&HLRBRep_SLPropsATool::Bounds),
                    R"#(returns the bounds of the Surface.)#"  , py::arg("A"),  py::arg("U1"),  py::arg("V1"),  py::arg("U2"),  py::arg("V2"))
;


    static_cast<py::class_<HLRBRep_TheIntPCurvePCurveOfCInter ,std::unique_ptr<HLRBRep_TheIntPCurvePCurveOfCInter>  , IntRes2d_Intersection >>(m.attr("HLRBRep_TheIntPCurvePCurveOfCInter"))
        .def(py::init<  >()  )
        .def("SetMinNbSamples",
...
;
    ...
    static_cast<py::class_<HLRBRep_TheLocateExtPCOfTheProjPCurOfCInter ,std::unique_ptr<HLRBRep_TheLocateExtPCOfTheProjPCurOfCInter>  >>(m.attr("HLRBRep_TheLocateExtPCOfTheProjPCurOfCInter"))
        .def(py::init<  >()  )
        .def("Perform",
...
;
    ...
    register_default_constructor<HLRBRep_EdgeIList ,std::unique_ptr<HLRBRep_EdgeIList>>(m,"HLRBRep_EdgeIList");

    static_cast<py::class_<HLRBRep_EdgeIList ,std::unique_ptr<HLRBRep_EdgeIList>  >>(m.attr("HLRBRep_EdgeIList"))
...
;
    ...
    static_cast<py::class_<HLRBRep_SLProps ,std::unique_ptr<HLRBRep_SLProps>  >>(m.attr("HLRBRep_SLProps"))
...
;
    ...
    register_default_constructor<HLRBRep_LineTool ,std::unique_ptr<HLRBRep_LineTool>>(m,"HLRBRep_LineTool");

    static_cast<py::class_<HLRBRep_LineTool ,std::unique_ptr<HLRBRep_LineTool>  >>(m.attr("HLRBRep_LineTool"))
...
;
    ...
    static_cast<py::class_<HLRBRep_ThePolygonOfInterCSurf ,std::unique_ptr<HLRBRep_ThePolygonOfInterCSurf>  >>(m.attr("HLRBRep_ThePolygonOfInterCSurf"))
...
;
    ...
    static_cast<py::class_<HLRBRep_TheQuadCurvExactInterCSurf ,std::unique_ptr<HLRBRep_TheQuadCurvExactInterCSurf>  >>(m.attr("HLRBRep_TheQuadCurvExactInterCSurf"))
        .def("IsDone",
        ...
        .def("NbIntervals",
             ...
             R"#(None)#" )
        .def("Intervals",
             (void (HLRBRep_TheQuadCurvExactInterCSurf::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (HLRBRep_TheQuadCurvExactInterCSurf::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&HLRBRep_TheQuadCurvExactInterCSurf::Intervals),
             R"#(U1 and U2 are the parameters of a segment on the curve.)#"  , py::arg("Index"),  py::arg("U1"),  py::arg("U2"))
;


    static_cast<py::class_<HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter ,std::unique_ptr<HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter>  , math_FunctionWithDerivative >>(m.attr("HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter"))
        .def("Value",
...
;
    ...
    static_cast<py::class_<HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter ,std::unique_ptr<HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter>  , math_FunctionWithDerivative >>(m.attr("HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter"))
        .def(py::init<  >()  )
        .def("SetPoint",
...
;
    ...
    static_cast<py::class_<HLRBRep_FaceData ,std::unique_ptr<HLRBRep_FaceData>  >>(m.attr("HLRBRep_FaceData"))
        .def(py::init<  >()  )
        .def("Set",
...
;
    ...
    static_cast<py::class_<HLRBRep_TheIntConicCurveOfCInter ,std::unique_ptr<HLRBRep_TheIntConicCurveOfCInter>  , IntRes2d_Intersection >>(m.attr("HLRBRep_TheIntConicCurveOfCInter"))
        .def(py::init<  >()  )
;

    register_default_constructor<HLRBRep_TheProjPCurOfCInter ,std::unique_ptr<HLRBRep_TheProjPCurOfCInter>>(m,"HLRBRep_TheProjPCurOfCInter");

    static_cast<py::class_<HLRBRep_TheProjPCurOfCInter ,std::unique_ptr<HLRBRep_TheProjPCurOfCInter>  >>(m.attr("HLRBRep_TheProjPCurOfCInter"))
;


    static_cast<py::class_<HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter ,std::unique_ptr<HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter>  , IntRes2d_Intersection >>(m.attr("HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter"))
        .def(py::init<  >()  )
;

    register_default_constructor<HLRBRep_BCurveTool ,std::unique_ptr<HLRBRep_BCurveTool>>(m,"HLRBRep_BCurveTool");

    static_cast<py::class_<HLRBRep_BCurveTool ,std::unique_ptr<HLRBRep_BCurveTool>  >>(m.attr("HLRBRep_BCurveTool"))
        .def_static("FirstParameter_s",
...
;
    ...
    static_cast<py::class_<HLRBRep_Hider ,std::unique_ptr<HLRBRep_Hider>  >>(m.attr("HLRBRep_Hider"))
...
;
    ...
    register_default_constructor<HLRBRep ,std::unique_ptr<HLRBRep>>(m,"HLRBRep");

    static_cast<py::class_<HLRBRep ,std::unique_ptr<HLRBRep>  >>(m.attr("HLRBRep"))
        ...
        .def_static("PolyHLRAngleAndDeflection_s",
                    (void (*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) >(&HLRBRep::PolyHLRAngleAndDeflection),
                    R"#(None)#"  , py::arg("InAngl"),  py::arg("OutAngl"),  py::arg("OutDefl"))
;


    static_cast<py::class_<HLRBRep_CLProps ,std::unique_ptr<HLRBRep_CLProps>  >>(m.attr("HLRBRep_CLProps"))
        .def(py::init< const Standard_Integer,const Standard_Real >()  , py::arg("N"),  py::arg("Resolution") )
        .def("SetParameter",
...
;
    ...
    register_default_constructor<HLRBRep_ThePolygonToolOfInterCSurf ,std::unique_ptr<HLRBRep_ThePolygonToolOfInterCSurf>>(m,"HLRBRep_ThePolygonToolOfInterCSurf");

    static_cast<py::class_<HLRBRep_ThePolygonToolOfInterCSurf ,std::unique_ptr<HLRBRep_ThePolygonToolOfInterCSurf>  >>(m.attr("HLRBRep_ThePolygonToolOfInterCSurf"))
...
;
    ...
    register_default_constructor<HLRBRep_ThePolyhedronToolOfInterCSurf ,std::unique_ptr<HLRBRep_ThePolyhedronToolOfInterCSurf>>(m,"HLRBRep_ThePolyhedronToolOfInterCSurf");

    static_cast<py::class_<HLRBRep_ThePolyhedronToolOfInterCSurf ,std::unique_ptr<HLRBRep_ThePolyhedronToolOfInterCSurf>  >>(m.attr("HLRBRep_ThePolyhedronToolOfInterCSurf"))
        .def_static("Bounding_s",
        ...
        .def_static("Triangle_s",
                    (void (*)( const HLRBRep_ThePolyhedronOfInterCSurf & ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (*)( const HLRBRep_ThePolyhedronOfInterCSurf & ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) >(&HLRBRep_ThePolyhedronToolOfInterCSurf::Triangle),
                    R"#(Give the indices of the 3 points of the triangle of address Index in the PolyhedronTool.)#"  , py::arg("thePolyh"),  py::arg("Index"),  py::arg("P1"),  py::arg("P2"),  py::arg("P3"))
        .def_static("Point_s",
...
;
    ...
    static_cast<py::class_<HLRBRep_ThePolyhedronOfInterCSurf ,std::unique_ptr<HLRBRep_ThePolyhedronOfInterCSurf>  >>(m.attr("HLRBRep_ThePolyhedronOfInterCSurf"))
        .def("Destroy",
        ...
        .def("DeflectionOverEstimation",
             ...
             R"#(None)#"  , py::arg("flec"))
        .def("Size",
             (void (HLRBRep_ThePolyhedronOfInterCSurf::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (HLRBRep_ThePolyhedronOfInterCSurf::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&HLRBRep_ThePolyhedronOfInterCSurf::Size),
             R"#(get the size of the discretization.)#"  , py::arg("nbdu"),  py::arg("nbdv"))
        .def("NbTriangles",
        ...
        .def("Triangle",
             (void (HLRBRep_ThePolyhedronOfInterCSurf::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (HLRBRep_ThePolyhedronOfInterCSurf::*)( const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&HLRBRep_ThePolyhedronOfInterCSurf::Triangle),
        ...
        .def("DeflectionOverEstimation",
             ...
             R"#(None)#" )
        .def("PlaneEquation",
             (void (HLRBRep_ThePolyhedronOfInterCSurf::*)( const Standard_Integer ,  gp_XYZ & ,  Standard_Real &  ) const) static_cast<void (HLRBRep_ThePolyhedronOfInterCSurf::*)( const Standard_Integer ,  gp_XYZ & ,  Standard_Real &  ) const>(&HLRBRep_ThePolyhedronOfInterCSurf::PlaneEquation),
        ...
        .def("Parameters",
             (void (HLRBRep_ThePolyhedronOfInterCSurf::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (HLRBRep_ThePolyhedronOfInterCSurf::*)( const Standard_Integer ,  Standard_Real & ,  Standard_Real &  ) const>(&HLRBRep_ThePolyhedronOfInterCSurf::Parameters),
...
;
    ...
    static_cast<py::class_<HLRBRep_PolyHLRToShape ,std::unique_ptr<HLRBRep_PolyHLRToShape>  >>(m.attr("HLRBRep_PolyHLRToShape"))
        .def(py::init<  >()  )
        .def("Update",
...
;
    ...
    static_cast<py::class_<HLRBRep_TheDistBetweenPCurvesOfTheIntPCurvePCurveOfCInter ,std::unique_ptr<HLRBRep_TheDistBetweenPCurvesOfTheIntPCurvePCurveOfCInter>  , math_FunctionSetWithDerivatives >>(m.attr("HLRBRep_TheDistBetweenPCurvesOfTheIntPCurvePCurveOfCInter"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<HLRBRep_EdgeInterferenceTool ,std::unique_ptr<HLRBRep_EdgeInterferenceTool>  >>(m.attr("HLRBRep_EdgeInterferenceTool"))
        .def(py::init< const opencascade::handle<HLRBRep_Data> & >()  , py::arg("DS") )
        .def("LoadEdge",
        ...
        .def("IsPeriodic",
             ...
             R"#(None)#" )
        .def("EdgeGeometry",
             (void (HLRBRep_EdgeInterferenceTool::*)( const Standard_Real ,  gp_Dir & ,  gp_Dir & ,  Standard_Real &  ) const) static_cast<void (HLRBRep_EdgeInterferenceTool::*)( const Standard_Real ,  gp_Dir & ,  gp_Dir & ,  Standard_Real &  ) const>(&HLRBRep_EdgeInterferenceTool::EdgeGeometry),
             R"#(Returns local geometric description of the Edge at parameter <Para>. See method Reset of class EdgeFaceTransition from TopCnx for other arguments.)#"  , py::arg("Param"),  py::arg("Tgt"),  py::arg("Nrm"),  py::arg("Curv"))
        ...
        .def("InterferenceBoundaryGeometry",
             (void (HLRBRep_EdgeInterferenceTool::*)( const HLRAlgo_Interference & ,  gp_Dir & ,  gp_Dir & ,  Standard_Real &  ) const) static_cast<void (HLRBRep_EdgeInterferenceTool::*)( const HLRAlgo_Interference & ,  gp_Dir & ,  gp_Dir & ,  Standard_Real &  ) const>(&HLRBRep_EdgeInterferenceTool::InterferenceBoundaryGeometry),
             R"#(Returns the geometry of the boundary at the interference <I>. See the AddInterference method of the class EdgeFaceTransition from TopCnx for the other arguments.)#"  , py::arg("I"),  py::arg("Tang"),  py::arg("Norm"),  py::arg("Curv"))
        .def("InitVertices",
             (void (HLRBRep_EdgeInterferenceTool::*)() ) static_cast<void (HLRBRep_EdgeInterferenceTool::*)() >(&HLRBRep_EdgeInterferenceTool::InitVertices),
             R"#(None)#" )
        .def("MoreVertices",
...
;
    ...
    static_cast<py::class_<HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter ,std::unique_ptr<HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter>  , Intf_Polygon2d >>(m.attr("HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter"))
        .def("DeflectionOverEstimation",
...
;
    ...
    static_cast<py::class_<HLRBRep_EdgeBuilder ,std::unique_ptr<HLRBRep_EdgeBuilder>  >>(m.attr("HLRBRep_EdgeBuilder"))
...
;
    ...
    static_cast<py::class_<HLRBRep_Curve ,std::unique_ptr<HLRBRep_Curve>  >>(m.attr("HLRBRep_Curve"))
        .def(py::init<  >()  )
        .def("Projector",
...
;
    ...
    static_cast<py::class_<HLRBRep_HLRToShape ,std::unique_ptr<HLRBRep_HLRToShape>  >>(m.attr("HLRBRep_HLRToShape"))
...
;
    ...
    static_cast<py::class_<HLRBRep_TheInterferenceOfInterCSurf ,std::unique_ptr<HLRBRep_TheInterferenceOfInterCSurf>  , Intf_Interference >>(m.attr("HLRBRep_TheInterferenceOfInterCSurf"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<HLRBRep_BiPnt2D ,std::unique_ptr<HLRBRep_BiPnt2D>  >>(m.attr("HLRBRep_BiPnt2D"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<HLRBRep_TheCSFunctionOfInterCSurf ,std::unique_ptr<HLRBRep_TheCSFunctionOfInterCSurf>  , math_FunctionSetWithDerivatives >>(m.attr("HLRBRep_TheCSFunctionOfInterCSurf"))
        .def("NbVariables",
...
;
    ...
    register_default_constructor<HLRBRep_ShapeToHLR ,std::unique_ptr<HLRBRep_ShapeToHLR>>(m,"HLRBRep_ShapeToHLR");

    static_cast<py::class_<HLRBRep_ShapeToHLR ,std::unique_ptr<HLRBRep_ShapeToHLR>  >>(m.attr("HLRBRep_ShapeToHLR"))
        .def_static("Load_s",
...
;
    ...
    register_default_constructor<HLRBRep_CurveTool ,std::unique_ptr<HLRBRep_CurveTool>>(m,"HLRBRep_CurveTool");

    static_cast<py::class_<HLRBRep_CurveTool ,std::unique_ptr<HLRBRep_CurveTool>  >>(m.attr("HLRBRep_CurveTool"))
        .def_static("FirstParameter_s",
        ...
        .def_static("GetInterval_s",
                    (void (*)( const Standard_Address ,  const Standard_Integer ,   const NCollection_Array1<Standard_Real> & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const Standard_Address ,  const Standard_Integer ,   const NCollection_Array1<Standard_Real> & ,  Standard_Real & ,  Standard_Real &  ) >(&HLRBRep_CurveTool::GetInterval),
...
;
    ...
    static_cast<py::class_<HLRBRep_TheExactInterCSurf ,std::unique_ptr<HLRBRep_TheExactInterCSurf>  >>(m.attr("HLRBRep_TheExactInterCSurf"))
        ...
        .def("ParameterOnSurface",
             (void (HLRBRep_TheExactInterCSurf::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (HLRBRep_TheExactInterCSurf::*)( Standard_Real & ,  Standard_Real &  ) const>(&HLRBRep_TheExactInterCSurf::ParameterOnSurface),
...
;
    ...
    static_cast<py::class_<HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter ,std::unique_ptr<HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter>  >>(m.attr("HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter"))
        .def("Perform",
             (void (HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::*)( const HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter & ,  const HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::*)( const HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter & ,  const HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Real & ,  Standard_Real &  ) >(&HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::Perform),
        ...
        .def("NbRoots",
             ...
             R"#(None)#" )
        .def("Roots",
             (void (HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::*)( Standard_Real & ,  Standard_Real &  ) ) static_cast<void (HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::*)( Standard_Real & ,  Standard_Real &  ) >(&HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::Roots),
             R"#(None)#"  , py::arg("U"),  py::arg("V"))
        .def("AnErrorOccurred",
...
;
    ...
    static_cast<py::class_<HLRBRep_VertexList ,std::unique_ptr<HLRBRep_VertexList>  >>(m.attr("HLRBRep_VertexList"))
...
;
    ...
    static_cast<py::class_<HLRBRep_CInter ,std::unique_ptr<HLRBRep_CInter>  , IntRes2d_Intersection >>(m.attr("HLRBRep_CInter"))
        .def(py::init<  >()  )
        .def("SetMinNbSamples",
...
;
    ...
    static_cast<py::class_<HLRBRep_Data ,opencascade::handle<HLRBRep_Data>  , Standard_Transient >>(m.attr("HLRBRep_Data"))
        ...
        .def("LocalLEGeometry2D",
             (void (HLRBRep_Data::*)( const Standard_Real ,  gp_Dir2d & ,  gp_Dir2d & ,  Standard_Real &  ) ) static_cast<void (HLRBRep_Data::*)( const Standard_Real ,  gp_Dir2d & ,  gp_Dir2d & ,  Standard_Real &  ) >(&HLRBRep_Data::LocalLEGeometry2D),
             R"#(Returns the local description of the projection of the current LEdge at parameter <Param>.)#"  , py::arg("Param"),  py::arg("Tg"),  py::arg("Nm"),  py::arg("Cu"))
        .def("LocalFEGeometry2D",
             (void (HLRBRep_Data::*)( const Standard_Integer ,  const Standard_Real ,  gp_Dir2d & ,  gp_Dir2d & ,  Standard_Real &  ) ) static_cast<void (HLRBRep_Data::*)( const Standard_Integer ,  const Standard_Real ,  gp_Dir2d & ,  gp_Dir2d & ,  Standard_Real &  ) >(&HLRBRep_Data::LocalFEGeometry2D),
             R"#(Returns the local description of the projection of the current FEdge at parameter <Param>.)#"  , py::arg("FE"),  py::arg("Param"),  py::arg("Tg"),  py::arg("Nm"),  py::arg("Cu"))
        .def("EdgeState",
...
;
    ...
    static_cast<py::class_<HLRBRep_Surface ,std::unique_ptr<HLRBRep_Surface>  >>(m.attr("HLRBRep_Surface"))
        .def(py::init<  >()  )
        .def("Projector",
...
;
    ...
    static_cast<py::class_<HLRBRep_ShapeBounds ,std::unique_ptr<HLRBRep_ShapeBounds>  >>(m.attr("HLRBRep_ShapeBounds"))
        .def(py::init<  >()  )
        ...
        .def("NbOfIso",
             ...
             R"#(None)#" )
        .def("Sizes",
             (void (HLRBRep_ShapeBounds::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (HLRBRep_ShapeBounds::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&HLRBRep_ShapeBounds::Sizes),
             R"#(None)#"  , py::arg("NV"),  py::arg("NE"),  py::arg("NF"))
        .def("Bounds",
             (void (HLRBRep_ShapeBounds::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (HLRBRep_ShapeBounds::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) const>(&HLRBRep_ShapeBounds::Bounds),
             R"#(None)#"  , py::arg("V1"),  py::arg("V2"),  py::arg("E1"),  py::arg("E2"),  py::arg("F1"),  py::arg("F2"))
        .def("UpdateMinMax",
...
;
    ...
    register_default_constructor<HLRBRep_SurfaceTool ,std::unique_ptr<HLRBRep_SurfaceTool>>(m,"HLRBRep_SurfaceTool");

    static_cast<py::class_<HLRBRep_SurfaceTool ,std::unique_ptr<HLRBRep_SurfaceTool>  >>(m.attr("HLRBRep_SurfaceTool"))
...
;
    ...
    static_cast<py::class_<HLRBRep_IntConicCurveOfCInter ,std::unique_ptr<HLRBRep_IntConicCurveOfCInter>  , IntRes2d_Intersection >>(m.attr("HLRBRep_IntConicCurveOfCInter"))
        .def(py::init<  >()  )
;


    static_cast<py::class_<HLRBRep_Intersector ,std::unique_ptr<HLRBRep_Intersector>  >>(m.attr("HLRBRep_Intersector"))
        .def(py::init<  >()  )
        .def("Perform",
...
;
    ...
    static_cast<py::class_<HLRBRep_BiPoint ,std::unique_ptr<HLRBRep_BiPoint>  >>(m.attr("HLRBRep_BiPoint"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<HLRBRep_BSurfaceTool ,std::unique_ptr<HLRBRep_BSurfaceTool>>(m,"HLRBRep_BSurfaceTool");

    static_cast<py::class_<HLRBRep_BSurfaceTool ,std::unique_ptr<HLRBRep_BSurfaceTool>  >>(m.attr("HLRBRep_BSurfaceTool"))
        .def_static("FirstUParameter_s",
...
;
    ...
    register_default_constructor<HLRBRep_EdgeFaceTool ,std::unique_ptr<HLRBRep_EdgeFaceTool>>(m,"HLRBRep_EdgeFaceTool");

    static_cast<py::class_<HLRBRep_EdgeFaceTool ,std::unique_ptr<HLRBRep_EdgeFaceTool>  >>(m.attr("HLRBRep_EdgeFaceTool"))
...
;
    ...
    static_cast<py::class_<HLRBRep_InterCSurf ,std::unique_ptr<HLRBRep_InterCSurf>  , IntCurveSurface_Intersection >>(m.attr("HLRBRep_InterCSurf"))
        .def(py::init<  >()  )
;


    static_cast<py::class_<HLRBRep_FaceIterator ,std::unique_ptr<HLRBRep_FaceIterator>  >>(m.attr("HLRBRep_FaceIterator"))
        .def(py::init<  >()  )
        .def("InitEdge",
...
;
    ...
    register_default_constructor<HLRBRep_TheCurveLocatorOfTheProjPCurOfCInter ,std::unique_ptr<HLRBRep_TheCurveLocatorOfTheProjPCurOfCInter>>(m,"HLRBRep_TheCurveLocatorOfTheProjPCurOfCInter");

    static_cast<py::class_<HLRBRep_TheCurveLocatorOfTheProjPCurOfCInter ,std::unique_ptr<HLRBRep_TheCurveLocatorOfTheProjPCurOfCInter>  >>(m.attr("HLRBRep_TheCurveLocatorOfTheProjPCurOfCInter"))
;


    static_cast<py::class_<HLRBRep_EdgeData ,std::unique_ptr<HLRBRep_EdgeData>  >>(m.attr("HLRBRep_EdgeData"))
        .def(py::init<  >()  )
        .def("Set",
...
;
    ...
    static_cast<py::class_<HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf ,std::unique_ptr<HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf>  , math_FunctionWithDerivative >>(m.attr("HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf"))
