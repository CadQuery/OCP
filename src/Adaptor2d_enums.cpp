...
// classes forward declarations only
    py::class_<Adaptor2d_Curve2d ,std::unique_ptr<Adaptor2d_Curve2d>  >(m,"Adaptor2d_Curve2d",R"#(Root class for 2D curves on which geometric algorithms work. An adapted curve is an interface between the services provided by a curve, and those required of the curve by algorithms, which use it. A derived concrete class is provided: Geom2dAdaptor_Curve for a curve from the Geom2d package.)#");
    ...
    py::class_<Adaptor2d_OffsetCurve ,std::unique_ptr<Adaptor2d_OffsetCurve>  , Adaptor2d_Curve2d >(m,"Adaptor2d_OffsetCurve",R"#(Defines an Offset curve (algorithmic 2d curve).)#");
    py::class_<Adaptor2d_HOffsetCurve ,opencascade::handle<Adaptor2d_HOffsetCurve>  , Adaptor2d_HCurve2d >(m,"Adaptor2d_HOffsetCurve",R"#()#");
    py::class_<Adaptor2d_Line2d ,std::unique_ptr<Adaptor2d_Line2d>  , Adaptor2d_Curve2d >(m,"Adaptor2d_Line2d",R"#(Use by the TopolTool to trim a surface.)#");
