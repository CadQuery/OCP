...
// classes forward declarations only
    py::class_<BRepFill_Sweep ,std::unique_ptr<BRepFill_Sweep>  >(m,"BRepFill_Sweep",R"#(Topological Sweep Algorithm Computes an Sweep shell using a generating wire, an SectionLaw and an LocationLaw.)#");
    ...
    py::class_<BRepFill_OffsetAncestors ,std::unique_ptr<BRepFill_OffsetAncestors>  >(m,"BRepFill_OffsetAncestors",R"#(this class is used to find the generating shapes of an OffsetWire.)#");
    py::class_<BRepFill_Generator ,std::unique_ptr<BRepFill_Generator>  >(m,"BRepFill_Generator",R"#(Compute a topological surface ( a shell) using generating wires. The face of the shell will be ruled surfaces passing by the wires. The wires must have the same number of edges.)#");
    py::class_<BRepFill_CompatibleWires ,std::unique_ptr<BRepFill_CompatibleWires>  >(m,"BRepFill_CompatibleWires",R"#(Constructs a sequence of Wires (with good orientation and origin) agreed each other so that the surface passing through these sections is not twisted)#");
    py::class_<BRepFill_Draft ,std::unique_ptr<BRepFill_Draft>  >(m,"BRepFill_Draft",R"#(None)#");
    py::class_<BRepFill_MultiLine ,std::unique_ptr<BRepFill_MultiLine>  , AppCont_Function >(m,"BRepFill_MultiLine",R"#(Class used to compute the 3d curve and the two 2d curves resulting from the intersection of a surface of linear extrusion( Bissec, Dz) and the 2 faces. This 3 curves will have the same parametrization as the Bissectrice. This class is to be send to an approximation routine.)#");
    py::class_<BRepFill_TrimSurfaceTool ,std::unique_ptr<BRepFill_TrimSurfaceTool>  >(m,"BRepFill_TrimSurfaceTool",R"#(Compute the Pcurves and the 3d curves resulting of the trimming of a face by an extruded surface.)#");
    py::class_<BRepFill ,std::unique_ptr<BRepFill>  >(m,"BRepFill",R"#(None)#");
    py::class_<BRepFill_TrimEdgeTool ,std::unique_ptr<BRepFill_TrimEdgeTool>  >(m,"BRepFill_TrimEdgeTool",R"#(Geometric Tool using to construct Offset Wires.)#");
    py::class_<BRepFill_TrimShellCorner ,std::unique_ptr<BRepFill_TrimShellCorner>  >(m,"BRepFill_TrimShellCorner",R"#(Trims sets of faces in the corner to make proper parts of pipe)#");
    py::class_<BRepFill_ApproxSeewing ,std::unique_ptr<BRepFill_ApproxSeewing>  >(m,"BRepFill_ApproxSeewing",R"#(Evaluate the 3dCurve and the PCurves described in a MultiLine from BRepFill. The parametrization of those curves is not imposed by the Bissectrice. The parametrization is given approximatively by the abscissa of the curve3d.)#");
    py::class_<BRepFill_ComputeCLine ,std::unique_ptr<BRepFill_ComputeCLine>  >(m,"BRepFill_ComputeCLine",R"#(None)#");
    ...
    py::class_<BRepFill_SectionPlacement ,std::unique_ptr<BRepFill_SectionPlacement>  >(m,"BRepFill_SectionPlacement",R"#(Place a shape in a local axis coordinate)#");
    py::class_<BRepFill_Pipe ,std::unique_ptr<BRepFill_Pipe>  >(m,"BRepFill_Pipe",R"#(Create a shape by sweeping a shape (the profile) along a wire (the spine).)#");
    ...
    py::class_<BRepFill_FaceAndOrder ,std::unique_ptr<BRepFill_FaceAndOrder>  >(m,"BRepFill_FaceAndOrder",R"#(A structure containing Face and Order of constraint)#");
    py::class_<BRepFill_Section ,std::unique_ptr<BRepFill_Section>  >(m,"BRepFill_Section",R"#(To store section definition)#");
    ...
    py::class_<BRepFill_Evolved ,std::unique_ptr<BRepFill_Evolved>  >(m,"BRepFill_Evolved",R"#(Constructs an evolved volume from a spine (wire or face) and a profile ( wire).)#");
    ...
    py::class_<BRepFill_EdgeFaceAndOrder ,std::unique_ptr<BRepFill_EdgeFaceAndOrder>  >(m,"BRepFill_EdgeFaceAndOrder",R"#(None)#");
