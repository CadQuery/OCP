...
// classes forward declarations only
    py::class_<IGESSolid_ToolConeFrustum ,std::unique_ptr<IGESSolid_ToolConeFrustum>  >(m,"IGESSolid_ToolConeFrustum",R"#(Tool to work on a ConeFrustum. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolSphere ,std::unique_ptr<IGESSolid_ToolSphere>  >(m,"IGESSolid_ToolSphere",R"#(Tool to work on a Sphere. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_ToolSolidInstance ,std::unique_ptr<IGESSolid_ToolSolidInstance>  >(m,"IGESSolid_ToolSolidInstance",R"#(Tool to work on a SolidInstance. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid ,std::unique_ptr<IGESSolid>  >(m,"IGESSolid",R"#(This package consists of B-Rep and CSG Solid entities)#");
    ...
    py::class_<IGESSolid_ToolToroidalSurface ,std::unique_ptr<IGESSolid_ToolToroidalSurface>  >(m,"IGESSolid_ToolToroidalSurface",R"#(Tool to work on a ToroidalSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolSphericalSurface ,std::unique_ptr<IGESSolid_ToolSphericalSurface>  >(m,"IGESSolid_ToolSphericalSurface",R"#(Tool to work on a SphericalSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolConicalSurface ,std::unique_ptr<IGESSolid_ToolConicalSurface>  >(m,"IGESSolid_ToolConicalSurface",R"#(Tool to work on a ConicalSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolCylinder ,std::unique_ptr<IGESSolid_ToolCylinder>  >(m,"IGESSolid_ToolCylinder",R"#(Tool to work on a Cylinder. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_TopoBuilder ,std::unique_ptr<IGESSolid_TopoBuilder>  >(m,"IGESSolid_TopoBuilder",R"#(This class manages the creation of an IGES Topologic entity (BREP : ManifoldSolid, Shell, Face) This includes definiting of Vertex and Edge Lists, building of Edges and Loops)#");
    ...
    py::class_<IGESSolid_HArray1OfVertexList ,std::unique_ptr<IGESSolid_HArray1OfVertexList>  >(m,"IGESSolid_HArray1OfVertexList",R"#()#");
    ...
    py::class_<IGESSolid_ToolPlaneSurface ,std::unique_ptr<IGESSolid_ToolPlaneSurface>  >(m,"IGESSolid_ToolPlaneSurface",R"#(Tool to work on a PlaneSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_ToolBooleanTree ,std::unique_ptr<IGESSolid_ToolBooleanTree>  >(m,"IGESSolid_ToolBooleanTree",R"#(Tool to work on a BooleanTree. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolManifoldSolid ,std::unique_ptr<IGESSolid_ToolManifoldSolid>  >(m,"IGESSolid_ToolManifoldSolid",R"#(Tool to work on a ManifoldSolid. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolShell ,std::unique_ptr<IGESSolid_ToolShell>  >(m,"IGESSolid_ToolShell",R"#(Tool to work on a Shell. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_ToolFace ,std::unique_ptr<IGESSolid_ToolFace>  >(m,"IGESSolid_ToolFace",R"#(Tool to work on a Face. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolLoop ,std::unique_ptr<IGESSolid_ToolLoop>  >(m,"IGESSolid_ToolLoop",R"#(Tool to work on a Loop. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolTorus ,std::unique_ptr<IGESSolid_ToolTorus>  >(m,"IGESSolid_ToolTorus",R"#(Tool to work on a Torus. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_ToolSolidOfLinearExtrusion ,std::unique_ptr<IGESSolid_ToolSolidOfLinearExtrusion>  >(m,"IGESSolid_ToolSolidOfLinearExtrusion",R"#(Tool to work on a SolidOfLinearExtrusion. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolVertexList ,std::unique_ptr<IGESSolid_ToolVertexList>  >(m,"IGESSolid_ToolVertexList",R"#(Tool to work on a VertexList. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_ToolRightAngularWedge ,std::unique_ptr<IGESSolid_ToolRightAngularWedge>  >(m,"IGESSolid_ToolRightAngularWedge",R"#(Tool to work on a RightAngularWedge. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_ToolSolidOfRevolution ,std::unique_ptr<IGESSolid_ToolSolidOfRevolution>  >(m,"IGESSolid_ToolSolidOfRevolution",R"#(Tool to work on a SolidOfRevolution. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_ToolEllipsoid ,std::unique_ptr<IGESSolid_ToolEllipsoid>  >(m,"IGESSolid_ToolEllipsoid",R"#(Tool to work on a Ellipsoid. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_ToolSolidAssembly ,std::unique_ptr<IGESSolid_ToolSolidAssembly>  >(m,"IGESSolid_ToolSolidAssembly",R"#(Tool to work on a SolidAssembly. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_HArray1OfShell ,std::unique_ptr<IGESSolid_HArray1OfShell>  >(m,"IGESSolid_HArray1OfShell",R"#()#");
    py::class_<IGESSolid_ToolCylindricalSurface ,std::unique_ptr<IGESSolid_ToolCylindricalSurface>  >(m,"IGESSolid_ToolCylindricalSurface",R"#(Tool to work on a CylindricalSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESSolid_ToolSelectedComponent ,std::unique_ptr<IGESSolid_ToolSelectedComponent>  >(m,"IGESSolid_ToolSelectedComponent",R"#(Tool to work on a SelectedComponent. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_HArray1OfLoop ,std::unique_ptr<IGESSolid_HArray1OfLoop>  >(m,"IGESSolid_HArray1OfLoop",R"#()#");
    ...
    py::class_<IGESSolid_ToolEdgeList ,std::unique_ptr<IGESSolid_ToolEdgeList>  >(m,"IGESSolid_ToolEdgeList",R"#(Tool to work on a EdgeList. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESSolid_HArray1OfFace ,std::unique_ptr<IGESSolid_HArray1OfFace>  >(m,"IGESSolid_HArray1OfFace",R"#()#");
    ...
    py::class_<IGESSolid_ToolBlock ,std::unique_ptr<IGESSolid_ToolBlock>  >(m,"IGESSolid_ToolBlock",R"#(Tool to work on a Block. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
