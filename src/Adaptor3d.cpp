...
// classes
    ...
    register_default_constructor<Adaptor3d_Curve ,std::unique_ptr<Adaptor3d_Curve>>(m,"Adaptor3d_Curve");

    static_cast<py::class_<Adaptor3d_Curve ,std::unique_ptr<Adaptor3d_Curve>  >>(m.attr("Adaptor3d_Curve"))
        .def("FirstParameter",
...
;
    ...
    register_default_constructor<Adaptor3d_Surface ,std::unique_ptr<Adaptor3d_Surface>>(m,"Adaptor3d_Surface");

    static_cast<py::class_<Adaptor3d_Surface ,std::unique_ptr<Adaptor3d_Surface>  >>(m.attr("Adaptor3d_Surface"))
        .def("FirstUParameter",
...
;
    ...
    static_cast<py::class_<Adaptor3d_IsoCurve ,std::unique_ptr<Adaptor3d_IsoCurve>  , Adaptor3d_Curve >>(m.attr("Adaptor3d_IsoCurve"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Adaptor3d_InterFunc ,std::unique_ptr<Adaptor3d_InterFunc>  , math_FunctionWithDerivative >>(m.attr("Adaptor3d_InterFunc"))
...
;
    ...
    register_default_constructor<Adaptor3d_HSurfaceTool ,std::unique_ptr<Adaptor3d_HSurfaceTool>>(m,"Adaptor3d_HSurfaceTool");

    static_cast<py::class_<Adaptor3d_HSurfaceTool ,std::unique_ptr<Adaptor3d_HSurfaceTool>  >>(m.attr("Adaptor3d_HSurfaceTool"))
...
;
    ...
    static_cast<py::class_<Adaptor3d_CurveOnSurface ,std::unique_ptr<Adaptor3d_CurveOnSurface>  , Adaptor3d_Curve >>(m.attr("Adaptor3d_CurveOnSurface"))
        .def(py::init<  >()  )
        .def(py::init< const opencascade::handle<Adaptor3d_HSurface> & >()  , py::arg("S") )
