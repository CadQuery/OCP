...
;
    ...
    register_default_constructor<StdSelect_BRepSelectionTool ,std::unique_ptr<StdSelect_BRepSelectionTool>>(m,"StdSelect_BRepSelectionTool");

    static_cast<py::class_<StdSelect_BRepSelectionTool ,std::unique_ptr<StdSelect_BRepSelectionTool>  >>(m.attr("StdSelect_BRepSelectionTool"))
        .def_static("Load_s",
...
;
    ...
    register_default_constructor<StdSelect ,std::unique_ptr<StdSelect>>(m,"StdSelect");

    static_cast<py::class_<StdSelect ,std::unique_ptr<StdSelect>  >>(m.attr("StdSelect"))
