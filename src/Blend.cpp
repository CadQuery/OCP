...
// classes
    ...
    static_cast<py::class_<Blend_Point ,std::unique_ptr<Blend_Point>  >>(m.attr("Blend_Point"))
        .def(py::init<  >()  )
        ...
        .def("PointOnS2",
             ...
             R"#(None)#" )
        .def("ParametersOnS1",
             (void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const>(&Blend_Point::ParametersOnS1),
             R"#(None)#"  , py::arg("U"),  py::arg("V"))
        .def("ParametersOnS2",
             (void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const>(&Blend_Point::ParametersOnS2),
             R"#(None)#"  , py::arg("U"),  py::arg("V"))
        .def("TangentOnS1",
        ...
        .def("PointOnC",
             ...
             R"#(None)#" )
        .def("ParametersOnS",
             (void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const>(&Blend_Point::ParametersOnS),
             R"#(None)#"  , py::arg("U"),  py::arg("V"))
        .def("ParameterOnC",
        ...
        .def("ParametersOnS1",
             (void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const>(&Blend_Point::ParametersOnS1),
             R"#(None)#"  , py::arg("U1"),  py::arg("V1"))
        .def("ParametersOnS2",
             (void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Blend_Point::*)( Standard_Real & ,  Standard_Real &  ) const>(&Blend_Point::ParametersOnS2),
             R"#(None)#"  , py::arg("U2"),  py::arg("V2"))
        .def("IsTangencyPoint",
             (Standard_Boolean (Blend_Point::*)() const) static_cast<Standard_Boolean (Blend_Point::*)() const>(&Blend_Point::IsTangencyPoint),
             R"#(Returns Standard_True if it was not possible to compute the tangent vectors at PointOnS1 and/or PointOnS2.)#" )
        .def("TangentOnS1",
...
;
    ...
    static_cast<py::class_<Blend_CurvPointFuncInv ,std::unique_ptr<Blend_CurvPointFuncInv> ,Py_Blend_CurvPointFuncInv , math_FunctionSetWithDerivatives >>(m.attr("Blend_CurvPointFuncInv"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<Blend_FuncInv ,std::unique_ptr<Blend_FuncInv> ,Py_Blend_FuncInv , math_FunctionSetWithDerivatives >>(m.attr("Blend_FuncInv"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<Blend_SurfPointFuncInv ,std::unique_ptr<Blend_SurfPointFuncInv> ,Py_Blend_SurfPointFuncInv , math_FunctionSetWithDerivatives >>(m.attr("Blend_SurfPointFuncInv"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<Blend_SurfCurvFuncInv ,std::unique_ptr<Blend_SurfCurvFuncInv> ,Py_Blend_SurfCurvFuncInv , math_FunctionSetWithDerivatives >>(m.attr("Blend_SurfCurvFuncInv"))
        .def("NbVariables",
...
;
    ...
    static_cast<py::class_<Blend_AppFunction ,std::unique_ptr<Blend_AppFunction> ,Py_Blend_AppFunction , math_FunctionSetWithDerivatives >>(m.attr("Blend_AppFunction"))
        .def("NbVariables",
        ...
        .def("GetShape",
             (void (Blend_AppFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (Blend_AppFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) >(&Blend_AppFunction::GetShape),
        ...
        .def("Resolution",
             (void (Blend_AppFunction::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Blend_AppFunction::*)( const Standard_Integer ,  const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) const>(&Blend_AppFunction::Resolution),
...
;
    ...
    static_cast<py::class_<Blend_Function ,std::unique_ptr<Blend_Function> ,Py_Blend_Function , Blend_AppFunction >>(m.attr("Blend_Function"))
        .def("NbVariables",
        ...
        .def("TwistOnS2",
             ...
             R"#(None)#" )
        .def("GetShape",
             (void (Blend_Function::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (Blend_Function::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) >(&Blend_Function::GetShape),
             R"#(None)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"),  py::arg("NbPoles2d"))
        .def("GetTolerance",
...
;
    ...
    static_cast<py::class_<Blend_SurfRstFunction ,std::unique_ptr<Blend_SurfRstFunction> ,Py_Blend_SurfRstFunction , Blend_AppFunction >>(m.attr("Blend_SurfRstFunction"))
        .def("NbVariables",
        ...
        .def("Intervals",
             ...
             R"#(Stores in <T> the parameters bounding the intervals of continuity <S>.)#"  , py::arg("T"),  py::arg("S"))
        .def("GetShape",
             (void (Blend_SurfRstFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (Blend_SurfRstFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) >(&Blend_SurfRstFunction::GetShape),
             R"#(None)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"),  py::arg("NbPoles2d"))
        .def("GetTolerance",
...
;
    ...
    static_cast<py::class_<Blend_RstRstFunction ,std::unique_ptr<Blend_RstRstFunction> ,Py_Blend_RstRstFunction , Blend_AppFunction >>(m.attr("Blend_RstRstFunction"))
        .def("NbVariables",
        ...
        .def("Intervals",
             ...
             R"#(Stores in <T> the parameters bounding the intervals of continuity <S>.)#"  , py::arg("T"),  py::arg("S"))
        .def("GetShape",
             (void (Blend_RstRstFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (Blend_RstRstFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) >(&Blend_RstRstFunction::GetShape),
             R"#(None)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"),  py::arg("NbPoles2d"))
        .def("GetTolerance",
...
;
    ...
    static_cast<py::class_<Blend_CSFunction ,std::unique_ptr<Blend_CSFunction> ,Py_Blend_CSFunction , Blend_AppFunction >>(m.attr("Blend_CSFunction"))
        .def("NbVariables",
        ...
        .def("GetShape",
             (void (Blend_CSFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (Blend_CSFunction::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) >(&Blend_CSFunction::GetShape),
             R"#(None)#"  , py::arg("NbPoles"),  py::arg("NbKnots"),  py::arg("Degree"),  py::arg("NbPoles2d"))
        .def("GetTolerance",
