...
// classes forward declarations only
    ...
    py::class_<IGESGraph_ToolUniformRectGrid ,std::unique_ptr<IGESGraph_ToolUniformRectGrid>  >(m,"IGESGraph_ToolUniformRectGrid",R"#(Tool to work on a UniformRectGrid. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGraph_ToolLineFontDefTemplate ,std::unique_ptr<IGESGraph_ToolLineFontDefTemplate>  >(m,"IGESGraph_ToolLineFontDefTemplate",R"#(Tool to work on a LineFontDefTemplate. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGraph_ToolLineFontPredefined ,std::unique_ptr<IGESGraph_ToolLineFontPredefined>  >(m,"IGESGraph_ToolLineFontPredefined",R"#(Tool to work on a LineFontPredefined. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGraph_ToolLineFontDefPattern ,std::unique_ptr<IGESGraph_ToolLineFontDefPattern>  >(m,"IGESGraph_ToolLineFontDefPattern",R"#(Tool to work on a LineFontDefPattern. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGraph_HArray1OfColor ,std::unique_ptr<IGESGraph_HArray1OfColor>  >(m,"IGESGraph_HArray1OfColor",R"#()#");
    py::class_<IGESGraph_ToolNominalSize ,std::unique_ptr<IGESGraph_ToolNominalSize>  >(m,"IGESGraph_ToolNominalSize",R"#(Tool to work on a NominalSize. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGraph_ToolIntercharacterSpacing ,std::unique_ptr<IGESGraph_ToolIntercharacterSpacing>  >(m,"IGESGraph_ToolIntercharacterSpacing",R"#(Tool to work on a IntercharacterSpacing. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGraph_ToolTextFontDef ,std::unique_ptr<IGESGraph_ToolTextFontDef>  >(m,"IGESGraph_ToolTextFontDef",R"#(Tool to work on a TextFontDef. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGraph ,std::unique_ptr<IGESGraph>  >(m,"IGESGraph",R"#(This package contains the group of classes necessary to define Graphic data among Structure Entities. (e.g., Fonts, Colors, Screen management ...))#");
    py::class_<IGESGraph_ToolDrawingSize ,std::unique_ptr<IGESGraph_ToolDrawingSize>  >(m,"IGESGraph_ToolDrawingSize",R"#(Tool to work on a DrawingSize. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGraph_ToolPick ,std::unique_ptr<IGESGraph_ToolPick>  >(m,"IGESGraph_ToolPick",R"#(Tool to work on a Pick. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGraph_ToolDrawingUnits ,std::unique_ptr<IGESGraph_ToolDrawingUnits>  >(m,"IGESGraph_ToolDrawingUnits",R"#(Tool to work on a DrawingUnits. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    py::class_<IGESGraph_ToolHighLight ,std::unique_ptr<IGESGraph_ToolHighLight>  >(m,"IGESGraph_ToolHighLight",R"#(Tool to work on a HighLight. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGraph_HArray1OfTextDisplayTemplate ,std::unique_ptr<IGESGraph_HArray1OfTextDisplayTemplate>  >(m,"IGESGraph_HArray1OfTextDisplayTemplate",R"#()#");
    ...
    py::class_<IGESGraph_HArray1OfTextFontDef ,std::unique_ptr<IGESGraph_HArray1OfTextFontDef>  >(m,"IGESGraph_HArray1OfTextFontDef",R"#()#");
    ...
    py::class_<IGESGraph_ToolColor ,std::unique_ptr<IGESGraph_ToolColor>  >(m,"IGESGraph_ToolColor",R"#(Tool to work on a Color. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGraph_ToolDefinitionLevel ,std::unique_ptr<IGESGraph_ToolDefinitionLevel>  >(m,"IGESGraph_ToolDefinitionLevel",R"#(Tool to work on a DefinitionLevel. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
    ...
    py::class_<IGESGraph_ToolTextDisplayTemplate ,std::unique_ptr<IGESGraph_ToolTextDisplayTemplate>  >(m,"IGESGraph_ToolTextDisplayTemplate",R"#(Tool to work on a TextDisplayTemplate. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule))#");
