...
// classes
    ...
    static_cast<py::class_<IGESDimen_ToolCurveDimension ,std::unique_ptr<IGESDimen_ToolCurveDimension>  >>(m.attr("IGESDimen_ToolCurveDimension"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolGeneralLabel ,std::unique_ptr<IGESDimen_ToolGeneralLabel>  >>(m.attr("IGESDimen_ToolGeneralLabel"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolNewGeneralNote ,std::unique_ptr<IGESDimen_ToolNewGeneralNote>  >>(m.attr("IGESDimen_ToolNewGeneralNote"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolLinearDimension ,std::unique_ptr<IGESDimen_ToolLinearDimension>  >>(m.attr("IGESDimen_ToolLinearDimension"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolDimensionedGeometry ,std::unique_ptr<IGESDimen_ToolDimensionedGeometry>  >>(m.attr("IGESDimen_ToolDimensionedGeometry"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolGeneralNote ,std::unique_ptr<IGESDimen_ToolGeneralNote>  >>(m.attr("IGESDimen_ToolGeneralNote"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolAngularDimension ,std::unique_ptr<IGESDimen_ToolAngularDimension>  >>(m.attr("IGESDimen_ToolAngularDimension"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolFlagNote ,std::unique_ptr<IGESDimen_ToolFlagNote>  >>(m.attr("IGESDimen_ToolFlagNote"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolSectionedArea ,std::unique_ptr<IGESDimen_ToolSectionedArea>  >>(m.attr("IGESDimen_ToolSectionedArea"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolSection ,std::unique_ptr<IGESDimen_ToolSection>  >>(m.attr("IGESDimen_ToolSection"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolRadiusDimension ,std::unique_ptr<IGESDimen_ToolRadiusDimension>  >>(m.attr("IGESDimen_ToolRadiusDimension"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolPointDimension ,std::unique_ptr<IGESDimen_ToolPointDimension>  >>(m.attr("IGESDimen_ToolPointDimension"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolGeneralSymbol ,std::unique_ptr<IGESDimen_ToolGeneralSymbol>  >>(m.attr("IGESDimen_ToolGeneralSymbol"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolLeaderArrow ,std::unique_ptr<IGESDimen_ToolLeaderArrow>  >>(m.attr("IGESDimen_ToolLeaderArrow"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolNewDimensionedGeometry ,std::unique_ptr<IGESDimen_ToolNewDimensionedGeometry>  >>(m.attr("IGESDimen_ToolNewDimensionedGeometry"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    register_default_constructor<IGESDimen ,std::unique_ptr<IGESDimen>>(m,"IGESDimen");

    static_cast<py::class_<IGESDimen ,std::unique_ptr<IGESDimen>  >>(m.attr("IGESDimen"))
        .def_static("Init_s",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolWitnessLine ,std::unique_ptr<IGESDimen_ToolWitnessLine>  >>(m.attr("IGESDimen_ToolWitnessLine"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolDimensionTolerance ,std::unique_ptr<IGESDimen_ToolDimensionTolerance>  >>(m.attr("IGESDimen_ToolDimensionTolerance"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_HArray1OfLeaderArrow ,std::unique_ptr<IGESDimen_HArray1OfLeaderArrow>  >>(m.attr("IGESDimen_HArray1OfLeaderArrow"))
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolBasicDimension ,std::unique_ptr<IGESDimen_ToolBasicDimension>  >>(m.attr("IGESDimen_ToolBasicDimension"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolDimensionUnits ,std::unique_ptr<IGESDimen_ToolDimensionUnits>  >>(m.attr("IGESDimen_ToolDimensionUnits"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolDimensionDisplayData ,std::unique_ptr<IGESDimen_ToolDimensionDisplayData>  >>(m.attr("IGESDimen_ToolDimensionDisplayData"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolCenterLine ,std::unique_ptr<IGESDimen_ToolCenterLine>  >>(m.attr("IGESDimen_ToolCenterLine"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolDiameterDimension ,std::unique_ptr<IGESDimen_ToolDiameterDimension>  >>(m.attr("IGESDimen_ToolDiameterDimension"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_ToolOrdinateDimension ,std::unique_ptr<IGESDimen_ToolOrdinateDimension>  >>(m.attr("IGESDimen_ToolOrdinateDimension"))
        .def(py::init<  >()  )
        .def("ReadOwnParams",
...
;
    ...
    static_cast<py::class_<IGESDimen_HArray1OfGeneralNote ,std::unique_ptr<IGESDimen_HArray1OfGeneralNote>  >>(m.attr("IGESDimen_HArray1OfGeneralNote"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
