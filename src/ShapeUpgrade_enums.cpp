...
// classes forward declarations only
    py::class_<ShapeUpgrade_ShapeDivide ,std::unique_ptr<ShapeUpgrade_ShapeDivide>  >(m,"ShapeUpgrade_ShapeDivide",R"#(Divides a all faces in shell with given criteria Shell.)#");
    py::class_<ShapeUpgrade_ShapeDivideClosed ,std::unique_ptr<ShapeUpgrade_ShapeDivideClosed>  , ShapeUpgrade_ShapeDivide >(m,"ShapeUpgrade_ShapeDivideClosed",R"#(Divides all closed faces in the shape. Class ShapeUpgrade_ClosedFaceDivide is used as divide tool.)#");
    ...
    py::class_<ShapeUpgrade_ShapeDivideArea ,std::unique_ptr<ShapeUpgrade_ShapeDivideArea>  , ShapeUpgrade_ShapeDivide >(m,"ShapeUpgrade_ShapeDivideArea",R"#(Divides faces from sprcified shape by max area criterium.)#");
    ...
    py::class_<ShapeUpgrade_ShapeDivideAngle ,std::unique_ptr<ShapeUpgrade_ShapeDivideAngle>  , ShapeUpgrade_ShapeDivide >(m,"ShapeUpgrade_ShapeDivideAngle",R"#(Splits all surfaces of revolution, cylindrical, toroidal, conical, spherical surfaces in the given shape so that each resulting segment covers not more than defined number of degrees (to segments less than 90).)#");
    ...
    py::class_<ShapeUpgrade_ShellSewing ,std::unique_ptr<ShapeUpgrade_ShellSewing>  >(m,"ShapeUpgrade_ShellSewing",R"#(This class provides a tool for applying sewing algorithm from BRepBuilderAPI: it takes a shape, calls sewing for each shell, and then replaces sewed shells with use of ShapeBuild_ReShape)#");
    ...
    py::class_<ShapeUpgrade_ShapeDivideClosedEdges ,std::unique_ptr<ShapeUpgrade_ShapeDivideClosedEdges>  , ShapeUpgrade_ShapeDivide >(m,"ShapeUpgrade_ShapeDivideClosedEdges",R"#(None)#");
    ...
    py::class_<ShapeUpgrade_ShapeDivideContinuity ,std::unique_ptr<ShapeUpgrade_ShapeDivideContinuity>  , ShapeUpgrade_ShapeDivide >(m,"ShapeUpgrade_ShapeDivideContinuity",R"#(API Tool for converting shapes with C0 geometry into C1 ones)#");
