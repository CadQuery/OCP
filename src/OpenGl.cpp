...
// classes
    ...
    static_cast<py::class_<OpenGl_BVHClipPrimitiveSet , shared_ptr<OpenGl_BVHClipPrimitiveSet>  >>(m.attr("OpenGl_BVHClipPrimitiveSet"))
        .def(py::init<  >()  )
    // methods
        .def("DynamicType",
             (const opencascade::handle<Standard_Type> & (OpenGl_BVHClipPrimitiveSet::*)() const) static_cast<const opencascade::handle<Standard_Type> & (OpenGl_BVHClipPrimitiveSet::*)() const>(&OpenGl_BVHClipPrimitiveSet::DynamicType),
             R"#(None)#" )
        .def("Size",
             (Standard_Integer (OpenGl_BVHClipPrimitiveSet::*)() const) static_cast<Standard_Integer (OpenGl_BVHClipPrimitiveSet::*)() const>(&OpenGl_BVHClipPrimitiveSet::Size),
             R"#(Returns total number of structures.)#" )
        .def("Box",
             (Graphic3d_BndBox3d (OpenGl_BVHClipPrimitiveSet::*)( const Standard_Integer  ) const) static_cast<Graphic3d_BndBox3d (OpenGl_BVHClipPrimitiveSet::*)( const Standard_Integer  ) const>(&OpenGl_BVHClipPrimitiveSet::Box),
             R"#(Returns AABB of the structure.)#"  , py::arg("theIdx"))
        .def("Center",
             (Standard_Real (OpenGl_BVHClipPrimitiveSet::*)( const Standard_Integer ,  const Standard_Integer  ) const) static_cast<Standard_Real (OpenGl_BVHClipPrimitiveSet::*)( const Standard_Integer ,  const Standard_Integer  ) const>(&OpenGl_BVHClipPrimitiveSet::Center),
             R"#(Calculates center of the AABB along given axis.)#"  , py::arg("theIdx"),  py::arg("theAxis"))
        .def("Swap",
             (void (OpenGl_BVHClipPrimitiveSet::*)( const Standard_Integer ,  const Standard_Integer  ) ) static_cast<void (OpenGl_BVHClipPrimitiveSet::*)( const Standard_Integer ,  const Standard_Integer  ) >(&OpenGl_BVHClipPrimitiveSet::Swap),
             R"#(Swaps structures with the given indices.)#"  , py::arg("theIdx1"),  py::arg("theIdx2"))
        .def("Add",
             (Standard_Boolean (OpenGl_BVHClipPrimitiveSet::*)( const OpenGl_Structure *  ) ) static_cast<Standard_Boolean (OpenGl_BVHClipPrimitiveSet::*)( const OpenGl_Structure *  ) >(&OpenGl_BVHClipPrimitiveSet::Add),
             R"#(Adds structure to the set.)#"  , py::arg("theStruct"))
        .def("Remove",
             (Standard_Boolean (OpenGl_BVHClipPrimitiveSet::*)( const OpenGl_Structure *  ) ) static_cast<Standard_Boolean (OpenGl_BVHClipPrimitiveSet::*)( const OpenGl_Structure *  ) >(&OpenGl_BVHClipPrimitiveSet::Remove),
             R"#(Removes the given structure from the set.)#"  , py::arg("theStruct"))
        .def("Clear",
             (void (OpenGl_BVHClipPrimitiveSet::*)() ) static_cast<void (OpenGl_BVHClipPrimitiveSet::*)() >(&OpenGl_BVHClipPrimitiveSet::Clear),
             R"#(Cleans the whole primitive set.)#" )
        .def("GetStructureById",
             (const OpenGl_Structure * (OpenGl_BVHClipPrimitiveSet::*)( Standard_Integer  ) ) static_cast<const OpenGl_Structure * (OpenGl_BVHClipPrimitiveSet::*)( Standard_Integer  ) >(&OpenGl_BVHClipPrimitiveSet::GetStructureById),
             R"#(Returns the structure corresponding to the given ID.)#"  , py::arg("theId"))
        .def("Structures",
             (const NCollection_IndexedMap<const OpenGl_Structure *> & (OpenGl_BVHClipPrimitiveSet::*)() const) static_cast<const NCollection_IndexedMap<const OpenGl_Structure *> & (OpenGl_BVHClipPrimitiveSet::*)() const>(&OpenGl_BVHClipPrimitiveSet::Structures),
             R"#(Access directly a collection of structures.)#" )
    // methods using call by reference i.s.o. return
    // static methods
        .def_static("get_type_name_s",
                    (const char * (*)() ) static_cast<const char * (*)() >(&OpenGl_BVHClipPrimitiveSet::get_type_name),
                    R"#(None)#" )
        .def_static("get_type_descriptor_s",
                    (const opencascade::handle<Standard_Type> & (*)() ) static_cast<const opencascade::handle<Standard_Type> & (*)() >(&OpenGl_BVHClipPrimitiveSet::get_type_descriptor),
                    R"#(None)#" )
...
;
    ...
    static_cast<py::class_<OpenGl_BVHClipPrimitiveTrsfPersSet , shared_ptr<OpenGl_BVHClipPrimitiveTrsfPersSet>  >>(m.attr("OpenGl_BVHClipPrimitiveTrsfPersSet"))
        .def(py::init< const opencascade::handle<Select3D_BVHBuilder3d> & >()  , py::arg("theBuilder") )
    // methods
        .def("Size",
             (Standard_Integer (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() const) static_cast<Standard_Integer (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() const>(&OpenGl_BVHClipPrimitiveTrsfPersSet::Size),
             R"#(Returns total number of structures.)#" )
        .def("Box",
             (Graphic3d_BndBox3d (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const Standard_Integer  ) const) static_cast<Graphic3d_BndBox3d (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const Standard_Integer  ) const>(&OpenGl_BVHClipPrimitiveTrsfPersSet::Box),
             R"#(Returns AABB of the structure.)#"  , py::arg("theIdx"))
        .def("Center",
             (Standard_Real (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const Standard_Integer ,  const Standard_Integer  ) const) static_cast<Standard_Real (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const Standard_Integer ,  const Standard_Integer  ) const>(&OpenGl_BVHClipPrimitiveTrsfPersSet::Center),
             R"#(Calculates center of the AABB along given axis.)#"  , py::arg("theIdx"),  py::arg("theAxis"))
        .def("Swap",
             (void (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const Standard_Integer ,  const Standard_Integer  ) ) static_cast<void (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const Standard_Integer ,  const Standard_Integer  ) >(&OpenGl_BVHClipPrimitiveTrsfPersSet::Swap),
             R"#(Swaps structures with the given indices.)#"  , py::arg("theIdx1"),  py::arg("theIdx2"))
        .def("Add",
             (Standard_Boolean (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const OpenGl_Structure *  ) ) static_cast<Standard_Boolean (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const OpenGl_Structure *  ) >(&OpenGl_BVHClipPrimitiveTrsfPersSet::Add),
             R"#(Adds structure to the set.)#"  , py::arg("theStruct"))
        .def("Remove",
             (Standard_Boolean (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const OpenGl_Structure *  ) ) static_cast<Standard_Boolean (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const OpenGl_Structure *  ) >(&OpenGl_BVHClipPrimitiveTrsfPersSet::Remove),
             R"#(Removes the given structure from the set.)#"  , py::arg("theStruct"))
        .def("Clear",
             (void (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() ) static_cast<void (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() >(&OpenGl_BVHClipPrimitiveTrsfPersSet::Clear),
             R"#(Cleans the whole primitive set.)#" )
        .def("GetStructureById",
             (const OpenGl_Structure * (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( Standard_Integer  ) ) static_cast<const OpenGl_Structure * (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( Standard_Integer  ) >(&OpenGl_BVHClipPrimitiveTrsfPersSet::GetStructureById),
             R"#(Returns the structure corresponding to the given ID.)#"  , py::arg("theId"))
        .def("Structures",
             (const NCollection_IndexedMap<const OpenGl_Structure *> & (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() const) static_cast<const NCollection_IndexedMap<const OpenGl_Structure *> & (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() const>(&OpenGl_BVHClipPrimitiveTrsfPersSet::Structures),
             R"#(Access directly a collection of structures.)#" )
        .def("MarkDirty",
             (void (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() ) static_cast<void (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() >(&OpenGl_BVHClipPrimitiveTrsfPersSet::MarkDirty),
             R"#(Marks object state as outdated (needs BVH rebuilding).)#" )
        .def("BVH",
             (const opencascade::handle<BVH_Tree<Standard_Real, 3> > & (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const opencascade::handle<Graphic3d_Camera> & ,   const Graphic3d_Mat4d & ,   const Graphic3d_Mat4d & ,  const Standard_Integer ,  const Standard_Integer ,  const Graphic3d_WorldViewProjState &  ) ) static_cast<const opencascade::handle<BVH_Tree<Standard_Real, 3> > & (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const opencascade::handle<Graphic3d_Camera> & ,   const Graphic3d_Mat4d & ,   const Graphic3d_Mat4d & ,  const Standard_Integer ,  const Standard_Integer ,  const Graphic3d_WorldViewProjState &  ) >(&OpenGl_BVHClipPrimitiveTrsfPersSet::BVH),
        ...
        .def("Builder",
             (const opencascade::handle<Select3D_BVHBuilder3d> & (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() const) static_cast<const opencascade::handle<Select3D_BVHBuilder3d> & (OpenGl_BVHClipPrimitiveTrsfPersSet::*)() const>(&OpenGl_BVHClipPrimitiveTrsfPersSet::Builder),
             R"#(Returns builder for bottom-level BVH.)#" )
        .def("SetBuilder",
             (void (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const opencascade::handle<Select3D_BVHBuilder3d> &  ) ) static_cast<void (OpenGl_BVHClipPrimitiveTrsfPersSet::*)( const opencascade::handle<Select3D_BVHBuilder3d> &  ) >(&OpenGl_BVHClipPrimitiveTrsfPersSet::SetBuilder),
...
;
    ...
    static_cast<py::class_<OpenGl_BVHTreeSelector , shared_ptr<OpenGl_BVHTreeSelector>  >>(m.attr("OpenGl_BVHTreeSelector"))
        .def(py::init<  >()  )
    // methods
        .def("SetViewVolume",
             (void (OpenGl_BVHTreeSelector::*)( const opencascade::handle<Graphic3d_Camera> &  ) ) static_cast<void (OpenGl_BVHTreeSelector::*)( const opencascade::handle<Graphic3d_Camera> &  ) >(&OpenGl_BVHTreeSelector::SetViewVolume),
             R"#(Retrieves view volume's planes equations and its vertices from projection and world-view matrices.)#"  , py::arg("theCamera"))
        .def("SetViewportSize",
             (void (OpenGl_BVHTreeSelector::*)( Standard_Integer ,  Standard_Integer ,  Standard_Real  ) ) static_cast<void (OpenGl_BVHTreeSelector::*)( Standard_Integer ,  Standard_Integer ,  Standard_Real  ) >(&OpenGl_BVHTreeSelector::SetViewportSize),
             R"#(None)#"  , py::arg("theViewportWidth"),  py::arg("theViewportHeight"),  py::arg("theResolutionRatio"))
        .def("SetCullingDistance",
             (void (OpenGl_BVHTreeSelector::*)( OpenGl_BVHTreeSelector::CullingContext & ,  Standard_Real  ) const) static_cast<void (OpenGl_BVHTreeSelector::*)( OpenGl_BVHTreeSelector::CullingContext & ,  Standard_Real  ) const>(&OpenGl_BVHTreeSelector::SetCullingDistance),
             R"#(Setup distance culling.)#"  , py::arg("theCtx"),  py::arg("theDistance"))
        .def("SetCullingSize",
             (void (OpenGl_BVHTreeSelector::*)( OpenGl_BVHTreeSelector::CullingContext & ,  Standard_Real  ) const) static_cast<void (OpenGl_BVHTreeSelector::*)( OpenGl_BVHTreeSelector::CullingContext & ,  Standard_Real  ) const>(&OpenGl_BVHTreeSelector::SetCullingSize),
             R"#(Setup size culling.)#"  , py::arg("theCtx"),  py::arg("theSize"))
        .def("CacheClipPtsProjections",
             (void (OpenGl_BVHTreeSelector::*)() ) static_cast<void (OpenGl_BVHTreeSelector::*)() >(&OpenGl_BVHTreeSelector::CacheClipPtsProjections),
        ...
        .def("IsCulled",
             (bool (OpenGl_BVHTreeSelector::*)( const OpenGl_BVHTreeSelector::CullingContext & ,   const Graphic3d_Vec3d & ,   const Graphic3d_Vec3d &  ) const) static_cast<bool (OpenGl_BVHTreeSelector::*)( const OpenGl_BVHTreeSelector::CullingContext & ,   const Graphic3d_Vec3d & ,   const Graphic3d_Vec3d &  ) const>(&OpenGl_BVHTreeSelector::IsCulled),
             R"#(Checks whether given AABB should be entirely culled or not.)#"  , py::arg("theCtx"),  py::arg("theMinPt"),  py::arg("theMaxPt"))
        .def("Camera",
             (const opencascade::handle<Graphic3d_Camera> & (OpenGl_BVHTreeSelector::*)() const) static_cast<const opencascade::handle<Graphic3d_Camera> & (OpenGl_BVHTreeSelector::*)() const>(&OpenGl_BVHTreeSelector::Camera),
             R"#(Return the camera definition.)#" )
        .def("ProjectionMatrix",
             (const OpenGl_Mat4d & (OpenGl_BVHTreeSelector::*)() const) static_cast<const OpenGl_Mat4d & (OpenGl_BVHTreeSelector::*)() const>(&OpenGl_BVHTreeSelector::ProjectionMatrix),
             R"#(Returns current projection matrix.)#" )
        .def("WorldViewMatrix",
             (const OpenGl_Mat4d & (OpenGl_BVHTreeSelector::*)() const) static_cast<const OpenGl_Mat4d & (OpenGl_BVHTreeSelector::*)() const>(&OpenGl_BVHTreeSelector::WorldViewMatrix),
             R"#(Returns current world view transformation matrix.)#" )
        .def("ViewportWidth",
             (Standard_Integer (OpenGl_BVHTreeSelector::*)() const) static_cast<Standard_Integer (OpenGl_BVHTreeSelector::*)() const>(&OpenGl_BVHTreeSelector::ViewportWidth),
             R"#(None)#" )
        .def("ViewportHeight",
             (Standard_Integer (OpenGl_BVHTreeSelector::*)() const) static_cast<Standard_Integer (OpenGl_BVHTreeSelector::*)() const>(&OpenGl_BVHTreeSelector::ViewportHeight),
             R"#(None)#" )
        .def("WorldViewProjState",
             (const Graphic3d_WorldViewProjState & (OpenGl_BVHTreeSelector::*)() const) static_cast<const Graphic3d_WorldViewProjState & (OpenGl_BVHTreeSelector::*)() const>(&OpenGl_BVHTreeSelector::WorldViewProjState),
...
;
    ...
    // methods
        .def("Init",
             (void (OpenGl_Clipping::*)( const Standard_Integer  ) ) static_cast<void (OpenGl_Clipping::*)( const Standard_Integer  ) >(&OpenGl_Clipping::Init),
             R"#(Initialize.)#"  , py::arg("theMaxPlanes"))
        .def("Reset",
             (void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const opencascade::handle<Graphic3d_SequenceOfHClipPlane> &  ) ) static_cast<void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const opencascade::handle<Graphic3d_SequenceOfHClipPlane> &  ) >(&OpenGl_Clipping::Reset),
             R"#(Setup list of global (for entire view) clipping planes and clears local plane list if it was not released before.)#"  , py::arg("theGlCtx"),  py::arg("thePlanes"))
        .def("SetLocalPlanes",
             (void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const opencascade::handle<Graphic3d_SequenceOfHClipPlane> &  ) ) static_cast<void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const opencascade::handle<Graphic3d_SequenceOfHClipPlane> &  ) >(&OpenGl_Clipping::SetLocalPlanes),
             R"#(Setup list of local (for current object) clipping planes.)#"  , py::arg("theGlCtx"),  py::arg("thePlanes"))
        .def("IsClippingOn",
             (Standard_Boolean (OpenGl_Clipping::*)() const) static_cast<Standard_Boolean (OpenGl_Clipping::*)() const>(&OpenGl_Clipping::IsClippingOn),
             R"#(Returns true if there are enabled clipping planes (NOT capping))#" )
        .def("IsCappingOn",
        ...
        .def("SetEnabled",
             (Standard_Boolean (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const OpenGl_ClippingIterator & ,  const Standard_Boolean  ) ) static_cast<Standard_Boolean (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const OpenGl_ClippingIterator & ,  const Standard_Boolean  ) >(&OpenGl_Clipping::SetEnabled),
             R"#(Disable plane temporarily.)#"  , py::arg("theGlCtx"),  py::arg("thePlane"),  py::arg("theIsEnabled"))
        .def("DisableGlobal",
             (void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> &  ) ) static_cast<void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> &  ) >(&OpenGl_Clipping::DisableGlobal),
             R"#(Temporarily disable all planes from the global (view) list, keep only local (object) list.)#"  , py::arg("theGlCtx"))
        .def("RestoreDisabled",
             (void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> &  ) ) static_cast<void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> &  ) >(&OpenGl_Clipping::RestoreDisabled),
             R"#(Restore all temporarily disabled planes. Does NOT affect constantly disabled planes Graphic3d_ClipPlane::IsOn().)#"  , py::arg("theGlCtx"))
        .def("DisableAllExcept",
             (void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const OpenGl_ClippingIterator &  ) ) static_cast<void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const OpenGl_ClippingIterator &  ) >(&OpenGl_Clipping::DisableAllExcept),
             R"#(Temporarily disable all planes except specified one. Does not affect already disabled planes.)#"  , py::arg("theGlCtx"),  py::arg("thePlane"))
        .def("EnableAllExcept",
             (void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const OpenGl_ClippingIterator &  ) ) static_cast<void (OpenGl_Clipping::*)( const opencascade::handle<OpenGl_Context> & ,  const OpenGl_ClippingIterator &  ) >(&OpenGl_Clipping::EnableAllExcept),
             R"#(Enable back planes disabled by ::DisableAllExcept(). Keeps only specified plane enabled.)#"  , py::arg("theGlCtx"),  py::arg("thePlane"))
    // methods using call by reference i.s.o. return
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
...
;
    ...
    // methods
        ...
        .def("IsDisabled",
             ...
             R"#(Return true if plane has been temporarily disabled either by Graphic3d_ClipPlane->IsOn() property or by temporary filter.)#" )
        .def("Value",
...
;
    ...
    static_cast<py::class_<OpenGl_RaytraceMaterial , shared_ptr<OpenGl_RaytraceMaterial>  >>(m.attr("OpenGl_RaytraceMaterial"))
        .def(py::init<  >()  )
        .def(py::init<  const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type & >()  , py::arg("theAmbient"),  py::arg("theDiffuse"),  py::arg("theSpecular") )
        .def(py::init<  const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type & >()  , py::arg("theAmbient"),  py::arg("theDiffuse"),  py::arg("theSpecular"),  py::arg("theEmission"),  py::arg("theTranspar") )
        .def(py::init<  const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type &, const BVH::VectorType<Standard_ShortReal, 4>::Type & >()  , py::arg("theAmbient"),  py::arg("theDiffuse"),  py::arg("theSpecular"),  py::arg("theEmission"),  py::arg("theTranspar"),  py::arg("theReflection"),  py::arg("theRefraction") )
    // methods
        .def("Packed",
...
;
    ...
    // methods
        .def("SizeX",
             (int (OpenGl_TileSampler::*)() const) static_cast<int (OpenGl_TileSampler::*)() const>(&OpenGl_TileSampler::SizeX),
             R"#(Returns width of ray-tracing viewport.)#" )
        .def("SizeY",
             (int (OpenGl_TileSampler::*)() const) static_cast<int (OpenGl_TileSampler::*)() const>(&OpenGl_TileSampler::SizeY),
             R"#(Returns height of ray-tracing viewport.)#" )
        .def("NbTilesX",
        ...
        .def("SetSize",
             (void (OpenGl_TileSampler::*)( const int ,  const int  ) ) static_cast<void (OpenGl_TileSampler::*)( const int ,  const int  ) >(&OpenGl_TileSampler::SetSize),
             R"#(Specifies size of ray-tracing viewport.)#"  , py::arg("theSizeX"),  py::arg("theSizeY"))
        .def("TileArea",
             (int (OpenGl_TileSampler::*)( const int ,  const int  ) const) static_cast<int (OpenGl_TileSampler::*)( const int ,  const int  ) const>(&OpenGl_TileSampler::TileArea),
             R"#(Returns number of pixels in the given tile.)#"  , py::arg("theX"),  py::arg("theY"))
        .def("GrabVarianceMap",
             (void (OpenGl_TileSampler::*)( const opencascade::handle<OpenGl_Context> &  ) ) static_cast<void (OpenGl_TileSampler::*)( const opencascade::handle<OpenGl_Context> &  ) >(&OpenGl_TileSampler::GrabVarianceMap),
             R"#(Fetches current error estimation from the GPU and builds 2D discrete distribution for tile sampling.)#"  , py::arg("theContext"))
        .def("Sample",
             (void (OpenGl_TileSampler::*)( int & ,  int &  ) ) static_cast<void (OpenGl_TileSampler::*)( int & ,  int &  ) >(&OpenGl_TileSampler::Sample),
             R"#(Samples tile location according to estimated error.)#"  , py::arg("theOffsetX"),  py::arg("theOffsetY"))
        .def("Reset",
             (void (OpenGl_TileSampler::*)() ) static_cast<void (OpenGl_TileSampler::*)() >(&OpenGl_TileSampler::Reset),
             R"#(Resets tile sampler to initial state.)#" )
        .def("Upload",
             (void (OpenGl_TileSampler::*)( const opencascade::handle<OpenGl_Context> & ,  const opencascade::handle<OpenGl_Texture> & ,  const int ,  const int ,  const bool  ) ) static_cast<void (OpenGl_TileSampler::*)( const opencascade::handle<OpenGl_Context> & ,  const opencascade::handle<OpenGl_Texture> & ,  const int ,  const int ,  const bool  ) >(&OpenGl_TileSampler::Upload),
             R"#(Uploads offsets of sampled tiles to the given OpenGL texture.)#"  , py::arg("theContext"),  py::arg("theTexture"),  py::arg("theNbTilesX"),  py::arg("theNbTilesY"),  py::arg("theAdaptive"))
    // methods using call by reference i.s.o. return
    // static methods
        .def_static("TileSize_s",
                    (int (*)() ) static_cast<int (*)() >(&OpenGl_TileSampler::TileSize),
...
;
    ...
    static_cast<py::class_<OpenGl_AspectFace , shared_ptr<OpenGl_AspectFace>  , OpenGl_Element >>(m.attr("OpenGl_AspectFace"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<OpenGl_AspectLine , shared_ptr<OpenGl_AspectLine>  , OpenGl_Element >>(m.attr("OpenGl_AspectLine"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<OpenGl_AspectMarker , shared_ptr<OpenGl_AspectMarker>  , OpenGl_Element >>(m.attr("OpenGl_AspectMarker"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<OpenGl_AspectText , shared_ptr<OpenGl_AspectText>  , OpenGl_Element >>(m.attr("OpenGl_AspectText"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<OpenGl_Text , shared_ptr_nodelete<OpenGl_Text>  , OpenGl_Element >>(m.attr("OpenGl_Text"))
...
;
    ...
    static_cast<py::class_<OpenGl_FrameStatsPrs , shared_ptr<OpenGl_FrameStatsPrs>  , OpenGl_Text >>(m.attr("OpenGl_FrameStatsPrs"))
        .def(py::init<  >()  )
    // methods
        .def("Render",
