...
// classes
    ...
    static_cast<py::class_<IntTools_BaseRangeSample ,std::unique_ptr<IntTools_BaseRangeSample>  >>(m.attr("IntTools_BaseRangeSample"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IntTools_SurfaceRangeSample ,std::unique_ptr<IntTools_SurfaceRangeSample>  >>(m.attr("IntTools_SurfaceRangeSample"))
        .def(py::init<  >()  )
        ...
        .def("GetIndexes",
             (void (IntTools_SurfaceRangeSample::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (IntTools_SurfaceRangeSample::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&IntTools_SurfaceRangeSample::GetIndexes),
             R"#(None)#"  , py::arg("theIndexU"),  py::arg("theIndexV"))
        .def("GetDepths",
             (void (IntTools_SurfaceRangeSample::*)( Standard_Integer & ,  Standard_Integer &  ) const) static_cast<void (IntTools_SurfaceRangeSample::*)( Standard_Integer & ,  Standard_Integer &  ) const>(&IntTools_SurfaceRangeSample::GetDepths),
             R"#(None)#"  , py::arg("theDepthU"),  py::arg("theDepthV"))
        .def("SetSampleRangeU",
...
;
    ...
    static_cast<py::class_<IntTools_CArray1OfReal ,std::unique_ptr<IntTools_CArray1OfReal>  >>(m.attr("IntTools_CArray1OfReal"))
...
;
    ...
    static_cast<py::class_<IntTools_Curve ,std::unique_ptr<IntTools_Curve>  >>(m.attr("IntTools_Curve"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IntTools_ShrunkRange ,std::unique_ptr<IntTools_ShrunkRange>  >>(m.attr("IntTools_ShrunkRange"))
        .def(py::init<  >()  )
        .def("SetData",
        ...
        .def("ShrunkRange",
             (void (IntTools_ShrunkRange::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IntTools_ShrunkRange::*)( Standard_Real & ,  Standard_Real &  ) const>(&IntTools_ShrunkRange::ShrunkRange),
             R"#(None)#"  , py::arg("aT1"),  py::arg("aT2"))
        .def("BndBox",
...
;
    ...
    static_cast<py::class_<IntTools_CurveRangeLocalizeData ,std::unique_ptr<IntTools_CurveRangeLocalizeData>  >>(m.attr("IntTools_CurveRangeLocalizeData"))
...
;
    ...
    static_cast<py::class_<IntTools_Root ,std::unique_ptr<IntTools_Root>  >>(m.attr("IntTools_Root"))
        .def(py::init<  >()  )
        ...
        .def("Interval",
             (void (IntTools_Root::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IntTools_Root::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&IntTools_Root::Interval),
             R"#(Returns the values of interval from which the Root was found [t1,t2] and the corresponding values of the function on the bounds f(t1), f(t2).)#"  , py::arg("t1"),  py::arg("t2"),  py::arg("f1"),  py::arg("f2"))
;
    ...
    static_cast<py::class_<IntTools_Context ,opencascade::handle<IntTools_Context>  , Standard_Transient >>(m.attr("IntTools_Context"))
        ...
        .def("UVBounds",
             (void (IntTools_Context::*)( const TopoDS_Face & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (IntTools_Context::*)( const TopoDS_Face & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) >(&IntTools_Context::UVBounds),
             R"#(Computes the boundaries of the face using surface adaptor)#"  , py::arg("theFace"),  py::arg("UMin"),  py::arg("UMax"),  py::arg("VMin"),  py::arg("VMax"))
        .def("ComputePE",
...
;
    ...
    static_cast<py::class_<IntTools_EdgeFace ,std::unique_ptr<IntTools_EdgeFace>  >>(m.attr("IntTools_EdgeFace"))
        .def(py::init<  >()  )
        .def("SetEdge",
...
;
    ...
    static_cast<py::class_<IntTools_MarkedRangeSet ,std::unique_ptr<IntTools_MarkedRangeSet>  >>(m.attr("IntTools_MarkedRangeSet"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<IntTools ,std::unique_ptr<IntTools>>(m,"IntTools");

    static_cast<py::class_<IntTools ,std::unique_ptr<IntTools>  >>(m.attr("IntTools"))
        .def_static("Length_s",
...
;
    ...
    static_cast<py::class_<IntTools_FaceFace ,std::unique_ptr<IntTools_FaceFace>  >>(m.attr("IntTools_FaceFace"))
        .def(py::init<  >()  )
        .def("SetParameters",
...
;
    ...
    static_cast<py::class_<IntTools_PntOn2Faces ,std::unique_ptr<IntTools_PntOn2Faces>  >>(m.attr("IntTools_PntOn2Faces"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IntTools_EdgeEdge ,std::unique_ptr<IntTools_EdgeEdge>  >>(m.attr("IntTools_EdgeEdge"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IntTools_PntOnFace ,std::unique_ptr<IntTools_PntOnFace>  >>(m.attr("IntTools_PntOnFace"))
        .def(py::init<  >()  )
        .def("Init",
        ...
        .def("Pnt",
             ...
             R"#(Selector)#" )
        .def("Parameters",
             (void (IntTools_PntOnFace::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IntTools_PntOnFace::*)( Standard_Real & ,  Standard_Real &  ) const>(&IntTools_PntOnFace::Parameters),
             R"#(Selector)#"  , py::arg("U"),  py::arg("V"))
;


    static_cast<py::class_<IntTools_FClass2d ,std::unique_ptr<IntTools_FClass2d>  >>(m.attr("IntTools_FClass2d"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IntTools_CArray1OfInteger ,std::unique_ptr<IntTools_CArray1OfInteger>  >>(m.attr("IntTools_CArray1OfInteger"))
        .def(py::init< const Standard_Integer >()  , py::arg("Length")=static_cast<const Standard_Integer>(0) )
...
;
    ...
    register_default_constructor<IntTools_WLineTool ,std::unique_ptr<IntTools_WLineTool>>(m,"IntTools_WLineTool");

    static_cast<py::class_<IntTools_WLineTool ,std::unique_ptr<IntTools_WLineTool>  >>(m.attr("IntTools_WLineTool"))
...
;
    ...
    static_cast<py::class_<IntTools_SurfaceRangeLocalizeData ,std::unique_ptr<IntTools_SurfaceRangeLocalizeData>  >>(m.attr("IntTools_SurfaceRangeLocalizeData"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<IntTools_Range ,std::unique_ptr<IntTools_Range>  >>(m.attr("IntTools_Range"))
        .def(py::init<  >()  )
        ...
        .def("Last",
             ...
             R"#(Selector)#" )
        .def("Range",
             (void (IntTools_Range::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IntTools_Range::*)( Standard_Real & ,  Standard_Real &  ) const>(&IntTools_Range::Range),
             R"#(Selector)#"  , py::arg("aFirst"),  py::arg("aLast"))
;

    register_default_constructor<IntTools_CurveRangeSampleMapHasher ,std::unique_ptr<IntTools_CurveRangeSampleMapHasher>>(m,"IntTools_CurveRangeSampleMapHasher");

    static_cast<py::class_<IntTools_CurveRangeSampleMapHasher ,std::unique_ptr<IntTools_CurveRangeSampleMapHasher>  >>(m.attr("IntTools_CurveRangeSampleMapHasher"))
...
;
    ...
    register_default_constructor<IntTools_Tools ,std::unique_ptr<IntTools_Tools>>(m,"IntTools_Tools");

    static_cast<py::class_<IntTools_Tools ,std::unique_ptr<IntTools_Tools>  >>(m.attr("IntTools_Tools"))
        ...
        .def_static("VertexParameters_s",
                    (void (*)( const IntTools_CommonPrt & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const IntTools_CommonPrt & ,  Standard_Real & ,  Standard_Real &  ) >(&IntTools_Tools::VertexParameters),
                    R"#(None)#"  , py::arg("theCP"),  py::arg("theT1"),  py::arg("theT2"))
        .def_static("VertexParameter_s",
                    (void (*)( const IntTools_CommonPrt & ,  Standard_Real &  ) ) static_cast<void (*)( const IntTools_CommonPrt & ,  Standard_Real &  ) >(&IntTools_Tools::VertexParameter),
                    R"#(None)#"  , py::arg("theCP"),  py::arg("theT"))
...
;
    ...
    static_cast<py::class_<IntTools_BeanFaceIntersector ,std::unique_ptr<IntTools_BeanFaceIntersector>  >>(m.attr("IntTools_BeanFaceIntersector"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<IntTools_SurfaceRangeSampleMapHasher ,std::unique_ptr<IntTools_SurfaceRangeSampleMapHasher>>(m,"IntTools_SurfaceRangeSampleMapHasher");

    static_cast<py::class_<IntTools_SurfaceRangeSampleMapHasher ,std::unique_ptr<IntTools_SurfaceRangeSampleMapHasher>  >>(m.attr("IntTools_SurfaceRangeSampleMapHasher"))
        .def_static("HashCode_s",
...
;
    ...
    static_cast<py::class_<IntTools_CommonPrt ,std::unique_ptr<IntTools_CommonPrt>  >>(m.attr("IntTools_CommonPrt"))
        .def(py::init<  >()  )
        ...
        .def("Range1",
             (void (IntTools_CommonPrt::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (IntTools_CommonPrt::*)( Standard_Real & ,  Standard_Real &  ) const>(&IntTools_CommonPrt::Range1),
             R"#(Returns the range of first edge.)#"  , py::arg("tf"),  py::arg("tl"))
        .def("Ranges2",
...
;
    ...
    static_cast<py::class_<IntTools_CurveRangeSample ,std::unique_ptr<IntTools_CurveRangeSample>  , IntTools_BaseRangeSample >>(m.attr("IntTools_CurveRangeSample"))
        .def(py::init<  >()  )
