...
// classes
    ...
    static_cast<py::class_<Geom2dConvert_CompCurveToBSplineCurve ,std::unique_ptr<Geom2dConvert_CompCurveToBSplineCurve>  >>(m.attr("Geom2dConvert_CompCurveToBSplineCurve"))
...
;
    ...
    register_default_constructor<Geom2dConvert ,std::unique_ptr<Geom2dConvert>>(m,"Geom2dConvert");

    static_cast<py::class_<Geom2dConvert ,std::unique_ptr<Geom2dConvert>  >>(m.attr("Geom2dConvert"))
...
;
    ...
    static_cast<py::class_<Geom2dConvert_BSplineCurveToBezierCurve ,std::unique_ptr<Geom2dConvert_BSplineCurveToBezierCurve>  >>(m.attr("Geom2dConvert_BSplineCurveToBezierCurve"))
...
;
    ...
    static_cast<py::class_<Geom2dConvert_BSplineCurveKnotSplitting ,std::unique_ptr<Geom2dConvert_BSplineCurveKnotSplitting>  >>(m.attr("Geom2dConvert_BSplineCurveKnotSplitting"))
...
;
    ...
    static_cast<py::class_<Geom2dConvert_ApproxCurve ,std::unique_ptr<Geom2dConvert_ApproxCurve>  >>(m.attr("Geom2dConvert_ApproxCurve"))
