...
// classes forward declarations only
    py::class_<Prs3d_Root ,std::unique_ptr<Prs3d_Root>  >(m,"Prs3d_Root",R"#(A root class for the standard presentation algorithms of the StdPrs package.)#");
    py::class_<Prs3d_ToolQuadric ,std::unique_ptr<Prs3d_ToolQuadric> ,Py_Prs3d_ToolQuadric >(m,"Prs3d_ToolQuadric",R"#(Base class to build 3D surfaces presentation of quadric surfaces.)#");
    py::class_<Prs3d_Arrow ,std::unique_ptr<Prs3d_Arrow>  , Prs3d_Root >(m,"Prs3d_Arrow",R"#(Provides class methods to draw an arrow at a given location, along a given direction and using a given angle.)#");
    py::class_<Prs3d_ToolDisk ,std::unique_ptr<Prs3d_ToolDisk>  , Prs3d_ToolQuadric >(m,"Prs3d_ToolDisk",R"#(Standard presentation algorithm that outputs graphical primitives for disk surface.)#");
    py::class_<Prs3d_ShapeTool ,std::unique_ptr<Prs3d_ShapeTool>  >(m,"Prs3d_ShapeTool",R"#(describes the behaviour requested for a wireframe shape presentation.)#");
    py::class_<Prs3d_ToolCylinder ,std::unique_ptr<Prs3d_ToolCylinder>  , Prs3d_ToolQuadric >(m,"Prs3d_ToolCylinder",R"#(Standard presentation algorithm that outputs graphical primitives for cylindrical surface.)#");
    py::class_<Prs3d_DimensionUnits ,std::unique_ptr<Prs3d_DimensionUnits>  >(m,"Prs3d_DimensionUnits",R"#(This class provides units for two dimension groups: - lengthes (length, radius, diameter) - angles)#");
    py::class_<Prs3d_BasicAspect ,opencascade::handle<Prs3d_BasicAspect>  , Standard_Transient >(m,"Prs3d_BasicAspect",R"#(All basic Prs3d_xxxAspect must inherits from this class The aspect classes qualifies how to represent a given kind of object.All basic Prs3d_xxxAspect must inherits from this class The aspect classes qualifies how to represent a given kind of object.)#");
    py::class_<Prs3d ,std::unique_ptr<Prs3d>  >(m,"Prs3d",R"#(The Prs3d package provides the following services - a presentation object (the context for all modifications to the display, its presentation will be displayed in every view of an active viewer) - an attribute manager governing how objects such as color, width, and type of line are displayed; these are generic objects, whereas those in StdPrs are specific geometries and topologies. - generic algorithms providing default settings for objects such as points, curves, surfaces and shapes - a root object which provides the abstract framework for the DsgPrs definitions at work in display of dimensions, relations and trihedra.)#");
    ...
    py::class_<Prs3d_Presentation ,opencascade::handle<Prs3d_Presentation>  , Graphic3d_Structure >(m,"Prs3d_Presentation",R"#(Defines a presentation object which can be displayed, highlighted or erased. The presentation object stores the results of the presentation algorithms as defined in the StdPrs classes and the Prs3d classes inheriting Prs3d_Root. This presentation object is used to give display attributes defined at this level to ApplicationInteractiveServices classes at the level above. A presentation object is attached to a given Viewer.Defines a presentation object which can be displayed, highlighted or erased. The presentation object stores the results of the presentation algorithms as defined in the StdPrs classes and the Prs3d classes inheriting Prs3d_Root. This presentation object is used to give display attributes defined at this level to ApplicationInteractiveServices classes at the level above. A presentation object is attached to a given Viewer.Defines a presentation object which can be displayed, highlighted or erased. The presentation object stores the results of the presentation algorithms as defined in the StdPrs classes and the Prs3d classes inheriting Prs3d_Root. This presentation object is used to give display attributes defined at this level to ApplicationInteractiveServices classes at the level above. A presentation object is attached to a given Viewer.)#");
    ...
    py::class_<Prs3d_ToolSphere ,std::unique_ptr<Prs3d_ToolSphere>  , Prs3d_ToolQuadric >(m,"Prs3d_ToolSphere",R"#(Standard presentation algorithm that outputs graphical primitives for spherical surface.)#");
    py::class_<Prs3d_PresentationShadow ,opencascade::handle<Prs3d_PresentationShadow>  , Prs3d_Presentation >(m,"Prs3d_PresentationShadow",R"#(Defines a "shadow" of existing presentation object with custom aspects.Defines a "shadow" of existing presentation object with custom aspects.)#");
    ...
    py::class_<Prs3d_Text ,std::unique_ptr<Prs3d_Text>  , Prs3d_Root >(m,"Prs3d_Text",R"#(A framework to define the display of texts.)#");
