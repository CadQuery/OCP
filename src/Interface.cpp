...
// classes
    ...
    static_cast<py::class_<Interface_EntityIterator ,std::unique_ptr<Interface_EntityIterator>  >>(m.attr("Interface_EntityIterator"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Interface_CheckTool ,std::unique_ptr<Interface_CheckTool>  >>(m.attr("Interface_CheckTool"))
...
;
    ...
    static_cast<py::class_<Interface_ShareTool ,std::unique_ptr<Interface_ShareTool>  >>(m.attr("Interface_ShareTool"))
...
;
    ...
    static_cast<py::class_<Interface_LineBuffer ,std::unique_ptr<Interface_LineBuffer>  >>(m.attr("Interface_LineBuffer"))
...
;
    ...
    static_cast<py::class_<Interface_HArray1OfHAsciiString ,std::unique_ptr<Interface_HArray1OfHAsciiString>  >>(m.attr("Interface_HArray1OfHAsciiString"))
...
;
    ...
    static_cast<py::class_<Interface_STAT ,std::unique_ptr<Interface_STAT>  >>(m.attr("Interface_STAT"))
        ...
        .def("Internals",
             (void (Interface_STAT::*)( opencascade::handle<TCollection_HAsciiString> & ,  Standard_Real & ,  opencascade::handle<TColStd_HSequenceOfAsciiString> & ,  opencascade::handle<TColStd_HSequenceOfReal> & ,  opencascade::handle<TColStd_HSequenceOfInteger> & ,  opencascade::handle<TColStd_HSequenceOfInteger> & ,  opencascade::handle<TColStd_HSequenceOfReal> &  ) const) static_cast<void (Interface_STAT::*)( opencascade::handle<TCollection_HAsciiString> & ,  Standard_Real & ,  opencascade::handle<TColStd_HSequenceOfAsciiString> & ,  opencascade::handle<TColStd_HSequenceOfReal> & ,  opencascade::handle<TColStd_HSequenceOfInteger> & ,  opencascade::handle<TColStd_HSequenceOfInteger> & ,  opencascade::handle<TColStd_HSequenceOfReal> &  ) const>(&Interface_STAT::Internals),
             R"#(Returns fields in once, without copying them, used for copy when starting)#"  , py::arg("tit"),  py::arg("total"),  py::arg("phn"),  py::arg("phw"),  py::arg("phdeb"),  py::arg("phfin"),  py::arg("stw"))
        .def("AddPhase",
...
;
    ...
    static_cast<py::class_<Interface_FileReaderTool ,std::unique_ptr<Interface_FileReaderTool> ,Py_Interface_FileReaderTool >>(m.attr("Interface_FileReaderTool"))
        .def("SetData",
...
;
    ...
    static_cast<py::class_<Interface_BitMap ,std::unique_ptr<Interface_BitMap>  >>(m.attr("Interface_BitMap"))
        .def(py::init<  >()  )
        ...
        .def("Internals",
             (void (Interface_BitMap::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  opencascade::handle<TColStd_HArray1OfInteger> & ,  opencascade::handle<TColStd_HSequenceOfAsciiString> &  ) const) static_cast<void (Interface_BitMap::*)( Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  opencascade::handle<TColStd_HArray1OfInteger> & ,  opencascade::handle<TColStd_HSequenceOfAsciiString> &  ) const>(&Interface_BitMap::Internals),
             R"#(Returns internal values, used for copying Flags values start at false)#"  , py::arg("nbitems"),  py::arg("nbwords"),  py::arg("nbflags"),  py::arg("flags"),  py::arg("names"))
        .def("Reservate",
...
;
    ...
    static_cast<py::class_<Interface_CopyTool ,std::unique_ptr<Interface_CopyTool>  >>(m.attr("Interface_CopyTool"))
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> &,const Interface_GeneralLib & >()  , py::arg("amodel"),  py::arg("lib") )
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> &,const opencascade::handle<Interface_Protocol> & >()  , py::arg("amodel"),  py::arg("protocol") )
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> & >()  , py::arg("amodel") )
        .def("Model",
...
;
    ...
    static_cast<py::class_<Interface_ShareFlags ,std::unique_ptr<Interface_ShareFlags>  >>(m.attr("Interface_ShareFlags"))
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> &,const Interface_GeneralLib & >()  , py::arg("amodel"),  py::arg("lib") )
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> &,const opencascade::handle<Interface_GTool> & >()  , py::arg("amodel"),  py::arg("gtool") )
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> &,const opencascade::handle<Interface_Protocol> & >()  , py::arg("amodel"),  py::arg("protocol") )
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> & >()  , py::arg("amodel") )
...
;
    ...
    static_cast<py::class_<Interface_HSequenceOfCheck ,std::unique_ptr<Interface_HSequenceOfCheck>  >>(m.attr("Interface_HSequenceOfCheck"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Interface_FileParameter ,std::unique_ptr<Interface_FileParameter>  >>(m.attr("Interface_FileParameter"))
        .def(py::init<  >()  )
        .def("Init",
...
;
    ...
    static_cast<py::class_<Interface_GeneralLib ,std::unique_ptr<Interface_GeneralLib>  >>(m.attr("Interface_GeneralLib"))
...
;
    ...
    static_cast<py::class_<Interface_MSG ,std::unique_ptr<Interface_MSG>  >>(m.attr("Interface_MSG"))
...
;
    ...
    register_default_constructor<Interface_MapAsciiStringHasher ,std::unique_ptr<Interface_MapAsciiStringHasher>>(m,"Interface_MapAsciiStringHasher");

    static_cast<py::class_<Interface_MapAsciiStringHasher ,std::unique_ptr<Interface_MapAsciiStringHasher>  >>(m.attr("Interface_MapAsciiStringHasher"))
...
;
    ...
    static_cast<py::class_<Interface_ReaderLib ,std::unique_ptr<Interface_ReaderLib>  >>(m.attr("Interface_ReaderLib"))
        .def(py::init< const opencascade::handle<Interface_Protocol> & >()  , py::arg("aprotocol") )
        .def(py::init<  >()  )
        .def("AddProtocol",
...
;
    ...
    static_cast<py::class_<Interface_Graph ,std::unique_ptr<Interface_Graph>  >>(m.attr("Interface_Graph"))
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> &,const Interface_GeneralLib &,const Standard_Boolean >()  , py::arg("amodel"),  py::arg("lib"),  py::arg("theModeStats")=static_cast<const Standard_Boolean>(Standard_True) )
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> &,const opencascade::handle<Interface_Protocol> &,const Standard_Boolean >()  , py::arg("amodel"),  py::arg("protocol"),  py::arg("theModeStats")=static_cast<const Standard_Boolean>(Standard_True) )
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> &,const opencascade::handle<Interface_GTool> &,const Standard_Boolean >()  , py::arg("amodel"),  py::arg("gtool"),  py::arg("theModeStats")=static_cast<const Standard_Boolean>(Standard_True) )
        .def(py::init< const opencascade::handle<Interface_InterfaceModel> &,const Standard_Boolean >()  , py::arg("amodel"),  py::arg("theModeStats")=static_cast<const Standard_Boolean>(Standard_True) )
...
;
    ...
    static_cast<py::class_<Interface_Category ,std::unique_ptr<Interface_Category>  >>(m.attr("Interface_Category"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Interface_CheckIterator ,std::unique_ptr<Interface_CheckIterator>  >>(m.attr("Interface_CheckIterator"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Interface_IntList ,std::unique_ptr<Interface_IntList>  >>(m.attr("Interface_IntList"))
        .def(py::init<  >()  )
        ...
        .def("Internals",
             (void (Interface_IntList::*)( Standard_Integer & ,  opencascade::handle<TColStd_HArray1OfInteger> & ,  opencascade::handle<TColStd_HArray1OfInteger> &  ) const) static_cast<void (Interface_IntList::*)( Standard_Integer & ,  opencascade::handle<TColStd_HArray1OfInteger> & ,  opencascade::handle<TColStd_HArray1OfInteger> &  ) const>(&Interface_IntList::Internals),
             R"#(Returns internal values, used for copying)#"  , py::arg("nbrefs"),  py::arg("ents"),  py::arg("refs"))
        .def("NbEntities",
...
;
    ...
    static_cast<py::class_<Interface_EntityList ,std::unique_ptr<Interface_EntityList>  >>(m.attr("Interface_EntityList"))
        .def(py::init<  >()  )
        .def("Clear",
...
;
    ...
    static_cast<py::class_<Interface_GraphContent ,std::unique_ptr<Interface_GraphContent>  , Interface_EntityIterator >>(m.attr("Interface_GraphContent"))
        .def(py::init<  >()  )
        .def(py::init< const Interface_Graph & >()  , py::arg("agraph") )
...
;
    ...
    static_cast<py::class_<Interface_FloatWriter ,std::unique_ptr<Interface_FloatWriter>  >>(m.attr("Interface_FloatWriter"))
        ...
        .def("Options",
             (void (Interface_FloatWriter::*)( Standard_Boolean & ,  Standard_Boolean & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Interface_FloatWriter::*)( Standard_Boolean & ,  Standard_Boolean & ,  Standard_Real & ,  Standard_Real &  ) const>(&Interface_FloatWriter::Options),
             R"#(Returns active options : <zerosup> is the option ZeroSuppress, <range> is True if a range is set, False else R1,R2 give the range (if it is set))#"  , py::arg("zerosup"),  py::arg("range"),  py::arg("R1"),  py::arg("R2"))
        .def("MainFormat",
