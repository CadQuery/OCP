...
;
    ...
    static_cast<py::class_<STEPControl_Reader ,std::unique_ptr<STEPControl_Reader>  , XSControl_Reader >>(m.attr("STEPControl_Reader"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<STEPControl_Writer ,std::unique_ptr<STEPControl_Writer>  >>(m.attr("STEPControl_Writer"))
        .def(py::init<  >()  )
        .def(py::init< const opencascade::handle<XSControl_WorkSession> &,const Standard_Boolean >()  , py::arg("WS"),  py::arg("scratch")=static_cast<const Standard_Boolean>(Standard_True) )
        .def("SetTolerance",
