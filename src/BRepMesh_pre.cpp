...
// classes forward declarations only
    py::class_<BRepMesh_BaseMeshAlgo ,opencascade::handle<BRepMesh_BaseMeshAlgo> ,Py_BRepMesh_BaseMeshAlgo >(m,"BRepMesh_BaseMeshAlgo",R"#(Class provides base fuctionality for algorithms building face triangulation. Performs initialization of BRepMesh_DataStructureOfDelaun and nodes map structures.)#");
    ...
    py::class_<BRepMesh_DefaultRangeSplitter , shared_ptr<BRepMesh_DefaultRangeSplitter>  >(m,"BRepMesh_DefaultRangeSplitter",R"#(Default tool to define range of discrete face model and obtain grid points distributed within this range.)#");
    ...
    py::class_<BRepMesh_Delaun , shared_ptr<BRepMesh_Delaun>  >(m,"BRepMesh_Delaun",R"#(Compute the Delaunay's triangulation with the algorithm of Watson.)#");
    ...
    py::class_<BRepMesh_ConeRangeSplitter , shared_ptr<BRepMesh_ConeRangeSplitter>  , BRepMesh_DefaultRangeSplitter >(m,"BRepMesh_ConeRangeSplitter",R"#(Auxiliary class extending default range splitter in order to generate internal nodes for conical surface.)#");
    py::class_<BRepMesh_ConstrainedBaseMeshAlgo ,opencascade::handle<BRepMesh_ConstrainedBaseMeshAlgo> ,Py_BRepMesh_ConstrainedBaseMeshAlgo , BRepMesh_BaseMeshAlgo >(m,"BRepMesh_ConstrainedBaseMeshAlgo",R"#(Class provides base fuctionality to build face triangulation using Dealunay approach. Performs generation of mesh using raw data from model.)#");
    py::class_<BRepMesh_CylinderRangeSplitter , shared_ptr<BRepMesh_CylinderRangeSplitter>  , BRepMesh_DefaultRangeSplitter >(m,"BRepMesh_CylinderRangeSplitter",R"#(Auxiliary class extending default range splitter in order to generate internal nodes for cylindrical surface.)#");
    ...
    py::class_<BRepMesh_SphereRangeSplitter , shared_ptr<BRepMesh_SphereRangeSplitter>  , BRepMesh_DefaultRangeSplitter >(m,"BRepMesh_SphereRangeSplitter",R"#(Auxiliary class extending default range splitter in order to generate internal nodes for spherical surface.)#");
    py::class_<BRepMesh_UVParamRangeSplitter , shared_ptr<BRepMesh_UVParamRangeSplitter>  , BRepMesh_DefaultRangeSplitter >(m,"BRepMesh_UVParamRangeSplitter",R"#(Intended to generate internal mesh nodes using UV parameters of boundary discrete points.)#");
    py::class_<BRepMesh_CustomBaseMeshAlgo ,opencascade::handle<BRepMesh_CustomBaseMeshAlgo> ,Py_BRepMesh_CustomBaseMeshAlgo , BRepMesh_ConstrainedBaseMeshAlgo >(m,"BRepMesh_CustomBaseMeshAlgo",R"#(Class provides base fuctionality to build face triangulation using custom triangulation algorithm. Performs generation of mesh using raw data from model.)#");
    py::class_<BRepMesh_DelaunayBaseMeshAlgo ,opencascade::handle<BRepMesh_DelaunayBaseMeshAlgo>  , BRepMesh_ConstrainedBaseMeshAlgo >(m,"BRepMesh_DelaunayBaseMeshAlgo",R"#(Class provides base fuctionality to build face triangulation using Dealunay approach. Performs generation of mesh using raw data from model.)#");
    py::class_<BRepMesh_NURBSRangeSplitter , shared_ptr<BRepMesh_NURBSRangeSplitter>  , BRepMesh_UVParamRangeSplitter >(m,"BRepMesh_NURBSRangeSplitter",R"#(Auxiliary class extending UV range splitter in order to generate internal nodes for NURBS surface.)#");
    py::class_<BRepMesh_TorusRangeSplitter , shared_ptr<BRepMesh_TorusRangeSplitter>  , BRepMesh_UVParamRangeSplitter >(m,"BRepMesh_TorusRangeSplitter",R"#(Auxiliary class extending UV range splitter in order to generate internal nodes for NURBS surface.)#");
    py::class_<BRepMesh_BoundaryParamsRangeSplitter , shared_ptr<BRepMesh_BoundaryParamsRangeSplitter>  , BRepMesh_NURBSRangeSplitter >(m,"BRepMesh_BoundaryParamsRangeSplitter",R"#(Auxiliary class extending UV range splitter in order to generate internal nodes for NURBS surface.)#");
