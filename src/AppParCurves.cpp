...
// classes
    ...
    static_cast<py::class_<AppParCurves_MultiCurve ,std::unique_ptr<AppParCurves_MultiCurve>  >>(m.attr("AppParCurves_MultiCurve"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<AppParCurves_MultiBSpCurve ,std::unique_ptr<AppParCurves_MultiBSpCurve>  , AppParCurves_MultiCurve >>(m.attr("AppParCurves_MultiBSpCurve"))
        .def(py::init<  >()  )
        .def(py::init< const Standard_Integer >()  , py::arg("NbPol") )
...
;
    ...
    static_cast<py::class_<AppParCurves_MultiPoint ,std::unique_ptr<AppParCurves_MultiPoint>  >>(m.attr("AppParCurves_MultiPoint"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<AppParCurves_HArray1OfConstraintCouple ,std::unique_ptr<AppParCurves_HArray1OfConstraintCouple>  >>(m.attr("AppParCurves_HArray1OfConstraintCouple"))
...
;
    ...
    static_cast<py::class_<AppParCurves_HArray1OfMultiCurve ,std::unique_ptr<AppParCurves_HArray1OfMultiCurve>  >>(m.attr("AppParCurves_HArray1OfMultiCurve"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    register_default_constructor<AppParCurves ,std::unique_ptr<AppParCurves>>(m,"AppParCurves");

    static_cast<py::class_<AppParCurves ,std::unique_ptr<AppParCurves>  >>(m.attr("AppParCurves"))
...
;
    ...
    static_cast<py::class_<AppParCurves_HArray1OfMultiPoint ,std::unique_ptr<AppParCurves_HArray1OfMultiPoint>  >>(m.attr("AppParCurves_HArray1OfMultiPoint"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<AppParCurves_HArray1OfMultiBSpCurve ,std::unique_ptr<AppParCurves_HArray1OfMultiBSpCurve>  >>(m.attr("AppParCurves_HArray1OfMultiBSpCurve"))
        .def(py::init< const Standard_Integer,const Standard_Integer >()  , py::arg("theLower"),  py::arg("theUpper") )
...
;
    ...
    static_cast<py::class_<AppParCurves_ConstraintCouple ,std::unique_ptr<AppParCurves_ConstraintCouple>  >>(m.attr("AppParCurves_ConstraintCouple"))
        .def(py::init<  >()  )
