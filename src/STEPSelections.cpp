...
;
    ...
    static_cast<py::class_<STEPSelections_HSequenceOfAssemblyLink ,std::unique_ptr<STEPSelections_HSequenceOfAssemblyLink>  >>(m.attr("STEPSelections_HSequenceOfAssemblyLink"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<STEPSelections_Counter ,std::unique_ptr<STEPSelections_Counter>  >>(m.attr("STEPSelections_Counter"))
        .def(py::init<  >()  )
        .def("Count",
...
;
    ...
    static_cast<py::class_<STEPSelections_AssemblyExplorer ,std::unique_ptr<STEPSelections_AssemblyExplorer>  >>(m.attr("STEPSelections_AssemblyExplorer"))
