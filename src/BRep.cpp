...
// classes
    ...
    register_default_constructor<BRep_Tool ,std::unique_ptr<BRep_Tool>>(m,"BRep_Tool");

    static_cast<py::class_<BRep_Tool ,std::unique_ptr<BRep_Tool>  >>(m.attr("BRep_Tool"))
        ...
        .def_static("CurveOnSurface_s",
                    (void (*)( const TopoDS_Edge & ,  opencascade::handle<Geom2d_Curve> & ,  opencascade::handle<Geom_Surface> & ,  TopLoc_Location & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const TopoDS_Edge & ,  opencascade::handle<Geom2d_Curve> & ,  opencascade::handle<Geom_Surface> & ,  TopLoc_Location & ,  Standard_Real & ,  Standard_Real &  ) >(&BRep_Tool::CurveOnSurface),
                    R"#(Returns in <C>, <S>, <L> a 2d curve, a surface and a location for the edge <E>. <C> and <S> are null if the edge has no curve on surface. Returns in <First> and <Last> the parameter range.)#"  , py::arg("E"),  py::arg("C"),  py::arg("S"),  py::arg("L"),  py::arg("First"),  py::arg("Last"))
        .def_static("CurveOnSurface_s",
                    (void (*)( const TopoDS_Edge & ,  opencascade::handle<Geom2d_Curve> & ,  opencascade::handle<Geom_Surface> & ,  TopLoc_Location & ,  Standard_Real & ,  Standard_Real & ,  const Standard_Integer  ) ) static_cast<void (*)( const TopoDS_Edge & ,  opencascade::handle<Geom2d_Curve> & ,  opencascade::handle<Geom_Surface> & ,  TopLoc_Location & ,  Standard_Real & ,  Standard_Real & ,  const Standard_Integer  ) >(&BRep_Tool::CurveOnSurface),
                    R"#(Returns in <C>, <S>, <L> the 2d curve, the surface and the location for the edge <E> of rank <Index>. <C> and <S> are null if the index is out of range. Returns in <First> and <Last> the parameter range.)#"  , py::arg("E"),  py::arg("C"),  py::arg("S"),  py::arg("L"),  py::arg("First"),  py::arg("Last"),  py::arg("Index"))
        ...
        .def_static("Range_s",
                    (void (*)( const TopoDS_Edge & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const TopoDS_Edge & ,  Standard_Real & ,  Standard_Real &  ) >(&BRep_Tool::Range),
                    R"#(Gets the range of the 3d curve.)#"  , py::arg("E"),  py::arg("First"),  py::arg("Last"))
        .def_static("Range_s",
                    (void (*)( const TopoDS_Edge & ,  const opencascade::handle<Geom_Surface> & ,  const TopLoc_Location & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const TopoDS_Edge & ,  const opencascade::handle<Geom_Surface> & ,  const TopLoc_Location & ,  Standard_Real & ,  Standard_Real &  ) >(&BRep_Tool::Range),
                    R"#(Gets the range of the edge on the pcurve on the surface.)#"  , py::arg("E"),  py::arg("S"),  py::arg("L"),  py::arg("First"),  py::arg("Last"))
        .def_static("Range_s",
                    (void (*)( const TopoDS_Edge & ,  const TopoDS_Face & ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (*)( const TopoDS_Edge & ,  const TopoDS_Face & ,  Standard_Real & ,  Standard_Real &  ) >(&BRep_Tool::Range),
                    R"#(Gets the range of the edge on the pcurve on the face.)#"  , py::arg("E"),  py::arg("F"),  py::arg("First"),  py::arg("Last"))
...
;
    ...
    register_default_constructor<BRep_PointRepresentation ,opencascade::handle<BRep_PointRepresentation>>(m,"BRep_PointRepresentation");
...
;
    ...
    register_default_constructor<BRep_PointsOnSurface ,opencascade::handle<BRep_PointsOnSurface>>(m,"BRep_PointsOnSurface");
...
;
    ...
    register_default_constructor<BRep_Builder ,std::unique_ptr<BRep_Builder>>(m,"BRep_Builder");

    static_cast<py::class_<BRep_Builder ,std::unique_ptr<BRep_Builder>  , TopoDS_Builder >>(m.attr("BRep_Builder"))
        .def("MakeFace",
...
;
    ...
    static_cast<py::class_<BRep_GCurve ,opencascade::handle<BRep_GCurve> ,Py_BRep_GCurve , BRep_CurveRepresentation >>(m.attr("BRep_GCurve"))
        ...
        .def("Range",
             (void (BRep_GCurve::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (BRep_GCurve::*)( Standard_Real & ,  Standard_Real &  ) const>(&BRep_GCurve::Range),
             R"#(None)#"  , py::arg("First"),  py::arg("Last"))
        .def("First",
