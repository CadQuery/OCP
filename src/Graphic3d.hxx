...
void preregister_template_Graphic3d_UniformValueTypeID(py::object &m, const char *name){
    py::class_<Graphic3d_UniformValueTypeID<T> ,std::unique_ptr<Graphic3d_UniformValueTypeID<T>> >(m,name,R"#(Generates unique type identifier for variable value.)#");
}

template <typename T>
void register_template_Graphic3d_UniformValueTypeID(py::object &m, const char *name){
    static_cast<py::class_<Graphic3d_UniformValueTypeID<T> ,std::unique_ptr<Graphic3d_UniformValueTypeID<T>> >>(m.attr(name))
    ;
};

template <typename T>
void preregister_template_Graphic3d_UniformValue(py::object &m, const char *name){
    py::class_<Graphic3d_UniformValue<T> ,std::unique_ptr<Graphic3d_UniformValue<T>> >(m,name,R"#(Describes specific value of custom uniform variable.)#");
}

template <typename T>
void register_template_Graphic3d_UniformValue(py::object &m, const char *name){
    static_cast<py::class_<Graphic3d_UniformValue<T> ,std::unique_ptr<Graphic3d_UniformValue<T>> >>(m.attr(name))
