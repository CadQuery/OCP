...
// classes forward declarations only
    py::class_<CDF_DirectoryIterator ,std::unique_ptr<CDF_DirectoryIterator>  >(m,"CDF_DirectoryIterator",R"#(None)#");
    py::class_<CDF ,std::unique_ptr<CDF>  >(m,"CDF",R"#(None)#");
    ...
    py::class_<CDF_Store ,std::unique_ptr<CDF_Store>  >(m,"CDF_Store",R"#(None)#");
