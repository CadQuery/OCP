...
// classes forward declarations only
    py::class_<FEmTool_Assembly ,std::unique_ptr<FEmTool_Assembly>  >(m,"FEmTool_Assembly",R"#(Assemble and solve system from (one dimensional) Finite Elements)#");
    py::class_<FEmTool_HAssemblyTable ,std::unique_ptr<FEmTool_HAssemblyTable>  >(m,"FEmTool_HAssemblyTable",R"#()#");
