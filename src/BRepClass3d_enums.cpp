...
// classes forward declarations only
    ...
    py::class_<BRepClass3d_BndBoxTreeSelectorLine , shared_ptr<BRepClass3d_BndBoxTreeSelectorLine>  >(m,"BRepClass3d_BndBoxTreeSelectorLine",R"#(None)#");
    py::class_<BRepClass3d_BndBoxTreeSelectorPoint , shared_ptr<BRepClass3d_BndBoxTreeSelectorPoint>  >(m,"BRepClass3d_BndBoxTreeSelectorPoint",R"#(None)#");
