...
// classes
    ...
    static_cast<py::class_<XmlObjMgt_Array1 ,std::unique_ptr<XmlObjMgt_Array1>  >>(m.attr("XmlObjMgt_Array1"))
...
;
    ...
    register_default_constructor<XmlObjMgt_GP ,std::unique_ptr<XmlObjMgt_GP>>(m,"XmlObjMgt_GP");

    static_cast<py::class_<XmlObjMgt_GP ,std::unique_ptr<XmlObjMgt_GP>  >>(m.attr("XmlObjMgt_GP"))
...
;
    ...
    static_cast<py::class_<XmlObjMgt_Persistent ,std::unique_ptr<XmlObjMgt_Persistent>  >>(m.attr("XmlObjMgt_Persistent"))
        .def(py::init<  >()  )
...
;
    ...
    register_default_constructor<XmlObjMgt ,std::unique_ptr<XmlObjMgt>>(m,"XmlObjMgt");

    static_cast<py::class_<XmlObjMgt ,std::unique_ptr<XmlObjMgt>  >>(m.attr("XmlObjMgt"))
