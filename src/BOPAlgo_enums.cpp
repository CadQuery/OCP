...
// classes forward declarations only
    ...
    py::class_<BOPAlgo_BuilderShape , shared_ptr_nodelete<BOPAlgo_BuilderShape> ,Py_BOPAlgo_BuilderShape , BOPAlgo_Algo >(m,"BOPAlgo_BuilderShape",R"#(Root class for algorithms that has shape as result. The class provides the History mechanism, which allows tracking the modification of the input shapes during the operation.)#");
