...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Error",
             []( Approx_FitAndDivide &self , const Standard_Integer Index ){ Standard_Real  tol3d; Standard_Real  tol2d; self.Error(Index,tol3d,tol2d); return std::make_tuple(tol3d,tol2d); },
             R"#(returns the tolerances 2d and 3d of the <Index> MultiCurve.)#"  , py::arg("Index"))
        .def("Parameters",
             []( Approx_FitAndDivide &self , const Standard_Integer Index ){ Standard_Real  firstp; Standard_Real  lastp; self.Parameters(Index,firstp,lastp); return std::make_tuple(firstp,lastp); },
             R"#(None)#"  , py::arg("Index"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Error",
             []( Approx_FitAndDivide2d &self , const Standard_Integer Index ){ Standard_Real  tol3d; Standard_Real  tol2d; self.Error(Index,tol3d,tol2d); return std::make_tuple(tol3d,tol2d); },
             R"#(returns the tolerances 2d and 3d of the <Index> MultiCurve.)#"  , py::arg("Index"))
        .def("Parameters",
             []( Approx_FitAndDivide2d &self , const Standard_Integer Index ){ Standard_Real  firstp; Standard_Real  lastp; self.Parameters(Index,firstp,lastp); return std::make_tuple(firstp,lastp); },
             R"#(None)#"  , py::arg("Index"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("SurfShape",
             []( Approx_SweepApproximation &self   ){ Standard_Integer  UDegree; Standard_Integer  VDegree; Standard_Integer  NbUPoles; Standard_Integer  NbVPoles; Standard_Integer  NbUKnots; Standard_Integer  NbVKnots; self.SurfShape(UDegree,VDegree,NbUPoles,NbVPoles,NbUKnots,NbVKnots); return std::make_tuple(UDegree,VDegree,NbUPoles,NbVPoles,NbUKnots,NbVKnots); },
             R"#(None)#" )
        .def("Curves2dShape",
             []( Approx_SweepApproximation &self   ){ Standard_Integer  Degree; Standard_Integer  NbPoles; Standard_Integer  NbKnots; self.Curves2dShape(Degree,NbPoles,NbKnots); return std::make_tuple(Degree,NbPoles,NbKnots); },
             R"#(None)#" )
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
