...
// classes
    ...
    static_cast<py::class_<HatchGen_IntersectionPoint ,std::unique_ptr<HatchGen_IntersectionPoint, py::nodelete> ,Py_HatchGen_IntersectionPoint >>(m.attr("HatchGen_IntersectionPoint"))
        .def("SetIndex",
...
;
    ...
    static_cast<py::class_<HatchGen_PointOnElement ,std::unique_ptr<HatchGen_PointOnElement>  , HatchGen_IntersectionPoint >>(m.attr("HatchGen_PointOnElement"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<HatchGen_Domain ,std::unique_ptr<HatchGen_Domain>  >>(m.attr("HatchGen_Domain"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<HatchGen_PointOnHatching ,std::unique_ptr<HatchGen_PointOnHatching>  , HatchGen_IntersectionPoint >>(m.attr("HatchGen_PointOnHatching"))
        .def(py::init<  >()  )
