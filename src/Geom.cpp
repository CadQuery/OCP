...
;
    ...
    static_cast<py::class_<Geom_HSequenceOfBSplineSurface ,std::unique_ptr<Geom_HSequenceOfBSplineSurface>  >>(m.attr("Geom_HSequenceOfBSplineSurface"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Geom_Surface ,opencascade::handle<Geom_Surface> ,Py_Geom_Surface , Geom_Geometry >>(m.attr("Geom_Surface"))
        ...
        .def("TransformParameters",
             (void (Geom_Surface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const) static_cast<void (Geom_Surface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const>(&Geom_Surface::TransformParameters),
             R"#(Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>.)#"  , py::arg("U"),  py::arg("V"),  py::arg("T"))
        ...
        .def("Bounds",
             (void (Geom_Surface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_Surface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_Surface::Bounds),
             R"#(Returns the parametric bounds U1, U2, V1 and V2 of this surface. If the surface is infinite, this function can return a value equal to Precision::Infinite: instead of Standard_Real::LastReal.)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("IsUClosed",
...
;
    ...
    static_cast<py::class_<Geom_Point ,opencascade::handle<Geom_Point> ,Py_Geom_Point , Geom_Geometry >>(m.attr("Geom_Point"))
        .def("Coord",
             (void (Geom_Point::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_Point::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_Point::Coord),
             R"#(returns the Coordinates of <me>.)#"  , py::arg("X"),  py::arg("Y"),  py::arg("Z"))
        .def("Pnt",
...
;
    ...
    static_cast<py::class_<Geom_CartesianPoint ,opencascade::handle<Geom_CartesianPoint>  , Geom_Point >>(m.attr("Geom_CartesianPoint"))
        ...
        .def("Coord",
             (void (Geom_CartesianPoint::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_CartesianPoint::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_CartesianPoint::Coord),
             R"#(Returns the coordinates of <me>.)#"  , py::arg("X"),  py::arg("Y"),  py::arg("Z"))
        .def("Pnt",
...
;
    ...
    static_cast<py::class_<Geom_CylindricalSurface ,opencascade::handle<Geom_CylindricalSurface>  , Geom_ElementarySurface >>(m.attr("Geom_CylindricalSurface"))
        ...
        .def("TransformParameters",
             (void (Geom_CylindricalSurface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const) static_cast<void (Geom_CylindricalSurface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const>(&Geom_CylindricalSurface::TransformParameters),
             R"#(Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>. me->Transformed(T)->Value(U',V') is the same point as me->Value(U,V).Transformed(T) Where U',V' are the new values of U,V after calling me->TranformParameters(U,V,T) This methods multiplies V by T.ScaleFactor())#"  , py::arg("U"),  py::arg("V"),  py::arg("T"))
        .def("ParametricTransformation",
        ...
        .def("Bounds",
             (void (Geom_CylindricalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_CylindricalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_CylindricalSurface::Bounds),
             R"#(The CylindricalSurface is infinite in the V direction so V1 = Realfirst, V2 = RealLast from package Standard. U1 = 0 and U2 = 2*PI.)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Coefficients",
             (void (Geom_CylindricalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_CylindricalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_CylindricalSurface::Coefficients),
             R"#(Returns the coefficients of the implicit equation of the quadric in the absolute cartesian coordinate system : These coefficients are normalized. A1.X**2 + A2.Y**2 + A3.Z**2 + 2.(B1.X.Y + B2.X.Z + B3.Y.Z) + 2.(C1.X + C2.Y + C3.Z) + D = 0.0)#"  , py::arg("A1"),  py::arg("A2"),  py::arg("A3"),  py::arg("B1"),  py::arg("B2"),  py::arg("B3"),  py::arg("C1"),  py::arg("C2"),  py::arg("C3"),  py::arg("D"))
        .def("Radius",
...
;
    ...
    static_cast<py::class_<Geom_OffsetSurface ,opencascade::handle<Geom_OffsetSurface>  , Geom_Surface >>(m.attr("Geom_OffsetSurface"))
        ...
        .def("Bounds",
             (void (Geom_OffsetSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_OffsetSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_OffsetSurface::Bounds),
             R"#(Returns the parametric bounds U1, U2, V1 and V2 of this offset surface. If the surface is infinite, this function can return: - Standard_Real::RealFirst(), or - Standard_Real::RealLast().)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Continuity",
        ...
        .def("TransformParameters",
             (void (Geom_OffsetSurface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const) static_cast<void (Geom_OffsetSurface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const>(&Geom_OffsetSurface::TransformParameters),
             R"#(Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>.)#"  , py::arg("U"),  py::arg("V"),  py::arg("T"))
        .def("ParametricTransformation",
...
;
    ...
    static_cast<py::class_<Geom_BezierCurve ,opencascade::handle<Geom_BezierCurve>  , Geom_BoundedCurve >>(m.attr("Geom_BezierCurve"))
        ...
        .def("Resolution",
             (void (Geom_BezierCurve::*)( const Standard_Real ,  Standard_Real &  ) ) static_cast<void (Geom_BezierCurve::*)( const Standard_Real ,  Standard_Real &  ) >(&Geom_BezierCurve::Resolution),
             R"#(Computes for this Bezier curve the parametric tolerance UTolerance for a given 3D tolerance Tolerance3D. If f(t) is the equation of this Bezier curve, UTolerance ensures that: |t1-t0| < UTolerance ===> |f(t1)-f(t0)| < Tolerance3D)#"  , py::arg("Tolerance3D"),  py::arg("UTolerance"))
        .def("Copy",
...
;
    ...
    static_cast<py::class_<Geom_BSplineCurve ,opencascade::handle<Geom_BSplineCurve>  , Geom_BoundedCurve >>(m.attr("Geom_BSplineCurve"))
        ...
        .def("PeriodicNormalization",
             (void (Geom_BSplineCurve::*)( Standard_Real &  ) const) static_cast<void (Geom_BSplineCurve::*)( Standard_Real &  ) const>(&Geom_BSplineCurve::PeriodicNormalization),
             R"#(returns the parameter normalized within the period if the curve is periodic : otherwise does not do anything)#"  , py::arg("U"))
        .def("SetPeriodic",
        ...
        .def("MovePoint",
             (void (Geom_BSplineCurve::*)( const Standard_Real ,  const gp_Pnt & ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (Geom_BSplineCurve::*)( const Standard_Real ,  const gp_Pnt & ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer &  ) >(&Geom_BSplineCurve::MovePoint),
        ...
        .def("MovePointAndTangent",
             (void (Geom_BSplineCurve::*)( const Standard_Real ,  const gp_Pnt & ,  const gp_Vec & ,  const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer &  ) ) static_cast<void (Geom_BSplineCurve::*)( const Standard_Real ,  const gp_Pnt & ,  const gp_Vec & ,  const Standard_Real ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer &  ) >(&Geom_BSplineCurve::MovePointAndTangent),
        ...
        .def("LocateU",
             (void (Geom_BSplineCurve::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const) static_cast<void (Geom_BSplineCurve::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const>(&Geom_BSplineCurve::LocateU),
             R"#(Locates the parametric value U in the sequence of knots. If "WithKnotRepetition" is True we consider the knot's representation with repetition of multiple knot value, otherwise we consider the knot's representation with no repetition of multiple knot values. Knots (I1) <= U <= Knots (I2) . if I1 = I2 U is a knot value (the tolerance criterion ParametricTolerance is used). . if I1 < 1 => U < Knots (1) - Abs(ParametricTolerance) . if I2 > NbKnots => U > Knots (NbKnots) + Abs(ParametricTolerance))#"  , py::arg("U"),  py::arg("ParametricTolerance"),  py::arg("I1"),  py::arg("I2"),  py::arg("WithKnotRepetition")=static_cast<const Standard_Boolean>(Standard_False))
        .def("Multiplicity",
        ...
        .def("Resolution",
             (void (Geom_BSplineCurve::*)( const Standard_Real ,  Standard_Real &  ) ) static_cast<void (Geom_BSplineCurve::*)( const Standard_Real ,  Standard_Real &  ) >(&Geom_BSplineCurve::Resolution),
             R"#(Computes for this BSpline curve the parametric tolerance UTolerance for a given 3D tolerance Tolerance3D. If f(t) is the equation of this BSpline curve, UTolerance ensures that: | t1 - t0| < Utolerance ===> |f(t1) - f(t0)| < Tolerance3D)#"  , py::arg("Tolerance3D"),  py::arg("UTolerance"))
        .def("Copy",
...
;
    ...
    static_cast<py::class_<Geom_Plane ,opencascade::handle<Geom_Plane>  , Geom_ElementarySurface >>(m.attr("Geom_Plane"))
        ...
        .def("TransformParameters",
             (void (Geom_Plane::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const) static_cast<void (Geom_Plane::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const>(&Geom_Plane::TransformParameters),
             R"#(Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>. me->Transformed(T)->Value(U',V') is the same point as me->Value(U,V).Transformed(T) Where U',V' are the new values of U,V after calling me->TranformParameters(U,V,T) This methods multiplies U and V by T.ScaleFactor())#"  , py::arg("U"),  py::arg("V"),  py::arg("T"))
        .def("ParametricTransformation",
        ...
        .def("Bounds",
             (void (Geom_Plane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_Plane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_Plane::Bounds),
             R"#(Returns the parametric bounds U1, U2, V1 and V2 of this plane. Because a plane is an infinite surface, the following is always true: - U1 = V1 = Standard_Real::RealFirst() - U2 = V2 = Standard_Real::RealLast().)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Coefficients",
             (void (Geom_Plane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_Plane::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_Plane::Coefficients),
             R"#(Computes the normalized coefficients of the plane's cartesian equation : Ax + By + Cz + D = 0.0)#"  , py::arg("A"),  py::arg("B"),  py::arg("C"),  py::arg("D"))
        .def("IsUClosed",
...
;
    ...
    static_cast<py::class_<Geom_BezierSurface ,opencascade::handle<Geom_BezierSurface>  , Geom_BoundedSurface >>(m.attr("Geom_BezierSurface"))
        ...
        .def("Bounds",
             (void (Geom_BezierSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_BezierSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_BezierSurface::Bounds),
             R"#(Returns the parametric bounds U1, U2, V1 and V2 of this Bezier surface. In the case of a Bezier surface, this function returns U1 = 0, V1 = 0, U2 = 1, V2 = 1.)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Continuity",
        ...
        .def("Resolution",
             (void (Geom_BezierSurface::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Geom_BezierSurface::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) >(&Geom_BezierSurface::Resolution),
...
;
    ...
    static_cast<py::class_<Geom_Vector ,opencascade::handle<Geom_Vector> ,Py_Geom_Vector , Geom_Geometry >>(m.attr("Geom_Vector"))
        ...
        .def("Coord",
             (void (Geom_Vector::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_Vector::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_Vector::Coord),
             R"#(Returns the coordinates X, Y and Z of this vector.)#"  , py::arg("X"),  py::arg("Y"),  py::arg("Z"))
        .def("Magnitude",
...
;
    ...
    static_cast<py::class_<Geom_SphericalSurface ,opencascade::handle<Geom_SphericalSurface>  , Geom_ElementarySurface >>(m.attr("Geom_SphericalSurface"))
        ...
        .def("Bounds",
             (void (Geom_SphericalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_SphericalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_SphericalSurface::Bounds),
             R"#(Returns the parametric bounds U1, U2, V1 and V2 of this sphere. For a sphere: U1 = 0, U2 = 2*PI, V1 = -PI/2, V2 = PI/2.)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Coefficients",
             (void (Geom_SphericalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_SphericalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_SphericalSurface::Coefficients),
...
;
    ...
    static_cast<py::class_<Geom_ConicalSurface ,opencascade::handle<Geom_ConicalSurface>  , Geom_ElementarySurface >>(m.attr("Geom_ConicalSurface"))
        ...
        .def("TransformParameters",
             (void (Geom_ConicalSurface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const) static_cast<void (Geom_ConicalSurface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const>(&Geom_ConicalSurface::TransformParameters),
             R"#(Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>.)#"  , py::arg("U"),  py::arg("V"),  py::arg("T"))
        .def("ParametricTransformation",
        ...
        .def("Bounds",
             (void (Geom_ConicalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_ConicalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_ConicalSurface::Bounds),
             R"#(The conical surface is infinite in the V direction so V1 = Realfirst from Standard and V2 = RealLast. U1 = 0 and U2 = 2*PI.)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Coefficients",
             (void (Geom_ConicalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_ConicalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_ConicalSurface::Coefficients),
             R"#(Returns the coefficients of the implicit equation of the quadric in the absolute cartesian coordinate system : These coefficients are normalized. A1.X**2 + A2.Y**2 + A3.Z**2 + 2.(B1.X.Y + B2.X.Z + B3.Y.Z) + 2.(C1.X + C2.Y + C3.Z) + D = 0.0)#"  , py::arg("A1"),  py::arg("A2"),  py::arg("A3"),  py::arg("B1"),  py::arg("B2"),  py::arg("B3"),  py::arg("C1"),  py::arg("C2"),  py::arg("C3"),  py::arg("D"))
        .def("RefRadius",
...
;
    ...
    static_cast<py::class_<Geom_RectangularTrimmedSurface ,opencascade::handle<Geom_RectangularTrimmedSurface>  , Geom_BoundedSurface >>(m.attr("Geom_RectangularTrimmedSurface"))
        ...
        .def("Bounds",
             (void (Geom_RectangularTrimmedSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_RectangularTrimmedSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_RectangularTrimmedSurface::Bounds),
             R"#(Returns the parametric bounds U1, U2, V1 and V2 of this patch.)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Continuity",
        ...
        .def("TransformParameters",
             (void (Geom_RectangularTrimmedSurface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const) static_cast<void (Geom_RectangularTrimmedSurface::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const>(&Geom_RectangularTrimmedSurface::TransformParameters),
             R"#(Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>.)#"  , py::arg("U"),  py::arg("V"),  py::arg("T"))
        .def("ParametricTransformation",
...
;
    ...
    static_cast<py::class_<Geom_ToroidalSurface ,opencascade::handle<Geom_ToroidalSurface>  , Geom_ElementarySurface >>(m.attr("Geom_ToroidalSurface"))
        ...
        .def("Bounds",
             (void (Geom_ToroidalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_ToroidalSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_ToroidalSurface::Bounds),
             R"#(Returns the parametric bounds U1, U2, V1 and V2 of this torus. For a torus: U1 = V1 = 0 and U2 = V2 = 2*PI .)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Coefficients",
...
;
    ...
    static_cast<py::class_<Geom_Transformation ,opencascade::handle<Geom_Transformation>  , Standard_Transient >>(m.attr("Geom_Transformation"))
        ...
        .def("Transforms",
             (void (Geom_Transformation::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_Transformation::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_Transformation::Transforms),
             R"#(Applies the transformation <me> to the triplet {X, Y, Z}.)#"  , py::arg("theX"),  py::arg("theY"),  py::arg("theZ"))
        .def("Copy",
...
;
    ...
    static_cast<py::class_<Geom_SurfaceOfRevolution ,opencascade::handle<Geom_SurfaceOfRevolution>  , Geom_SweptSurface >>(m.attr("Geom_SurfaceOfRevolution"))
        ...
        .def("TransformParameters",
             (void (Geom_SurfaceOfRevolution::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const) static_cast<void (Geom_SurfaceOfRevolution::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const>(&Geom_SurfaceOfRevolution::TransformParameters),
             R"#(Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>.)#"  , py::arg("U"),  py::arg("V"),  py::arg("T"))
        .def("ParametricTransformation",
             ...
             R"#(Returns a 2d transformation used to find the new parameters of a point on the transformed surface.)#"  , py::arg("T"))
        .def("Bounds",
             (void (Geom_SurfaceOfRevolution::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_SurfaceOfRevolution::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_SurfaceOfRevolution::Bounds),
             R"#(Returns the parametric bounds U1, U2 , V1 and V2 of this surface. A surface of revolution is always complete, so U1 = 0, U2 = 2*PI.)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("IsUClosed",
...
;
    ...
    static_cast<py::class_<Geom_SurfaceOfLinearExtrusion ,opencascade::handle<Geom_SurfaceOfLinearExtrusion>  , Geom_SweptSurface >>(m.attr("Geom_SurfaceOfLinearExtrusion"))
        ...
        .def("Bounds",
             (void (Geom_SurfaceOfLinearExtrusion::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_SurfaceOfLinearExtrusion::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_SurfaceOfLinearExtrusion::Bounds),
             R"#(Returns the parametric bounds U1, U2, V1 and V2 of this surface of linear extrusion. A surface of linear extrusion is infinite in the v parametric direction, so: - V1 = Standard_Real::RealFirst() - V2 = Standard_Real::RealLast().)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("IsUClosed",
        ...
        .def("TransformParameters",
             (void (Geom_SurfaceOfLinearExtrusion::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const) static_cast<void (Geom_SurfaceOfLinearExtrusion::*)( Standard_Real & ,  Standard_Real & ,  const gp_Trsf &  ) const>(&Geom_SurfaceOfLinearExtrusion::TransformParameters),
             R"#(Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>.)#"  , py::arg("U"),  py::arg("V"),  py::arg("T"))
        .def("ParametricTransformation",
...
;
    ...
    static_cast<py::class_<Geom_BSplineSurface ,opencascade::handle<Geom_BSplineSurface>  , Geom_BoundedSurface >>(m.attr("Geom_BSplineSurface"))
        ...
        .def("PeriodicNormalization",
             (void (Geom_BSplineSurface::*)( Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_BSplineSurface::*)( Standard_Real & ,  Standard_Real &  ) const>(&Geom_BSplineSurface::PeriodicNormalization),
             R"#(returns the parameter normalized within the period if the surface is periodic : otherwise does not do anything)#"  , py::arg("U"),  py::arg("V"))
        .def("SetUOrigin",
        ...
        .def("LocateU",
             (void (Geom_BSplineSurface::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const) static_cast<void (Geom_BSplineSurface::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const>(&Geom_BSplineSurface::LocateU),
        ...
        .def("LocateV",
             (void (Geom_BSplineSurface::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const) static_cast<void (Geom_BSplineSurface::*)( const Standard_Real ,  const Standard_Real ,  Standard_Integer & ,  Standard_Integer & ,  const Standard_Boolean  ) const>(&Geom_BSplineSurface::LocateV),
        ...
        .def("MovePoint",
             (void (Geom_BSplineSurface::*)( const Standard_Real ,  const Standard_Real ,  const gp_Pnt & ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) ) static_cast<void (Geom_BSplineSurface::*)( const Standard_Real ,  const Standard_Real ,  const gp_Pnt & ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  const Standard_Integer ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer & ,  Standard_Integer &  ) >(&Geom_BSplineSurface::MovePoint),
        ...
        .def("Bounds",
             (void (Geom_BSplineSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const) static_cast<void (Geom_BSplineSurface::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Real &  ) const>(&Geom_BSplineSurface::Bounds),
             R"#(Returns the parametric bounds of the surface. Warnings : These parametric values are the bounds of the array of knots UKnots and VKnots only if the first knots and the last knots have a multiplicity equal to UDegree + 1 or VDegree + 1)#"  , py::arg("U1"),  py::arg("U2"),  py::arg("V1"),  py::arg("V2"))
        .def("Continuity",
        ...
        .def("Resolution",
             (void (Geom_BSplineSurface::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) ) static_cast<void (Geom_BSplineSurface::*)( const Standard_Real ,  Standard_Real & ,  Standard_Real &  ) >(&Geom_BSplineSurface::Resolution),
