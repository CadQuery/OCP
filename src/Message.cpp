...
;
    ...
    static_cast<py::class_<Message_ProgressSentry ,std::unique_ptr<Message_ProgressSentry>  >>(m.attr("Message_ProgressSentry"))
...
;
    ...
    register_default_constructor<Message_MsgFile ,std::unique_ptr<Message_MsgFile>>(m,"Message_MsgFile");

    static_cast<py::class_<Message_MsgFile ,std::unique_ptr<Message_MsgFile>  >>(m.attr("Message_MsgFile"))
        .def_static("Load_s",
...
;
    ...
    static_cast<py::class_<Message_ProgressIndicator ,opencascade::handle<Message_ProgressIndicator> ,Py_Message_ProgressIndicator , Standard_Transient >>(m.attr("Message_ProgressIndicator"))
        ...
        .def("GetScale",
             (void (Message_ProgressIndicator::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Boolean &  ) const) static_cast<void (Message_ProgressIndicator::*)( Standard_Real & ,  Standard_Real & ,  Standard_Real & ,  Standard_Boolean &  ) const>(&Message_ProgressIndicator::GetScale),
             R"#(Returns all parameters for current scale)#"  , py::arg("min"),  py::arg("max"),  py::arg("step"),  py::arg("isInf"))
        .def("SetValue",
...
;
    ...
    register_default_constructor<Message ,std::unique_ptr<Message>>(m,"Message");

    static_cast<py::class_<Message ,std::unique_ptr<Message>  >>(m.attr("Message"))
...
;
    ...
    static_cast<py::class_<Message_Msg ,std::unique_ptr<Message_Msg>  >>(m.attr("Message_Msg"))
        .def(py::init<  >()  )
...
;
    ...
    static_cast<py::class_<Message_ProgressScale ,std::unique_ptr<Message_ProgressScale>  >>(m.attr("Message_ProgressScale"))
        .def(py::init<  >()  )
        .def("SetName",
