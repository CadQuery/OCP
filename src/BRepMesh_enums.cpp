...
// classes forward declarations only
    ...
    py::class_<BRepMesh_CircleInspector , shared_ptr<BRepMesh_CircleInspector>  >(m,"BRepMesh_CircleInspector",R"#(Auxilary class to find circles shot by the given point.)#");
    ...
    py::class_<BRepMesh_Classifier , shared_ptr<BRepMesh_Classifier>  >(m,"BRepMesh_Classifier",R"#(Auxilary class contains information about correctness of discretized face and used for classification of points regarding face internals.)#");
    ...
    py::class_<BRepMesh_EdgeParameterProvider , shared_ptr<BRepMesh_EdgeParameterProvider>  >(m,"BRepMesh_EdgeParameterProvider",R"#(Auxiliary class provides correct parameters on curve regarding SameParameter flag.)#");
    ...
    py::class_<BRepMesh_PairOfPolygon , shared_ptr<BRepMesh_PairOfPolygon>  >(m,"BRepMesh_PairOfPolygon",R"#(None)#");
    py::class_<BRepMesh_SelectorOfDataStructureOfDelaun , shared_ptr<BRepMesh_SelectorOfDataStructureOfDelaun>  >(m,"BRepMesh_SelectorOfDataStructureOfDelaun",R"#(Describes a selector and an iterator on a selector of components of a mesh.)#");
    py::class_<BRepMesh_ShapeTool , shared_ptr<BRepMesh_ShapeTool>  >(m,"BRepMesh_ShapeTool",R"#(None)#");
    ...
    py::class_<BRepMesh_VertexInspector , shared_ptr<BRepMesh_VertexInspector>  >(m,"BRepMesh_VertexInspector",R"#(Class intended for fast searching of the coincidence points.)#");
    py::class_<BRepMesh_VertexTool , shared_ptr<BRepMesh_VertexTool>  >(m,"BRepMesh_VertexTool",R"#(Describes data structure intended to keep mesh nodes defined in UV space and implements functionality providing their uniqueness regarding thir position.)#");
    py::class_<BRepMesh_WireChecker , shared_ptr<BRepMesh_WireChecker>  >(m,"BRepMesh_WireChecker",R"#(Auxilary class intended to check correctness of discretized face. In particular, checks boundaries of discretized face for self intersections and gaps.)#");
    py::class_<BRepMesh_WireInterferenceChecker , shared_ptr<BRepMesh_WireInterferenceChecker>  >(m,"BRepMesh_WireInterferenceChecker",R"#(Auxilary class implementing functionality for checking interference between two discretized wires.)#");
