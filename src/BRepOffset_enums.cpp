...
// classes forward declarations only
    py::class_<BRepOffset ,std::unique_ptr<BRepOffset>  >(m,"BRepOffset",R"#(Auxiliary tools for offset algorithms)#");
    ...
    py::class_<BRepOffset_MakeSimpleOffset ,std::unique_ptr<BRepOffset_MakeSimpleOffset>  >(m,"BRepOffset_MakeSimpleOffset",R"#(Limitations: According to the algorithm nature result depends on the smoothness of input data. Smooth (G1-continuity) input shape will lead to the good result.)#");
    py::class_<BRepOffset_Interval ,std::unique_ptr<BRepOffset_Interval>  >(m,"BRepOffset_Interval",R"#(None)#");
    py::class_<BRepOffset_Offset ,std::unique_ptr<BRepOffset_Offset>  >(m,"BRepOffset_Offset",R"#(This class compute elemenary offset surface. Evaluate the offset generated : 1 - from a face. 2 - from an edge. 3 - from a vertex.)#");
    py::class_<BRepOffset_MakeLoops ,std::unique_ptr<BRepOffset_MakeLoops>  >(m,"BRepOffset_MakeLoops",R"#(None)#");
    py::class_<BRepOffset_Inter2d ,std::unique_ptr<BRepOffset_Inter2d>  >(m,"BRepOffset_Inter2d",R"#(Computes the intersections betwwen edges on a face stores result is SD as AsDes from BRepOffset.)#");
    py::class_<BRepOffset_Analyse ,std::unique_ptr<BRepOffset_Analyse>  >(m,"BRepOffset_Analyse",R"#(Analyse of a shape consit to Find the part of edges convex concave tangent.)#");
    py::class_<BRepOffset_Inter3d ,std::unique_ptr<BRepOffset_Inter3d>  >(m,"BRepOffset_Inter3d",R"#(Computes the intersection face face in a set of faces Store the result in a SD as AsDes.)#");
    py::class_<BRepOffset_Tool ,std::unique_ptr<BRepOffset_Tool>  >(m,"BRepOffset_Tool",R"#(None)#");
    py::class_<BRepOffset_MakeOffset ,std::unique_ptr<BRepOffset_MakeOffset>  >(m,"BRepOffset_MakeOffset",R"#(None)#");
