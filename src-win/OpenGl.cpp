...
;
    ...
    // methods
        ...
        .def("Init",
             (Standard_Boolean (OpenGl_Context::*)( const Aspect_Handle , const Aspect_Handle , const Aspect_RenderingContext , const Standard_Boolean ) ) static_cast<Standard_Boolean (OpenGl_Context::*)( const Aspect_Handle , const Aspect_Handle , const Aspect_RenderingContext , const Standard_Boolean ) >(&OpenGl_Context::Init),
             R"#(Initialize class from specified window and rendering context. Method should be called only once.)#"  , py::arg("theWindow"),  py::arg("theWindowDC"),  py::arg("theGContext"),  py::arg("theIsCoreProfile")=static_cast<const Standard_Boolean>(Standard_False))
        .def("Window",
             (Aspect_Handle (OpenGl_Context::*)() const) static_cast<Aspect_Handle (OpenGl_Context::*)() const>(&OpenGl_Context::Window),
             R"#(Returns the window handle (HWND) currently bound to this OpenGL context)#" )
        .def("CheckExtension",
