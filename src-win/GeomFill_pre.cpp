...
// classes forward declarations only
    ...
    py::class_<GeomFill_CornerState , shared_ptr<GeomFill_CornerState> >(m,"GeomFill_CornerState",R"#(Class (should be a structure) storing the informations about continuity, normals parallelism, coons conditions and bounds tangents angle on the corner of contour to be filled.)#");
    py::class_<GeomFill_Filling , shared_ptr<GeomFill_Filling> >(m,"GeomFill_Filling",R"#(Root class for Filling;)#");
    py::class_<GeomFill_FunctionDraft , shared_ptr<GeomFill_FunctionDraft> , math_FunctionSetWithDerivatives>(m,"GeomFill_FunctionDraft",R"#(None)#");
    py::class_<GeomFill_FunctionGuide , shared_ptr<GeomFill_FunctionGuide> , math_FunctionSetWithDerivatives>(m,"GeomFill_FunctionGuide",R"#(None)#");
    py::class_<GeomFill_HArray1OfLocationLaw ,opencascade::handle<GeomFill_HArray1OfLocationLaw> , GeomFill_Array1OfLocationLaw, Standard_Transient>(m,"GeomFill_HArray1OfLocationLaw",R"#()#");
    py::class_<GeomFill_HArray1OfSectionLaw ,opencascade::handle<GeomFill_HArray1OfSectionLaw> , GeomFill_Array1OfSectionLaw, Standard_Transient>(m,"GeomFill_HArray1OfSectionLaw",R"#()#");
    py::class_<GeomFill_HSequenceOfAx2 ,opencascade::handle<GeomFill_HSequenceOfAx2> , GeomFill_SequenceOfAx2, Standard_Transient>(m,"GeomFill_HSequenceOfAx2",R"#()#");
    ...
    py::class_<GeomFill_LocFunction , shared_ptr<GeomFill_LocFunction> >(m,"GeomFill_LocFunction",R"#(None)#");
    ...
    py::class_<GeomFill_Pipe , shared_ptr<GeomFill_Pipe> >(m,"GeomFill_Pipe",R"#(Describes functions to construct pipes. A pipe is built by sweeping a curve (the section) along another curve (the path). The Pipe class provides the following types of construction: - pipes with a circular section of constant radius, - pipes with a constant section, - pipes with a section evolving between two given curves. All standard specific cases are detected in order to build, where required, a plane, cylinder, cone, sphere, torus, surface of linear extrusion or surface of revolution. Generally speaking, the result is a BSpline surface (NURBS). A Pipe object provides a framework for: - defining the pipe to be built, - implementing the construction algorithm, and - consulting the resulting surface. There are several methods to instantiate a Pipe: 1) give a path and a radius : the section is a circle. This location is the first point of the path, and this direction is the first derivate (calculate at the first point ) of the path.)#");
    py::class_<GeomFill_PlanFunc , shared_ptr<GeomFill_PlanFunc> , math_FunctionWithDerivative>(m,"GeomFill_PlanFunc",R"#(None)#");
    py::class_<GeomFill_PolynomialConvertor , shared_ptr<GeomFill_PolynomialConvertor> >(m,"GeomFill_PolynomialConvertor",R"#(To convert circular section in polynome)#");
    py::class_<GeomFill_Profiler , shared_ptr<GeomFill_Profiler> >(m,"GeomFill_Profiler",R"#(Evaluation of the common BSplineProfile of a group of curves from Geom. All the curves will have the same degree, the same knot-vector, so the same number of poles.)#");
    py::class_<GeomFill_QuasiAngularConvertor , shared_ptr<GeomFill_QuasiAngularConvertor> >(m,"GeomFill_QuasiAngularConvertor",R"#(To convert circular section in QuasiAngular Bezier form)#");
    ...
    py::class_<GeomFill_SectionPlacement , shared_ptr<GeomFill_SectionPlacement> >(m,"GeomFill_SectionPlacement",R"#(To place section in sweep Function)#");
    py::class_<GeomFill_SnglrFunc , shared_ptr<GeomFill_SnglrFunc> , Adaptor3d_Curve>(m,"GeomFill_SnglrFunc",R"#(to represent function C'(t)^C''(t))#");
    py::class_<GeomFill_Sweep , shared_ptr<GeomFill_Sweep> >(m,"GeomFill_Sweep",R"#(Geometrical Sweep Algorithm)#");
    ...
    py::class_<GeomFill_SweepSectionGenerator , shared_ptr<GeomFill_SweepSectionGenerator> >(m,"GeomFill_SweepSectionGenerator",R"#(class for instantiation of AppBlend. evaluate the sections of a sweep surface.)#");
    py::class_<GeomFill_Tensor , shared_ptr<GeomFill_Tensor> >(m,"GeomFill_Tensor",R"#(used to store the "gradient of gradient")#");
    ...
    py::class_<GeomFill_Coons , shared_ptr<GeomFill_Coons> , GeomFill_Filling>(m,"GeomFill_Coons",R"#(None)#");
    ...
    py::class_<GeomFill_Curved , shared_ptr<GeomFill_Curved> , GeomFill_Filling>(m,"GeomFill_Curved",R"#(None)#");
    ...
    py::class_<GeomFill_Generator , shared_ptr<GeomFill_Generator> , GeomFill_Profiler>(m,"GeomFill_Generator",R"#(Create a surface using generating lines. Inherits profiler. The surface will be a BSplineSurface passing by all the curves described in the generator. The VDegree of the resulting surface is 1.)#");
    ...
    py::class_<GeomFill_SectionGenerator , shared_ptr<GeomFill_SectionGenerator> , GeomFill_Profiler>(m,"GeomFill_SectionGenerator",R"#(gives the functions needed for instantiation from AppSurf in AppBlend. Allow to evaluate a surface passing by all the curves if the Profiler.)#");
    ...
    py::class_<GeomFill_Stretch , shared_ptr<GeomFill_Stretch> , GeomFill_Filling>(m,"GeomFill_Stretch",R"#(None)#");
