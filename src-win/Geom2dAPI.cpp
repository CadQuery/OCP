...
// classes
    ...
    // methods using call by reference i.s.o. return
        .def("Parameters",
             []( Geom2dAPI_ExtremaCurveCurve &self , const Standard_Integer Index ){ Standard_Real  U1; Standard_Real  U2; self.Parameters(Index,U1,U2); return std::make_tuple(U1,U2); },
        ...
        .def("LowerDistanceParameters",
             []( Geom2dAPI_ExtremaCurveCurve &self   ){ Standard_Real  U1; Standard_Real  U2; self.LowerDistanceParameters(U1,U2); return std::make_tuple(U1,U2); },
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Parameter",
             []( Geom2dAPI_ProjectPointOnCurve &self , const Standard_Integer Index ){ Standard_Real  U; self.Parameter(Index,U); return std::make_tuple(U); },
             R"#(Returns the parameter on the curve of a point which is the orthogonal projection. Index is a number of a computed projected point. Exceptions Standard_OutOfRange if Index is not in the range [ 1,NbPoints ], where NbPoints is the number of solution points)#"  , py::arg("Index"))
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
