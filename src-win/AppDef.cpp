...
;
    ...
    // methods using call by reference i.s.o. return
        .def("ErrorGradient",
             []( AppDef_BSpParLeastSquareOfMyBSplGradientOfBSplineCompute &self , math_Vector & Grad ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.ErrorGradient(Grad,F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
        ...
        .def("Error",
             []( AppDef_BSpParLeastSquareOfMyBSplGradientOfBSplineCompute &self   ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.Error(F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Error",
             []( AppDef_BSplineCompute &self   ){ Standard_Real  tol3d; Standard_Real  tol2d; self.Error(tol3d,tol2d); return std::make_tuple(tol3d,tol2d); },
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Error",
             []( AppDef_Compute &self , const Standard_Integer Index ){ Standard_Real  tol3d; Standard_Real  tol2d; self.Error(Index,tol3d,tol2d); return std::make_tuple(tol3d,tol2d); },
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("ErrorGradient",
             []( AppDef_ParLeastSquareOfMyGradientOfCompute &self , math_Vector & Grad ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.ErrorGradient(Grad,F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances. Grad is the derivative vector of the function F.)#"  , py::arg("Grad"))
        .def("Error",
             []( AppDef_ParLeastSquareOfMyGradientOfCompute &self   ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.Error(F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances.)#" )
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("ErrorGradient",
             []( AppDef_ParLeastSquareOfMyGradientbisOfBSplineCompute &self , math_Vector & Grad ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.ErrorGradient(Grad,F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances. Grad is the derivative vector of the function F.)#"  , py::arg("Grad"))
        .def("Error",
             []( AppDef_ParLeastSquareOfMyGradientbisOfBSplineCompute &self   ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.Error(F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances.)#" )
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("ErrorGradient",
             []( AppDef_ParLeastSquareOfTheGradient &self , math_Vector & Grad ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.ErrorGradient(Grad,F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances. Grad is the derivative vector of the function F.)#"  , py::arg("Grad"))
        .def("Error",
             []( AppDef_ParLeastSquareOfTheGradient &self   ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.Error(F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances.)#" )
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("ErrorGradient",
             []( AppDef_TheLeastSquares &self , math_Vector & Grad ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.ErrorGradient(Grad,F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances. Grad is the derivative vector of the function F.)#"  , py::arg("Grad"))
        .def("Error",
             []( AppDef_TheLeastSquares &self   ){ Standard_Real  F; Standard_Real  MaxE3d; Standard_Real  MaxE2d; self.Error(F,MaxE3d,MaxE2d); return std::make_tuple(F,MaxE3d,MaxE2d); },
             R"#(returns the maximum errors between the MultiLine and the approximation curves. F is the sum of the square distances.)#" )
    // static methods
    // static methods using call by reference i.s.o. return
    // operators
...
;
    ...
    // methods using call by reference i.s.o. return
        .def("Criterium",
             []( AppDef_Variational &self   ){ Standard_Real  VFirstOrder; Standard_Real  VSecondOrder; Standard_Real  VThirdOrder; self.Criterium(VFirstOrder,VSecondOrder,VThirdOrder); return std::make_tuple(VFirstOrder,VSecondOrder,VThirdOrder); },
             R"#(returns the values of the quality criterium.)#" )
        .def("CriteriumWeight",
             []( AppDef_Variational &self   ){ Standard_Real  Percent1; Standard_Real  Percent2; Standard_Real  Percent3; self.CriteriumWeight(Percent1,Percent2,Percent3); return std::make_tuple(Percent1,Percent2,Percent3); },
