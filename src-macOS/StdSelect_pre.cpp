...
// classes forward declarations only
    ...
    py::class_<StdSelect_Prs , shared_ptr<StdSelect_Prs> >(m,"StdSelect_Prs",R"#(allows entities owners to be hilighted independantly from PresentableObjectsallows entities owners to be hilighted independantly from PresentableObjectsallows entities owners to be hilighted independantly from PresentableObjects)#");
