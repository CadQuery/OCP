...
// classes forward declarations only
    ...
    py::class_<Geom2dGcc_FunctionTanCuCuCu , shared_ptr<Geom2dGcc_FunctionTanCuCuCu> , math_FunctionSetWithDerivatives>(m,"Geom2dGcc_FunctionTanCuCuCu",R"#(This abstract class describes a set on N Functions of M independant variables.)#");
    py::class_<Geom2dGcc_FunctionTanCuCuOnCu , shared_ptr<Geom2dGcc_FunctionTanCuCuOnCu> , math_FunctionSetWithDerivatives>(m,"Geom2dGcc_FunctionTanCuCuOnCu",R"#(This abstract class describes a set on N Functions of M independant variables.)#");
