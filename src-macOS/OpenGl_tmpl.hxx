...
template <typename theBaseClass_t>
void preregister_template_OpenGl_TmplCore45(py::object &m, const char *name){
    py::class_<OpenGl_TmplCore45<theBaseClass_t> , shared_ptr<OpenGl_TmplCore45<theBaseClass_t>> >(m,name,R"#(OpenGL 4.5 definition.)#");
}

template <typename theBaseClass_t>
void register_template_OpenGl_TmplCore45(py::object &m, const char *name){
    static_cast<py::class_<OpenGl_TmplCore45<theBaseClass_t> , shared_ptr<OpenGl_TmplCore45<theBaseClass_t>> >>(m.attr(name))
    ;
};
